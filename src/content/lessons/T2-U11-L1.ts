...
export const T2U11L1: Lesson = {
  ...
  quiz: {
    pool: [
      // @q01
      { id: "U11L1-mcq-1", type: "mcq", category: "procedural", prompt: "If x + 3 = 11, what is x?", options: [ { id: "a", text: "8" }, { id: "b", text: "14" }, { id: "c", text: "3" }, { id: "d", text: "11" } ], correctOptionId: "a", diagnoses: { b: "14 is 11 + 3 — you added instead of undoing.", c: "3 is the number added, not the unknown.", d: "11 is the total, not x." }, explanation: "Undo the +3: x = 11 − 3 = 8.", hints: ["Undo the +3.", "11 − 3.", "8."] },
      // @q02
      { id: "U11L1-mcq-2", type: "mcq", category: "conceptual", prompt: "What does 2x mean?", options: [ { id: "a", text: "2 × x" }, { id: "b", text: "2 + x" }, { id: "c", text: "x²" }, { id: "d", text: "x + 2" } ], correctOptionId: "a", diagnoses: { b: "2 + x is written 2 + x, not 2x.", c: "x² is x × x.", d: "x + 2 is addition, not multiplication." }, explanation: "A number next to a letter means multiply: 2x = 2 × x.", hints: ["Adjacent number and letter = multiply.", "2x = 2 × x.", "2 × x."] },
      // @q03
      { id: "U11L1-mcq-3", type: "mcq", category: "word", prompt: "A number is doubled, then 5 is added, giving 17. Which equation matches?", options: [ { id: "a", text: "2x + 5 = 17" }, { id: "b", text: "x + 2 + 5 = 17" }, { id: "c", text: "2(x + 5) = 17" }, { id: "d", text: "x + 5 = 17" } ], correctOptionId: "a", diagnoses: { b: "Doubling means ×2, not +2.", c: "The 5 is added AFTER doubling, not inside.", d: "Missing the doubling of x." }, explanation: "Double x (2x), then add 5: 2x + 5 = 17.", hints: ["Double first: 2x.", "Then add 5.", "2x + 5 = 17."] },
      // @q04
      { id: "U11L1-mcq-4", type: "mcq", category: "procedural", prompt: "If 2x = 10, what is x?", options: [ { id: "a", text: "5" }, { id: "b", text: "20" }, { id: "c", text: "8" }, { id: "d", text: "12" } ], correctOptionId: "a", diagnoses: { b: "20 is 2 × 10 — you multiplied instead of dividing.", c: "8 is 10 − 2, wrong operation.", d: "12 is 10 + 2, wrong operation." }, explanation: "Undo the ×2: x = 10 ÷ 2 = 5.", hints: ["Undo the ×2.", "10 ÷ 2.", "5."] },
      // @q05
      { id: "U11L1-mcq-5", type: "mcq", category: "conceptual", prompt: "Why is x = 8 the correct solution to x + 3 = 11?", options: [ { id: "a", text: "8 + 3 = 11, so it checks" }, { id: "b", text: "8 is the biggest number" }, { id: "c", text: "8 is half of 16" }, { id: "d", text: "It looks right" } ], correctOptionId: "a", diagnoses: { b: "Size is irrelevant — only the check matters.", c: "Unrelated fact.", d: "Math needs a verifiable reason." }, explanation: "Substituting x = 8 gives 8 + 3 = 11 — the equation reads true, so the solution is verified.", hints: ["Plug 8 in for x.", "8 + 3 = 11.", "It checks."] },
      // @q06
      { id: "U11L1-mcq-6", type: "mcq", category: "word", prompt: "Some money m is shared, then $8 is added and the total becomes $20. Which equation matches?", options: [ { id: "a", text: "m + 8 = 20" }, { id: "b", text: "8m = 20" }, { id: "c", text: "m − 8 = 20" }, { id: "d", text: "m = 20 + 8" } ], correctOptionId: "a", diagnoses: { b: "8m means $8 per share, not adding $8.", c: "Money was added, not removed.", d: "m = 12, not 28 — the +8 is undone by subtracting." }, explanation: "Start with m, add 8, end at 20: m + 8 = 20, so m = 12.", hints: ["Start with m.", "Add 8 → m + 8 = 20.", "m = 12."] },
      // @q07
      { id: "U11L1-num-1", type: "numeric-input", category: "procedural", prompt: "Solve: x − 4 = 9. Type x.", answer: 13, tolerance: 0, explanation: "Undo the −4 by adding 4: x = 9 + 4 = 13.", hints: ["Undo the −4.", "9 + 4.", "13."] },
      // @q08
      { id: "U11L1-num-2", type: "numeric-input", category: "procedural", prompt: "Solve: 3x = 21. Type x.", answer: 7, tolerance: 0, explanation: "Undo the ×3 by dividing: x = 21 ÷ 3 = 7.", hints: ["Undo the ×3.", "21 ÷ 3.", "7."] },
      // @q09
      { id: "U11L1-num-3", type: "numeric-input", category: "conceptual", prompt: "A number doubled, then minus 1, equals 9. If x is the number, type x.", answer: 5, tolerance: 0, explanation: "2x − 1 = 9 → 2x = 10 → x = 5.", hints: ["Undo −1 first: 2x = 10.", "Then ÷2.", "5."] },
      // @q10
      { id: "U11L1-frac-1", type: "fraction-input", category: "conceptual", prompt: "If 2x = 1, what is x? Write it as a fraction.", numerator: 1, denominator: 2, acceptEquivalent: true, explanation: "x = 1 ÷ 2 = 1/2.", hints: ["Divide both sides by 2.", "1 ÷ 2.", "1/2."] },
      // @q11
      { id: "U11L1-tf-1", type: "true-false-justify", category: "conceptual", prompt: "If x + 5 = 12, then x = 7.", isTrue: true, explanation: "x = 12 − 5 = 7, and 7 + 5 = 12 checks.", hints: ["Undo the +5.", "12 − 5 = 7.", "True."] },
      // @q12
      { id: "U11L1-tf-2", type: "true-false-justify", category: "conceptual", prompt: "2x = 10 means x = 20.", isTrue: false, explanation: "Undo the ×2: x = 10 ÷ 2 = 5, not 20.", hints: ["Divide, don't multiply.", "10 ÷ 2.", "False — x = 5."] },
      // @q13
      ...
      // @q14
      { id: "U11L1-drag-1", type: "drag-match", category: "conceptual", prompt: "Match each equation to its solution.", pairs: [ { source: "x + 2 = 7", target: "5" }, { source: "3x = 15", target: "5" }, { source: "x − 1 = 4", target: "5" } ], diagnoses: { "x + 2 = 7->6": "7 − 2 = 5.", "3x = 15->12": "15 ÷ 3 = 5.", "x − 1 = 4->3": "4 + 1 = 5." }, explanation: "Each solves to x = 5: 7−2, 15÷3, 4+1.", hints: ["Undo the operation on each.", "All three give the same x.", "Match to 5."] },
      // @q15
      { id: "U11L1-graph-1", type: "graph-interact", category: "word", prompt: "The slider holds the unknown x. Set it so x + 4 = 9 (key: value).", challenge: "Set the slider to 5.", validate: { value: 5 }, tolerance: 0, explanation: "x = 9 − 4 = 5.", hints: ["Undo the +4.", "9 − 4.", "5."] }
    ],
