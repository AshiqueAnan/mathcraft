...
export const T4U29L4: Lesson = {
  ...
  quiz: {
    pool: [
      ...
      // @q02
      { id: "U29L4-mcq-2", type: "mcq", category: "conceptual", prompt: "Independent events satisfy…", options: [ { id: "a", text: "P(A and B) = P(A) × P(B)" }, { id: "b", text: "P(A and B) = 0 always" }, { id: "c", text: "P(A and B) = P(A) + P(B)" }, { id: "d", text: "P(B) changes after A" } ], correctOptionId: "a", diagnoses: { b: "That's mutually exclusive.", c: "Addition is for OR with overlap.", d: "Independence means no change." }, explanation: "One outcome doesn't influence the other — the product rule applies.", hints: ["No influence.", "Multiply.", "P(A) × P(B)."] },
      // @q03
      { id: "U29L4-mcq-3", type: "mcq", category: "word", prompt: "Bag: 2 red, 3 blue. WITHOUT replacement, P(red then red) = …", options: [ { id: "a", text: "2/5 × 1/4 = 1/10" }, { id: "b", text: "2/5 × 2/5 = 4/25" }, { id: "c", text: "2/5 + 1/4" }, { id: "d", text: "1/2" } ], correctOptionId: "a", diagnoses: { b: "4/25 assumes replacement — the bag changed.", c: "Would need OR logic, not AND.", d: "1/2 isn't this product." }, explanation: "First red 2/5; one red removed leaves 1 red of 4 → multiply 2/5 × 1/4.", hints: ["Bag shrinks.", "2/5 then 1/4.", "1/10."] },
      // @q04
      { id: "U29L4-mcq-4", type: "mcq", category: "procedural", prompt: "P(A) = 0.4, P(B) = 0.5, independent. P(A and B) = …", options: [ { id: "a", text: "0.2" }, { id: "b", text: "0.9" }, { id: "c", text: "0.1" }, { id: "d", text: "0.45" } ], correctOptionId: "a", diagnoses: { b: "0.9 is P(A or B) without subtracting overlap.", c: "0.1 subtracts — wrong operation.", d: "0.45 averages." }, explanation: "0.4 × 0.5 = 0.2.", hints: ["Multiply.", "0.4 × 0.5.", "0.2."] },
      // @q05
      ...
      // @q06
      { id: "U29L4-mcq-6", type: "mcq", category: "word", prompt: "P(A) = 0.5, P(B) = 0.3, P(A and B) = 0.15. P(A or B) = …", options: [ { id: "a", text: "0.65" }, { id: "b", text: "0.8" }, { id: "c", text: "0.5" }, { id: "d", text: "0.35" } ], correctOptionId: "a", diagnoses: { b: "0.8 adds without subtracting the overlap.", c: "0.5 is just P(A).", d: "0.35 subtracts everything." }, explanation: "0.5 + 0.3 − 0.15 = 0.65 — subtract the double-counted overlap.", hints: ["Add, subtract overlap.", "0.8 − 0.15.", "0.65."] },
      // @q07
