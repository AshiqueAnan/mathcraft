...
export const T3U23L1: Lesson = {
  ...
  quiz: {
    pool: [
      // @q01
      { id: "U23L1-mcq-1", type: "mcq", category: "procedural", prompt: "A rectangle is 7 m by 4 m. Its area is…", options: [ { id: "a", text: "28 m²" }, { id: "b", text: "11 m²" }, { id: "c", text: "22 m²" }, { id: "d", text: "14 m²" } ], correctOptionId: "a", diagnoses: { b: "That's length + width, not ×.", c: "That's the perimeter (2 of each) — area is ×.", d: "That's only twice the width." }, explanation: "7 rows of 4 squares = 28 m².", hints: ["Multiply length × width.", "7 × 4.", "7 rows of 4 squares = 28 m²."] },
      // @q02
      { id: "U23L1-mcq-2", type: "mcq", category: "conceptual", prompt: "Why is area measured in square units?", options: [ { id: "a", text: "Squares are prettier than circles" }, { id: "b", text: "We count unit squares inside the shape" }, { id: "c", text: "Because length × width makes squares" }, { id: "d", text: "It's just a convention" } ], correctOptionId: "b", diagnoses: { a: "Aesthetic choice isn't the reason.", c: "The formula creates a square number, but area was counting squares first.", d: "It is a convention — but with a reason: the squares fill the shape." }, explanation: "The unit square is the measuring tile; area reports how many fit.", hints: ["What fills the shape?", "Unit squares.", "Counting tiles."] },
      // @q03
      { id: "U23L1-mcq-3", type: "mcq", category: "word", prompt: "A rug is 12 ft by 9 ft. How many 1 ft squares cover it?", options: [ { id: "a", text: "21" }, { id: "b", text: "42" }, { id: "c", text: "108" }, { id: "d", text: "96" } ], correctOptionId: "c", diagnoses: { b: "42 is 12 + 9 + 21? No — multiply.", a: "21 is half the sum — wrong move.", d: "96 is (12−4)×12 — not the counts on the rug." }, explanation: "12 × 9 = 108 ft².", hints: ["12 rows of 9.", "12 × 9.", "12 × 9 = 108 ft²."] },
      // @q04
      { id: "U23L1-mcq-4", type: "mcq", category: "procedural", prompt: "A parallelogram has base 10 cm and height 6 cm. Area = …", options: [ { id: "a", text: "120 cm²" }, { id: "b", text: "30 cm²" }, { id: "c", text: "16 cm²" }, { id: "d", text: "60 cm²" } ], correctOptionId: "d", diagnoses: { b: "30 halves it — that's the triangle on this base.", c: "16 is base + height — add, not multiply.", a: "120 doubles it — maybe you used 12 as height." }, explanation: "Slide the slice: base × height = 10 × 6 = 60 cm².", hints: ["Cut and slide to a rectangle.", "10 × 6.", "Slide the slice: base × height = 10 × 6 = 60 cm²."] },
      // @q05
      { id: "U23L1-mcq-5", type: "mcq", category: "conceptual", prompt: "Double the base AND height of a rectangle. Its area…", options: [ { id: "a", text: "quadruples" }, { id: "b", text: "doubles" }, { id: "c", text: "stays the same" }, { id: "d", text: "triples" } ], correctOptionId: "a", diagnoses: { b: "Doubling ONE side doubles area; doubling both gives 2×2.", c: "Scaling both sides always changes area.", d: "3× would need base ×3-ish scale." }, explanation: "2l × 2w = 4(lw): four times as many squares.", hints: ["Both sides ×2.", "2 × 2 = 4.", "2l × 2w = 4(lw): four times as many squares."] },
      // @q06
      { id: "U23L1-mcq-6", type: "mcq", category: "word", prompt: "A triangular garden has base 8 m and height 5 m. Its area is…", options: [ { id: "a", text: "40 m²" }, { id: "b", text: "20 m²" }, { id: "c", text: "13 m²" }, { id: "d", text: "80 m²" } ], correctOptionId: "b", diagnoses: { a: "40 is the parallelogram WITHOUT halving.", c: "13 is base + height — area multiplies.", d: "80 multiplies but forgets the half." }, explanation: "½ × 8 × 5 = 20 m².", hints: ["Half a parallelogram.", "½ × 8 × 5.", "½ × 8 × 5 = 20 m²."] },
      // @q07
      { id: "U23L1-num-1", type: "numeric-input", category: "procedural", prompt: "Rectangle 9 cm by 6 cm — area in cm².", answer: 54, tolerance: 0, unit: "cm²", explanation: "9 × 6 = 54 cm².", hints: ["Multiply the sides.", "9 × 6.", "9 × 6 = 54 cm²."] },
      // @q08
      { id: "U23L1-num-2", type: "numeric-input", category: "procedural", prompt: "Parallelogram: base 12 m, height 7 m — area in m².", answer: 84, tolerance: 0, unit: "m²", explanation: "Base × height = 12 × 7 = 84 m².", hints: ["Base × perpendicular height.", "12 × 7.", "Base × height = 12 × 7 = 84 m²."] },
      // @q09
      { id: "U23L1-num-3", type: "numeric-input", category: "conceptual", prompt: "Triangle: base 10 cm, height 8 cm — area in cm².", answer: 40, tolerance: 0, unit: "cm²", explanation: "½ × 10 × 8 = 40 cm².", hints: ["Half the rectangle.", "½ × 10 × 8.", "½ × 10 × 8 = 40 cm²."] },
      // @q10
      { id: "U23L1-frac-1", type: "fraction-input", category: "conceptual", prompt: "A triangle sits on a parallelogram's base with the same height. What fraction of the parallelogram's area is the triangle?", numerator: 1, denominator: 2, acceptEquivalent: true, explanation: "The triangle is exactly half the parallelogram.", hints: ["Copy + rotate the triangle.", "Half.", "The triangle is exactly half the parallelogram."] },
      // @q11
      { id: "U23L1-tf-1", type: "true-false-justify", category: "conceptual", prompt: "A parallelogram's area is base × slanted-side length.", isTrue: false, explanation: "The height (perpendicular distance) is what multiplies the base, not the slant.", hints: ["Which length is at right angles?", "Perpendicular height.", "The height (perpendicular distance) is what multiplies the base, not the slant."] },
      // @q12
      { id: "U23L1-tf-2", type: "true-false-justify", category: "conceptual", prompt: "Triangles with the same base and height share the same area even if their tips slide.", isTrue: true, explanation: "Sliding the tip keeps base × height the same — area doesn't depend on slant.", hints: ["What does the formula need?", "Only base and height.", "Sliding the tip keeps base × height the same — area doesn't depend on slant."] },
      // @q13
      { id: "U23L1-order-1", type: "order-steps", category: "word", prompt: "Order the steps to find a triangle's area (base 9 cm, height 8 cm).", sequence: ["Multiply base × height: 9 × 8 = 72", "Halve the product: 72 ÷ 2", "Write the unit: 36 cm²"], diagnoses: { "Multiply base × height: 9 × 8 = 72@1": "Multiply first.", "Halve the product: 72 ÷ 2@0": "Halving comes after multiplying.", "Write the unit: 36 cm²@0": "State the value before the unit." }, explanation: "Base × height, then halve, then attach cm².", hints: ["Multiply first.", "Then halve.", "Base × height, then halve, then attach cm²."] },
      // @q14
      ...
      // @q15
      { id: "U23L1-graph-1", type: "graph-interact", category: "word", prompt: "A triangle's base is 8 and its height is 5. Set the slider to its area (key: value).", challenge: "A triangle's base is 8 and its height is 5. — adjust the values below to match the condition.", validate: { value: 20 }, tolerance: 0.01, explanation: "½ × 8 × 5 = 20.", hints: ["Half of 40.", "20.", "½ × 8 × 5 = 20."] }
    ],
