...
export const T1U8L2: Lesson = {
  ...
  quiz: {
    pool: [
      ...
      // @q02
      { id: "U8L2-mcq-2", type: "mcq", category: "conceptual", prompt: "Which shows √20 in fully simplified form?", options: [ { id: "a", text: "5√2" }, { id: "b", text: "2√5" }, { id: "c", text: "2√10" }, { id: "d", text: "√4 × √5" } ], correctOptionId: "b", diagnoses: { a: "5√2 = √50, not √20.", c: "√10 has no square factor, but 20 = 4 × 5 — you missed the 4.", d: "Correct thinking, but √4 × √5 isn't simplified — the 2 must come out." }, explanation: "20 = 4 × 5, so √20 = √4 × √5 = 2√5.", hints: ["Largest square factor of 20?", "20 = 4 × 5.", "2√5."] },
      // @q03
      ...
      // @q04
      { id: "U8L2-mcq-4", type: "mcq", category: "procedural", prompt: "Simplify √72.", options: [ { id: "a", text: "√36 × √2" }, { id: "b", text: "2√18" }, { id: "c", text: "8√9" }, { id: "d", text: "6√2" } ], correctOptionId: "d", diagnoses: { b: "2√18 still has a square factor — √18 = 3√2, so this becomes 6√2.", c: "√9 = 3, so 8√9 = 24 — way too big.", a: "Right split, not simplified — pull the 6 out." }, explanation: "72 = 36 × 2, so √72 = 6√2.", hints: ["Largest square factor of 72?", "72 = 36 × 2.", "6√2."] },
      // @q05
