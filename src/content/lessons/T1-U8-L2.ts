...
export const T1U8L2: Lesson = {
  ...
  quiz: {
    pool: [
      // @q01
      { id: "U8L2-mcq-1", type: "mcq", category: "procedural", prompt: "Simplify √12.", options: [ { id: "a", text: "2√3" }, { id: "b", text: "3√2" }, { id: "c", text: "√12 stays" }, { id: "d", text: "√6" } ], correctOptionId: "a", diagnoses: { b: "3√2 = √18, not √12.", c: "12 has the square factor 4 — it can be tidied.", d: "√6 is √12 halved — wrong value." }, explanation: "12 = 4 × 3, so √12 = √4 × √3 = 2√3.", hints: ["Look for the biggest square factor of 12.", "12 = 4 × 3.", "12 = 4 × 3, so √12 = √4 × √3 = 2√3."] },
      // @q02
      { id: "U8L2-mcq-2", type: "mcq", category: "conceptual", prompt: "Which shows √20 in fully simplified form?", options: [ { id: "a", text: "5√2" }, { id: "b", text: "2√5" }, { id: "c", text: "2√10" }, { id: "d", text: "√4 × √5" } ], correctOptionId: "b", diagnoses: { a: "5√2 = √50, not √20.", c: "√10 has no square factor, but 20 = 4 × 5 — you missed the 4.", d: "Correct thinking, but √4 × √5 isn't simplified — the 2 must come out." }, explanation: "20 = 4 × 5, so √20 = √4 × √5 = 2√5.", hints: ["Largest square factor of 20?", "20 = 4 × 5.", "20 = 4 × 5, so √20 = √4 × √5 = 2√5."] },
      // @q03
      { id: "U8L2-mcq-3", type: "mcq", category: "word", prompt: "A square patch of garden has area 48 m². Which expression is the exact side length, simplified?", options: [ { id: "a", text: "2√12 m" }, { id: "b", text: "3√4 m" }, { id: "c", text: "4√3 m" }, { id: "d", text: "√48 m" } ], correctOptionId: "c", diagnoses: { b: "√4 = 2, so 3√4 = 6 — not the side of area 48.", a: "√48 simplifies further: √48 = 4√3, not 2√12.", d: "√48 is exact but not yet simplified — tidy it." }, explanation: "side = √48 = √(16 × 3) = 4√3 m.", hints: ["side² = area.", "48 = 16 × 3.", "side = √48 = √(16 × 3) = 4√3 m."] },
      // @q04
      { id: "U8L2-mcq-4", type: "mcq", category: "procedural", prompt: "Simplify √72.", options: [ { id: "a", text: "√36 × √2" }, { id: "b", text: "2√18" }, { id: "c", text: "8√9" }, { id: "d", text: "6√2" } ], correctOptionId: "d", diagnoses: { b: "2√18 still has a square factor — √18 = 3√2, so this becomes 6√2.", c: "√9 = 3, so 8√9 = 24 — way too big.", a: "Right split, not simplified — pull the 6 out." }, explanation: "72 = 36 × 2, so √72 = 6√2.", hints: ["Largest square factor of 72?", "72 = 36 × 2.", "72 = 36 × 2, so √72 = 6√2."] },
      // @q05
      { id: "U8L2-mcq-5", type: "mcq", category: "conceptual", prompt: "Which surd is ALREADY fully simplified?", options: [ { id: "a", text: "√21" }, { id: "b", text: "√8" }, { id: "c", text: "√12" }, { id: "d", text: "√27" } ], correctOptionId: "a", diagnoses: { b: "√8 = 2√2 — 4 is a square factor.", c: "√12 = 2√3 — 4 is a square factor.", d: "√27 = 3√3 — 9 is a square factor." }, explanation: "21 = 3 × 7 has no square factor, so √21 stays as is.", hints: ["Which radicand has a square factor?", "21 = 3 × 7 — no square.", "21 = 3 × 7 has no square factor, so √21 stays as is."] },
      // @q06
      { id: "U8L2-mcq-6", type: "mcq", category: "word", prompt: "A tile is a square with side √50 cm. What is its area (exact)?", options: [ { id: "a", text: "25 cm²" }, { id: "b", text: "50 cm²" }, { id: "c", text: "5√2 cm²" }, { id: "d", text: "100 cm²" } ], correctOptionId: "b", diagnoses: { a: "25 is half the radicand — squaring isn't halving.", c: "5√2 is the simplified SIDE, not the area.", d: "That would be a side of 10 cm." }, explanation: "Area = (√50)² = 50 cm² — squaring a surd removes the root.", hints: ["Area = side × side.", "(√50)² = 50.", "Area = (√50)² = 50 cm² — squaring a surd removes the root."] },
      // @q07
      { id: "U8L2-num-1", type: "numeric-input", category: "procedural", prompt: "Simplify √75. Type the number OUTSIDE the root.", answer: 5, tolerance: 0, explanation: "75 = 25 × 3, so √75 = 5√3 — the 5 walks out.", hints: ["Largest square factor of 75?", "75 = 25 × 3.", "75 = 25 × 3, so √75 = 5√3 — the 5 walks out."] },
      // @q08
      { id: "U8L2-num-2", type: "numeric-input", category: "procedural", prompt: "Simplify √98. Type the number OUTSIDE the root.", answer: 7, tolerance: 0, explanation: "98 = 49 × 2, so √98 = 7√2 — the 7 walks out.", hints: ["Largest square factor of 98?", "98 = 49 × 2.", "98 = 49 × 2, so √98 = 7√2 — the 7 walks out."] },
      // @q09
      { id: "U8L2-num-3", type: "numeric-input", category: "conceptual", prompt: "Simplify √80. Type the number OUTSIDE the root.", answer: 4, tolerance: 0, explanation: "80 = 16 × 5, so √80 = 4√5 — the 4 walks out.", hints: ["Largest square factor of 80?", "80 = 16 × 5.", "80 = 16 × 5, so √80 = 4√5 — the 4 walks out."] },
      // @q10
      { id: "U8L2-frac-1", type: "fraction-input", category: "conceptual", prompt: "Simplify √(4/9). Write the answer as a fraction.", numerator: 2, denominator: 3, acceptEquivalent: true, explanation: "√(4/9) = √4 / √9 = 2/3.", hints: ["Root top and bottom separately.", "√4 = 2, √9 = 3.", "√(4/9) = √4 / √9 = 2/3."] },
      // @q11
      { id: "U8L2-tf-1", type: "true-false-justify", category: "conceptual", prompt: "√18 = 3√2.", isTrue: true, explanation: "18 = 9 × 2, so √18 = √9 × √2 = 3√2 — true.", hints: ["Largest square factor of 18?", "18 = 9 × 2.", "18 = 9 × 2, so √18 = √9 × √2 = 3√2 — true."] },
      // @q12
      { id: "U8L2-tf-2", type: "true-false-justify", category: "conceptual", prompt: "√50 is already fully simplified.", isTrue: false, explanation: "50 = 25 × 2, so √50 = 5√2 — it was not simplified.", hints: ["Does 50 have a square factor?", "50 = 25 × 2.", "50 = 25 × 2, so √50 = 5√2 — it was not simplified."] },
      // @q13
