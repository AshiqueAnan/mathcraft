...
export const T2U17L3: Lesson = {
  ...
  quiz: {
    pool: [
      ...
      // @q04
      { id: "U17L3-mcq-4", type: "mcq", category: "procedural", prompt: "3, 9, 27, … What is T(5)?", options: [ { id: "a", text: "729" }, { id: "b", text: "81" }, { id: "c", text: "2430" }, { id: "d", text: "243" } ], correctOptionId: "d", diagnoses: { b: "81 is T(4) — one step early.", c: "×10 is not the ratio.", a: "729 = 3 × 3⁵ — too many powers." }, explanation: "T(5) = 3 × 3⁴ = 3 × 81 = 243.", hints: ["r = 3.", "3 × 3⁴.", "243."] },
      // @q05
      ...
      // @q06
      { id: "U17L3-mcq-6", type: "mcq", category: "word", prompt: "A rabbit population triples each year: 10, 30, 90, … Year 4 = ?", options: [ { id: "a", text: "810" }, { id: "b", text: "270" }, { id: "c", text: "120" }, { id: "d", text: "250" } ], correctOptionId: "b", diagnoses: { a: "810 is year 5 (10 × 3⁴).", c: "120 = 10 + 30 + … — that's adding.", d: "10 × 3³ = 270, not 250." }, explanation: "Year 1 = 10 → year 4 = 10 × 3³ = 270.", hints: ["3 jumps to year 4.", "10 × 3³.", "270."] },
      // @q07
