...
export const T2U17L3: Lesson = {
  ...
  quiz: {
    pool: [
      // @q01
      { id: "U17L3-mcq-1", type: "mcq", category: "procedural", prompt: "2, 6, 18, 54, … What is r?", options: [ { id: "a", text: "3" }, { id: "b", text: "2" }, { id: "c", text: "4" }, { id: "d", text: "6" } ], correctOptionId: "a", diagnoses: { b: "6 × 2 = 12, not 18.", c: "6 + 4 = 10, not 18 — this isn't +4.", d: "6 is the SECOND term, not the ratio." }, explanation: "6 ÷ 2 = 3 and 18 ÷ 6 = 3 — ratio 3.", hints: ["Divide neighbours.", "6/2 = 3.", "r = 3."] },
      // @q02
      { id: "U17L3-mcq-2", type: "mcq", category: "conceptual", prompt: "What's the key difference between arithmetic and geometric sequences?", options: [ { id: "a", text: "Arithmetic adds; geometric multiplies" }, { id: "b", text: "Arithmetic multiplies; geometric adds" }, { id: "c", text: "They're identical" }, { id: "d", text: "Only geometry uses numbers" } ], correctOptionId: "a", diagnoses: { b: "Reversed — think +d vs ×r.", c: "1, 2, 3 vs 1, 2, 4 diverge quickly.", d: "Both are pure number lists." }, explanation: "+d (linear) versus ×r (curved exponential growth).", hints: ["Think of the gap.", "+d or ×r.", "Add vs multiply."] },
      // @q03
      { id: "U17L3-mcq-3", type: "mcq", category: "word", prompt: "Bacteria double hourly: 100 at hour 0, 200, 400, … Hour 6 = ?", options: [ { id: "a", text: "6400" }, { id: "b", text: "1200" }, { id: "c", text: "640" }, { id: "d", text: "600" } ], correctOptionId: "a", diagnoses: { b: "1200 = 100 + 6×? — that's adding, not doubling.", c: "640 lacks the final doubling step.", d: "600 is adding 100 per hour." }, explanation: "T(7) = 100 × 2⁶ = 6400 (hour 0 is the first term).", hints: ["Hours 0–6 is 6 doublings.", "100 × 2⁶.", "6400."] },
      // @q04
      { id: "U17L3-mcq-4", type: "mcq", category: "procedural", prompt: "3, 9, 27, … What is T(5)?", options: [ { id: "a", text: "243" }, { id: "b", text: "81" }, { id: "c", text: "2430" }, { id: "d", text: "729" } ], correctOptionId: "a", diagnoses: { b: "81 is T(4) — one step early.", c: "×10 is not the ratio.", d: "729 = 3 × 3⁵ — too many powers." }, explanation: "T(5) = 3 × 3⁴ = 3 × 81 = 243.", hints: ["r = 3.", "3 × 3⁴.", "243."] },
      // @q05
      ...
      // @q06
      { id: "U17L3-mcq-6", type: "mcq", category: "word", prompt: "A rabbit population triples each year: 10, 30, 90, … Year 4 = ?", options: [ { id: "a", text: "270" }, { id: "b", text: "810" }, { id: "c", text: "120" }, { id: "d", text: "250" } ], correctOptionId: "a", diagnoses: { b: "810 is year 5 (10 × 3⁴).", c: "120 = 10 + 30 + … — that's adding.", d: "10 × 3³ = 270, not 250." }, explanation: "Year 1 = 10 → year 4 = 10 × 3³ = 270.", hints: ["3 jumps to year 4.", "10 × 3³.", "270."] },
      // @q07
      { id: "U17L3-num-1", type: "numeric-input", category: "procedural", prompt: "2, 4, 8, 16, … Type T(8).", answer: 256, tolerance: 0, explanation: "T(8) = 2 × 2⁷ = 256.", hints: ["r = 2.", "2 × 2⁷.", "256."] },
      // @q08
      { id: "U17L3-num-2", type: "numeric-input", category: "procedural", prompt: "5, 10, 20, … Type T(6).", answer: 160, tolerance: 0, explanation: "5 × 2⁵ = 160.", hints: ["r = 2.", "5 × 32.", "160."] },
      // @q09
      { id: "U17L3-num-3", type: "numeric-input", category: "conceptual", prompt: "1, 3, 9, 27, … Type T(7).", answer: 729, tolerance: 0, explanation: "r = 3: 1 × 3⁶ = 729.", hints: ["r = 3.", "3⁶ = 729.", "729."] },
      // @q10
      { id: "U17L3-frac-1", type: "fraction-input", category: "conceptual", prompt: "100, 50, 25, … Type T(4) as a fraction.", numerator: 25, denominator: 2, acceptEquivalent: true, explanation: "r = 1/2: 100 × (1/2)³ = 25/2.", hints: ["r = 1/2.", "100 ÷ 8.", "25/2."] },
      // @q11
      { id: "U17L3-tf-1", type: "true-false-justify", category: "conceptual", prompt: "2, 6, 18, 54, … is geometric with r = 3.", isTrue: true, explanation: "Each term × 3 — ratio 3.", hints: ["Divide neighbours.", "×3 each.", "True."] },
      // @q12
      { id: "U17L3-tf-2", type: "true-false-justify", category: "conceptual", prompt: "2, 4, 6, 8, … is geometric (multiplied by 2).", isTrue: false, explanation: "Gaps are +2 — it's arithmetic, not ×2 (4 × 2 = 8, not 6).", hints: ["Check gaps.", "+2 each.", "Arithmetic."] },
      // @q13
      { id: "U17L3-order-1", type: "order-steps", category: "word", prompt: "Order the steps to find T(6) of 5, 10, 20, …", sequence: ["Find the ratio: 10 ÷ 5 = 2", "Write T(n) = 5 × 2^(n−1)", "Substitute n = 6: 5 × 2⁵", "Simplify: 5 × 32 = 160"], diagnoses: { "Find the ratio: 10 ÷ 5 = 2@1": "Find r first.", "Write T(n) = 5 × 2^(n−1)@0": "State the formula before substituting.", "Substitute n = 6: 5 × 2⁵@1": "Plug n in after the formula." }, explanation: "Find r, write the formula, substitute, simplify.", hints: ["r = 2.", "Write formula.", "Plug in 6."] },
      // @q14
      { id: "U17L3-drag-1", type: "drag-match", category: "conceptual", prompt: "Match each sequence to its ratio or difference.", pairs: [ { source: "2, 4, 8, 16", target: "Ratio 2 (geometric)" }, { source: "2, 4, 6, 8", target: "Difference 2 (arithmetic)" }, { source: "3, 9, 27", target: "Ratio 3 (geometric)" } ], diagnoses: { "2, 4, 8, 16->Difference 2 (arithmetic)": "8 − 4 = 4, so the gaps aren't constant — it ×2s.", "2, 4, 6, 8->Ratio 2 (geometric)": "4 × 2 = 8, not 6 — the gaps are +2.", "3, 9, 27->Ratio 2 (geometric)": "9 ÷ 3 = 3, so r = 3." }, explanation: "Divide neighbours for ratio; subtract for difference.", hints: ["Divide for r.", "Subtract for d.", "Check both."] },
      // @q15
      { id: "U17L3-graph-1", type: "graph-interact", category: "word", prompt: "The doubling curve 2, 4, 8, 16, 32 … Set the slider to the SIXTH term (key: value).", challenge: "Set the slider to 64.", validate: { value: 64 }, tolerance: 0.01, explanation: "T(6) = 2 × 2⁵ = 64 — six terms, five doublings.", hints: ["6 terms = 5 doublings.", "2 × 2⁵.", "64."] }
    ],
