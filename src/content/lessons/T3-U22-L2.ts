...
export const T3U22L2: Lesson = {
  ...
  quiz: {
    pool: [
      ...
      // @q02
      { id: "U22L2-mcq-2", type: "mcq", category: "conceptual", prompt: "Points 5 cm from a LINE form…", options: [ { id: "a", text: "Two parallel lines, 5 cm on each side" }, { id: "b", text: "One circle centred on the line" }, { id: "c", text: "Five points" }, { id: "d", text: "A single line" } ], correctOptionId: "a", diagnoses: { b: "Circles belong to fixed distance from a point.", c: "A locus is continuous, not discrete.", d: "Both sides of the line count." }, explanation: "The line has two sides — glide 5 cm along each side.", hints: ["Both sides.", "Parallel glide.", "Two lines."] },
      // @q03
      { id: "U22L2-mcq-3", type: "mcq", category: "word", prompt: "A dog tied by a 4 m rope to a post traces what locus as it circles?", options: [ { id: "a", text: "A circle radius 4 m around the post" }, { id: "b", text: "A straight line" }, { id: "c", text: "Two parallel lines" }, { id: "d", text: "Nothing" } ], correctOptionId: "a", diagnoses: { b: "The rope lets it move in all directions.", c: "Parallels need a line target.", d: "It moves — a whole circle of places." }, explanation: "Fixed distance from the post → circle radius = rope length.", hints: ["Fixed rope.", "All around post.", "Circle."] },
      // @q04
      { id: "U22L2-mcq-4", type: "mcq", category: "procedural", prompt: "Points equidistant from A and B form…", options: [ { id: "a", text: "The perpendicular bisector of AB" }, { id: "b", text: "A circle through A and B" }, { id: "c", text: "The segment AB" }, { id: "d", text: "Two parallel lines" } ], correctOptionId: "a", diagnoses: { b: "Equal distance to BOTH points means the bisector, not a circle.", c: "The segment is the endpoints' path, not the equidistant set.", d: "Parallels aren't equidistant to two separate points." }, explanation: "Every equidistant point lies on the perpendicular bisector (U22-L1).", hints: ["Equidistant to two.", "Perp bisector.", "The bisector."] },
      // @q05
      ...
      // @q06
      { id: "U22L2-mcq-6", type: "mcq", category: "word", prompt: "A sprinkler wets a circle of radius 6 m. What is the locus of wetted ground?", options: [ { id: "a", text: "A circle radius 6 m around the sprinkler" }, { id: "b", text: "The sprinkler itself" }, { id: "c", text: "Two parallel lines" }, { id: "d", text: "A hexagon" } ], correctOptionId: "a", diagnoses: { b: "The sprinkler is the centre, not the wet area.", c: "Parallels would mean a line source.", d: "No hexagon here." }, explanation: "Fixed 6 m reach from the sprinkler point → the circle.", hints: ["Reach = radius.", "Around the sprout.", "Circle."] },
      // @q07
