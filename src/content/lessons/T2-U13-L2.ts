...
export const T2U13L2: Lesson = {
  ...
  quiz: {
    pool: [
      ...
      // @q03
      { id: "U13L2-mcq-3", type: "mcq", category: "word", prompt: "F = ma is Newton's law. Make m the subject.", options: [ { id: "a", text: "m = a/F" }, { id: "b", text: "m = F × a" }, { id: "c", text: "m = F/a" }, { id: "d", text: "m = F − a" } ], correctOptionId: "c", diagnoses: { b: "Undo ×a by dividing, not multiplying.", a: "Divide by a, so m = F/a.", d: "Addition isn't involved." }, explanation: "m is multiplied by a: divide both sides by a → m = F/a.", hints: ["Undo the ×a.", "Divide by a.", "m = F/a."] },
      // @q04
      { id: "U13L2-mcq-4", type: "mcq", category: "procedural", prompt: "Make x the subject of y = 2x + 3.", options: [ { id: "a", text: "x = 2y − 3" }, { id: "b", text: "x = y/2 − 3" }, { id: "c", text: "x = (y + 3)/2" }, { id: "d", text: "x = (y − 3)/2" } ], correctOptionId: "d", diagnoses: { b: "Divide the whole side by 2 — not term by term.", c: "Subtract 3 first, not add.", a: "Wrong — 2y − 3 rearranges wrongly." }, explanation: "Undo +3 (y − 3 = 2x), then ÷2 → x = (y − 3)/2.", hints: ["Undo +3 first.", "Then ÷2.", "x = (y − 3)/2."] },
      // @q05
