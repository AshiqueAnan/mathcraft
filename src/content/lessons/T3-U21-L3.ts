...
export const T3U21L3: Lesson = {
  ...
  quiz: {
    pool: [
      // @q01
      { id: "U21L3-mcq-1", type: "mcq", category: "procedural", prompt: "Which must be true for a square but not a general rectangle?", options: [ { id: "a", text: "All four sides equal" }, { id: "b", text: "All angles 90°" }, { id: "c", text: "Both pairs parallel" }, { id: "d", text: "Four sides" } ], correctOptionId: "a", diagnoses: { b: "Rectangles have right angles too.", c: "Rectangles have both pairs parallel.", d: "Both are quadrilaterals." }, explanation: "Right angles and parallels are shared; equal sides are the square's extra property.", hints: ["Square's extra.", "Equal sides.", "Right angles and parallels are shared; equal sides are the square's extra property."] },
      // @q02
      { id: "U21L3-mcq-2", type: "mcq", category: "conceptual", prompt: "Is every rectangle a square?", options: [ { id: "a", text: "Yes — right angles define the square" }, { id: "b", text: "No — a square needs equal sides too" }, { id: "c", text: "Only if it's small" }, { id: "d", text: "Never" } ], correctOptionId: "b", diagnoses: { a: "Right angles make a rectangle; equal sides make it a square.", c: "Size is irrelevant.", d: "Some rectangles ARE squares (the equal-sided ones)." }, explanation: "Square ⊂ rectangle, not the other way.", hints: ["Hierarchy.", "One direction.", "Square ⊂ rectangle, not the other way."] },
      // @q03
      { id: "U21L3-mcq-3", type: "mcq", category: "word", prompt: "A rhombus-shaped kite: all sides equal, no right angles. Is it a parallelogram?", options: [ { id: "a", text: "Only if opposite angles are equal" }, { id: "b", text: "No — it must have right angles" }, { id: "c", text: "Yes — both pairs of opposite sides are parallel" }, { id: "d", text: "Never" } ], correctOptionId: "c", diagnoses: { b: "Right angles are NOT required for a parallelogram.", a: "Opposite angles equal follows automatically.", d: "A rhombus IS a parallelogram by parallel definition." }, explanation: "Equal sides imply both pairs parallel → it's a parallelogram.", hints: ["Parallelogram = parallels.", "Rhombus has them.", "Equal sides imply both pairs parallel → it's a parallelogram."] },
      // @q04
      { id: "U21L3-mcq-4", type: "mcq", category: "procedural", prompt: "An isosceles triangle's apex is 40°. What are the base angles?", options: [ { id: "a", text: "140° each" }, { id: "b", text: "80° each" }, { id: "c", text: "40° each" }, { id: "d", text: "70° each" } ], correctOptionId: "d", diagnoses: { b: "80+80+40 = 200 — too much; base = (180−40)/2.", c: "40° is the apex, not a base.", a: "140° can't fit with another base angle." }, explanation: "(180 − 40) / 2 = 70°.", hints: ["Base angles equal.", "(180−40)/2.", "(180 − 40) / 2 = 70°."] },
      // @q05
      { id: "U21L3-mcq-5", type: "mcq", category: "conceptual", prompt: "In a parallelogram, opposite angles are…", options: [ { id: "a", text: "Equal" }, { id: "b", text: "Supplementary (180°)" }, { id: "c", text: "Complementary (90°)" }, { id: "d", text: "Unrelated" } ], correctOptionId: "a", diagnoses: { b: "ADJACENT angles are supplementary in a parallelogram.", c: "90° pairs only in rectangles.", d: "Parallel rules fix the opposite pairs." }, explanation: "Parallel lines make opposite angles equal (alternate/corresponding).", hints: ["Opposite corners.", "Parallel lines.", "Parallel lines make opposite angles equal (alternate/corresponding)."] },
      // @q06
      { id: "U21L3-mcq-6", type: "mcq", category: "word", prompt: "A lozenge window is a rhombus with one angle 120°. Its opposite angle is…", options: [ { id: "a", text: "60°" }, { id: "b", text: "120°" }, { id: "c", text: "180°" }, { id: "d", text: "90°" } ], correctOptionId: "b", diagnoses: { a: "60° is the ADJACENT angle (180 − 120).", c: "180° isn't a single corner.", d: "Right angles only in squares/rectangles." }, explanation: "Opposite angles of a parallelogram are equal: 120°.", hints: ["Opposite equal.", "120°.", "Opposite angles of a parallelogram are equal: 120°."] },
      // @q07
      { id: "U21L3-num-1", type: "numeric-input", category: "procedural", prompt: "Isosceles base angles: apex 80°. Type each base angle.", answer: 50, tolerance: 0, explanation: "(180 − 80)/2 = 50°.", hints: ["(180−80)/2.", "50.", "(180 − 80)/2 = 50°."] },
      // @q08
      { id: "U21L3-num-2", type: "numeric-input", category: "procedural", prompt: "A parallelogram has one angle 60°. Type the opposite angle.", answer: 60, tolerance: 0, explanation: "Opposite angles equal.", hints: ["Opposite equal.", "60.", "Opposite angles equal."] },
      // @q09
      { id: "U21L3-num-3", type: "numeric-input", category: "conceptual", prompt: "Same parallelogram: type an ADJACENT angle.", answer: 120, tolerance: 0, explanation: "Adjacent = 180 − 60 = 120°.", hints: ["180 − 60.", "120.", "Adjacent = 180 − 60 = 120°."] },
      // @q10
      { id: "U21L3-frac-1", type: "fraction-input", category: "conceptual", prompt: "In a square, one angle as a fraction of 180°.", numerator: 1, denominator: 2, acceptEquivalent: true, explanation: "90° = 1/2 of 180°.", hints: ["90 ÷ 180.", "1/2.", "90° = 1/2 of 180°."] },
      // @q11
      { id: "U21L3-tf-1", type: "true-false-justify", category: "conceptual", prompt: "Every square is a rhombus.", isTrue: true, explanation: "Equal sides + parallel opposites — exactly a rhombus.", hints: ["Equal sides.", "Parallels.", "Equal sides + parallel opposites — exactly a rhombus."] },
      // @q12
      { id: "U21L3-tf-2", type: "true-false-justify", category: "conceptual", prompt: "Every rhombus is a square.", isTrue: false, explanation: "A rhombus needs equal sides only — right angles not guaranteed.", hints: ["Not always 90°.", "Rhombus = equal sides.", "A rhombus needs equal sides only — right angles not guaranteed."] },
      // @q13
      ...
      // @q14
      { id: "U21L3-drag-1", type: "drag-match", category: "conceptual", prompt: "Match each shape to its defining extra property.", pairs: [ { source: "Rectangle", target: "Right angles" }, { source: "Rhombus", target: "Equal sides" }, { source: "Square", target: "Both right angles and equal sides" } ], diagnoses: { "Rectangle->Equal sides": "Rectangles may have unequal sides.", "Rhombus->Right angles": "A rhombus needs equal sides, not 90°.", "Square->Right angles": "Squares have BOTH properties." }, explanation: "Each subclass adds its own property.", hints: ["Rectangle = 90°.", "Rhombus = equal sides.", "Each subclass adds its own property."] },
      // @q15
      { id: "U21L3-graph-1", type: "graph-interact", category: "word", prompt: "A rhombus has one angle 100°. Set the slider to its opposite angle (key: value).", challenge: "Adjust the values below so they match the condition described in the prompt.", validate: { value: 100 }, tolerance: 0.01, explanation: "Opposite angles of a parallelogram are equal.", hints: ["Opposite equal.", "100.", "Opposite angles of a parallelogram are equal."] }
    ],
