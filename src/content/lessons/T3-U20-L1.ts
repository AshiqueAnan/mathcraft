...
export const T3U20L1: Lesson = {
  ...
  quiz: {
    pool: [
      ...
      // @q04
      { id: "U20L1-mcq-4", type: "mcq", category: "procedural", prompt: "A straight line is split into 40° and x. What is x?", options: [ { id: "a", text: "90°" }, { id: "b", text: "40°" }, { id: "c", text: "180°" }, { id: "d", text: "140°" } ], correctOptionId: "d", diagnoses: { b: "x is the rest of the straight line, not the given angle.", c: "180 is the whole straight line.", a: "Right angle is 90°, not half of 180 here." }, explanation: "180 − 40 = 140° on a straight line.", hints: ["Straight line = 180°.", "180 − 40.", "140°."] },
      // @q05
