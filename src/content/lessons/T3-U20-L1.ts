...
export const T3U20L1: Lesson = {
  ...
  quiz: {
    pool: [
      // @q01
      { id: "U20L1-mcq-1", type: "mcq", category: "procedural", prompt: "Angles of 110° and 250° meet at a point. What's the total around the point?", options: [ { id: "a", text: "360°" }, { id: "b", text: "180°" }, { id: "c", text: "90°" }, { id: "d", text: "140°" } ], correctOptionId: "a", diagnoses: { b: "Two angles filling a point add to a full turn: 360°.", c: "90° is a quarter turn.", d: "140 is 360 − 220, not the total." }, explanation: "110 + 250 = 360 — the angles tile a full turn.", hints: ["Full turn.", "360°.", "110 + 250 = 360 — the angles tile a full turn."] },
      // @q02
      { id: "U20L1-mcq-2", type: "mcq", category: "conceptual", prompt: "Why do angles around a point always add to 360°?", options: [ { id: "a", text: "Because rays are long" }, { id: "b", text: "They tile the whole turn — no gaps, no overlaps" }, { id: "c", text: "By definition of a right angle" }, { id: "d", text: "They add to 180 by accident" } ], correctOptionId: "b", diagnoses: { a: "Ray length is irrelevant to the angle sum.", c: "Right angles are 90° — a different fact.", d: "The 360 is about tiling a full turn." }, explanation: "Angles around a point exactly cover one full 360° rotation.", hints: ["Full rotation.", "Tile the turn.", "Angles around a point exactly cover one full 360° rotation."] },
      // @q03
      { id: "U20L1-mcq-3", type: "mcq", category: "word", prompt: "A windmill's blades split a point into 120° each. How many blades?", options: [ { id: "a", text: "2" }, { id: "b", text: "4" }, { id: "c", text: "3" }, { id: "d", text: "6" } ], correctOptionId: "c", diagnoses: { b: "4 blades would be 90° each.", a: "2 blades make 180° each.", d: "6 blades would be 60° each." }, explanation: "360 ÷ 120 = 3 blades.", hints: ["360 ÷ 120.", "3.", "360 ÷ 120 = 3 blades."] },
      // @q04
      { id: "U20L1-mcq-4", type: "mcq", category: "procedural", prompt: "A straight line is split into 40° and x. What is x?", options: [ { id: "a", text: "90°" }, { id: "b", text: "40°" }, { id: "c", text: "180°" }, { id: "d", text: "140°" } ], correctOptionId: "d", diagnoses: { b: "x is the rest of the straight line, not the given angle.", c: "180 is the whole straight line.", a: "Right angle is 90°, not half of 180 here." }, explanation: "180 − 40 = 140° on a straight line.", hints: ["Straight line = 180°.", "180 − 40.", "180 − 40 = 140° on a straight line."] },
      // @q05
      ...
      // @q06
      { id: "U20L1-mcq-6", type: "mcq", category: "word", prompt: "A pizza is cut into 6 equal slices. What angle does each slice occupy at the centre?", options: [ { id: "a", text: "30°" }, { id: "b", text: "60°" }, { id: "c", text: "45°" }, { id: "d", text: "90°" } ], correctOptionId: "b", diagnoses: { a: "30° would need 12 slices.", c: "45° would need 8 slices.", d: "90° would give 4 slices." }, explanation: "360 ÷ 6 = 60° per slice.", hints: ["360 ÷ 6.", "60°.", "360 ÷ 6 = 60° per slice."] },
      // @q07
      { id: "U20L1-num-1", type: "numeric-input", category: "procedural", prompt: "Angles of 120° and 150° meet at a point. Type the missing angle x.", answer: 90, tolerance: 0, explanation: "x = 360 − 120 − 150 = 90°.", hints: ["360 − 120 − 150.", "90.", "x = 360 − 120 − 150 = 90°."] },
      // @q08
      { id: "U20L1-num-2", type: "numeric-input", category: "procedural", prompt: "Angles on a straight line: 70° and x. Type x.", answer: 110, tolerance: 0, explanation: "x = 180 − 70 = 110°.", hints: ["Straight line = 180°.", "180 − 70.", "x = 180 − 70 = 110°."] },
      // @q09
      { id: "U20L1-num-3", type: "numeric-input", category: "conceptual", prompt: "A right angle is split into 35° and x. Type x.", answer: 55, tolerance: 0, explanation: "x = 90 − 35 = 55°.", hints: ["Right angle = 90°.", "90 − 35.", "x = 90 − 35 = 55°."] },
      // @q10
      { id: "U20L1-frac-1", type: "fraction-input", category: "conceptual", prompt: "A clock turns from 12 to 3 — what fraction of a full turn is that? Write as a fraction.", numerator: 1, denominator: 4, acceptEquivalent: true, explanation: "12 to 3 is a quarter turn = 1/4.", hints: ["12 → 3 is 3 hours of 12.", "1/4 turn.", "12 to 3 is a quarter turn = 1/4."] },
      // @q11
      { id: "U20L1-tf-1", type: "true-false-justify", category: "conceptual", prompt: "Three angles around a point, 60° each, add to 180°.", isTrue: false, explanation: "60 × 3 = 180, but around a point the total must be 360° — three angles can't tile a full turn with only 180°.", hints: ["Full turn = 360°.", "180 is only half.", "60 × 3 = 180, but around a point the total must be 360° — three angles can't tile a full turn with only 180°."] },
      // @q12
      { id: "U20L1-tf-2", type: "true-false-justify", category: "conceptual", prompt: "Angles on a straight line add to 180°.", isTrue: true, explanation: "Half a turn is 180° — angles along a line share that straight angle.", hints: ["Straight = 180°.", "Half turn.", "Half a turn is 180° — angles along a line share that straight angle."] },
      // @q13
      ...
      // @q14
      { id: "U20L1-drag-1", type: "drag-match", category: "conceptual", prompt: "Match each turn to its angle.", pairs: [ { source: "Full turn", target: "360°" }, { source: "Half turn", target: "180°" }, { source: "Quarter turn", target: "90°" } ], diagnoses: { "Full turn->180°": "Full turn is 360°.", "Half turn->90°": "Half is 180°, quarter is 90°.", "Quarter turn->360°": "Quarter is 90°." }, explanation: "Full = 360°, half = 180°, quarter = 90°.", hints: ["Whole rotation.", "Half.", "Full = 360°, half = 180°, quarter = 90°."] },
      // @q15
      { id: "U20L1-graph-1", type: "graph-interact", category: "word", prompt: "Two angles around a point are 220° and 140°. Set the slider to their total (key: value).", challenge: "Two angles around a point are 220° and 140°. — adjust the values below to match the condition.", validate: { value: 360 }, tolerance: 0.01, explanation: "220 + 140 = 360 — the full turn.", hints: ["220 + 140.", "360.", "220 + 140 = 360 — the full turn."] }
    ],
