...
export const T3U25L2: Lesson = {
  ...
  quiz: {
    pool: [
      ...
      // @q03
      { id: "U25L2-mcq-3", type: "mcq", category: "word", prompt: "A right triangle with legs 5 and 12: the proof guarantees c² = …", options: [ { id: "a", text: "17" }, { id: "b", text: "60" }, { id: "c", text: "169" }, { id: "d", text: "289" } ], correctOptionId: "c", diagnoses: { b: "60 is 5 × 12 — that's a rectangle.", a: "17 adds the legs.", d: "289 is 17² of the wrong sum." }, explanation: "25 + 144 = 169 = 13².", hints: ["25 + 144.", "169.", "c² = 169."] },
      // @q04
      { id: "U25L2-mcq-4", type: "mcq", category: "procedural", prompt: "Legs 7 and 24. The hypotenuse is…", options: [ { id: "a", text: "625" }, { id: "b", text: "31" }, { id: "c", text: "168" }, { id: "d", text: "25" } ], correctOptionId: "d", diagnoses: { b: "31 adds the legs.", c: "168 multiplies them.", a: "625 is c² — take the root." }, explanation: "49 + 576 = 625 = 25².", hints: ["49 + 576.", "√625.", "25."] },
      // @q05
      ...
      // @q06
      { id: "U25L2-mcq-6", type: "mcq", category: "word", prompt: "A right triangle's hypotenuse is 10 and one leg is 6. The other leg is…", options: [ { id: "a", text: "4" }, { id: "b", text: "8" }, { id: "c", text: "16" }, { id: "d", text: "136" } ], correctOptionId: "b", diagnoses: { a: "4 is 10 − 6 — you must subtract squares, then root.", c: "16 is b² — take the square root.", d: "136 is 100 + 36 — that adds the squares." }, explanation: "b² = 100 − 36 = 64 → b = 8.", hints: ["100 − 36.", "√64.", "8."] },
      // @q07
