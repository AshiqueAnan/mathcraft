...
export const T3U25L2: Lesson = {
  ...
  quiz: {
    pool: [
      ...
      // @q02
      { id: "U25L2-mcq-2", type: "mcq", category: "conceptual", prompt: "In the rearrangement proof, the 'leftover' area…", options: [ { id: "a", text: "doubles when the triangles slide" }, { id: "b", text: "stays the same in both arrangements" }, { id: "c", text: "shrinks to half" }, { id: "d", text: "depends on the triangle sizes" } ], correctOptionId: "b", diagnoses: { a: "Sliding doesn't change the area — only the shape.", c: "Same four triangles, same leftover space.", d: "The leftover is fixed by the big square minus four triangles." }, explanation: "Same total square, same four triangles → same leftover area, reshaped.", hints: ["Same square minus same triangles.", "Area conserved.", "Stays the same."] },
      // @q03
      { id: "U25L2-mcq-3", type: "mcq", category: "word", prompt: "A right triangle with legs 5 and 12: the proof guarantees c² = …", options: [ { id: "a", text: "17" }, { id: "b", text: "60" }, { id: "c", text: "169" }, { id: "d", text: "289" } ], correctOptionId: "c", diagnoses: { b: "60 is 5 × 12 — that's a rectangle.", a: "17 adds the legs.", d: "289 is 17² of the wrong sum." }, explanation: "25 + 144 = 169 = 13².", hints: ["25 + 144.", "169.", "25 + 144 = 169 = 13²."] },
      // @q04
      { id: "U25L2-mcq-4", type: "mcq", category: "procedural", prompt: "Legs 7 and 24. The hypotenuse is…", options: [ { id: "a", text: "625" }, { id: "b", text: "31" }, { id: "c", text: "168" }, { id: "d", text: "25" } ], correctOptionId: "d", diagnoses: { b: "31 adds the legs.", c: "168 multiplies them.", a: "625 is c² — take the root." }, explanation: "49 + 576 = 625 = 25².", hints: ["49 + 576.", "√625.", "49 + 576 = 625 = 25²."] },
      // @q05
      { id: "U25L2-mcq-5", type: "mcq", category: "conceptual", prompt: "Why does counting squares on a grid NOT prove Pythagoras for ALL triangles?", options: [ { id: "a", text: "Some hypotenuses aren't whole numbers, so their squares don't tile the grid" }, { id: "b", text: "Grids only work for squares" }, { id: "c", text: "Right triangles never sit on clean points" }, { id: "d", text: "Counting takes too long" } ], correctOptionId: "a", diagnoses: { b: "Grids handle many shapes, but irrational lengths break the tilings.", c: "Right triangles with rational legs do sit on clean points.", d: "Time isn't the mathematical objection." }, explanation: "The rearrangement proof covers irrational hypotenuses like √13 — counting can't.", hints: ["√13 isn't whole.", "No clean tiling.", "The rearrangement proof covers irrational hypotenuses like √13 — counting can't."] },
      // @q06
      { id: "U25L2-mcq-6", type: "mcq", category: "word", prompt: "A right triangle's hypotenuse is 10 and one leg is 6. The other leg is…", options: [ { id: "a", text: "4" }, { id: "b", text: "8" }, { id: "c", text: "16" }, { id: "d", text: "136" } ], correctOptionId: "b", diagnoses: { a: "4 is 10 − 6 — you must subtract squares, then root.", c: "16 is b² — take the square root.", d: "136 is 100 + 36 — that adds the squares." }, explanation: "b² = 100 − 36 = 64 → b = 8.", hints: ["100 − 36.", "√64.", "b² = 100 − 36 = 64 → b = 8."] },
      // @q07
      { id: "U25L2-num-1", type: "numeric-input", category: "procedural", prompt: "Legs 2 and 3. c² = …", answer: 13, tolerance: 0, explanation: "4 + 9 = 13.", hints: ["2² + 3².", "13.", "4 + 9 = 13."] },
      // @q08
      { id: "U25L2-num-2", type: "numeric-input", category: "procedural", prompt: "Legs 9 and 12. The hypotenuse is…", answer: 15, tolerance: 0, explanation: "81 + 144 = 225 = 15².", hints: ["81 + 144.", "√225.", "81 + 144 = 225 = 15²."] },
      // @q09
      { id: "U25L2-num-3", type: "numeric-input", category: "conceptual", prompt: "Legs 1 and 1. c² = …", answer: 2, tolerance: 0, explanation: "1 + 1 = 2 → the hypotenuse is √2.", hints: ["1² + 1².", "2.", "1 + 1 = 2 → the hypotenuse is √2."] },
      // @q10
      { id: "U25L2-frac-1", type: "fraction-input", category: "conceptual", prompt: "In a 1-1-√2 right triangle, the hypotenuse is √2. What fraction of the triangle's leg-square total (2) is the hypotenuse's square (2)?", numerator: 1, denominator: 1, acceptEquivalent: true, explanation: "c² = 2 and a² + b² = 2 — the rearrangement says they're EQUAL, a 1/1 match.", hints: ["Both equal 2.", "1/1.", "c² = 2 and a² + b² = 2 — the rearrangement says they're EQUAL, a 1/1 match."] },
      // @q11
      { id: "U25L2-tf-1", type: "true-false-justify", category: "conceptual", prompt: "The rearrangement proof works even when the hypotenuse is irrational like √13.", isTrue: true, explanation: "The proof never counts unit squares — it compares the same area recut, so irrational lengths are fine.", hints: ["No counting needed.", "Area is conserved.", "The proof never counts unit squares — it compares the same area recut, so irrational lengths are fine."] },
      // @q12
      { id: "U25L2-tf-2", type: "true-false-justify", category: "conceptual", prompt: "In the proof, you may use DIFFERENT triangles in each arrangement.", isTrue: false, explanation: "The four triangles must be the same copies — different triangles change the leftover area.", hints: ["Identical copies.", "Same four triangles.", "The four triangles must be the same copies — different triangles change the leftover area."] },
      // @q13
      ...
      // @q15
      { id: "U25L2-graph-1", type: "graph-interact", category: "word", prompt: "Legs 6 and 8. Set the slider to c², the hypotenuse squared (key: value).", challenge: "Legs 6 and 8. — adjust the values below to match the condition.", validate: { value: 100 }, tolerance: 0.01, explanation: "36 + 64 = 100 = c².", hints: ["36 + 64.", "100.", "36 + 64 = 100 = c²."] }
    ],
