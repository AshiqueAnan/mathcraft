    ...
    pool: [
      {
        ...
        hints: ["Is it direct or inverse?", "Doubling paint → doubling area.", "Direct: litres ×2 → area ×2 = 40 m²."],
      },
      {
        ...
        hints: ["Double the bakers?", "Time goes DOWN.", "More workers → less time: inverse."],
      },
      {
        ...
        hints: ["Speed doubled.", "Time halves.", "Speed and time are inverse for fixed distance: speed ×2 → time ÷2 = 1 h."],
      },
      {
        ...
        hints: ["Which Grows together?", "Slices → cost.", "More slices, proportionally more cost — both grow together at a constant rate."],
      },
      {
        ...
        hints: ["$6 ÷ 2 kg = $3/kg.", "5 × 3.", "Rate = $3/kg. 5 kg = $15. Direct."],
      },
      {
        ...
        hints: ["Workers × time = constant.", "4 × 6 = 24.", "Workers × hours = 24 (constant)."],
      },
      {
        ...
        hints: ["$10 ÷ 5 = $2.", "8 × 2.", "Rate $2/pen. 8 × 2 = $16. Direct."],
      },
      {
        ...
        hints: ["Pumps × time = 6.", "6 ÷ 6.", "Inverse: pumps × hours = 6."],
      },
      {
        ...
        hints: ["Route = speed × time.", "8 × 3 = 24 km.", "Distance = 8 × 3 = 24 km."],
      },
      {
        ...
        hints: ["50 parts per machine.", "5 × 50.", "Direct: 3 → 150, so 5 → 150 × (5/3) = 250."],
      },
      {
        ...
        hints: ["4 equal workers.", "Each does 1 part.", "4 workers split the job: one does 1/4 of it in that time."],
      },
      {
        ...
        hints: ["Speed constant.", "More time → further.", "Double the time at the same speed → double the distance."],
      },
      {
      ...
      },
      {
        ...
        hints: ["3 × 6 = 18.", "18 ÷ 2.", "Inverse: painters × hours constant → divide by new count."],
      },
      {
        ...
        hints: ["Sugar price grows.", "Speed cuts time.", "Look at direction: both grow (direct) or opposite (inverse)."],
      },
      {
        ...
        challenge: "Slider : 4 workers take 6 h. Set hours for 3 workers (inverse, constant 24). — adjust the values below to match the condition.",
        validate: { hours: 8 },
        tolerance: 0.1,
        explanation: "4 × 6 = 24; 24 ÷ 3 = 8 h.",
        hints: ["Workers × hours = 24.", "24 ÷ 3.", "4 × 6 = 24; 24 ÷ 3 = 8 h."],
      },
    ],
