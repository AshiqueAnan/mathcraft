  ...
  quiz: {
    pool: [
      ...
      },
      {
        ...
        options: [{ id: "a", text: "1 hour" }, { id: "b", text: "2 hours" }, { id: "c", text: "4 hours" }, { id: "d", text: "30 minutes" }],
        correctOptionId: "a",
        diagnoses: { b: "Doubling speed doesn't keep time the same — it halves it.", c: "4 hours would be HALF the speed.", d: "That's ×4 the speed, wrong." },
      ...
      },
      {
        ...
        options: [
          { id: "a", text: "Slices of pizza and total cost at a fixed price per slice" },
          { id: "b", text: "Bakers and time to bake one cake" },
          { id: "c", text: "Speed and time over a fixed distance" },
          { id: "d", text: "Machines and hours at a fixed job" },
        ],
        correctOptionId: "a",
        diagnoses: { b: "More bakers → less time: inverse.", c: "Faster → quicker: inverse.", d: "More machines → fewer hours: inverse." },
      ...
      },
      {
        ...
        options: [{ id: "a", text: "8 hours" }, { id: "b", text: "4.5 hours" }, { id: "c", text: "6 hours" }, { id: "d", text: "2 hours" }],
        correctOptionId: "a",
        diagnoses: { b: "4.5 would assume direct ratio (3/4 of 6), but workers are inverse.", c: "Only if 1 worker were added/removed symmetrically.", d: "Fewer workers → more time, not less." },
