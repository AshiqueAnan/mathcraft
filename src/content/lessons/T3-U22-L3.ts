...
export const T3U22L3: Lesson = {
  ...
  quiz: {
    pool: [
      ...
      // @q02
      { id: "U22L3-mcq-2", type: "mcq", category: "conceptual", prompt: "Rotational symmetry of order 4 means the shape matches itself every…", options: [ { id: "a", text: "90° turn" }, { id: "b", text: "180° turn" }, { id: "c", text: "45° turn" }, { id: "d", text: "360° turn" } ], correctOptionId: "a", diagnoses: { b: "180° is order 2.", c: "45° gives order 8.", d: "A full turn matches everything — trivial." }, explanation: "360°/4 = 90° turns bring it onto itself.", hints: ["360 ÷ 4.", "90°.", "90°."] },
      // @q03
      { id: "U22L3-mcq-3", type: "mcq", category: "word", prompt: "A road sign is a square. How many mirror axes does it have?", options: [ { id: "a", text: "4" }, { id: "b", text: "2" }, { id: "c", text: "1" }, { id: "d", text: "8" } ], correctOptionId: "a", diagnoses: { b: "2 is for a rectangle, the square adds the diagonals.", c: "1 belongs to isosceles.", d: "8 would be a regular octagon's axes." }, explanation: "Squares match across both midlines AND both diagonals → 4 axes.", hints: ["Square.", "Midlines + diagonals.", "4."] },
      // @q04
      { id: "U22L3-mcq-4", type: "mcq", category: "procedural", prompt: "Regular hexagon rotational order is…", options: [ { id: "a", text: "6" }, { id: "b", text: "3" }, { id: "c", text: "2" }, { id: "d", text: "12" } ], correctOptionId: "a", diagnoses: { b: "Order 3 would need 120° turns — a triangle shape.", c: "Order 2 is a half-turn only.", d: "12 would be a 12-gon." }, explanation: "A hexagon matches every 60° turn: order 6.", hints: ["360 ÷ 6.", "60° turns.", "Order 6."] },
      // @q05
      ...
      // @q06
      { id: "U22L3-mcq-6", type: "mcq", category: "word", prompt: "A clock face's 12 marks: what's its rotational order?", options: [ { id: "a", text: "12" }, { id: "b", text: "6" }, { id: "c", text: "24" }, { id: "d", text: "4" } ], correctOptionId: "a", diagnoses: { b: "6 would need 60° copies — not the hour marks.", c: "24 marks would be half-hour ticks.", d: "4 belongs to a four-fold object." }, explanation: "Each 30° turn brings the 12-hour face onto itself: order 12.", hints: ["360 ÷ 12.", "30° turns.", "12."] },
      // @q07
