...
export const T3U22L3: Lesson = {
  ...
  quiz: {
    pool: [
      ...
      // @q06
      { id: "U22L3-mcq-6", type: "mcq", category: "word", prompt: "A clock face's 12 marks: what's its rotational order?", options: [ { id: "a", text: "6" }, { id: "b", text: "12" }, { id: "c", text: "24" }, { id: "d", text: "4" } ], correctOptionId: "b", diagnoses: { a: "6 would need 60° copies — not the hour marks.", c: "24 marks would be half-hour ticks.", d: "4 belongs to a four-fold object." }, explanation: "Each 30° turn brings the 12-hour face onto itself: order 12.", hints: ["360 ÷ 12.", "30° turns.", "Each 30° turn brings the 12-hour face onto itself: order 12."] },
      // @q07
      { id: "U22L3-num-1", type: "numeric-input", category: "procedural", prompt: "A square's rotational order.", answer: 4, tolerance: 0, explanation: "90° turns fit four times in 360°.", hints: ["360 ÷ 90.", "4.", "90° turns fit four times in 360°."] },
      // @q08
      { id: "U22L3-num-2", type: "numeric-input", category: "procedural", prompt: "Number of symmetry axes of a regular pentagon.", answer: 5, tolerance: 0, explanation: "Each vertex-to-opposite-midpoint fold is an axis: 5.", hints: ["One per vertex.", "5.", "Each vertex-to-opposite-midpoint fold is an axis: 5."] },
      // @q09
      { id: "U22L3-num-3", type: "numeric-input", category: "conceptual", prompt: "A capital 'H' has how many mirror axes?", answer: 2, tolerance: 0, explanation: "Reflect across the vertical middle and the horizontal middle both match.", hints: ["Vertical fold.", "Horizontal fold.", "Reflect across the vertical middle and the horizontal middle both match."] },
      // @q10
      { id: "U22L3-frac-1", type: "fraction-input", category: "conceptual", prompt: "A regular hexagon matches at 60°. Express 60 as a fraction of 360°.", numerator: 1, denominator: 6, acceptEquivalent: true, explanation: "60/360 = 1/6.", hints: ["60 ÷ 360.", "1/6.", "60/360 = 1/6."] },
      // @q11
      { id: "U22L3-tf-1", type: "true-false-justify", category: "conceptual", prompt: "Every square has rotational symmetry of order 4.", isTrue: true, explanation: "Four 90° rotations map it onto itself.", hints: ["90° snaps.", "Order 4.", "Four 90° rotations map it onto itself."] },
      // @q12
      { id: "U22L3-tf-2", type: "true-false-justify", category: "conceptual", prompt: "A rectangle has 4 lines of symmetry.", isTrue: false, explanation: "Only 2 (midlines); its diagonals don't fold-match.", hints: ["2 midlines.", "No diagonals.", "Only 2 (midlines); its diagonals don't fold-match."] },
      // @q13
      { id: "U22L3-order-1", type: "order-steps", category: "word", prompt: "Order the steps to count a square's rotational order.", sequence: ["Find the turn that matches: 90°", "How many in 360°? 360 ÷ 90 = 4", "State order 4", "Check: 4 × 90 = 360 ✓"], diagnoses: { "Find the turn that matches: 90°@1": "Find the matching turn first.", "How many in 360°? 360 ÷ 90 = 4@0": "Then divide 360.", "Check: 4 × 90 = 360 ✓@0": "Check last." }, explanation: "Matching turn, divide 360, state, verify.", hints: ["90° turn.", "360 ÷ 90.", "Matching turn, divide 360, state, verify."] },
      // @q14
      ...
      // @q15
      { id: "U22L3-graph-1", type: "graph-interact", category: "word", prompt: "A regular octagon matches every 45°. Set the slider to its rotational order (key: value).", challenge: "A regular octagon matches every 45°. — adjust the values below to match the condition.", validate: { value: 8 }, tolerance: 0.01, explanation: "360 ÷ 45 = 8.", hints: ["360 ÷ 45.", "8.", "360 ÷ 45 = 8."] }
    ],
