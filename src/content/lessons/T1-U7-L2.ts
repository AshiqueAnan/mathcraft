    ...
    pool: [
      {
        ...
        hints: ["Same base 2.", "Add the indices.", "Same base → add indices: 2^(3+4) = 2⁷."],
      },
      {
        id: "U7L2-mcq-2", type: "mcq", category: "conceptual",
        prompt: "Why can 2³ × 2⁴ become 2⁷?",
        options: [
          { id: "a", text: "Because 3 × 4 = 12" },
          { id: "b", text: "Both are stacks of the SAME base 2, so we count all twos" },
          { id: "c", text: "Because indices always add" },
          { id: "d", text: "It can't" },
        ],
        correctOptionId: "b",
        diagnoses: { a: "3×4 = 12 would be power-of-a-power if (2³)⁴, not the product.", c: "Indices add only for same bases.", d: "Expanding (2×2×2)(2×2×2×2) = 7 twos, so it CAN." },
        explanation: "The expanded stacks share the base 2 — counting all twos adds their counts.",
        hints: ["Expand both.", "Count the 2s.", "The expanded stacks share the base 2 — counting all twos adds their counts."],
      },
      {
        ...
        options: [{ id: "a", text: "2¹² = 4096" }, { id: "b", text: "2³ + 2⁴ = 24" }, { id: "c", text: "2⁷ = 128" }, { id: "d", text: "2 × 7 = 14" }],
        correctOptionId: "c",
        diagnoses: { b: "Powers multiply, not add, when combining doublings.", a: "2¹² would be (2³)⁴.", d: "Don't multiply base by total hours." },
        explanation: "2³ × 2⁴ = 2⁷ = 128.",
        hints: ["Add indices.", "2⁷.", "2³ × 2⁴ = 2⁷ = 128."],
      },
      {
        ...
        correctOptionId: "d",
        diagnoses: { b: "6 ÷ 2 = 3 is wrong — indices SUBTRACT on division.", c: "5¹² adds indices, but division subtracts.", a: "5⁸ adds the indices." },
        explanation: "Divide → subtract indices: 5^(6−2) = 5⁴.",
        hints: ["Expand: cancel two 5s.", "6 − 2.", "Divide → subtract indices: 5^(6−2) = 5⁴."],
      },
      {
      ...
      },
      {
        ...
        options: [{ id: "a", text: "2⁵ = 32" }, { id: "b", text: "2⁶ = 64" }, { id: "c", text: "2⁸ = 256" }, { id: "d", text: "6² = 36" }],
        correctOptionId: "b",
        diagnoses: { a: "2⁵ adds indices — power of a power MULTIPLIES.", c: "2⁸ = 2^(2+2+2+2)? No — multiply 2×3 = 6.", d: "6² treats the 2 and 3 as a new base — wrong." },
        explanation: "(a^m)^n = a^(m×n): (2²)³ = 2⁶ = 64.",
        hints: ["Power of a power.", "Multiply indices 2 × 3.", "(a^m)^n = a^(m×n): (2²)³ = 2⁶ = 64."],
      },
      {
        ...
        hints: ["Same base 3.", "Add 2 + 3.", "Add indices: 2 + 3 = 5 → 3⁵."],
      },
      {
        ...
        hints: ["Same base 10.", "Subtract 7 − 4.", "Subtract indices: 7 − 4 = 3 → 10³."],
      },
      {
      ...
      },
      {
        ...
        hints: ["Subtract indices: 2.", "2² = 4.", "2⁵÷2³ = 2² = 4 → 4/1."],
      },
      {
        ...
        hints: ["Same base 2.", "Add 3 + 5.", "3 + 5 = 8 → same base, add indices."],
      },
      {
        ...
        hints: ["Different bases 5 and 6.", "Can't add exponents.", "Different bases: 5² × 6² = 25 × 36 = 900, but 30⁴ = 810,000."],
      },
      {
        ...
        hints: ["Same base?", "Add indices.", "Same base → add indices."],
      },
      {
      ...
      },
      {
        ...
        hints: ["Add indices: 5.", "5⁵.", "5² × 5³ = 5⁵ = 3125."],
      },
    ],
