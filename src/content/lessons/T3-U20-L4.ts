...
export const T3U20L4: Lesson = {
  ...
  quiz: {
    pool: [
      ...
      // @q04
      { id: "U20L4-mcq-4", type: "mcq", category: "procedural", prompt: "A triangle's exterior angle is 120°. The two opposite interiors are…", options: [ { id: "a", text: "Both 60° always" }, { id: "b", text: "60° and 60°" }, { id: "c", text: "120° and 60°" }, { id: "d", text: "Any pair summing to 120°" } ], correctOptionId: "d", diagnoses: { b: "60+60 sums to 120 but isn't forced.", c: "One of them must be less; only the sum is fixed.", a: "Only the SUM is fixed at 120°." }, explanation: "Exterior = sum of the two remote interiors; many pairs work.", hints: ["Exterior = remote sum.", "Pair sums to 120°.", "Any such pair."] },
      // @q05
      ...
      // @q06
      { id: "U20L4-mcq-6", type: "mcq", category: "word", prompt: "A kite's tail forms a triangle with angles 50° and 70°. The third angle is…", options: [ { id: "a", text: "80°" }, { id: "b", text: "60°" }, { id: "c", text: "90°" }, { id: "d", text: "130°" } ], correctOptionId: "b", diagnoses: { a: "80 = 50 + 30, not from the sum rule.", c: "90 is only for right triangles.", d: "130 is 180 − 50, missing the 70." }, explanation: "180 − 50 − 70 = 60°.", hints: ["180 − 120.", "60°.", "60°."] },
      // @q07
