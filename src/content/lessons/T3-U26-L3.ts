...
export const T3U26L3: Lesson = {
  ...
  quiz: {
    pool: [
      ...
      // @q02
      { id: "U26L3-mcq-2", type: "mcq", category: "conceptual", prompt: "To find an ANGLE from two sides you use…", options: [ { id: "a", text: "the ratio itself" }, { id: "b", text: "the inverse ratio (sin⁻¹ / tan⁻¹)" }, { id: "c", text: "the hypotenuse only" }, { id: "d", text: "multiplication by 360" } ], correctOptionId: "b", diagnoses: { a: "The ratio gives a decimal — the inverse turns it back into degrees.", c: "You need both sides, not one.", d: "360° has nothing to do with it." }, explanation: "Compute the ratio, then apply its inverse to recover θ in degrees.", hints: ["Ratio → inverse.", "sin⁻¹ or tan⁻¹.", "Compute the ratio, then apply its inverse to recover θ in degrees."] },
      // @q03
      { id: "U26L3-mcq-3", type: "mcq", category: "word", prompt: "A tree casts a 20 m shadow; the sun is at 30°. Height = tan 30° × 20 ≈ …", options: [ { id: "a", text: "34.6 m" }, { id: "b", text: "20 m" }, { id: "c", text: "11.5 m" }, { id: "d", text: "5.8 m" } ], correctOptionId: "c", diagnoses: { b: "20 m is the shadow (adjacent), not the height.", a: "34.6 divides by tan — inverted.", d: "5.8 multiplies by sin instead of tan." }, explanation: "height = tan 30° × 20 ≈ 0.577 × 20 ≈ 11.5 m.", hints: ["tan 30° ≈ 0.577.", "0.577 × 20.", "height = tan 30° × 20 ≈ 0."] },
      // @q04
      { id: "U26L3-mcq-4", type: "mcq", category: "procedural", prompt: "Opposite 3, hypotenuse 5. θ = sin⁻¹(0.6) ≈ …", options: [ { id: "a", text: "60°" }, { id: "b", text: "53.1°" }, { id: "c", text: "30°" }, { id: "d", text: "36.9°" } ], correctOptionId: "d", diagnoses: { b: "53.1° is the OTHER acute angle (cos⁻¹ of 0.6).", c: "30° has sine 0.5, not 0.6.", a: "60° has sine ≈ 0.866." }, explanation: "sin⁻¹(0.6) ≈ 36.9°.", hints: ["sin⁻¹ 0.6.", "≈ 36.9°.", "sin⁻¹(0.6) ≈ 36.9°."] },
      // @q05
      { id: "U26L3-mcq-5", type: "mcq", category: "conceptual", prompt: "Elevation and depression angles are measured from…", options: [ { id: "a", text: "the horizontal" }, { id: "b", text: "the vertical" }, { id: "c", text: "the hypotenuse" }, { id: "d", text: "the ground level of the far object" } ], correctOptionId: "a", diagnoses: { b: "They tilt up or down FROM horizontal.", c: "The hypotenuse is a side, not a reference line.", d: "Reference is the observer's horizontal line." }, explanation: "Angle of elevation looks up from horizontal; depression looks down from it.", hints: ["Sight line vs horizontal.", "From the horizontal.", "Angle of elevation looks up from horizontal; depression looks down from it."] },
      // @q06
      { id: "U26L3-mcq-6", type: "mcq", category: "word", prompt: "A 5 m ladder makes a 60° angle with the ground. Height reached = …", options: [ { id: "a", text: "≈ 2.5 m" }, { id: "b", text: "≈ 4.33 m" }, { id: "c", text: "≈ 8.66 m" }, { id: "d", text: "5 m" } ], correctOptionId: "b", diagnoses: { a: "2.5 uses sin 30° — wrong angle.", c: "8.66 divides by sin — inverted.", d: "5 m is the ladder (hypotenuse)." }, explanation: "height = sin 60° × 5 ≈ 0.866 × 5 ≈ 4.33 m.", hints: ["sin 60° × 5.", "0.866 × 5.", "height = sin 60° × 5 ≈ 0."] },
      // @q07
      { id: "U26L3-num-1", type: "numeric-input", category: "procedural", prompt: "cos 60° = 0.5, hypotenuse 12. The adjacent side is…", answer: 6, tolerance: 0, explanation: "adjacent = 0.5 × 12 = 6.", hints: ["cos × hypotenuse.", "0.5 × 12.", "adjacent = 0.5 × 12 = 6."] },
      // @q08
      { id: "U26L3-num-2", type: "numeric-input", category: "procedural", prompt: "tan 30° ≈ 0.577, height = 5. The adjacent (ground distance) is about…", answer: 8.66, tolerance: 0.2, explanation: "adjacent = height ÷ tan = 5 ÷ 0.577 ≈ 8.66.", hints: ["Divide by tan.", "5 ÷ 0.577.", "adjacent = height ÷ tan = 5 ÷ 0."] },
      // @q09
      { id: "U26L3-num-3", type: "numeric-input", category: "conceptual", prompt: "A 3-4-5 triangle: tan θ = 3/4 = 0.75. θ ≈ … (degrees, 1 dp)", answer: 36.9, tolerance: 0.2, unit: "°", explanation: "tan⁻¹(0.75) ≈ 36.87° ≈ 36.9°.", hints: ["tan⁻¹ 0.75.", "≈ 36.9°.", "tan⁻¹(0.75) ≈ 36.87° ≈ 36.9°."] },
      // @q10
      { id: "U26L3-frac-1", type: "fraction-input", category: "conceptual", prompt: "cos θ = 0.8 with hypotenuse 10. What FRACTION is the adjacent side of the hypotenuse?", numerator: 8, denominator: 10, acceptEquivalent: true, explanation: "adjacent = 8, hypotenuse = 10 → 8/10 = 0.8.", hints: ["Adjacent over hypotenuse.", "8/10.", "adjacent = 8, hypotenuse = 10 → 8/10 = 0."] },
      // @q11
      { id: "U26L3-tf-1", type: "true-false-justify", category: "conceptual", prompt: "Calculator degree mode is essential for inverse trig angles.", isTrue: true, explanation: "Radian mode would output different numbers — these problems are in degrees.", hints: ["Degrees vs radians.", "Use degree mode.", "Radian mode would output different numbers — these problems are in degrees."] },
      // @q12
      { id: "U26L3-tf-2", type: "true-false-justify", category: "conceptual", prompt: "Given an angle and the adjacent side, tangent can find the opposite side.", isTrue: true, explanation: "opposite = tan θ × adjacent — forward use of tangent.", hints: ["tan = o/a.", "o = tan × a.", "opposite = tan θ × adjacent — forward use of tangent."] },
      // @q13
      { id: "U26L3-order-1", type: "order-steps", category: "word", prompt: "Order the steps to find angle θ from opposite 3, adjacent 4.", sequence: ["Compute ratio: 3 ÷ 4 = 0.75", "Identify as tan θ", "Apply inverse: θ = tan⁻¹(0.75)"], diagnoses: { "Compute ratio: 3 ÷ 4 = 0.75@1": "Compute the ratio first.", "Identify as tan θ@0": "Then name the ratio.", "Apply inverse: θ = tan⁻¹(0.75)@0": "Apply inverse last." }, explanation: "Ratio, identify, inverse.", hints: ["3 ÷ 4.", "tan.", "Ratio, identify, inverse."] },
      // @q14
      { id: "U26L3-drag-1", type: "drag-match", category: "conceptual", prompt: "Match each known pair to the ratio you'd use.", pairs: [ { source: "opposite + hypotenuse", target: "sine (or inverse)" }, { source: "adjacent + hypotenuse", target: "cosine (or inverse)" }, { source: "opposite + adjacent", target: "tangent (or inverse)" } ], diagnoses: { "opposite + hypotenuse->cosine (or inverse)": "Sine pairs opposite with hypotenuse.", "adjacent + hypotenuse->tangent (or inverse)": "Cosine pairs adjacent with hypotenuse.", "opposite + adjacent->sine (or inverse)": "Tangent pairs the two legs." }, explanation: "Pick the ratio built from your two known sides.", hints: ["O,H → sin.", "A,H → cos.", "Pick the ratio built from your two known sides."] },
      // @q15
      { id: "U26L3-graph-1", type: "graph-interact", category: "word", prompt: "sin 30° = 0.5 with hypotenuse 10. Set the slider to the OPPOSITE side (key: value).", challenge: "sin 30° = 0.5 with hypotenuse 10. — adjust the values below to match the condition.", validate: { value: 5 }, tolerance: 0.01, explanation: "opposite = 0.5 × 10 = 5.", hints: ["0.5 × 10.", "5.", "opposite = 0.5 × 10 = 5."] }
    ],
