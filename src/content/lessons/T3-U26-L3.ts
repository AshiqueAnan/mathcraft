...
export const T3U26L3: Lesson = {
  ...
  quiz: {
    pool: [
      ...
      // @q02
      { id: "U26L3-mcq-2", type: "mcq", category: "conceptual", prompt: "To find an ANGLE from two sides you use…", options: [ { id: "a", text: "the ratio itself" }, { id: "b", text: "the inverse ratio (sin⁻¹ / tan⁻¹)" }, { id: "c", text: "the hypotenuse only" }, { id: "d", text: "multiplication by 360" } ], correctOptionId: "b", diagnoses: { a: "The ratio gives a decimal — the inverse turns it back into degrees.", c: "You need both sides, not one.", d: "360° has nothing to do with it." }, explanation: "Compute the ratio, then apply its inverse to recover θ in degrees.", hints: ["Ratio → inverse.", "sin⁻¹ or tan⁻¹.", "Inverse."] },
      // @q03
      ...
      // @q04
      { id: "U26L3-mcq-4", type: "mcq", category: "procedural", prompt: "Opposite 3, hypotenuse 5. θ = sin⁻¹(0.6) ≈ …", options: [ { id: "a", text: "60°" }, { id: "b", text: "53.1°" }, { id: "c", text: "30°" }, { id: "d", text: "36.9°" } ], correctOptionId: "d", diagnoses: { b: "53.1° is the OTHER acute angle (cos⁻¹ of 0.6).", c: "30° has sine 0.5, not 0.6.", a: "60° has sine ≈ 0.866." }, explanation: "sin⁻¹(0.6) ≈ 36.9°.", hints: ["sin⁻¹ 0.6.", "≈ 36.9°.", "36.9°."] },
      // @q05
