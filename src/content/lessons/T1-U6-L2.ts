    ...
    pool: [
      {
        ...
        hints: ["Total parts = 3 + 5.", "40 ÷ 8 = 5 per part.", "8 parts, one part = 5."],
      },
      {
        id: "U6L2-mcq-2", type: "mcq", category: "conceptual",
        prompt: "Why do you add the ratio numbers (a + b) first?",
        options: [
          { id: "a", text: "To make the numbers bigger" },
          { id: "b", text: "To find how many equal parts the whole breaks into" },
          { id: "c", text: "To find the biggest share" },
          { id: "d", text: "You don't add them" },
        ],
        correctOptionId: "b",
        diagnoses: { a: "Adding isn't for size — it counts the total slices.", c: "You add first, then each share is found after.", d: "The ratio's parts always add to the whole's slice count." },
      ...
      },
      {
        ...
        options: [{ id: "a", text: "$25" }, { id: "b", text: "$20" }, { id: "c", text: "$80" }, { id: "d", text: "$40" }],
        correctOptionId: "c",
        diagnoses: { b: "20 is the SMALLER share (1 part).", a: "25 = 100 ÷ 4 — wrong part count.", d: "40 ignores the 5 parts." },
        explanation: "5 parts, one part = 20. Larger (4 parts) = 80.",
        hints: ["1 + 4 = 5 parts.", "100 ÷ 5 = 20.", "5 parts, one part = 20."],
      },
      {
        id: "U6L2-mcq-4", type: "mcq", category: "procedural",
        prompt: "Split 60 in ratio 2:3. What is the smaller share?",
        options: [{ id: "a", text: "30" }, { id: "b", text: "36" }, { id: "c", text: "20" }, { id: "d", text: "24" }],
        correctOptionId: "d",
        diagnoses: { b: "36 is the larger share (3 parts).", c: "20 = 60 ÷ 3 — wrong part count.", a: "30 = 60 ÷ 2." },
        explanation: "5 parts, one part = 12. Smaller (2) = 24.",
        hints: ["2 + 3 = 5 parts.", "60 ÷ 5 = 12.", "5 parts, one part = 12."],
      },
      {
        ...
        hints: ["1 + 1 = 2 parts.", "50 ÷ 2.", "2 parts, one part = 25, each gets 1 part = 25."],
      },
      {
        id: "U6L2-mcq-6", type: "mcq", category: "word",
        prompt: "A wire 48 cm is cut in ratio 1:3. Shorter piece?",
        options: [{ id: "a", text: "36 cm" }, { id: "b", text: "12 cm" }, { id: "c", text: "16 cm" }, { id: "d", text: "24 cm" }],
        correctOptionId: "b",
        diagnoses: { a: "36 is the longer piece.", c: "16 = 48 ÷ 3.", d: "24 = 48 ÷ 2." },
        explanation: "4 parts, one part = 12. Shorter (1 part) = 12 cm.",
        hints: ["1 + 3 = 4 parts.", "48 ÷ 4 = 12.", "4 parts, one part = 12."],
      },
      {
        ...
        hints: ["4 parts total.", "40 ÷ 4 = 10.", "4 parts, one part = 10."],
      },
      {
        ...
        hints: ["5 parts.", "90 ÷ 5 = 18.", "5 parts, one part = 18."],
      },
      {
        ...
        hints: ["Add the ratio.", "4 + 5.", "4 + 5 = 9 parts."],
      },
      {
        ...
        hints: ["8 parts.", "120 ÷ 8 = 15.", "8 parts, one part = 15."],
      },
      {
        ...
        hints: ["3 + 5 = 8.", "3 out of 8.", "Whole = 8 parts; 3/8."],
      },
      {
        ...
        hints: ["One part each.", "Equal share.", "1:1 means one part each — exactly equal shares ($25 each)."],
      },
      {
      ...
      },
      {
        ...
        hints: ["Total parts 3.", "One part 10.", "Find one part, then scale by each ratio number."],
      },
      {
      ...
      },
      {
        ...
        tolerance: 0.01,
        explanation: "5 parts, one part = 12, smaller (2) = 24.",
        hints: ["2 + 3 = 5 parts.", "60 ÷ 5 = 12.", "5 parts, one part = 12, smaller (2) = 24."],
      },
    ],
