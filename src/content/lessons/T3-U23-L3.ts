...
export const T3U23L3: Lesson = {
  ...
  quiz: {
    pool: [
      // @q01
      { id: "U23L3-mcq-1", type: "mcq", category: "procedural", prompt: "A circle's diameter is 10 cm. Its circumference is closest to…", options: [ { id: "a", text: "31.4 cm" }, { id: "b", text: "15.7 cm" }, { id: "c", text: "78.5 cm" }, { id: "d", text: "62.8 cm" } ], correctOptionId: "a", diagnoses: { b: "15.7 uses the radius in πd — half the diameter.", c: "78.5 is the AREA, not the rim.", d: "62.8 is π × 2d." }, explanation: "C = πd ≈ 3.14 × 10 = 31.4 cm.", hints: ["Circumference = πd.", "3.14 × 10.", "31.4."] },
      // @q02
      { id: "U23L3-mcq-2", type: "mcq", category: "conceptual", prompt: "Roll a wheel: one full turn covers one…", options: [ { id: "a", text: "circumference" }, { id: "b", text: "diameter" }, { id: "c", text: "radius" }, { id: "d", text: "area" } ], correctOptionId: "a", diagnoses: { b: "A diameter is only part of the rim.", c: "Radius is half the width.", d: "Area is the inside, not the travel." }, explanation: "Every full turn rolls out exactly the circumference.", hints: ["Full turn = rim", "Circumference.", "Circumference."] },
      // @q03
      { id: "U23L3-mcq-3", type: "mcq", category: "word", prompt: "A bicycle wheel is 0.7 m across. One turn covers about…", options: [ { id: "a", text: "2.2 m" }, { id: "b", text: "1.4 m" }, { id: "c", text: "0.35 m" }, { id: "d", text: "4.4 m" } ], correctOptionId: "a", diagnoses: { b: "1.4 is the diameter doubled, not π times it.", c: "0.35 is the radius.", d: "4.4 is 2 × π × diameter." }, explanation: "C = πd ≈ 3.14 × 0.7 ≈ 2.2 m.", hints: ["π × diameter.", "3.14 × 0.7.", "≈ 2.2 m."] },
      // @q04
      { id: "U23L3-mcq-4", type: "mcq", category: "procedural", prompt: "Circle radius 4 cm. Its area is closest to…", options: [ { id: "a", text: "50.24 cm²" }, { id: "b", text: "25.12 cm²" }, { id: "c", text: "12.56 cm²" }, { id: "d", text: "100.48 cm²" } ], correctOptionId: "a", diagnoses: { b: "25.12 is circumference (2πr), not area.", c: "12.56 is πr with r = 4 — missing the square.", d: "100.48 uses diameter 8 in πr²." }, explanation: "A = πr² = π × 16 ≈ 50.24 cm².", hints: ["Square the radius.", "π × 16.", "≈ 50.24."] },
      // @q05
      { id: "U23L3-mcq-5", type: "mcq", category: "conceptual", prompt: "Double a circle's radius. Its area…", options: [ { id: "a", text: "quadruples" }, { id: "b", text: "doubles" }, { id: "c", text: "stays the same" }, { id: "d", text: "triples" } ], correctOptionId: "a", diagnoses: { b: "Doubling r doubles the circumference, not area.", c: "Scaling the radius always changes area.", d: "3× would need a ×√3 scale." }, explanation: "π(2r)² = 4πr² — four times.", hints: ["r² scales.", "(2r)² = 4r².", "Quadruples."] },
      // @q06
      { id: "U23L3-mcq-6", type: "mcq", category: "word", prompt: "A circular pond is 6 m wide. Fencing around it needs about…", options: [ { id: "a", text: "18.8 m" }, { id: "b", text: "37.7 m" }, { id: "c", text: "28.3 m" }, { id: "d", text: "9.4 m" } ], correctOptionId: "a", diagnoses: { b: "37.7 is 2πd — wrong formula.", c: "28.3 is the area, not the fence line.", d: "9.4 is πr — missing the doubling." }, explanation: "C = πd ≈ 3.14 × 6 ≈ 18.8 m.", hints: ["Diameter = 6.", "π × 6.", "≈ 18.8 m."] },
      // @q07
      { id: "U23L3-num-1", type: "numeric-input", category: "procedural", prompt: "Circle radius 3 m. Circumference in m (use π ≈ 3.14).", answer: 18.84, tolerance: 0.1, unit: "m", explanation: "C = 2πr = 2 × 3.14 × 3 ≈ 18.84 m.", hints: ["2πr.", "2 × 3.14 × 3.", "≈ 18.84."] },
      // @q08
      { id: "U23L3-num-2", type: "numeric-input", category: "procedural", prompt: "Circle radius 5 cm. Area in cm² (use π ≈ 3.14).", answer: 78.5, tolerance: 0.1, unit: "cm²", explanation: "A = πr² = 3.14 × 25 = 78.5 cm².", hints: ["Square the radius.", "3.14 × 25.", "78.5."] },
      // @q09
      { id: "U23L3-num-3", type: "numeric-input", category: "conceptual", prompt: "A wheel diameter 1 m rolls 6.28 m. How many full turns?", answer: 2, tolerance: 0, explanation: "One turn = πd ≈ 3.14 m; 6.28 ÷ 3.14 = 2 turns.", hints: ["One turn ≈ 3.14 m.", "6.28 ÷ 3.14.", "2."] },
      // @q10
      { id: "U23L3-frac-1", type: "fraction-input", category: "conceptual", prompt: "A semicircle is what fraction of its full circle?", numerator: 1, denominator: 2, acceptEquivalent: true, explanation: "Half the circumference and half the area.", hints: ["Half a circle.", "1/2.", "1/2."] },
      // @q11
      { id: "U23L3-tf-1", type: "true-false-justify", category: "conceptual", prompt: "A circle's area is πr², but its circumference is 2πr.", isTrue: true, explanation: "Area squares the radius; circumference is the rim's length — different formulas, both use π.", hints: ["One squares, one multiplies.", "Both true.", "True."] },
      // @q12
      { id: "U23L3-tf-2", type: "true-false-justify", category: "conceptual", prompt: "The circumference of a circle is 2π times its radius.", isTrue: true, explanation: "C = 2πr is the rim length; π times the diameter is the same.", hints: ["C = πd and d = 2r.", "2πr.", "True."] },
      // @q13
      ...
      // @q15
      { id: "U23L3-graph-1", type: "graph-interact", category: "word", prompt: "A circle's radius is 5. Set the slider to its AREA (key: value).", challenge: "Set the slider to 78.5.", validate: { value: 78.5 }, tolerance: 0.1, explanation: "A = π × 25 ≈ 78.5.", hints: ["π × 5².", "≈ 78.5.", "78.5."] }
    ],
