...
export const T5U31L2: Lesson = {
  ...
  quiz: {
    pool: [
      ...
      // @q02
      { id: "U31L2-mcq-2", type: "mcq", category: "conceptual", prompt: "y = (x+3)² + 1. Axis of symmetry is…", options: [ { id: "a", text: "x = -3" }, { id: "b", text: "x = 3" }, { id: "c", text: "y = 1" }, { id: "d", text: "x = 1" } ], correctOptionId: "a", diagnoses: { b: "+3 inside means h = -3, so axis x = -3.", c: "The axis is vertical, not horizontal.", d: "x = 1 is the vertex's y, not the axis." }, explanation: "Axis is x = h; the +3 inside means h = -3.", hints: ["+3 → h = -3.", "Axis: x = h.", "x = -3."] },
      // @q03
      { id: "U31L2-mcq-3", type: "mcq", category: "word", prompt: "A ball's height is h(t) = -(t-2)² + 10. Its maximum height is…", options: [ { id: "a", text: "10" }, { id: "b", text: "2" }, { id: "c", text: "-2" }, { id: "d", text: "14" } ], correctOptionId: "a", diagnoses: { b: "2 is the time of the peak, not the height.", c: "-2 is negative — heights aren't.", d: "14 is 2+10+2 — no." }, explanation: "The k = 10 is the maximum (vertex y-coordinate).", hints: ["Vertex y.", "k = 10.", "10."] },
      // @q04
      { id: "U31L2-mcq-4", type: "mcq", category: "procedural", prompt: "y = -(x-1)² + 4. The vertex is…", options: [ { id: "a", text: "(1, 4) and it's a maximum" }, { id: "b", text: "(-1, 4) maximum" }, { id: "c", text: "(1, -4) minimum" }, { id: "d", text: "(1, 4) minimum" } ], correctOptionId: "a", diagnoses: { b: "(-1, 4) misreads the inside sign.", c: "k is +4, not -4.", d: "The negative in front flips it to a maximum." }, explanation: "Vertex (1, 4); the leading minus makes it a maximum.", hints: ["- in front.", "Downward.", "Maximum at (1, 4)."] },
      // @q05
      ...
      // @q06
      { id: "U31L2-mcq-6", type: "mcq", category: "word", prompt: "A dolphin's jump is h(t) = -(t-1)² + 5. When does it reach its peak?", options: [ { id: "a", text: "at t = 1" }, { id: "b", text: "at t = 5" }, { id: "c", text: "at t = 0" }, { id: "d", text: "never" } ], correctOptionId: "a", diagnoses: { b: "5 is the peak height, not the time.", c: "t = 0 is the start.", d: "It peaks — h = 1 is the time." }, explanation: "h = 1 is the time of the peak (vertex x-coordinate).", hints: ["h = 1.", "Vertex x.", "t = 1."] },
      // @q07
