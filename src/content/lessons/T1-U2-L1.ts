    ...
    pool: [
      {
        ...
        hints: ["Multiply first.", "4 × 2 = ?", "4 × 2 = 8, then 3 + 8 = 11."],
      },
      {
        id: "U2L1-mcq-2", type: "mcq", category: "conceptual",
        prompt: "Why does 2 + 3 × 4 equal 14 and not 20?",
        options: [
          { id: "a", text: "Because + is always last" },
          { id: "b", text: "× creates one block before + joins" },
          { id: "c", text: "Because 3×4 is bigger than 2+3" },
          { id: "d", text: "It doesn't — it's 20" },
        ],
        correctOptionId: "b",
        diagnoses: { a: "+ isn't 'always last' — but × groups first here.", c: "Size isn't the reason.", d: "It is 14." },
        explanation: "Multiplication forms a single block (12), then addition joins it: 2 + 12 = 14.",
        hints: ["What groups first?", "× forms the block.", "Multiplication forms a single block (12), then addition joins it: 2 + 12 = 14."],
      },
      {
        id: "U2L1-mcq-3", type: "mcq", category: "procedural",
        prompt: "(3 + 4) × 2 = ?",
        options: [{ id: "a", text: "10" }, { id: "b", text: "11" }, { id: "c", text: "14" }, { id: "d", text: "24" }],
        correctOptionId: "c",
        diagnoses: { b: "11 skips the ×2 after the bracket.", a: "That's 3 + 4×2.", d: "24 multiplies everything." },
        explanation: "Bracket first: 3 + 4 = 7, then 7 × 2 = 14.",
        hints: ["Brackets first.", "7 × 2.", "Bracket first: 3 + 4 = 7, then 7 × 2 = 14."],
      },
      {
        id: "U2L1-mcq-4", type: "mcq", category: "word",
        prompt: "A tray has 4 rows of 6 buns; you add 5 loose buns. Total?",
        options: [{ id: "a", text: "30" }, { id: "b", text: "26" }, { id: "c", text: "54" }, { id: "d", text: "29" }],
        correctOptionId: "d",
        diagnoses: { b: "26 is 4 × 6 + 5 with a mistake: 4×6=24, +5=29.", c: "54 multiplies the 5 too.", a: "30 forgets the 5." },
        explanation: "4 × 6 + 5 = 24 + 5 = 29 (taking 4×6 as the block).",
        hints: ["Tray block = 4 × 6.", "24 + 5.", "4 × 6 + 5 = 24 + 5 = 29 (taking 4×6 as the block)."],
      },
      {
        ...
        hints: ["Multiply first.", "10 − 6.", "2 × 3 = 6, then 10 − 6 = 4."],
      },
      {
        id: "U2L1-mcq-6", type: "mcq", category: "word",
        prompt: "3 packs of 7 stickers, plus 4 singles. How many stickers?",
        options: [{ id: "a", text: "21" }, { id: "b", text: "25" }, { id: "c", text: "28" }, { id: "d", text: "34" }],
        correctOptionId: "b",
        diagnoses: { a: "21 ignores the 4 singles.", c: "28 is 4×7.", d: "34 is 3+4×7." },
        explanation: "3 × 7 + 4 = 21 + 4 = 25.",
        hints: ["Pack block = 3 × 7.", "21 + 4.", "3 × 7 + 4 = 21 + 4 = 25."],
      },
      {
        ...
        hints: ["× first.", "12.", "2 × 6 = 12, so 5 + 12 = 17."],
      },
      {
        ...
        hints: ["Brackets first.", "7 × 6.", "Bracket: 7 × 6 = 42."],
      },
      {
        ...
        hints: ["÷ shares same priority as ×.", "18 − 3.", "6 ÷ 2 = 3, so 18 − 3 = 15."],
      },
      {
        ...
        hints: ["Bracket the addition.", "(2+3).", "(2 + 3) × 4 = 5 × 4 = 20."],
      },
      {
        ...
        hints: ["Total slices = 2 × 4.", "Left = 8 − 2.", "8 slices total; 6 left = 6/8 = 3/4."],
      },
      {
        ...
        hints: ["Multiply first.", "2 + 12.", "× first: 2 + 12 = 14, not 20."],
      },
      {
        ...
        hints: ["Left side = 20.", "Right side = 14.", "20 ≠ 14, so the brackets change the answer."],
      },
      {
        ...
        hints: ["÷ and × come before + and −.", "8 ÷ 2 first.", "8 ÷ 2 = 4, then 4 + 1 = 5."],
      },
      {
        ...
        hints: ["3 + 8.", "7 × 2.", "Only the bracket changes the grouping: 11, 14, 10."],
      },
      {
        ...
        challenge: "Slider key 'value': — adjust the values below to match the condition.",
        validate: { value: 14 }, tolerance: 0,
        explanation: "2 + 12 = 14.",
        hints: ["Multiply first.", "2 + 12.", "2 + 12 = 14."],
      },
    ],
