  ...
  quiz: {
    pool: [
      ...
      },
      {
        ...
        hints: ["What is the thousands place worth?", "3 thousands = 3 × 1,000.", "The thousands place is worth 1,000, so the digit 3 there means 3 × 1,000 = 3,000."],
      },
      {
      ...
      },
      {
        ...
        hints: ["How many 90,000s fit in 1,000,000?", "90,000 × 10 = 900,000.", "1,000,000 ÷ 90,000 ≈ 11."],
      },
      {
        ...
        hints: ["Compare the millions digit first.", "1.5 > 1.05 > 1.0005 > 0.15.", "Compare the leading digits: 1."],
      },
      {
        ...
        hints: ["Split the million cents into 2-cent pieces.", "Half of a million.", "1,000,000 ÷ 2 = 500,000 messages."],
      },
      {
        ...
        hints: ["Thousands first.", "8,000 + 400.", "8 thousands + 4 hundreds = 8,400."],
      },
      {
        ...
        hints: ["×10 adds one zero.", "3,500 with a zero on the end.", "3,500 × 10 = 35,000 — every digit shifts one place left."],
      },
      {
        ...
        hints: ["Read the number: seven thousand.", "Seven THOUSAND.", "The 7 is the leading digit: it sits in the thousands place, worth 1,000."],
      },
      {
      ...
      },
      {
        ...
        hints: ["5,000 × 10 = 50,000.", "So 5,000 is one part out of ten.", "5,000 is 1/10 of 50,000."],
      },
      {
        ...
        hints: ["How many 100,000s in 1,000,000?", "100,000 × 10 = 1,000,000.", "1,000,000 ÷ 100,000 = 10, so yes — a million is ten times a hundred thousand."],
      },
      {
        ...
        hints: ["2,500 with a zero appended.", "25,000 is ten times 2,500.", "25,000 = 2,500 × 10, so yes."],
      },
      {
      ...
      },
      {
        ...
        challenge: "Slide the value so the expression equals 6,000 . — adjust the values below to match the condition.",
        validate: { value: 6000 }, tolerance: 0,
        explanation: "6,000 is six thousand.",
        hints: ["You want six thousand.", "Set the slider to 6000.", "6,000 is six thousand."],
      },
    ],
