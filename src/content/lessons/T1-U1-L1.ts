  ...
  quiz: {
    pool: [
      ...
      },
      {
        ...
        options: [
          { id: "a", text: "3,000" }, { id: "b", text: "300" }, { id: "c", text: "30" }, { id: "d", text: "3" },
        ],
        correctOptionId: "a",
        diagnoses: { b: "That's the hundreds place.", c: "That's the tens place.", d: "That's the ones place." },
      ...
      },
      {
        ...
        options: [
          { id: "a", text: "6" }, { id: "b", text: "5" }, { id: "c", text: "7" }, { id: "d", text: "9" },
        ],
        correctOptionId: "a",
        diagnoses: { b: "10⁵ = 100,000 has five zeros — one less.", c: "10⁷ = ten million has seven.", d: "10⁹ is a billion." },
      ...
      },
      {
        ...
        options: [
          { id: "a", text: "About 11" }, { id: "b", text: "About 100" }, { id: "c", text: "About 9" }, { id: "d", text: "About 900" },
        ],
        correctOptionId: "a",
        diagnoses: { b: "That would hold 9 million.", c: "Nine stadiums hold 810,000 — nearly a million but short.", d: "Way too many." },
      ...
      },
      {
        ...
        options: [
          { id: "a", text: "500,000" }, { id: "b", text: "50,000" }, { id: "c", text: "5,000" }, { id: "d", text: "2,000" },
        ],
        correctOptionId: "a",
        diagnoses: { b: "That pays for 100,000 cents' worth — ten times too few.", c: "That's only 10,000 cents.", d: "That's just 4,000 cents." },
