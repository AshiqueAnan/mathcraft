...
export const T2U12L1: Lesson = {
  ...
  quiz: {
    pool: [
      ...
      // @q03
      { id: "U12L1-mcq-3", type: "mcq", category: "word", prompt: "A garden is 5 m wide and (x + 3) m long. Which gives its area?", options: [ { id: "a", text: "x + 15" }, { id: "b", text: "5x + 3" }, { id: "c", text: "5x + 15" }, { id: "d", text: "5x + 8" } ], correctOptionId: "c", diagnoses: { b: "The 5 must multiply the 3 too.", a: "The 5 must multiply the x too.", d: "8 is 5 + 3 — wrong operation." }, explanation: "Area = 5 × (x + 3) = 5x + 15.", hints: ["Area = width × length.", "5 × (x + 3).", "5x + 15."] },
      // @q04
      { id: "U12L1-mcq-4", type: "mcq", category: "procedural", prompt: "Expand 2(3x + 5).", options: [ { id: "a", text: "3x + 10" }, { id: "b", text: "5x + 7" }, { id: "c", text: "6x + 5" }, { id: "d", text: "6x + 10" } ], correctOptionId: "d", diagnoses: { b: "5x + 7 adds coefficients — wrong.", c: "The 2 must multiply the 5 too.", a: "The 2 must multiply the 3x too." }, explanation: "2 × 3x = 6x and 2 × 5 = 10 → 6x + 10.", hints: ["2 × 3x.", "2 × 5.", "6x + 10."] },
      // @q05
      ...
      // @q06
      { id: "U12L1-mcq-6", type: "mcq", category: "word", prompt: "A wall is 4 m tall and (2x + 1) m wide. Which gives its area?", options: [ { id: "a", text: "8x + 1" }, { id: "b", text: "8x + 4" }, { id: "c", text: "2x + 4" }, { id: "d", text: "6x + 5" } ], correctOptionId: "b", diagnoses: { a: "The 4 must multiply the 1 too.", c: "The 4 must multiply the 2x too.", d: "6x + 5 adds — wrong." }, explanation: "4 × (2x + 1) = 8x + 4.", hints: ["4 × 2x.", "4 × 1.", "8x + 4."] },
      // @q07
