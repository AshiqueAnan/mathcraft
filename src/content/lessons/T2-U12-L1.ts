...
export const T2U12L1: Lesson = {
  ...
  quiz: {
    pool: [
      // @q01
      { id: "U12L1-mcq-1", type: "mcq", category: "procedural", prompt: "Expand 3(x + 4).", options: [ { id: "a", text: "3x + 12" }, { id: "b", text: "3x + 4" }, { id: "c", text: "x + 12" }, { id: "d", text: "3x + 7" } ], correctOptionId: "a", diagnoses: { b: "The 3 must multiply the 4 too.", c: "The 3 must multiply the x too.", d: "7 is 3 + 4 — wrong operation." }, explanation: "3 × x = 3x and 3 × 4 = 12 → 3x + 12.", hints: ["Multiply 3 by x.", "Multiply 3 by 4.", "3x + 12."] },
      // @q02
      { id: "U12L1-mcq-2", type: "mcq", category: "conceptual", prompt: "Why does 3(x + 4) = 3x + 12?", options: [ { id: "a", text: "A 3-by-(x+4) rectangle splits into 3x and 12" }, { id: "b", text: "3 and 4 add to 7" }, { id: "c", text: "The x disappears" }, { id: "d", text: "Brackets mean subtract" } ], correctOptionId: "a", diagnoses: { b: "Addition of 3+4 isn't what brackets do here.", c: "x stays — it's multiplied by 3.", d: "Brackets mean multiply the outside by the inside." }, explanation: "The area model: height 3, width x + 4 → strips 3x and 12.", hints: ["Think of a rectangle.", "Height 3, width x + 4.", "Two strips."] },
      // @q03
      { id: "U12L1-mcq-3", type: "mcq", category: "word", prompt: "A garden is 5 m wide and (x + 3) m long. Which gives its area?", options: [ { id: "a", text: "5x + 15" }, { id: "b", text: "5x + 3" }, { id: "c", text: "x + 15" }, { id: "d", text: "5x + 8" } ], correctOptionId: "a", diagnoses: { b: "The 5 must multiply the 3 too.", c: "The 5 must multiply the x too.", d: "8 is 5 + 3 — wrong operation." }, explanation: "Area = 5 × (x + 3) = 5x + 15.", hints: ["Area = width × length.", "5 × (x + 3).", "5x + 15."] },
      // @q04
      { id: "U12L1-mcq-4", type: "mcq", category: "procedural", prompt: "Expand 2(3x + 5).", options: [ { id: "a", text: "6x + 10" }, { id: "b", text: "5x + 7" }, { id: "c", text: "6x + 5" }, { id: "d", text: "3x + 10" } ], correctOptionId: "a", diagnoses: { b: "5x + 7 adds coefficients — wrong.", c: "The 2 must multiply the 5 too.", d: "The 2 must multiply the 3x too." }, explanation: "2 × 3x = 6x and 2 × 5 = 10 → 6x + 10.", hints: ["2 × 3x.", "2 × 5.", "6x + 10."] },
      // @q05
      { id: "U12L1-mcq-5", type: "mcq", category: "conceptual", prompt: "What is the distributive law?", options: [ { id: "a", text: "a(b + c) = ab + ac" }, { id: "b", text: "a(b + c) = ab + c" }, { id: "c", text: "a(b + c) = a + b + c" }, { id: "d", text: "a(b + c) = ab + bc" } ], correctOptionId: "a", diagnoses: { b: "The a must hit the c too.", c: "That's just removing brackets wrongly.", d: "bc would need b outside — only a is outside." }, explanation: "The outside term multiplies every inside term: a(b + c) = ab + ac.", hints: ["a multiplies b.", "a multiplies c.", "ab + ac."] },
      // @q06
      { id: "U12L1-mcq-6", type: "mcq", category: "word", prompt: "A wall is 4 m tall and (2x + 1) m wide. Which gives its area?", options: [ { id: "a", text: "8x + 4" }, { id: "b", text: "8x + 1" }, { id: "c", text: "2x + 4" }, { id: "d", text: "6x + 5" } ], correctOptionId: "a", diagnoses: { b: "The 4 must multiply the 1 too.", c: "The 4 must multiply the 2x too.", d: "6x + 5 adds — wrong." }, explanation: "4 × (2x + 1) = 8x + 4.", hints: ["4 × 2x.", "4 × 1.", "8x + 4."] },
      // @q07
      { id: "U12L1-num-1", type: "numeric-input", category: "procedural", prompt: "Expand 5(x + 2). Type the coefficient of x.", answer: 5, tolerance: 0, explanation: "5 × x = 5x, so the coefficient is 5.", hints: ["5 × x.", "5x.", "5."] },
      // @q08
      { id: "U12L1-num-2", type: "numeric-input", category: "procedural", prompt: "Expand 4(x + 3). Type the constant term.", answer: 12, tolerance: 0, explanation: "4 × 3 = 12, the constant.", hints: ["4 × 3.", "12.", "12."] },
      // @q09
      { id: "U12L1-num-3", type: "numeric-input", category: "conceptual", prompt: "Expand 3(2x + 4). Type the coefficient of x.", answer: 6, tolerance: 0, explanation: "3 × 2x = 6x, so the coefficient is 6.", hints: ["3 × 2x.", "6x.", "6."] },
      // @q10
      { id: "U12L1-frac-1", type: "fraction-input", category: "conceptual", prompt: "Expand ½(2x + 4). Write the constant term as a fraction.", numerator: 2, denominator: 1, acceptEquivalent: true, explanation: "½ × 2x = x and ½ × 4 = 2 → x + 2.", hints: ["½ × 2x = x.", "½ × 4 = 2.", "2 = 2/1."] },
      // @q11
      { id: "U12L1-tf-1", type: "true-false-justify", category: "conceptual", prompt: "3(x + 4) = 3x + 12.", isTrue: true, explanation: "The 3 multiplies both x and 4.", hints: ["3 × x.", "3 × 4.", "True."] },
      // @q12
      { id: "U12L1-tf-2", type: "true-false-justify", category: "conceptual", prompt: "2(x + 3) = 2x + 3.", isTrue: false, explanation: "The 2 must multiply the 3 too: 2x + 6.", hints: ["2 × 3.", "2x + 6.", "False."] },
      // @q13
      ...
      // @q14
      { id: "U12L1-drag-1", type: "drag-match", category: "conceptual", prompt: "Match each bracket to its expansion.", pairs: [ { source: "2(x + 5)", target: "2x + 10" }, { source: "3(x + 1)", target: "3x + 3" }, { source: "4(x + 2)", target: "4x + 8" } ], diagnoses: { "2(x + 5)->3x + 3": "2 × 5 = 10.", "3(x + 1)->4x + 8": "3 × 1 = 3.", "4(x + 2)->2x + 10": "4 × 2 = 8." }, explanation: "Multiply the outside by each inside term.", hints: ["Multiply the outside by x.", "Then by the number.", "Match."] },
      // @q15
      { id: "U12L1-graph-1", type: "graph-interact", category: "word", prompt: "Set the slider to the constant term of 3(x + 4) (key: value).", challenge: "Set the slider to 12.", validate: { value: 12 }, tolerance: 0, explanation: "3 × 4 = 12.", hints: ["3 × 4.", "12.", "Set slider to 12."] }
    ],
