...
export const T2U19L1: Lesson = {
  ...
  quiz: {
    pool: [
      ...
      // @q02
      { id: "U19L1-mcq-2", type: "mcq", category: "conceptual", prompt: "What does the VERTEX of a parabola represent?", options: [ { id: "a", text: "Where it crosses the y-axis" }, { id: "b", text: "The turning point — max or min" }, { id: "c", text: "Where it crosses the x-axis" }, { id: "d", text: "The steepest straight part" } ], correctOptionId: "b", diagnoses: { a: "That's the y-intercept.", c: "Those are the roots.", d: "Parabolas aren't straight." }, explanation: "The vertex is the curve's turning point, its highest or lowest.", hints: ["Turning point.", "Max or min.", "Vertex."] },
      // @q03
