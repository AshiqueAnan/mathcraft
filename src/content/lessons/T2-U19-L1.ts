...
export const T2U19L1: Lesson = {
  ...
  quiz: {
    pool: [
      // @q01
      { id: "U19L1-mcq-1", type: "mcq", category: "procedural", prompt: "y = −3x² opens how?", options: [ { id: "a", text: "Down (a < 0)" }, { id: "b", text: "Up (a > 0)" }, { id: "c", text: "It stays flat" }, { id: "d", text: "Sideways" } ], correctOptionId: "a", diagnoses: { b: "Negative a means a frown.", c: "Only a = 0 gives a line.", d: "Parabolas open vertically, not sideways." }, explanation: "a = −3 < 0 → opens down.", hints: ["Sign of a.", "Negative → down.", "Down."] },
      // @q02
      { id: "U19L1-mcq-2", type: "mcq", category: "conceptual", prompt: "What does the VERTEX of a parabola represent?", options: [ { id: "a", text: "The turning point — max or min" }, { id: "b", text: "Where it crosses the y-axis" }, { id: "c", text: "Where it crosses the x-axis" }, { id: "d", text: "The steepest straight part" } ], correctOptionId: "a", diagnoses: { b: "That's the y-intercept.", c: "Those are the roots.", d: "Parabolas aren't straight." }, explanation: "The vertex is the curve's turning point, its highest or lowest.", hints: ["Turning point.", "Max or min.", "Vertex."] },
      // @q03
      { id: "U19L1-mcq-3", type: "mcq", category: "word", prompt: "A ball: h = −5t² + 20t. Opens down because…", options: [ { id: "a", text: "a = −5, the ball rises then falls" }, { id: "b", text: "t is squared" }, { id: "c", text: "20 is big" }, { id: "d", text: "It's a line" } ], correctOptionId: "a", diagnoses: { b: "Squaring alone isn't the cause — the sign of a is.", c: "Size doesn't set direction.", d: "The squared term bends it into a curve." }, explanation: "a = −5 < 0 → the arc arcs downward: rise then fall.", hints: ["a = −5.", "Negative a.", "Rise then fall."] },
      // @q04
      { id: "U19L1-mcq-4", type: "mcq", category: "procedural", prompt: "y = 2x² vs y = x²: which is narrower?", options: [ { id: "a", text: "y = 2x² (bigger |a|)" }, { id: "b", text: "y = x²" }, { id: "c", text: "Same width" }, { id: "d", text: "Neither is a parabola" } ], correctOptionId: "a", diagnoses: { b: "Smaller |a| spreads wider.", c: "a changes the width.", d: "Both are parabolas." }, explanation: "|2| > |1| → steeper sides → narrower U.", hints: ["Compare |a|.", "2 > 1.", "y = 2x²."] },
      // @q05
      { id: "U19L1-mcq-5", type: "mcq", category: "conceptual", prompt: "What are the ROOTS of a parabola?", options: [ { id: "a", text: "Where the curve crosses the x-axis" }, { id: "b", text: "The vertex" }, { id: "c", text: "The y-intercept" }, { id: "d", text: "The axis of symmetry" } ], correctOptionId: "a", diagnoses: { b: "The vertex is the turning point.", c: "The y-intercept is where x = 0.", d: "The axis is a line of symmetry." }, explanation: "Roots = x-intercepts = where y = 0.", hints: ["y = 0.", "x-axis.", "Crossings."] },
      // @q06
      { id: "U19L1-mcq-6", type: "mcq", category: "word", prompt: "Arch of a bridge: y = −0.5x² + 8. What is the highest point of the arch?", options: [ { id: "a", text: "y = 8 at the vertex (0, 8)" }, { id: "b", text: "y = 0 at the base" }, { id: "c", text: "y = −8" }, { id: "d", text: "At the roots" } ], correctOptionId: "a", diagnoses: { b: "The BASE is the roots; the arch's peak is the vertex.", c: "Negative y is below ground.", d: "Roots are where the arch meets the ground." }, explanation: "The vertex at (0, 8) is the arch's peak.", hints: ["Vertex.", "Symmetry at x = 0.", "y = 8."] },
      // @q07
      { id: "U19L1-num-1", type: "numeric-input", category: "procedural", prompt: "y = x² − 4. Type the y-coordinate of the vertex.", answer: -4, tolerance: 0, explanation: "Vertex at (0, −4) for y = x² − 4.", hints: ["Symmetric at x = 0.", "y = 0² − 4.", "−4."] },
      // @q08
      { id: "U19L1-num-2", type: "numeric-input", category: "procedural", prompt: "y = x² − 4. Type the POSITIVE root.", answer: 2, tolerance: 0, explanation: "x² − 4 = 0 → x = ±2.", hints: ["x² = 4.", "x = ±2.", "2."] },
      // @q09
      { id: "U19L1-num-3", type: "numeric-input", category: "conceptual", prompt: "A ball: h = −5t² + 20. Type the maximum height (vertex y).", answer: 20, tolerance: 0, explanation: "Vertex at t = 0 → h = 20.", hints: ["Vertex at t = 0.", "h = 20.", "20."] },
      // @q10
      { id: "U19L1-frac-1", type: "fraction-input", category: "conceptual", prompt: "y = (1/2)x². Write a (the coefficient) as the fraction it is.", numerator: 1, denominator: 2, acceptEquivalent: true, explanation: "a = 1/2 — wider than y = x².", hints: ["a is the x² coefficient.", "1/2.", "1/2."] },
      // @q11
      { id: "U19L1-tf-1", type: "true-false-justify", category: "conceptual", prompt: "y = −x² opens downward.", isTrue: true, explanation: "a = −1 < 0 → frown.", hints: ["a < 0.", "Down.", "True."] },
      // @q12
      { id: "U19L1-tf-2", type: "true-false-justify", category: "conceptual", prompt: "The vertex of y = x² − 4x + 3 is at (0, 3).", isTrue: false, explanation: "(0, 3) is the y-intercept; the vertex turns at (2, −1).", hints: ["(0, 3) is the intercept.", "Symmetry → x = 2.", "False."] },
      // @q13
