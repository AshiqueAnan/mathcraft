...
export const T2U18L3: Lesson = {
  ...
  quiz: {
    pool: [
      ...
      // @q06
      { id: "U18L3-mcq-6", type: "mcq", category: "word", prompt: "A plane descends: h = −3t + 10 (km). At what height does it start (t = 0)?", options: [ { id: "a", text: "−3 km" }, { id: "b", text: "10 km" }, { id: "c", text: "7 km" }, { id: "d", text: "3 km" } ], correctOptionId: "b", diagnoses: { a: "−3 is the descent rate (m).", c: "7 = 10 − 3 — that's 1 minute in.", d: "3 is the rate without sign." }, explanation: "c = 10 — height at start.", hints: ["c = starting value.", "10.", "10 km."] },
      // @q07
