...
export const T2U18L3: Lesson = {
  ...
  quiz: {
    pool: [
      // @q01
      { id: "U18L3-mcq-1", type: "mcq", category: "procedural", prompt: "For y = 3x + 2, what is the gradient m?", options: [ { id: "a", text: "3" }, { id: "b", text: "2" }, { id: "c", text: "−3" }, { id: "d", text: "1/3" } ], correctOptionId: "a", diagnoses: { b: "2 is c, the intercept.", c: "The x coefficient is +3.", d: "That's run over rise." }, explanation: "m is the coefficient of x: 3.", hints: ["m = x's coefficient.", "3.", "3."] },
      // @q02
      { id: "U18L3-mcq-2", type: "mcq", category: "conceptual", prompt: "Where does y = 3x + 2 cross the y-axis?", options: [ { id: "a", text: "(0, 2)" }, { id: "b", text: "(2, 0)" }, { id: "c", text: "(0, 3)" }, { id: "d", text: "(3, 2)" } ], correctOptionId: "a", diagnoses: { b: "c is y when x = 0 — (0, 2), not (2, 0).", c: "3 is m, not the intercept.", d: "That's a point on the line, not the axis crossing." }, explanation: "At x = 0, y = 3(0) + 2 = 2.", hints: ["Set x = 0.", "y = 2.", "(0, 2)."] },
      // @q03
      { id: "U18L3-mcq-3", type: "mcq", category: "word", prompt: "A taxi: ₹20 base + ₹5/km: C = 5d + 20. What is the base fare (c)?", options: [ { id: "a", text: "₹20" }, { id: "b", text: "₹5" }, { id: "c", text: "₹25" }, { id: "d", text: "₹4" } ], correctOptionId: "a", diagnoses: { b: "5 is the rate per km (m).", c: "25 = 20 + 5 — that's 1 km's cost.", d: "4 is d flipped." }, explanation: "c = 20 — the charge before any km.", hints: ["c is the constant.", "Base = 20.", "₹20."] },
      // @q04
      { id: "U18L3-mcq-4", type: "mcq", category: "procedural", prompt: "Which line is PARALLEL to y = 2x + 1?", options: [ { id: "a", text: "y = 2x − 5" }, { id: "b", text: "y = 3x + 1" }, { id: "c", text: "y = −2x + 1" }, { id: "d", text: "y = x + 2" } ], correctOptionId: "a", diagnoses: { b: "m = 3 changes the tilt.", c: "m = −2 slopes down instead of up.", d: "m = 1, a different tilt." }, explanation: "Same m (2) → same slope → parallel; c moves it.", hints: ["Parallel = same m.", "m = 2.", "y = 2x − 5."] },
      // @q05
      ...
      // @q06
      { id: "U18L3-mcq-6", type: "mcq", category: "word", prompt: "A plane descends: h = −3t + 10 (km). At what height does it start (t = 0)?", options: [ { id: "a", text: "10 km" }, { id: "b", text: "−3 km" }, { id: "c", text: "7 km" }, { id: "d", text: "3 km" } ], correctOptionId: "a", diagnoses: { b: "−3 is the descent rate (m).", c: "7 = 10 − 3 — that's 1 minute in.", d: "3 is the rate without sign." }, explanation: "c = 10 — height at start.", hints: ["c = starting value.", "10.", "10 km."] },
      // @q07
      { id: "U18L3-num-1", type: "numeric-input", category: "procedural", prompt: "For y = −2x + 5, type the value of c.", answer: 5, tolerance: 0, explanation: "c = 5 — where it crosses the y-axis.", hints: ["c is the constant.", "5.", "5."] },
      // @q08
      { id: "U18L3-num-2", type: "numeric-input", category: "procedural", prompt: "For y = 4x − 3, type the intercept y when x = 0.", answer: -3, tolerance: 0, explanation: "y = 4(0) − 3 = −3.", hints: ["Set x = 0.", "y = −3.", "−3."] },
      // @q09
      { id: "U18L3-num-3", type: "numeric-input", category: "conceptual", prompt: "A line through (0, 7) with gradient 2. Type c.", answer: 7, tolerance: 0, explanation: "The y-intercept IS the line through (0, 7): c = 7.", hints: ["c = y when x = 0.", "x = 0 gives 7.", "c = 7."] },
      // @q10
      { id: "U18L3-frac-1", type: "fraction-input", category: "conceptual", prompt: "A line rises 1 for every 2 along and crosses at (0, 3). Write its equation's gradient as a fraction.", numerator: 1, denominator: 2, acceptEquivalent: true, explanation: "m = 1/2 — the line is y = (1/2)x + 3.", hints: ["m = rise/run.", "1/2.", "m = 1/2."] },
      // @q11
      { id: "U18L3-tf-1", type: "true-false-justify", category: "conceptual", prompt: "y = 2x + 5 and y = 2x − 1 are parallel.", isTrue: true, explanation: "Same m = 2 — identical tilt, different intercepts.", hints: ["Same m.", "Parallel.", "True."] },
      // @q12
      { id: "U18L3-tf-2", type: "true-false-justify", category: "conceptual", prompt: "y = 3x − 5 crosses the y-axis at (0, −5), not (−5, 0).", isTrue: true, explanation: "c = −5 is the y-value when x = 0.", hints: ["Set x = 0.", "y = −5.", "(0, −5)."] },
      // @q13
      { id: "U18L3-order-1", type: "order-steps", category: "word", prompt: "Order the steps to draw y = 2x + 1.", sequence: ["Read m = 2 and c = 1", "Mark the intercept (0, 1)", "From there, go 1 right and 2 up to a second point", "Draw the line through both points"], diagnoses: { "Read m = 2 and c = 1@1": "Read the equation first.", "Mark the intercept (0, 1)@0": "Mark the intercept before using slope.", "Draw the line through both points@0": "Plot both points before drawing." }, explanation: "Read, mark intercept, step out the slope, draw.", hints: ["m and c.", "Intercept.", "Slope steps."] },
      // @q14
      ...
      // @q15
      { id: "U18L3-graph-1", type: "graph-interact", category: "word", prompt: "The line y = 2x + 3 crosses the y-axis at (0, 3). Set the slider to the INTERCEPT value (key: value).", challenge: "Set the slider to 3.", validate: { value: 3 }, tolerance: 0.01, explanation: "c = 3 — the y-intercept.", hints: ["c = intercept.", "3.", "3."] }
    ],
