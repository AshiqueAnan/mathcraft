...
export const T2U14L1: Lesson = {
  ...
  quiz: {
    pool: [
      ...
      // @q06
      { id: "U14L1-mcq-6", type: "mcq", category: "word", prompt: "A ladder's top is 8 + x rungs from the ground, reaching 15 rungs high. Solve for x.", options: [ { id: "a", text: "x = 23" }, { id: "b", text: "x = 7" }, { id: "c", text: "x = 15" }, { id: "d", text: "x = 8" } ], correctOptionId: "b", diagnoses: { a: "23 = 8 + 15 — added.", c: "15 is the total.", d: "8 is the constant." }, explanation: "8 + x = 15 → subtract 8: x = 7.", hints: ["8 + x = 15.", "Subtract 8.", "x = 7."] },
      // @q07
