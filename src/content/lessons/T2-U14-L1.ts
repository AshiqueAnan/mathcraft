...
export const T2U14L1: Lesson = {
  ...
  quiz: {
    pool: [
      // @q01
      { id: "U14L1-mcq-1", type: "mcq", category: "procedural", prompt: "Solve x + 3 = 11.", options: [ { id: "a", text: "x = 8" }, { id: "b", text: "x = 14" }, { id: "c", text: "x = 3" }, { id: "d", text: "x = 11" } ], correctOptionId: "a", diagnoses: { b: "14 = 11 + 3, added instead of subtracting.", c: "3 is the number to remove, not x.", d: "x is the answer, not the total." }, explanation: "Subtract 3 from both sides: x = 8.", hints: ["Subtract 3 both sides.", "11 − 3.", "x = 8."] },
      // @q02
      { id: "U14L1-mcq-2", type: "mcq", category: "conceptual", prompt: "Why can't you subtract 3 from only one side of x + 3 = 11?", options: [ { id: "a", text: "The scale would tip — both sides must stay equal" }, { id: "b", text: "3 is a negative number" }, { id: "c", text: "Only the left side has x" }, { id: "d", text: "The right side is bigger" } ], correctOptionId: "a", diagnoses: { b: "3 is positive here.", c: "That's fine — but operations must hit both sides.", d: "Size isn't relevant to correctness." }, explanation: "An equation is a balance: changing one side breaks the equality.", hints: ["What does '=' demand?", "Balance.", "Same to both sides."] },
      // @q03
      { id: "U14L1-mcq-3", type: "mcq", category: "word", prompt: "Your balance at a cash machine is b dollars. You buy a $4 snack; the new balance is b − 4 = 20. What was b?", options: [ { id: "a", text: "24" }, { id: "b", text: "16" }, { id: "c", text: "20" }, { id: "d", text: "5" } ], correctOptionId: "a", diagnoses: { b: "16 = 20 − 4 — added the wrong side.", c: "20 is the new balance.", d: "5 is 20 ÷ 4, wrong." }, explanation: "Add 4 to both sides: b = 24.", hints: ["Add 4 both sides.", "20 + 4.", "24."] },
      // @q04
      { id: "U14L1-mcq-4", type: "mcq", category: "procedural", prompt: "Solve x − 4 = 9.", options: [ { id: "a", text: "x = 13" }, { id: "b", text: "x = 5" }, { id: "c", text: "x = 9" }, { id: "d", text: "x = 36" } ], correctOptionId: "a", diagnoses: { b: "5 = 9 − 4 — you subtracted instead of adding.", c: "9 is the right side, not x.", d: "36 = 9 × 4 — wrong operation." }, explanation: "Add 4 to both sides: x = 13.", hints: ["Add 4 both sides.", "9 + 4.", "x = 13."] },
      // @q05
      { id: "U14L1-mcq-5", type: "mcq", category: "conceptual", prompt: "How do you check x = 13 solves x − 4 = 9?", options: [ { id: "a", text: "Substitute 13 for x: 13 − 4 = 9" }, { id: "b", text: "See if 13 is big enough" }, { id: "c", text: "Add 13 and 4" }, { id: "d", text: "Guess another number" } ], correctOptionId: "a", diagnoses: { b: "Size isn't the test.", c: "Adding 13 and 4 isn't the equation.", d: "Guessing isn't verifying." }, explanation: "Plug x = 13 back in: 13 − 4 = 9 ✓.", hints: ["Plug the answer in.", "13 − 4.", "9 ✓."] },
      // @q06
      { id: "U14L1-mcq-6", type: "mcq", category: "word", prompt: "A ladder's top is 8 + x rungs from the ground, reaching 15 rungs high. Solve for x.", options: [ { id: "a", text: "x = 7" }, { id: "b", text: "x = 23" }, { id: "c", text: "x = 15" }, { id: "d", text: "x = 8" } ], correctOptionId: "a", diagnoses: { b: "23 = 8 + 15 — added.", c: "15 is the total.", d: "8 is the constant." }, explanation: "8 + x = 15 → subtract 8: x = 7.", hints: ["8 + x = 15.", "Subtract 8.", "x = 7."] },
      // @q07
      { id: "U14L1-num-1", type: "numeric-input", category: "procedural", prompt: "Solve x + 5 = 12. Type x.", answer: 7, tolerance: 0, explanation: "Subtract 5 from both sides: x = 7.", hints: ["Subtract 5.", "12 − 5.", "7."] },
      // @q08
      { id: "U14L1-num-2", type: "numeric-input", category: "procedural", prompt: "Solve x − 6 = 10. Type x.", answer: 16, tolerance: 0, explanation: "Add 6 to both sides: x = 16.", hints: ["Add 6.", "10 + 6.", "16."] },
      // @q09
      { id: "U14L1-num-3", type: "numeric-input", category: "conceptual", prompt: "Fill the gap: x + 9 = 20. Type x.", answer: 11, tolerance: 0, explanation: "20 − 9 = 11.", hints: ["Undo +9.", "20 − 9.", "11."] },
      // @q10
      { id: "U14L1-frac-1", type: "fraction-input", category: "conceptual", prompt: "Solve x + 1/2 = 1. Write x as a fraction.", numerator: 1, denominator: 2, acceptEquivalent: true, explanation: "x = 1 − 1/2 = 1/2.", hints: ["Subtract 1/2.", "1 − 1/2.", "1/2."] },
      // @q11
      { id: "U14L1-tf-1", type: "true-false-justify", category: "conceptual", prompt: "x = 4 solves x + 7 = 11.", isTrue: true, explanation: "4 + 7 = 11 ✓.", hints: ["Plug in 4.", "4 + 7.", "11 — True."] },
      // @q12
      { id: "U14L1-tf-2", type: "true-false-justify", category: "conceptual", prompt: "Subtracting 5 from only the left side of x + 5 = 12 gives a valid equation.", isTrue: false, explanation: "Only one side changed breaks the balance — both sides must get the same treatment.", hints: ["Balance rule.", "Both sides.", "False."] },
      // @q13
      { id: "U14L1-order-1", type: "order-steps", category: "word", prompt: "Order the steps to solve x + 3 = 11.", sequence: ["Write x + 3 = 11", "Subtract 3 from both sides", "x = 8", "Check: 8 + 3 = 11"], diagnoses: { "Subtract 3 from both sides@0": "Write the equation first.", "Check: 8 + 3 = 11@0": "Check at the end.", "x = 8@1": "Subtract before writing the answer." }, explanation: "Subtract 3 both sides, then verify.", hints: ["Write the equation.", "Undo the +3.", "Check."] },
      // @q14
      { id: "U14L1-drag-1", type: "drag-match", category: "conceptual", prompt: "Match each equation to its solution.", pairs: [ { source: "x + 2 = 7", target: "x = 5" }, { source: "x − 3 = 8", target: "x = 11" }, { source: "x + 10 = 10", target: "x = 0" } ], diagnoses: { "x + 2 = 7->x = 11": "7 − 2 = 5.", "x − 3 = 8->x = 0": "8 + 3 = 11.", "x + 10 = 10->x = 5": "10 − 10 = 0." }, explanation: "Undo the addition/subtraction on each.", hints: ["Undo + or −.", "Solve each.", "Match."] },
      // @q15
      { id: "U14L1-graph-1", type: "graph-interact", category: "word", prompt: "Set the slider to x so x + 4 = 9 (key: value).", challenge: "Set the slider to 5.", validate: { value: 5 }, tolerance: 0, explanation: "x = 9 − 4 = 5.", hints: ["Undo +4.", "9 − 4.", "5."] }
    ],
