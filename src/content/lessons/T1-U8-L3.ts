...
export const T1U8L3: Lesson = {
  ...
  quiz: {
    pool: [
      // @q01
      { id: "U8L3-mcq-1", type: "mcq", category: "procedural", prompt: "Rationalize: 1/√3.", options: [ { id: "a", text: "√3/3" }, { id: "b", text: "√3" }, { id: "c", text: "1/3" }, { id: "d", text: "3/√3" } ], correctOptionId: "a", diagnoses: { b: "√3 alone is just the numerator of the tidy form.", c: "You multiplied only the denominator — that changes the value.", d: "That's the same as the start, still untidy downstairs." }, explanation: "1/√3 × √3/√3 = √3/3 — the denominator becomes the whole 3.", hints: ["Multiply top and bottom by √3.", "√3 × √3 = 3.", "√3/3."] },
      // @q02
      { id: "U8L3-mcq-2", type: "mcq", category: "conceptual", prompt: "Why is √2/2 preferred over 1/√2?", options: [ { id: "a", text: "The denominator is a whole number, easier to compare and add" }, { id: "b", text: "It is a bigger number" }, { id: "c", text: "The surd is gone entirely" }, { id: "d", text: "Decimals are exact in √2/2" } ], correctOptionId: "a", diagnoses: { b: "Both are ≈ 0.7071 — same value.", c: "√2 remains, but upstairs; only the denominator is rational.", d: "Neither expression is a terminating decimal." }, explanation: "A whole-number denominator makes fractions easier to add, compare, and estimate — while the value stays identical.", hints: ["What changed between the two forms?", "The surd moved upstairs.", "Whole denominator wins."] },
      // @q03
      { id: "U8L3-mcq-3", type: "mcq", category: "word", prompt: "An architect notes a roof slope as 2/√5. What is the rationalized form?", options: [ { id: "a", text: "2√5/5" }, { id: "b", text: "√5/2" }, { id: "c", text: "2/5" }, { id: "d", text: "√5" } ], correctOptionId: "a", diagnoses: { b: "√5/2 is the reciprocal's rationalized form, not this.", c: "You rationalized the denominator but dropped the numerator's 2.", d: "√5 alone ignores the original 2 on top." }, explanation: "2/√5 × √5/√5 = 2√5/5.", hints: ["Multiply top and bottom by √5.", "√5 × √5 = 5.", "2√5/5."] },
      // @q04
      { id: "U8L3-mcq-4", type: "mcq", category: "procedural", prompt: "Rationalize: 5/√2.", options: [ { id: "a", text: "5√2/2" }, { id: "b", text: "5/2" }, { id: "c", text: "√2/2" }, { id: "d", text: "5√2" } ], correctOptionId: "a", diagnoses: { b: "You multiplied only the bottom — value changed.", c: "That's 1/√2's tidy form, missing the 5.", d: "The denominator must stay 2 after √2 × √2." }, explanation: "5/√2 × √2/√2 = 5√2/2.", hints: ["Multiply top and bottom by √2.", "√2 × √2 = 2.", "5√2/2."] },
      // @q05
      { id: "U8L3-mcq-5", type: "mcq", category: "conceptual", prompt: "Which statement is TRUE about 1/√2 and √2/2?", options: [ { id: "a", text: "They are exactly equal" }, { id: "b", text: "√2/2 is slightly larger" }, { id: "c", text: "1/√2 is rational" }, { id: "d", text: "They differ after the 2nd decimal" } ], correctOptionId: "a", diagnoses: { b: "Square both: each gives 1/2.", c: "Both contain an irrational surd.", d: "They are the same number, digit for digit." }, explanation: "Multiplying 1/√2 by √2/√2 (which equals 1) yields √2/2 — the exact same value.", hints: ["What is √2/√2?", "Multiplying by 1 never changes a number.", "Equal exactly."] },
      // @q06
      { id: "U8L3-mcq-6", type: "mcq", category: "word", prompt: "A physics table lists 3/√3 as a speed factor. Rationalized, this equals:", options: [ { id: "a", text: "√3" }, { id: "b", text: "3√3/3" }, { id: "c", text: "1/√3" }, { id: "d", text: "3" } ], correctOptionId: "a", diagnoses: { b: "3√3/3 simplifies to √3 — don't stop halfway.", c: "That's the reciprocal's tidy form.", d: "3 would need 9/3 — only √3 = 3/√3 works." }, explanation: "3/√3 × √3/√3 = 3√3/3 = √3.", hints: ["Multiply top and bottom by √3.", "3√3 over 3.", "√3."] },
      // @q07
      { id: "U8L3-num-1", type: "numeric-input", category: "procedural", prompt: "Rationalize 1/√2: the tidy numerator is √2, and the whole (rational) denominator is? Type it.", answer: 2, tolerance: 0, explanation: "1/√2 × √2/√2 = √2/2 — denominator 2.", hints: ["√2 × √2 = ?", "2.", "2."] },
      // @q08
      { id: "U8L3-num-2", type: "numeric-input", category: "procedural", prompt: "Rationalize 2/√7: type the whole-number denominator.", answer: 7, tolerance: 0, explanation: "2/√7 × √7/√7 = 2√7/7 — denominator 7.", hints: ["√7 × √7 = ?", "7.", "7."] },
      // @q09
      { id: "U8L3-num-3", type: "numeric-input", category: "conceptual", prompt: "What is 1/√2 as a decimal to 2 dp?", answer: 0.71, tolerance: 0.005, explanation: "√2/2 ≈ 0.7071 ≈ 0.71 at 2 dp.", hints: ["√2 ≈ 1.414.", "1.414 ÷ 2.", "0.71."] },
      // @q10
      ...
      // @q15
      { id: "U8L3-graph-1", type: "graph-interact", category: "word", prompt: "The number line shows 1/√2. Set the point to the same value written as √2/2 (key: value).", challenge: "Set the slider to 0.71.", validate: { value: 0.71 }, tolerance: 0.01, explanation: "√2/2 ≈ 0.7071 — same value as 1/√2.", hints: ["√2 ≈ 1.414.", "Divide by 2.", "0.71."] }
    ],
