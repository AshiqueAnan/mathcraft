...
export const T2U11L2: Lesson = {
  ...
  quiz: {
    pool: [
      // @q01
      { id: "U11L2-mcq-1", type: "mcq", category: "procedural", prompt: "Evaluate 3n + 2 for n = 4.", options: [ { id: "a", text: "14" }, { id: "b", text: "20" }, { id: "c", text: "9" }, { id: "d", text: "18" } ], correctOptionId: "a", diagnoses: { b: "20 is 4×4+4 — check the coefficient.", c: "9 is 3 + 4 + 2, wrong grouping.", d: "18 is 4 × 3 + 2 × 3, over-applied." }, explanation: "3 × 4 + 2 = 12 + 2 = 14.", hints: ["Multiply first: 3 × 4.", "Then add 2.", "14."] },
      // @q02
      { id: "U11L2-mcq-2", type: "mcq", category: "conceptual", prompt: "In y = 3n, what does the 3 do?", options: [ { id: "a", text: "Triples whatever n is" }, { id: "b", text: "Adds 3 to n" }, { id: "c", text: "Makes n three digits long" }, { id: "d", text: "Ignores n" } ], correctOptionId: "a", diagnoses: { b: "3n is 3 × n, not 3 + n.", c: "Digits are irrelevant to a variable.", d: "n is the input the machine multiplies." }, explanation: "3n multiplies the slot n by 3 — it's a machine that triples.", hints: ["What operation sits between 3 and n?", "Multiplication.", "Triples n."] },
      // @q03
      { id: "U11L2-mcq-3", type: "mcq", category: "word", prompt: "A taxi charges $3 per km plus a $2 flag fall. Which expression gives the fare for n km?", options: [ { id: "a", text: "3n + 2" }, { id: "b", text: "3 + 2n" }, { id: "c", text: "5n" }, { id: "d", text: "2n + 3n" } ], correctOptionId: "a", diagnoses: { b: "3 + 2n charges $2/km — wrong rate.", c: "5n merges the flag fall into the rate.", d: "2n + 3n = 5n, same mistake." }, explanation: "$3 per km → 3n, plus the $2 flag fall: 3n + 2.", hints: ["Rate per km comes first.", "Then the fixed fee.", "3n + 2."] },
      // @q04
      { id: "U11L2-mcq-4", type: "mcq", category: "procedural", prompt: "Evaluate n² for n = 5.", options: [ { id: "a", text: "25" }, { id: "b", text: "10" }, { id: "c", text: "5" }, { id: "d", text: "125" } ], correctOptionId: "a", diagnoses: { b: "10 is 5 × 2, not 5 × 5.", c: "5 is just n itself.", d: "125 is 5³." }, explanation: "n² means n × n: 5 × 5 = 25.", hints: ["n² = n × n.", "5 × 5.", "25."] },
      // @q05
      ...
      // @q06
      { id: "U11L2-mcq-6", type: "mcq", category: "word", prompt: "A square's side is n cm. Which expression gives its area?", options: [ { id: "a", text: "n²" }, { id: "b", text: "4n" }, { id: "c", text: "2n" }, { id: "d", text: "n + n" } ], correctOptionId: "a", diagnoses: { b: "4n is the perimeter.", c: "2n is two sides.", d: "n + n = 2n, also two sides." }, explanation: "Area = side × side = n × n = n².", hints: ["Area = side × side.", "n × n.", "n²."] },
      // @q07
      { id: "U11L2-num-1", type: "numeric-input", category: "procedural", prompt: "Evaluate 4n + 1 for n = 6. Type the value.", answer: 25, tolerance: 0, explanation: "4 × 6 + 1 = 24 + 1 = 25.", hints: ["4 × 6 first.", "24 + 1.", "25."] },
      // @q08
      { id: "U11L2-num-2", type: "numeric-input", category: "procedural", prompt: "Evaluate n² + 3 for n = 7. Type the value.", answer: 52, tolerance: 0, explanation: "7² + 3 = 49 + 3 = 52.", hints: ["7² = 49.", "Add 3.", "52."] },
      // @q09
      { id: "U11L2-num-3", type: "numeric-input", category: "conceptual", prompt: "2n + 5 = 19. Solve for n. Type n.", answer: 7, tolerance: 0, explanation: "2n = 19 − 5 = 14, so n = 7.", hints: ["Undo +5 first.", "2n = 14.", "n = 7."] },
      // @q10
      { id: "U11L2-frac-1", type: "fraction-input", category: "conceptual", prompt: "If 4n = 1, what is n? Write it as a fraction.", numerator: 1, denominator: 4, acceptEquivalent: true, explanation: "n = 1 ÷ 4 = 1/4.", hints: ["Divide both sides by 4.", "1 ÷ 4.", "1/4."] },
      // @q11
      { id: "U11L2-tf-1", type: "true-false-justify", category: "conceptual", prompt: "Evaluating 3n for n = 4 gives 12.", isTrue: true, explanation: "3 × 4 = 12.", hints: ["3n = 3 × n.", "3 × 4.", "True."] },
      // @q12
      { id: "U11L2-tf-2", type: "true-false-justify", category: "conceptual", prompt: "2n means 'add 2 to n'. ", isTrue: false, explanation: "2n means 2 × n — multiplication, not addition.", hints: ["Adjacent letters/numbers multiply.", "2n = 2 × n.", "False."] },
      // @q13
      { id: "U11L2-order-1", type: "order-steps", category: "word", prompt: "Order the steps to evaluate 2n + 3 for n = 5.", sequence: ["Write the expression: 2n + 3", "Substitute n = 5: 2 × 5 + 3", "Multiply: 10", "Add: 13"], diagnoses: { "Substitute n = 5: 2 × 5 + 3@0": "Write the expression first.", "Add: 13@0": "Multiply before adding.", "Multiply: 10@3": "Substitute before multiplying." }, explanation: "Substitute, multiply, then add — order of operations.", hints: ["Write the expression.", "Plug in n = 5.", "Then compute."] },
      // @q14
      { id: "U11L2-drag-1", type: "drag-match", category: "conceptual", prompt: "Match each expression to its value when n = 3.", pairs: [ { source: "2n", target: "6" }, { source: "n²", target: "9" }, { source: "n + 5", target: "8" } ], diagnoses: { "2n->9": "2 × 3 = 6.", "n²->6": "3 × 3 = 9.", "n + 5->6": "3 + 5 = 8." }, explanation: "2×3=6, 3×3=9, 3+5=8.", hints: ["Substitute n = 3.", "Compute each expression.", "Match."] },
      // @q15
      { id: "U11L2-graph-1", type: "graph-interact", category: "word", prompt: "Set the slider to n so that 3n = 15 (key: value).", challenge: "Set the slider to 5.", validate: { value: 5 }, tolerance: 0, explanation: "3n = 15 → n = 5.", hints: ["15 ÷ 3.", "5.", "Set slider to 5."] }
    ],
