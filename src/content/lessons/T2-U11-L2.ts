...
export const T2U11L2: Lesson = {
  ...
  quiz: {
    pool: [
      ...
      // @q04
      { id: "U11L2-mcq-4", type: "mcq", category: "procedural", prompt: "Evaluate n² for n = 5.", options: [ { id: "a", text: "125" }, { id: "b", text: "10" }, { id: "c", text: "5" }, { id: "d", text: "25" } ], correctOptionId: "d", diagnoses: { b: "10 is 5 × 2, not 5 × 5.", c: "5 is just n itself.", a: "125 is 5³." }, explanation: "n² means n × n: 5 × 5 = 25.", hints: ["n² = n × n.", "5 × 5.", "25."] },
      // @q05
