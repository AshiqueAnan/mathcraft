...
export const T1U7L4: Lesson = {
  ...
  quiz: {
    pool: [
      ...
      { id: "U7L4-mcq-2", type: "mcq", category: "conceptual", prompt: "Why is 2^(1/2) × 2^(1/2) = 2?", options: [{ id: "a", text: "Indices add: 1/2+1/2 = 1" }, { id: "b", text: "Rounded" }, { id: "c", text: "Because halves" }, { id: "d", text: "It doesn't" }], correctOptionId: "a", diagnoses: { b: "No rounding — exact.", c: "The real reason is the index law.", d: "It does: 2¹ = 2." }, explanation: "Same base → add indices: 2^(1/2+1/2) = 2¹ = 2.", hints: ["Same base.", "Add indices.", "1/2+1/2 = 1."] },
      { id: "U7L4-mcq-3", type: "mcq", category: "word", prompt: "Square area 16. Side = 16^(1/2) = ?", options: [{ id: "a", text: "4" }, { id: "b", text: "8" }, { id: "c", text: "256" }, { id: "d", text: "2" }], correctOptionId: "a", diagnoses: { b: "8²=64.", c: "256=16².", d: "2²=4." }, explanation: "√16 = 4.", hints: ["Area = side².", "What squares to 16?", "4."] },
      { id: "U7L4-mcq-4", type: "mcq", category: "procedural", prompt: "8^(1/3) = ?", options: [{ id: "a", text: "2" }, { id: "b", text: "√8" }, { id: "c", text: "4" }, { id: "d", text: "8/3" }], correctOptionId: "a", diagnoses: { b: "1/3 is cube root.", c: "3³=27, 4³=64.", d: "Not a root." }, explanation: "8^(1/3) = ∛8 = 2.", hints: ["Denominator 3 = cube root.", "What cubed gives 8?", "2."] },
      ...
      { id: "U7L4-mcq-6", type: "mcq", category: "word", prompt: "Cube volume 27. Edge = 27^(1/3) = ?", options: [{ id: "a", text: "3" }, { id: "b", text: "9" }, { id: "c", text: "27" }, { id: "d", text: "81" }], correctOptionId: "a", diagnoses: { b: "9³=729.", c: "27 is volume.", d: "81³ huge." }, explanation: "∛27 = 3.", hints: ["Cube root of 27.", "3×3×3.", "3."] },
