    ...
    pool: [
      ...
      },
      {
        ...
        options: [
          ...
          { id: "b", text: "$\\frac{1}{2}$" },
          { id: "c", text: "$\\frac{3}{7}$" },
          { id: "d", text: "Can't tell without renaming" },
        ],
        correctOptionId: "b",
        diagnoses: {
          ...
          d: "We CAN tell — a common denominator settles it: halves win.",
        },
      ...
      },
      {
        ...
        options: [
          { id: "a", text: "The $\\frac{1}{4}$ bottle" },
          { id: "b", text: "The $\\frac{3}{8}$ bottle" },
          { id: "c", text: "Same amount" },
          { id: "d", text: "Depends on the bottle size" },
        ],
        correctOptionId: "b",
        diagnoses: {
          a: "Rename: $\\frac{1}{4} = \\frac{2}{8}$, and $\\frac{3}{8}$ is more than $\\frac{2}{8}$.",
      ...
      },
      {
        ...
        diagnoses: {
          ...
          c: "$\\frac{1}{2} = \\frac{5}{10}$ — that's the largest, not the smallest.",
        },
      ...
      },
      {
        ...
        diagnoses: {
          ...
          c: "Different fractions rename differently — check with a common denominator.",
