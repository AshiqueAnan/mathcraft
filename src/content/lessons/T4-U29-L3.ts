...
export const T4U29L3: Lesson = {
  ...
  quiz: {
    pool: [
      ...
      // @q04
      { id: "U29L3-mcq-4", type: "mcq", category: "procedural", prompt: "Roll a die, then flip a coin. Number of paths in the sample space = …", options: [ { id: "a", text: "2" }, { id: "b", text: "8" }, { id: "c", text: "6" }, { id: "d", text: "12" } ], correctOptionId: "d", diagnoses: { b: "8 is 2³ — wrong multiplier.", c: "6 ignores the coin.", a: "2 ignores the die." }, explanation: "6 die outcomes × 2 coin outcomes = 12 paths.", hints: ["6 × 2.", "12.", "12."] },
      // @q05
      ...
      // @q06
      { id: "U29L3-mcq-6", type: "mcq", category: "word", prompt: "Two coins: P(exactly one head) = …", options: [ { id: "a", text: "1/4" }, { id: "b", text: "1/2" }, { id: "c", text: "3/4" }, { id: "d", text: "1" } ], correctOptionId: "b", diagnoses: { a: "1/4 is P(HH) alone.", c: "3/4 is P(at least one head).", d: "1 is certainty." }, explanation: "P(HT) + P(TH) = ¼ + ¼ = ½ — ADD the two distinct paths.", hints: ["HT + TH.", "¼ + ¼.", "1/2."] },
      // @q07
