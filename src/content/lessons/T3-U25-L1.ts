...
export const T3U25L1: Lesson = {
  ...
  quiz: {
    pool: [
      ...
      // @q04
      { id: "U25L1-mcq-4", type: "mcq", category: "procedural", prompt: "Legs 5 and 12. The hypotenuse is…", options: [ { id: "a", text: "169" }, { id: "b", text: "17" }, { id: "c", text: "60" }, { id: "d", text: "13" } ], correctOptionId: "d", diagnoses: { b: "17 adds the legs.", c: "60 multiplies them.", a: "169 is c² — take the root." }, explanation: "25 + 144 = 169 = 13², so c = 13.", hints: ["25 + 144.", "169 = c².", "c = 13."] },
      // @q05
