...
export const T3U25L1: Lesson = {
  ...
  quiz: {
    pool: [
      // @q01
      { id: "U25L1-mcq-1", type: "mcq", category: "procedural", prompt: "A right triangle has legs 3 and 4. Its hypotenuse is…", options: [ { id: "a", text: "5" }, { id: "b", text: "7" }, { id: "c", text: "12" }, { id: "d", text: "25" } ], correctOptionId: "a", diagnoses: { b: "7 adds the legs — square them first.", c: "12 multiplies them.", d: "25 is c², not c." }, explanation: "3² + 4² = 9 + 16 = 25 = 5², so c = 5.", hints: ["9 + 16.", "25 = c².", "3² + 4² = 9 + 16 = 25 = 5², so c = 5."] },
      // @q02
      { id: "U25L1-mcq-2", type: "mcq", category: "conceptual", prompt: "In a 3-4-5 right triangle, which side is the hypotenuse?", options: [ { id: "a", text: "3 — the smallest" }, { id: "b", text: "5 — opposite the right angle" }, { id: "c", text: "4 — the run" }, { id: "d", text: "Any side" } ], correctOptionId: "b", diagnoses: { a: "The smallest side faces the smallest angle.", c: "The run is a leg, not the longest side.", d: "The hypotenuse is specifically opposite the 90° corner." }, explanation: "The hypotenuse is always the longest side, opposite the right angle.", hints: ["Opposite 90°.", "Longest.", "The hypotenuse is always the longest side, opposite the right angle."] },
      // @q03
      { id: "U25L1-mcq-3", type: "mcq", category: "word", prompt: "A ladder 5 m long leans against a wall reaching 4 m up. How far is its base from the wall?", options: [ { id: "a", text: "9 m" }, { id: "b", text: "6 m" }, { id: "c", text: "3 m" }, { id: "d", text: "5 m" } ], correctOptionId: "c", diagnoses: { b: "6 is 5 + 1, not from Pythagoras.", a: "9 is 5² − 4²? No — 25 − 16 = 9 = b², and b = √9 = 3.", d: "5 is the ladder itself." }, explanation: "b² = 5² − 4² = 25 − 16 = 9 → b = 3 m.", hints: ["25 − 16.", "b² = 9.", "b² = 5² − 4² = 25 − 16 = 9 → b = 3 m."] },
      // @q04
      { id: "U25L1-mcq-4", type: "mcq", category: "procedural", prompt: "Legs 5 and 12. The hypotenuse is…", options: [ { id: "a", text: "169" }, { id: "b", text: "17" }, { id: "c", text: "60" }, { id: "d", text: "13" } ], correctOptionId: "d", diagnoses: { b: "17 adds the legs.", c: "60 multiplies them.", a: "169 is c² — take the root." }, explanation: "25 + 144 = 169 = 13², so c = 13.", hints: ["25 + 144.", "169 = c².", "25 + 144 = 169 = 13², so c = 13."] },
      // @q05
      ...
      // @q06
      { id: "U25L1-mcq-6", type: "mcq", category: "word", prompt: "A right triangle has legs 8 and 15. The hypotenuse is…", options: [ { id: "a", text: "23" }, { id: "b", text: "17" }, { id: "c", text: "120" }, { id: "d", text: "289" } ], correctOptionId: "b", diagnoses: { a: "23 adds the legs.", c: "120 multiplies them.", d: "289 is c² — take the square root." }, explanation: "64 + 225 = 289 = 17².", hints: ["64 + 225.", "289.", "64 + 225 = 289 = 17²."] },
      // @q07
      { id: "U25L1-num-1", type: "numeric-input", category: "procedural", prompt: "Legs 6 and 8. The hypotenuse is…", answer: 10, tolerance: 0, explanation: "36 + 64 = 100 = 10².", hints: ["36 + 64.", "√100.", "36 + 64 = 100 = 10²."] },
      // @q08
      { id: "U25L1-num-2", type: "numeric-input", category: "procedural", prompt: "Leg 5, hypotenuse 13. The other leg is…", answer: 12, tolerance: 0, explanation: "b² = 169 − 25 = 144 → b = 12.", hints: ["169 − 25.", "√144.", "b² = 169 − 25 = 144 → b = 12."] },
      // @q09
      { id: "U25L1-num-3", type: "numeric-input", category: "conceptual", prompt: "The square on a 5-unit side holds how many unit squares?", answer: 25, tolerance: 0, explanation: "5² = 25.", hints: ["5 × 5.", "25.", "5² = 25."] },
      // @q10
      { id: "U25L1-frac-1", type: "fraction-input", category: "conceptual", prompt: "In a 3-4-5 triangle, the square on the shortest side is what fraction of the square on the hypotenuse?", numerator: 9, denominator: 25, acceptEquivalent: true, explanation: "3² = 9 and 5² = 25 → 9/25.", hints: ["3² = 9.", "5² = 25.", "3² = 9 and 5² = 25 → 9/25."] },
      // @q11
      { id: "U25L1-tf-1", type: "true-false-justify", category: "conceptual", prompt: "The hypotenuse is the longest side of a right triangle.", isTrue: true, explanation: "It sits opposite the 90° corner, the largest angle, so it's the longest side.", hints: ["Opposite the biggest angle.", "Longest side.", "It sits opposite the 90° corner, the largest angle, so it's the longest side."] },
      // @q12
      { id: "U25L1-tf-2", type: "true-false-justify", category: "conceptual", prompt: "In a² + b² = c², any side can play the role of c.", isTrue: false, explanation: "c must be the hypotenuse — the longest side opposite the right angle.", hints: ["c is fixed.", "Hypotenuse only.", "c must be the hypotenuse — the longest side opposite the right angle."] },
      // @q13
      { id: "U25L1-order-1", type: "order-steps", category: "word", prompt: "Order the steps to check a 3-4-5 triangle.", sequence: ["Square the legs: 9 + 16", "Add: 9 + 16 = 25", "Compare with 5²: 25 = 25 ✓"], diagnoses: { "Square the legs: 9 + 16@1": "Square the legs first.", "Add: 9 + 16 = 25@0": "Then add.", "Compare with 5²: 25 = 25 ✓@0": "Compare last." }, explanation: "Square, add, compare with c².", hints: ["9 + 16.", "25.", "Square, add, compare with c²."] },
      // @q14
      { id: "U25L1-drag-1", type: "drag-match", category: "conceptual", prompt: "Match each side of a 3-4-5 triangle.", pairs: [ { source: "Hypotenuse", target: "5" }, { source: "One leg", target: "3" }, { source: "Other leg", target: "4" } ], diagnoses: { "Hypotenuse->3": "The hypotenuse is the longest side.", "One leg->5": "5 is the hypotenuse, not a leg.", "Other leg->3": "Legs are 3 and 4." }, explanation: "3² + 4² = 25 = 5² — 5 is the hypotenuse.", hints: ["Longest = 5.", "Short = 3.", "3² + 4² = 25 = 5² — 5 is the hypotenuse."] },
      // @q15
      { id: "U25L1-graph-1", type: "graph-interact", category: "word", prompt: "A right triangle's legs are 3 and 4. Set the slider to the HYPOTENUSE (key: value).", challenge: "A right triangle's legs are 3 and 4. — adjust the values below to match the condition.", validate: { value: 5 }, tolerance: 0.01, explanation: "√(9 + 16) = √25 = 5.", hints: ["√25.", "5.", "√(9 + 16) = √25 = 5."] }
    ],
