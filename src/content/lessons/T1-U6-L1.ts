    ...
    pool: [
      {
        ...
        hints: ["Scale both parts by the same number.", "2:1 × 2.", "4:2."],
      },
      {
        id: "U6L1-mcq-2", type: "mcq", category: "conceptual",
        prompt: "Which is NOT the same ratio as 3:2?",
        options: [{ id: "a", text: "6:4" }, { id: "b", text: "9:6" }, { id: "c", text: "1.5:1" }, { id: "d", text: "2:3" }],
        correctOptionId: "d",
        diagnoses: { a: "6:4 = 3:2 × 2 — same.", b: "9:6 = 3:2 × 3 — same.", c: "1.5:1 = 3:2 ÷ 2 — same." },
      ...
      },
      {
        ...
        options: [{ id: "a", text: "9" }, { id: "b", text: "6" }, { id: "c", text: "4" }, { id: "d", text: "12" }],
        correctOptionId: "a",
        diagnoses: { b: "6 is 2 cups × 3 — but the ratio is 3:2, not 1:1.", c: "4 = 2 × 2 — half the needed eggs.", d: "12 = 3×4 with flour tripled? 6 cups is ×3 flour, so ×3 eggs = 9." },
        explanation: "Flour went 2 → 6 (×3). Eggs also ×3: 9.",
        hints: ["Flour ×3.", "Eggs ×3 too.", "9."],
      },
      {
        id: "U6L1-mcq-4", type: "mcq", category: "conceptual",
        prompt: "A ratio 4:3 — what fraction of the whole is the FIRST part?",
        options: [{ id: "a", text: "$\\frac{4}{7}$" }, { id: "b", text: "$\\frac{4}{3}$" }, { id: "c", text: "$\\frac{3}{7}$" }, { id: "d", text: "$\\frac{1}{4}$" }],
        correctOptionId: "a",
        diagnoses: { b: "4/3 is over 1 — a part of a whole can't exceed it.", c: "3/7 is the SECOND part's share.", d: "1/4 confuses the ratio ratio with a quarter." },
        explanation: "Whole = 4 + 3 = 7 parts, so the first part is 4 out of 7.",
        hints: ["Add the parts to get the whole.", "4 out of 7.", "4/7."],
      },
      {
        ...
        hints: ["HCF of 10 and 15.", "5.", "2:3."],
      },
      {
        id: "U6L1-mcq-6", type: "mcq", category: "word",
        prompt: "Paint mixed red:blue = 2:3. You use 12 parts blue. How much red?",
        options: [{ id: "a", text: "8" }, { id: "b", text: "18" }, { id: "c", text: "6" }, { id: "d", text: "12" }],
        correctOptionId: "a",
        diagnoses: { b: "18 = 12 × 1.5 — wrong scale.", c: "6 = 12 ÷ 2 — you scaled blue alone.", d: "12 keeps 1:1, wrong ratio." },
        explanation: "Blue 3 → 12 (×4). Red 2 × 4 = 8.",
        hints: ["Blue ×4.", "Red ×4.", "8."],
      },
      {
      ...
      },
      {
        ...
        hints: ["Multiply both by 3.", "3 × 3.", "9:12."],
      },
      {
      ...
      },
      {
        ...
        hints: ["Add the parts.", "2 out of 5.", "2/5."],
      },
      {
      ...
      },
      {
        ...
        hints: ["Add the parts.", "5 + 2.", "7 — false."],
      },
      {
      ...
      },
      {
        ...
        challenge: "Set the slider to 10.",
        validate: { value: 10 },
        tolerance: 0.01,
        explanation: "A = 2 × 5 = 10.",
        hints: ["A is double B.", "2 × 5.", "10."],
      },
    ],
