...
export const T2U17L2: Lesson = {
  ...
  quiz: {
    pool: [
      ...
      // @q06
      { id: "U17L2-mcq-6", type: "mcq", category: "word", prompt: "Savings $10/week starting at $50: 50, 60, 70, … Week 20 = ?", options: [ { id: "a", text: "$250" }, { id: "b", text: "$240" }, { id: "c", text: "$200" }, { id: "d", text: "$230" } ], correctOptionId: "b", diagnoses: { a: "250 = 50 + 20 × 10 — only 19 jumps to week 20.", c: "200 = 50 + 15 × 10 — miscounted weeks.", d: "230 = 50 + 18 × 10 — one week short." }, explanation: "T(20) = 50 + 19 × 10 = $240.", hints: ["Week 20 → 19 jumps.", "50 + 190.", "T(20) = 50 + 19 × 10 = $240."] },
      // @q07
      { id: "U17L2-num-1", type: "numeric-input", category: "procedural", prompt: "2, 5, 8, 11, … Type T(10).", answer: 29, tolerance: 0, explanation: "a = 2, d = 3: T(10) = 2 + 9 × 3 = 29.", hints: ["a = 2, d = 3.", "2 + 9 × 3.", "a = 2, d = 3: T(10) = 2 + 9 × 3 = 29."] },
      // @q08
      { id: "U17L2-num-2", type: "numeric-input", category: "procedural", prompt: "3, 6, 9, 12, … Type T(100).", answer: 300, tolerance: 0, explanation: "T(100) = 3 + 99 × 3 = 300.", hints: ["99 jumps.", "3 + 297.", "T(100) = 3 + 99 × 3 = 300."] },
      // @q09
      { id: "U17L2-num-3", type: "numeric-input", category: "conceptual", prompt: "100, 90, 80, … Type T(20).", answer: -90, tolerance: 0, explanation: "a = 100, d = −10: T(20) = 100 + 19 × (−10) = −90.", hints: ["d = −10.", "100 − 190.", "a = 100, d = −10: T(20) = 100 + 19 × (−10) = −90."] },
      // @q10
      { id: "U17L2-frac-1", type: "fraction-input", category: "conceptual", prompt: "1/2, 1, 3/2, 2, … Type T(5) as a fraction.", numerator: 5, denominator: 2, acceptEquivalent: true, explanation: "a = 1/2, d = 1/2: T(5) = 1/2 + 4 × 1/2 = 5/2.", hints: ["d = 1/2.", "1/2 + 2.", "a = 1/2, d = 1/2: T(5) = 1/2 + 4 × 1/2 = 5/2."] },
      // @q11
      { id: "U17L2-tf-1", type: "true-false-justify", category: "conceptual", prompt: "For 3, 6, 9, …, T(100) = 3 + 99 × 3.", isTrue: true, explanation: "Term 100 adds d 99 times — exactly the formula.", hints: ["99 jumps.", "3 + 99 × 3.", "Term 100 adds d 99 times — exactly the formula."] },
      // @q12
      { id: "U17L2-tf-2", type: "true-false-justify", category: "conceptual", prompt: "For 10, 20, 30, …, T(5) = 10 + 5 × 10.", isTrue: false, explanation: "T(5) = 10 + 4 × 10 = 50 — only 4 jumps to the 5th term.", hints: ["n − 1 = 4.", "10 + 40.", "T(5) = 10 + 4 × 10 = 50 — only 4 jumps to the 5th term."] },
      // @q13
      { id: "U17L2-order-1", type: "order-steps", category: "word", prompt: "Order the steps to find T(100) of 5, 9, 13, …", sequence: ["Identify a = 5 and d = 4", "Use T(n) = a + (n − 1)d", "Substitute n = 100: 5 + 99 × 4", "Simplify: T(100) = 401"], diagnoses: { "Identify a = 5 and d = 4@1": "Identify first.", "Use T(n) = a + (n − 1)d@0": "State the formula before substituting.", "Substitute n = 100: 5 + 99 × 4@1": "Substitute after writing the formula." }, explanation: "Identify, write the formula, plug in n = 100, simplify.", hints: ["Find a and d.", "Write formula.", "Identify, write the formula, plug in n = 100, simplify."] },
      // @q14
      ...
      // @q15
      { id: "U17L2-graph-1", type: "graph-interact", category: "word", prompt: "3, 6, 9, 12, … reaches 300 at term 100. Set the slider to T(101) (key: value).", challenge: "3, 6, 9, 12, … reaches 300 at term 100. — adjust the values below to match the condition.", validate: { value: 303 }, tolerance: 0.01, explanation: "T(101) = 3 + 100 × 3 = 303.", hints: ["n = 101.", "3 + 100 × 3.", "T(101) = 3 + 100 × 3 = 303."] }
    ],
