...
export const T2U17L2: Lesson = {
  ...
  quiz: {
    pool: [
      ...
      // @q02
      { id: "U17L2-mcq-2", type: "mcq", category: "conceptual", prompt: "Why is the formula a + (n − 1)d and not a + n·d?", options: [ { id: "a", text: "The first term already has d added zero times — term n adds d only n − 1 times" }, { id: "b", text: "Because d is negative" }, { id: "c", text: "Because n can't be big" }, { id: "d", text: "The formula actually is a + n·d" } ], correctOptionId: "a", diagnoses: { b: "The (n − 1) holds for positive and negative d alike.", c: "n can be any size — the formula scales.", d: "For a = 3, d = 3, a + n·d would make T(1) = 6, wrong." }, explanation: "Term 1 = a + 0·d; each step adds d once → term n has n − 1 steps.", hints: ["Term 1 has zero d.", "Term n has n − 1 d's.", "(n − 1)."] },
      // @q03
      { id: "U17L2-mcq-3", type: "mcq", category: "word", prompt: "A ladder: 20 cm rung 1, then +5 cm each: 20, 25, 30, … What's rung 10?", options: [ { id: "a", text: "65 cm" }, { id: "b", text: "70 cm" }, { id: "c", text: "60 cm" }, { id: "d", text: "50 cm" } ], correctOptionId: "a", diagnoses: { b: "70 = 20 + 10 × 5 — should be 9 jumps.", c: "60 = 20 + 8 × 5 — you're one rung short.", d: "50 = 20 + 6 × 5 — count the jumps carefully." }, explanation: "T(10) = 20 + 9 × 5 = 65 cm.", hints: ["9 jumps for rung 10.", "20 + 45.", "65 cm."] },
      // @q04
      { id: "U17L2-mcq-4", type: "mcq", category: "procedural", prompt: "5, 9, 13, … Which is the nth-term formula?", options: [ { id: "a", text: "T(n) = 5 + 4(n − 1)" }, { id: "b", text: "T(n) = 5 + 5(n − 1)" }, { id: "c", text: "T(n) = 9 + 4(n − 1)" }, { id: "d", text: "T(n) = 5n" } ], correctOptionId: "a", diagnoses: { b: "d = 4 (9 − 5), not 5.", c: "a = 5 is the FIRST term, not 9.", d: "5n gives 5, 10, 15 — gaps of 5, not 4." }, explanation: "a = 5 and d = 4 → T(n) = 5 + 4(n − 1).", hints: ["a = 5.", "d = 4.", "5 + 4(n − 1)."] },
      // @q05
