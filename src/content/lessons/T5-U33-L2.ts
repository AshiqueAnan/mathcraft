...
export const T5U33L2: Lesson = {
  ...
  quiz: {
    pool: [
      ...
      // @q06
      { id: "U33L2-mcq-6", type: "mcq", category: "word", prompt: "Two forces 6 N and 8 N at 120°. The resultant uses…", options: [ { id: "a", text: "cosine rule (sides with included angle)" }, { id: "b", text: "sine rule" }, { id: "c", text: "Pythagoras (6² + 8²)" }, { id: "d", text: "no triangle exists" } ], correctOptionId: "a", diagnoses: { b: "Sine rule needs a side-opposite pair.", c: "Pythagoras needs 90° — here it's 120°.", d: "Two sides + included angle always make a triangle." }, explanation: "The resultant is the third side of a triangle: SAS → cosine rule.", hints: ["Included angle.", "SAS.", "Cosine."] },
      // @q07
