...
export const T3U23L2: Lesson = {
  ...
  quiz: {
    pool: [
      ...
      // @q02
      { id: "U23L2-mcq-2", type: "mcq", category: "conceptual", prompt: "Why does the trapezium formula use the AVERAGE of the bases?", options: [ { id: "a", text: "Copy + flip: the pair forms a parallelogram with base a+b; one copy is half" }, { id: "b", text: "Because trapeziums are always symmetric" }, { id: "c", text: "Because width matters more than height" }, { id: "d", text: "To match the rectangle formula" } ], correctOptionId: "a", diagnoses: { b: "Trapeziums need not be symmetric.", c: "Height still matters — it multiplies the average.", d: "The rectangle has equal bases; the average reduces to them." }, explanation: "Two flipped copies tile a parallelogram of base a + b; each trapezium is half.", hints: ["Copy + rotate 180°.", "Pair = parallelogram base a+b.", "Half of that."] },
      // @q03
      { id: "U23L2-mcq-3", type: "mcq", category: "word", prompt: "A ramp is trapezoidal: parallel edges 2 m and 4 m, gap 3 m. Its area is…", options: [ { id: "a", text: "9 m²" }, { id: "b", text: "18 m²" }, { id: "c", text: "6 m²" }, { id: "d", text: "12 m²" } ], correctOptionId: "a", diagnoses: { b: "18 forgot the half.", c: "6 is (4−2)×3 — wrong move.", d: "12 is 4 × 3 without the average." }, explanation: "½(2 + 4) × 3 = ½ × 6 × 3 = 9 m².", hints: ["Average the edges.", "½ × 6 × 3.", "9."] },
      // @q04
      { id: "U23L2-mcq-4", type: "mcq", category: "procedural", prompt: "Bases 10 cm and 6 cm, height 8 cm. Trapezium area = …", options: [ { id: "a", text: "64 cm²" }, { id: "b", text: "128 cm²" }, { id: "c", text: "32 cm²" }, { id: "d", text: "80 cm²" } ], correctOptionId: "a", diagnoses: { b: "128 didn't halve.", c: "32 halved the height — wrong side to halve.", d: "80 is 10 × 8, ignoring base 6." }, explanation: "½(10 + 6) × 8 = ½ × 16 × 8 = 64 cm².", hints: ["Sum then average the bases.", "8 × 8.", "64."] },
      // @q05
      ...
      // @q06
      { id: "U23L2-mcq-6", type: "mcq", category: "word", prompt: "A garden bed has parallel sides 12 m and 8 m, with 5 m between them. Area = …", options: [ { id: "a", text: "50 m²" }, { id: "b", text: "100 m²" }, { id: "c", text: "25 m²" }, { id: "d", text: "60 m²" } ], correctOptionId: "a", diagnoses: { b: "100 forgot to halve.", c: "25 halved 50 m — the height isn't the value to halve.", d: "60 is 12 × 5, ignoring the other base." }, explanation: "½(12 + 8) × 5 = ½ × 20 × 5 = 50 m².", hints: ["Average the parallel sides.", "10 × 5.", "50."] },
      // @q07
