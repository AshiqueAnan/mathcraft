  ...
  quiz: {
    pool: [
      ...
      },
      {
        ...
        options: [{ id: "a", text: "Only the shared primes with lowest exponent" }, { id: "b", text: "Every prime with its highest exponent" }, { id: "c", text: "The biggest number" }, { id: "d", text: "The smallest prime" }],
        correctOptionId: "b",
        diagnoses: { a: "Lowest exponent is the HCF rule.", c: "The numbers may be bigger than one input.", d: "Just one prime misses the others." },
      ...
      },
      {
        ...
        options: [{ id: "a", text: "9:16" }, { id: "b", text: "9:20" }, { id: "c", text: "9:24" }, { id: "d", text: "9:48" }],
        correctOptionId: "c",
        diagnoses: { b: "20 isn't a multiple of 12.", a: "16 isn't a multiple of 12.", d: "48 is a common multiple but not the first after 9:00." },
      ...
      },
      {
        ...
        prompt: "LCM(6, 8) = ?",
        options: [{ id: "a", text: "14" }, { id: "b", text: "2" }, { id: "c", text: "48" }, { id: "d", text: "24" }],
        correctOptionId: "d",
        diagnoses: { b: "HCF is 2.", c: "48 is a common multiple but twice too big.", a: "14 is just 6 + 8." },
        explanation: "6 = 2×3, 8 = 2³. Highest: 2³×3 = 24.",
        hints: ["6 = 2·3.", "8 = 2³.", "6 = 2×3, 8 = 2³."],
      },
      {
        ...
        hints: ["Both prime.", "No shared factors.", "5 and 7 are prime and distinct → nothing shared → LCM = 5 × 7 = 35."],
      },
      {
        ...
        options: [{ id: "a", text: "In 8 days" }, { id: "b", text: "In 15 days" }, { id: "c", text: "In 5 days" }, { id: "d", text: "In 3 days" }],
        correctOptionId: "b",
        diagnoses: { a: "8 is 3 + 5, not a common multiple.", c: "5 isn't a multiple of 3.", d: "3 isn't a multiple of 5." },
        explanation: "LCM(3, 5) = 15 days.",
        hints: ["Multiples of 3 & 5.", "First match.", "LCM(3, 5) = 15 days."],
      },
      {
      ...
      },
      {
        ...
        hints: ["LCM(4, 7).", "No shared factors.", "LCM(4, 7) = 28 (4 and 7 share nothing)."],
      },
      {
        ...
        hints: ["12 out of 24.", "Simplify.", "12/24 = 1/2."],
      },
      {
      ...
      },
      {
        ...
        hints: ["Check 12 and 18 as multiples of both.", "12 < 24 and works.", "24 is a common multiple, but 12 is smaller — so LCM = 12."],
      },
      {
        ...
        hints: ["Factor 6 and 8.", "Max exponents.", "Highest powers 2³ and 3 give 24."],
      },
      {
        ...
        hints: ["4×6/2.", "3×5.", "12, 15, 24 respectively."],
      },
      {
        ...
        hints: ["First shared multiple of 4 and 6.", "Multiples: 4,8,12 and 6,12.", "LCM(4, 6) = 12."],
      },
    ],
