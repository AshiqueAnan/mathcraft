...
export const T2U19L3: Lesson = {
  ...
  quiz: {
    pool: [
      // @q01
      { id: "U19L3-mcq-1", type: "mcq", category: "procedural", prompt: "y = x² and y = 4 cross at x = 2 and x = −2. The solution of x² = 4 is…", options: [ { id: "a", text: "x = ±2" }, { id: "b", text: "y = 4" }, { id: "c", text: "x = 4" }, { id: "d", text: "x = 2 only" } ], correctOptionId: "a", diagnoses: { b: "4 is y — the solution is the x of the crossings.", c: "4 is the y-value, not x.", d: "Both crossings count: +2 AND −2." }, explanation: "Both x-values where the curves meet solve x² = 4.", hints: ["Crossing x's.", "±2.", "x = ±2."] },
      // @q02
      { id: "U19L3-mcq-2", type: "mcq", category: "conceptual", prompt: "When two graphs cross at (3, 9), what is the solution?", options: [ { id: "a", text: "x = 3 (read the x-coordinate)" }, { id: "b", text: "y = 9" }, { id: "c", text: "x = 9" }, { id: "d", text: "Both x = 3 and y = 9 are solutions" } ], correctOptionId: "a", diagnoses: { b: "9 is what the two expressions equal — the answer, not x.", c: "x is the first coordinate.", d: "The solution of the equation is its x-value." }, explanation: "The x-coordinate of the meeting point is the solution.", hints: ["x first.", "Read x.", "x = 3."] },
      // @q03
      { id: "U19L3-mcq-3", type: "mcq", category: "word", prompt: "Profit: P = x² − 5x + 6 = 0. Reading the graph, where does it cross the axis?", options: [ { id: "a", text: "x = 2 and x = 3" }, { id: "b", text: "y = 6" }, { id: "c", text: "x = 6" }, { id: "d", text: "x = 0 only" } ], correctOptionId: "a", diagnoses: { b: "6 is the y-intercept, not a root.", c: "6 is a constant, not a crossing.", d: "The curve crosses twice, not once." }, explanation: "Roots at x = 2 and x = 3 — the axis crossings.", hints: ["Where y = 0.", "Two crossings.", "2 and 3."] },
      // @q04
      { id: "U19L3-mcq-4", type: "mcq", category: "procedural", prompt: "Solve x² = x + 2 graphically. Where do the graphs meet?", options: [ { id: "a", text: "x = 2 and x = −1" }, { id: "b", text: "x = 1 and x = −2" }, { id: "c", text: "x = 2 only" }, { id: "d", text: "x = 4" } ], correctOptionId: "a", diagnoses: { b: "Check: (−1)² = 1 and −1 + 2 = 1 ✓; (2)² = 4, 2 + 2 = 4 ✓ — it's 2 and −1.", c: "x = −1 also fits.", d: "4 is a y-value, not x." }, explanation: "The parabola and line cross at x = 2 and x = −1.", hints: ["Test each x.", "(2)² = 4 = 2 + 2.", "2 and −1."] },
      // @q05
      { id: "U19L3-mcq-5", type: "mcq", category: "conceptual", prompt: "Why is a graph solution only an ESTIMATE sometimes?", options: [ { id: "a", text: "The crossing may fall between grid marks we can't read exactly" }, { id: "b", text: "Graphs are always wrong" }, { id: "c", text: "Curves can't be plotted" }, { id: "d", text: "The grid has no numbers" } ], correctOptionId: "a", diagnoses: { b: "The graph is accurate — our reading of a messy spot is approximate.", c: "Curves plot fine.", d: "Grids have marks; precision is the limit." }, explanation: "A crossing at 2.37 is read as 'about 2.4' — algebra gets exact.", hints: ["Between marks.", "Reading limit.", "Estimate."] },
      // @q06
      { id: "U19L3-mcq-6", type: "mcq", category: "word", prompt: "Two cables cross on a graph at x = 7. What does the crossing mean in the real world?", options: [ { id: "a", text: "At input 7, both outputs are equal" }, { id: "b", text: "Cable A is broken at 7" }, { id: "c", text: "The graph ends at 7" }, { id: "d", text: "7 is the y-intercept" } ], correctOptionId: "a", diagnoses: { b: "A crossing is equality, not damage.", c: "Graphs extend beyond single points.", d: "7 is an x-value, not the intercept." }, explanation: "The meeting x makes both formulas give the same output.", hints: ["Same y at that x.", "Equal outputs.", "x = 7."] },
      // @q07
      { id: "U19L3-num-1", type: "numeric-input", category: "procedural", prompt: "y = x² and y = 9 cross at ±3. Type the POSITIVE solution of x² = 9.", answer: 3, tolerance: 0, explanation: "The crossing at x = 3 solves x² = 9.", hints: ["√9.", "+3.", "3."] },
      // @q08
      { id: "U19L3-num-2", type: "numeric-input", category: "procedural", prompt: "y = x² and y = x + 2 cross at x = 2 and x = −1. Type the LARGER solution.", answer: 2, tolerance: 0, explanation: "Larger of 2 and −1 is 2.", hints: ["2 > −1.", "2.", "2."] },
      // @q09
      { id: "U19L3-num-3", type: "numeric-input", category: "conceptual", prompt: "Two graphs meet at (4, 7). Type the solution x.", answer: 4, tolerance: 0, explanation: "The x-coordinate 4 is the solution.", hints: ["Read x.", "4.", "4."] },
      // @q10
      { id: "U19L3-frac-1", type: "fraction-input", category: "conceptual", prompt: "y = 1/x and y = 2 cross at x = 1/2. Write the solution as a fraction.", numerator: 1, denominator: 2, acceptEquivalent: true, explanation: "The crossing x is 1/2.", hints: ["Where they meet.", "x = 1/2.", "1/2."] },
      // @q11
      { id: "U19L3-tf-1", type: "true-false-justify", category: "conceptual", prompt: "To solve x² = 4 graphically, you read the x-coordinate of the crossings.", isTrue: true, explanation: "Crossings at (±2, 4) give solutions x = ±2.", hints: ["x-coordinate.", "±2.", "True."] },
      // @q12
      { id: "U19L3-tf-2", type: "true-false-justify", category: "conceptual", prompt: "If two graphs never cross, the equation has exactly one solution.", isTrue: false, explanation: "No crossing = no shared x = no solution.", hints: ["No meeting.", "No solution.", "False."] },
      // @q13
      { id: "U19L3-order-1", type: "order-steps", category: "word", prompt: "Order the steps to solve x² = x + 2 graphically.", sequence: ["Plot y = x² (curve) and y = x + 2 (line)", "Find where the two graphs meet", "Read the x-coordinates of the crossings", "State solutions: x = 2, x = −1"], diagnoses: { "Plot y = x² (curve) and y = x + 2 (line)@1": "Plot both first.", "Find where the two graphs meet@0": "Locate meetings before reading.", "Read the x-coordinates of the crossings@1": "Read x of each crossing." }, explanation: "Plot, locate, read x, list solutions.", hints: ["Plot both.", "Find meetings.", "Read x's."] },
      // @q14
      { id: "U19L3-drag-1", type: "drag-match", category: "conceptual", prompt: "Match each crossing to its solution.", pairs: [ { source: "y = x² meets y = 4 at x = ±2", target: "x² = 4 → ±2" }, { source: "y = x² meets y = x + 2 at x = 2, −1", target: "x² = x + 2 → 2, −1" }, { source: "y = 1/x meets y = 2 at x = 1/2", target: "1/x = 2 → 1/2" } ], diagnoses: { "y = x² meets y = 4 at x = ±2->1/x = 2 → 1/2": "That crossing is for x² = 4.", "y = x² meets y = x + 2 at x = 2, −1->x² = 4 → ±2": "x² = x + 2 gives 2 and −1.", "y = 1/x meets y = 2 at x = 1/2->x² = x + 2 → 2, −1": "1/x = 2 solves to 1/2." }, explanation: "The crossing x solves the equation formed by setting the sides equal.", hints: ["Set the y's equal.", "Read crossing x.", "Match."] },
      // @q15
      { id: "U19L3-graph-1", type: "graph-interact", category: "word", prompt: "y = x² and y = x + 2 meet at x = 2. Set the slider to that solution (key: value).", challenge: "Set the slider to 2.", validate: { value: 2 }, tolerance: 0.01, explanation: "The crossing at x = 2 solves x² = x + 2.", hints: ["Crossing x.", "2.", "2."] }
    ],
