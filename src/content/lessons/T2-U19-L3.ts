...
export const T2U19L3: Lesson = {
  ...
  quiz: {
    pool: [
      ...
      // @q04
      { id: "U19L3-mcq-4", type: "mcq", category: "procedural", prompt: "Solve x² = x + 2 graphically. Where do the graphs meet?", options: [ { id: "a", text: "x = 4" }, { id: "b", text: "x = 1 and x = −2" }, { id: "c", text: "x = 2 only" }, { id: "d", text: "x = 2 and x = −1" } ], correctOptionId: "d", diagnoses: { b: "Check: (−1)² = 1 and −1 + 2 = 1 ✓; (2)² = 4, 2 + 2 = 4 ✓ — it's 2 and −1.", c: "x = −1 also fits.", a: "4 is a y-value, not x." }, explanation: "The parabola and line cross at x = 2 and x = −1.", hints: ["Test each x.", "(2)² = 4 = 2 + 2.", "2 and −1."] },
      // @q05
