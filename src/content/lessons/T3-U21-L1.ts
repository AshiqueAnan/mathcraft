...
export const T3U21L1: Lesson = {
  ...
  quiz: {
    pool: [
      ...
      // @q03
      { id: "U21L1-mcq-3", type: "mcq", category: "word", prompt: "A honeycomb cell is a regular hexagon. Its interior angle sum is…", options: [ { id: "a", text: "540°" }, { id: "b", text: "360°" }, { id: "c", text: "720°" }, { id: "d", text: "1080°" } ], correctOptionId: "c", diagnoses: { b: "360° is a quadrilateral.", a: "540° is a pentagon.", d: "1080° would be an octagon." }, explanation: "(6 − 2) × 180 = 720°.", hints: ["6 sides.", "(4) × 180.", "720°."] },
      // @q04
      { id: "U21L1-mcq-4", type: "mcq", category: "procedural", prompt: "Interior angle sum of an OCTAGON?", options: [ { id: "a", text: "360°" }, { id: "b", text: "720°" }, { id: "c", text: "1440°" }, { id: "d", text: "1080°" } ], correctOptionId: "d", diagnoses: { b: "720° is a hexagon.", c: "1440° is n × 180 without subtracting 2.", a: "360° is a quadrilateral." }, explanation: "(8 − 2) × 180 = 6 × 180 = 1080°.", hints: ["n = 8.", "6 × 180.", "1080°."] },
      // @q05
      ...
      // @q06
      { id: "U21L1-mcq-6", type: "mcq", category: "word", prompt: "A stop sign is a regular octagon. Each interior angle is…", options: [ { id: "a", text: "120°" }, { id: "b", text: "135°" }, { id: "c", text: "108°" }, { id: "d", text: "150°" } ], correctOptionId: "b", diagnoses: { a: "120° is a hexagon's angle.", c: "108° is a pentagon's.", d: "150° is a dodecagon's." }, explanation: "1080 ÷ 8 = 135°.", hints: ["Sum 1080°.", "÷ 8.", "135°."] },
      // @q07
