...
export const T3U21L1: Lesson = {
  ...
  quiz: {
    pool: [
      // @q01
      { id: "U21L1-mcq-1", type: "mcq", category: "procedural", prompt: "A quadrilateral splits into how many triangles from one vertex?", options: [ { id: "a", text: "2" }, { id: "b", text: "4" }, { id: "c", text: "3" }, { id: "d", text: "1" } ], correctOptionId: "a", diagnoses: { b: "4 is the side count; triangles are sides − 2.", c: "3 triangles is a pentagon.", d: "One triangle can't tile a quadrilateral." }, explanation: "n − 2 = 4 − 2 = 2 triangles.", hints: ["n = 4 sides.", "n − 2.", "n − 2 = 4 − 2 = 2 triangles."] },
      // @q02
      { id: "U21L1-mcq-2", type: "mcq", category: "conceptual", prompt: "Why does the triangle count use n − 2?", options: [ { id: "a", text: "You always remove 2 sides when cutting" }, { id: "b", text: "Two sides of the polygon become the 'ends', so only n − 2 triangles fit between the rays" }, { id: "c", text: "Because triangles have 3 sides" }, { id: "d", text: "It's an approximation" } ], correctOptionId: "b", diagnoses: { a: "It's about geometry of the fan, not removing sides.", c: "The 3-side fact doesn't give n − 2 by itself.", d: "It's exact, not approximate." }, explanation: "A fan from one vertex uses the two adjacent sides as the outer triangle edges — leaving n − 2 triangles.", hints: ["Fan from a vertex.", "n − 2 triangles.", "A fan from one vertex uses the two adjacent sides as the outer triangle edges — leaving n − 2 triangles."] },
      // @q03
      { id: "U21L1-mcq-3", type: "mcq", category: "word", prompt: "A honeycomb cell is a regular hexagon. Its interior angle sum is…", options: [ { id: "a", text: "540°" }, { id: "b", text: "360°" }, { id: "c", text: "720°" }, { id: "d", text: "1080°" } ], correctOptionId: "c", diagnoses: { b: "360° is a quadrilateral.", a: "540° is a pentagon.", d: "1080° would be an octagon." }, explanation: "(6 − 2) × 180 = 720°.", hints: ["6 sides.", "(4) × 180.", "(6 − 2) × 180 = 720°."] },
      // @q04
      { id: "U21L1-mcq-4", type: "mcq", category: "procedural", prompt: "Interior angle sum of an OCTAGON?", options: [ { id: "a", text: "360°" }, { id: "b", text: "720°" }, { id: "c", text: "1440°" }, { id: "d", text: "1080°" } ], correctOptionId: "d", diagnoses: { b: "720° is a hexagon.", c: "1440° is n × 180 without subtracting 2.", a: "360° is a quadrilateral." }, explanation: "(8 − 2) × 180 = 6 × 180 = 1080°.", hints: ["n = 8.", "6 × 180.", "(8 − 2) × 180 = 6 × 180 = 1080°."] },
      // @q05
      { id: "U21L1-mcq-5", type: "mcq", category: "conceptual", prompt: "Regular decagon — the sum is 1440°. Each interior angle is…", options: [ { id: "a", text: "144°" }, { id: "b", text: "160°" }, { id: "c", text: "140°" }, { id: "d", text: "180°" } ], correctOptionId: "a", diagnoses: { b: "160° would be an 18-gon's angle.", c: "140° would need sum 1400.", d: "180° is a straight line, not one angle." }, explanation: "1440 ÷ 10 = 144° per angle.", hints: ["Divide by 10.", "144", "1440 ÷ 10 = 144° per angle."] },
      // @q06
      { id: "U21L1-mcq-6", type: "mcq", category: "word", prompt: "A stop sign is a regular octagon. Each interior angle is…", options: [ { id: "a", text: "120°" }, { id: "b", text: "135°" }, { id: "c", text: "108°" }, { id: "d", text: "150°" } ], correctOptionId: "b", diagnoses: { a: "120° is a hexagon's angle.", c: "108° is a pentagon's.", d: "150° is a dodecagon's." }, explanation: "1080 ÷ 8 = 135°.", hints: ["Sum 1080°.", "÷ 8.", "1080 ÷ 8 = 135°."] },
      // @q07
      { id: "U21L1-num-1", type: "numeric-input", category: "procedural", prompt: "Interior angle sum of a PENTAGON?", answer: 540, tolerance: 0, explanation: "(5 − 2) × 180 = 540°.", hints: ["5 − 2 = 3.", "3 × 180.", "(5 − 2) × 180 = 540°."] },
      // @q08
      { id: "U21L1-num-2", type: "numeric-input", category: "procedural", prompt: "A polygon's sum is 900°. How many sides?", answer: 7, tolerance: 0, explanation: "900 ÷ 180 = 5 → n − 2 = 5 → n = 7.", hints: ["900 ÷ 180.", "5 + 2.", "900 ÷ 180 = 5 → n − 2 = 5 → n = 7."] },
      // @q09
      { id: "U21L1-num-3", type: "numeric-input", category: "conceptual", prompt: "A regular hexagon — each interior angle?", answer: 120, tolerance: 0, explanation: "720 ÷ 6 = 120°.", hints: ["Sum 720°.", "÷ 6.", "720 ÷ 6 = 120°."] },
      // @q10
      { id: "U21L1-frac-1", type: "fraction-input", category: "conceptual", prompt: "A triangle's share of a quadrilateral's 360° sum — write it as a fraction of the whole for ONE triangle.", numerator: 1, denominator: 2, acceptEquivalent: true, explanation: "Quadrilateral = 2 triangles; each holds 180° = 1/2 of 360°.", hints: ["2 triangles.", "1/2.", "Quadrilateral = 2 triangles; each holds 180° = 1/2 of 360°."] },
      // @q11
      { id: "U21L1-tf-1", type: "true-false-justify", category: "conceptual", prompt: "Every quadrilateral has interior sum 360°.", isTrue: true, explanation: "2 triangles × 180° = 360° — the formula (4 − 2) × 180.", hints: ["n − 2 = 2.", "2 × 180.", "2 triangles × 180° = 360° — the formula (4 − 2) × 180."] },
      // @q12
      { id: "U21L1-tf-2", type: "true-false-justify", category: "conceptual", prompt: "The interior sum formula uses (n − 1) × 180°.", isTrue: false, explanation: "It's (n − 2) × 180° — a quadrilateral is 360°, not 540°.", hints: ["n − 2.", "Quad = 360°.", "It's (n − 2) × 180° — a quadrilateral is 360°, not 540°."] },
      // @q13
      { id: "U21L1-order-1", type: "order-steps", category: "word", prompt: "Order the steps to find the sum for a hexagon.", sequence: ["Count sides: n = 6", "Triangles from one vertex: n − 2 = 4", "Multiply: 4 × 180° = 720°", "State: sum = 720°"], diagnoses: { "Count sides: n = 6@1": "Count first.", "Triangles from one vertex: n − 2 = 4@0": "Find triangles before multiplying.", "State: sum = 720°@0": "State last." }, explanation: "Count, subtract 2, multiply by 180, state.", hints: ["n = 6.", "n − 2 = 4.", "Count, subtract 2, multiply by 180, state."] },
      // @q14
      { id: "U21L1-drag-1", type: "drag-match", category: "conceptual", prompt: "Match each polygon to its interior sum.", pairs: [ { source: "Triangle", target: "180°" }, { source: "Quadrilateral", target: "360°" }, { source: "Pentagon", target: "540°" } ], diagnoses: { "Triangle->360°": "Triangle is just 180°.", "Quadrilateral->540°": "Quad = 360°.", "Pentagon->180°": "Pentagon = 540°." }, explanation: "(n − 2) × 180 for each.", hints: ["n − 2.", "× 180.", "(n − 2) × 180 for each."] },
      // @q15
      { id: "U21L1-graph-1", type: "graph-interact", category: "word", prompt: "A regular pentagon's each-angle is 108°. Set the slider to the SUM of all five (key: value).", challenge: "A regular pentagon's each-angle is 108°. — adjust the values below to match the condition.", validate: { value: 540 }, tolerance: 0.01, explanation: "5 × 108 = 540° — or (5 − 2) × 180.", hints: ["5 × 108.", "540.", "5 × 108 = 540° — or (5 − 2) × 180."] }
    ],
