    ...
    pool: [
      {
        ...
        hints: ["% = out of 100.", "0.5 = 5 tenths = 50 hundredths.", "0.5 × 100 = 50, with the % sign → 50%."],
      },
      {
      ...
      },
      {
        ...
        hints: ["60% = 0.6.", "0.6 × 200.", "60% = 0.6. 0.6 × 200 = 120."],
      },
      {
        ...
        hints: ["25% is a quarter.", "Quarter of 40.", "25% = 1/4. 40 ÷ 4 = 10."],
      },
      {
      ...
      },
      {
        ...
        hints: ["Move decimal two places right.", "0.35 → 35.", "0.35 × 100 = 35%."],
      },
      {
        ...
        hints: ["Percent = out of 100.", "12 ÷ 100.", "12% = 12/100 = 0."],
      },
      {
      ...
      },
      {
        ...
        hints: ["15% = 0.15.", "0.15 × 120.", "15% = 0.15. 0.15 × 120 = $18."],
      },
      {
        ...
        hints: ["0.5 = 5 tenths.", "Simplify.", "0.5 = 5/10 = 1/2."],
      },
      {
        ...
        hints: ["Percent out of 100.", "5 ÷ 100.", "5% = 5/100 = 0."],
      },
      {
        ...
        hints: ["50% = 50/100.", "0.5 = 5/10.", "50% = 0.5 — same amount, different costume."],
      },
      {
        ...
        hints: ["3 ÷ 5.", "0.6.", "Divide the top by the bottom, then ×100."],
      },
      {
