...
export const T5U32L1: Lesson = {
  ...
  quiz: {
    pool: [
      ...
      // @q06
      { id: "U32L1-mcq-6", type: "mcq", category: "word", prompt: "A 200 mg dose of medicine decays with a 1-day half-life. After 2 days, remaining = …", options: [ { id: "a", text: "100 mg" }, { id: "b", text: "50 mg" }, { id: "c", text: "25 mg" }, { id: "d", text: "0 mg" } ], correctOptionId: "b", diagnoses: { a: "100 mg is after only 1 half-life.", c: "25 mg is after 3 half-lives.", d: "It halves, never hitting zero." }, explanation: "200 × (1/2)² = 200 × 1/4 = 50 mg.", hints: ["Halve twice.", "200 → 100 → 50.", "50 mg."] },
      // @q07
