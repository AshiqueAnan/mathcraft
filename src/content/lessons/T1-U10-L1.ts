...
export const T1U10L1: Lesson = {
  ...
  quiz: {
    pool: [
      // @q01
      { id: "U10L1-mcq-1", type: "mcq", category: "procedural", prompt: "If A = {2, 4, 6, 8}, which statement is TRUE?", options: [ { id: "a", text: "6 ∈ A" }, { id: "b", text: "5 ∈ A" }, { id: "c", text: "8 ∉ A" }, { id: "d", text: "2 ∉ A" } ], correctOptionId: "a", diagnoses: { b: "5 is odd — it fails A's 'even' test.", c: "8 IS in A, so 'not in' is wrong.", d: "2 IS in A." }, explanation: "6 is an even number in the set, so 6 ∈ A.", hints: ["What does ∈ mean?", "Is 6 listed in A?", "6 is an even number in the set, so 6 ∈ A."] },
      // @q02
      { id: "U10L1-mcq-2", type: "mcq", category: "conceptual", prompt: "Which is the SAME set as {1, 2, 3}?", options: [ { id: "a", text: "{1, 1, 2}" }, { id: "b", text: "{3, 1, 2}" }, { id: "c", text: "{1, 2, 3, 4}" }, { id: "d", text: "{}" } ], correctOptionId: "b", diagnoses: { a: "Missing 3 and 1 is duplicated — different collection.", c: "Has an extra member, 4.", d: "The empty set has no members." }, explanation: "Sets ignore order: {1, 2, 3} = {3, 1, 2} because they hold the same members.", hints: ["Order never matters to a set.", "Compare the members, not the sequence.", "Sets ignore order: {1, 2, 3} = {3, 1, 2} because they hold the same members."] },
      // @q03
      { id: "U10L1-mcq-3", type: "mcq", category: "word", prompt: "A class's 'pets at home' set P = {cat, dog, fish, bird}. Rina has a hamster. Which is true?", options: [ { id: "a", text: "P = {hamster}" }, { id: "b", text: "hamster ∈ P" }, { id: "c", text: "hamster ∉ P" }, { id: "d", text: "P has 5 members" } ], correctOptionId: "c", diagnoses: { b: "Hamster isn't in the listed pet set.", a: "P lists four pets, not one.", d: "P has exactly 4 members." }, explanation: "Hamster is not a member of the listed set P, so hamster ∉ P.", hints: ["Is hamster on the list?", "No.", "Hamster is not a member of the listed set P, so hamster ∉ P."] },
      // @q04
      { id: "U10L1-mcq-4", type: "mcq", category: "procedural", prompt: "Which listing describes 'the set of vowel letters'?", options: [ { id: "a", text: "{a, b, c, d}" }, { id: "b", text: "{b, c, d}" }, { id: "c", text: "{1, 2, 3}" }, { id: "d", text: "{a, e, i, o, u}" } ], correctOptionId: "d", diagnoses: { b: "b, c, d are consonants.", c: "Numbers aren't letters.", a: "b, c, d aren't vowels." }, explanation: "The vowels are exactly a, e, i, o, u.", hints: ["Which letters are vowels?", "a, e, i, o, u.", "The vowels are exactly a, e, i, o, u."] },
      // @q05
      { id: "U10L1-mcq-5", type: "mcq", category: "conceptual", prompt: "The set D = {days starting with S}. Which belongs?", options: [ { id: "a", text: "Sunday" }, { id: "b", text: "Monday" }, { id: "c", text: "Friday" }, { id: "d", text: "Wednesday" } ], correctOptionId: "a", diagnoses: { b: "Monday starts with M.", c: "Friday starts with F.", d: "Wednesday starts with W." }, explanation: "Sunday starts with S, so Sunday ∈ D.", hints: ["Which day begins with S?", "Saturday and Sunday.", "Sunday starts with S, so Sunday ∈ D."] },
      // @q06
      { id: "U10L1-mcq-6", type: "mcq", category: "word", prompt: "A chef's 'ingredients in the fridge' set has 5 items. She buys milk, which is not among them. What is the new set?", options: [ { id: "a", text: "Still 5 — milk replaces one" }, { id: "b", text: "The old 5 plus milk — 6 members" }, { id: "c", text: "4 members" }, { id: "d", text: "Milk only" } ], correctOptionId: "b", diagnoses: { a: "Adding a NEW item grows the set by one.", c: "Nothing was removed.", d: "Milk joins, not replaces." }, explanation: "Adding a new distinct member makes the set have 6 members.", hints: ["Was milk already in the set?", "No — it's new.", "Adding a new distinct member makes the set have 6 members."] },
      // @q07
      { id: "U10L1-num-1", type: "numeric-input", category: "procedural", prompt: "If A = {1, 3, 5, 7, 9}, how many members does A have? Type the count.", answer: 5, tolerance: 0, explanation: "A lists five odd numbers between 0 and 10.", hints: ["Count the listed elements.", "1, 3, 5, 7, 9.", "A lists five odd numbers between 0 and 10."] },
      // @q08
      { id: "U10L1-num-2", type: "numeric-input", category: "procedural", prompt: "E = {multiples of 3 less than 20}. How many members does E have? Type the count.", answer: 6, tolerance: 0, explanation: "3, 6, 9, 12, 15, 18 — six multiples of 3 under 20.", hints: ["List the multiples of 3 below 20.", "3, 6, 9, 12, 15, 18.", "3, 6, 9, 12, 15, 18 — six multiples of 3 under 20."] },
      // @q09
      { id: "U10L1-num-3", type: "numeric-input", category: "conceptual", prompt: "The set of single-digit primes is P = {2, 3, 5, 7}. Type the member that is also even.", answer: 2, tolerance: 0, explanation: "2 is the only even prime in P.", hints: ["Which of 2, 3, 5, 7 is even?", "Only 2.", "2 is the only even prime in P."] },
      // @q10
      { id: "U10L1-frac-1", type: "fraction-input", category: "conceptual", prompt: "The set W = {days of the week} has 7 members. Tuesday and Thursday start with T. What fraction of W starts with T? (Write as a fraction.)", numerator: 2, denominator: 7, acceptEquivalent: false, explanation: "Of the 7 days, 2 start with T, so the fraction is 2/7.", hints: ["How many days start with T?", "2 out of 7.", "Of the 7 days, 2 start with T, so the fraction is 2/7."] },
      // @q11
      ...
      // @q15
      { id: "U10L1-graph-1", type: "graph-interact", category: "word", prompt: "This slider counts members of set S = {1, 2, 3, 4, 5, 6}. Set it to the value of the LARGEST even member (key: value).", challenge: "Adjust the values below so they match the condition described in the prompt.", validate: { value: 6 }, tolerance: 0, explanation: "The largest even number in S is 6.", hints: ["Which members are even?", "2, 4, 6.", "The largest even number in S is 6."] }
    ],
