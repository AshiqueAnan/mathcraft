...
export const T1U10L1: Lesson = {
  ...
  quiz: {
    pool: [
      ...
      // @q02
      { id: "U10L1-mcq-2", type: "mcq", category: "conceptual", prompt: "Which is the SAME set as {1, 2, 3}?", options: [ { id: "a", text: "{1, 1, 2}" }, { id: "b", text: "{3, 1, 2}" }, { id: "c", text: "{1, 2, 3, 4}" }, { id: "d", text: "{}" } ], correctOptionId: "b", diagnoses: { a: "Missing 3 and 1 is duplicated — different collection.", c: "Has an extra member, 4.", d: "The empty set has no members." }, explanation: "Sets ignore order: {1, 2, 3} = {3, 1, 2} because they hold the same members.", hints: ["Order never matters to a set.", "Compare the members, not the sequence.", "{3, 1, 2}."] },
      // @q03
