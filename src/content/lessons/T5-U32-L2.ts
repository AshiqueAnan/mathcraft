...
export const T5U32L2: Lesson = {
  ...
  intuitionBlocks: [{ widget: "number-line", narrative: "Slide along powers of 2 on the number line: 1, 2, 4, 8, 16… The logarithm asks which position a target sits at — log₂8 = 3 because 8 sits at position 3. Drag the target to 32 and watch log₂32 = 5 appear. The line turns multiplication into addition of positions." }],
  ...
  quiz: {
    pool: [
      // @q01
      { id: "U32L2-mcq-1", type: "mcq", category: "procedural", prompt: "log₂ 8 = …", options: [ { id: "a", text: "3" }, { id: "b", text: "8" }, { id: "c", text: "2" }, { id: "d", text: "16" } ], correctOptionId: "a", diagnoses: { b: "8 is the target, not the exponent.", c: "2 is the base.", d: "16 is 2×8 — wrong idea." }, explanation: "2³ = 8, so log₂8 = 3.", hints: ["2^? = 8.", "2³.", "3."] },
      // @q02
      { id: "U32L2-mcq-2", type: "mcq", category: "conceptual", prompt: "What question does log₃ 81 ask?", options: [ { id: "a", text: "3 to the what equals 81?" }, { id: "b", text: "81 divided by 3?" }, { id: "c", text: "81 times 3?" }, { id: "d", text: "what is 3³?" } ], correctOptionId: "a", diagnoses: { b: "That's a quotient.", c: "That's a product.", d: "3³ = 27, not 81." }, explanation: "log_b(a) asks for the exponent: b^? = a.", hints: ["Base to the what.", "Exponent.", "3^? = 81."] },
      // @q03
      { id: "U32L2-mcq-3", type: "mcq", category: "word", prompt: "Sound doubles in 'loudness steps' every 3 dB. A whisper of 2 steps is 4 times louder than 1 step. log₂ 4 = …", options: [ { id: "a", text: "2" }, { id: "b", text: "4" }, { id: "c", text: "1" }, { id: "d", text: "8" } ], correctOptionId: "a", diagnoses: { b: "4 is the loudness, not the step.", c: "1 step would be 2×, not 4×.", d: "8 is 2³." }, explanation: "2² = 4, so log₂4 = 2 steps.", hints: ["2^? = 4.", "2².", "2."] },
      // @q04
      { id: "U32L2-mcq-4", type: "mcq", category: "procedural", prompt: "log₃ 27 = …", options: [ { id: "a", text: "3" }, { id: "b", text: "9" }, { id: "c", text: "27" }, { id: "d", text: "81" } ], correctOptionId: "a", diagnoses: { b: "9 is 3² — one step too small.", c: "27 is the target.", d: "81 is 3⁴." }, explanation: "3³ = 27, so log₃27 = 3.", hints: ["3^? = 27.", "3³.", "3."] },
      // @q05
      { id: "U32L2-mcq-5", type: "mcq", category: "conceptual", prompt: "log₂ 32 equals log₂ 4 + log₂ 8 because…", options: [ { id: "a", text: "multiplying 4×8 = 32 adds their log-positions" }, { id: "b", text: "adding 4+8 = 12" }, { id: "c", text: "they're both powers of 2" }, { id: "d", text: "no — the statement is false" } ], correctOptionId: "a", diagnoses: { b: "Logs add positions when the NUMBERS multiply, not add.", c: "True but not the reason.", d: "log₂4 + log₂8 = 2 + 3 = 5 = log₂32 — it holds." }, explanation: "log(mn) = log m + log n — multiplication turns into addition of exponents.", hints: ["4 × 8.", "2 + 3.", "log₂32."] },
      // @q06
      { id: "U32L2-mcq-6", type: "mcq", category: "word", prompt: "Earthquakes: each whole number on the scale is 10× the energy. A 6 is how many times stronger than a 4?", options: [ { id: "a", text: "100×" }, { id: "b", text: "10×" }, { id: "c", text: "2×" }, { id: "d", text: "20×" } ], correctOptionId: "a", diagnoses: { b: "10× is one step (5 vs 4).", c: "2× is for adding, not multiplying.", d: "20 is 10+10, not 10×10." }, explanation: "Two steps up: 10×10 = 100× — the scale is logarithmic.", hints: ["6 − 4 = 2 steps.", "10².", "100×."] },
      // @q07
      { id: "U32L2-num-1", type: "numeric-input", category: "procedural", prompt: "log₂ 16 = …", answer: 4, tolerance: 0, explanation: "2⁴ = 16.", hints: ["2^? = 16.", "2⁴.", "4."] },
      // @q08
      { id: "U32L2-num-2", type: "numeric-input", category: "procedural", prompt: "log₅ 125 = …", answer: 3, tolerance: 0, explanation: "5³ = 125.", hints: ["5^? = 125.", "5³.", "3."] },
      // @q09
      { id: "U32L2-num-3", type: "numeric-input", category: "conceptual", prompt: "log₂ 2 = …", answer: 1, tolerance: 0, explanation: "2¹ = 2 — any base's log of itself is 1.", hints: ["2¹ = 2.", "1.", "1."] },
      // @q10
      { id: "U32L2-frac-1", type: "fraction-input", category: "conceptual", prompt: "log₂ (1/2) — the exponent with 2^x = 1/2. Express the answer as a fraction.", numerator: -1, denominator: 1, acceptEquivalent: true, explanation: "2⁻¹ = 1/2 — negative exponents give reciprocals.", hints: ["2^? = ½.", "2⁻¹.", "-1/1."] },
      // @q11
      { id: "U32L2-tf-1", type: "true-false-justify", category: "conceptual", prompt: "log₂ 8 + log₂ 4 = log₂ 32.", isTrue: true, explanation: "3 + 2 = 5 = log₂32 — multiplication turns to addition.", hints: ["3 + 2.", "5.", "True."] },
      // @q12
      { id: "U32L2-tf-2", type: "true-false-justify", category: "conceptual", prompt: "log₂ (−8) is a valid real number.", isTrue: false, explanation: "No power of 2 is negative — the input must be positive.", hints: ["2^? > 0 always.", "Negative input.", "False."] },
      // @q13
      { id: "U32L2-order-1", type: "order-steps", category: "word", prompt: "Order the steps to evaluate log₂ 64.", sequence: ["Ask: 2 to the what equals 64?", "List powers: 2,4,8,16,32,64", "Count positions: 6"], diagnoses: { "Ask: 2 to the what equals 64?@1": "Ask the question first.", "List powers: 2,4,8,16,32,64@0": "Then list.", "Count positions: 6@0": "Count last." }, explanation: "Whose power, list, count.", hints: ["What exponent?", "Powers.", "6."] },
      // @q14
      { id: "U32L2-drag-1", type: "drag-match", category: "conceptual", prompt: "Match each logarithm to its value.", pairs: [ { source: "log₂ 8", target: "3" }, { source: "log₁₀ 100", target: "2" }, { source: "log₅ 25", target: "2" } ], diagnoses: { "log₂ 8->2": "2³ = 8.", "log₁₀ 100->3": "10² = 100.", "log₅ 25->3": "5² = 25." }, explanation: "Each asks base^? = target.", hints: ["2³.", "10².", "5²."] },
      // @q15
      { id: "U32L2-graph-1", type: "graph-interact", category: "word", prompt: "log₂ 8 = 3. Set the slider to the value of log₂ 8 (key: value).", challenge: "Set the slider to 3.", validate: { value: 3 }, tolerance: 0.01, explanation: "2³ = 8 → log₂8 = 3.", hints: ["2³.", "3.", "3."] }
    ],
