...
export const T5U32L2: Lesson = {
  ...
  quiz: {
    pool: [
      ...
      // @q02
      { id: "U32L2-mcq-2", type: "mcq", category: "conceptual", prompt: "What question does log₃ 81 ask?", options: [ { id: "a", text: "81 divided by 3?" }, { id: "b", text: "3 to the what equals 81?" }, { id: "c", text: "81 times 3?" }, { id: "d", text: "what is 3³?" } ], correctOptionId: "b", diagnoses: { a: "That's a quotient.", c: "That's a product.", d: "3³ = 27, not 81." }, explanation: "log_b(a) asks for the exponent: b^? = a.", hints: ["Base to the what.", "Exponent.", "3^? = 81."] },
      // @q03
      { id: "U32L2-mcq-3", type: "mcq", category: "word", prompt: "Sound doubles in 'loudness steps' every 3 dB. A whisper of 2 steps is 4 times louder than 1 step. log₂ 4 = …", options: [ { id: "a", text: "1" }, { id: "b", text: "4" }, { id: "c", text: "2" }, { id: "d", text: "8" } ], correctOptionId: "c", diagnoses: { b: "4 is the loudness, not the step.", a: "1 step would be 2×, not 4×.", d: "8 is 2³." }, explanation: "2² = 4, so log₂4 = 2 steps.", hints: ["2^? = 4.", "2².", "2."] },
      // @q04
      { id: "U32L2-mcq-4", type: "mcq", category: "procedural", prompt: "log₃ 27 = …", options: [ { id: "a", text: "81" }, { id: "b", text: "9" }, { id: "c", text: "27" }, { id: "d", text: "3" } ], correctOptionId: "d", diagnoses: { b: "9 is 3² — one step too small.", c: "27 is the target.", a: "81 is 3⁴." }, explanation: "3³ = 27, so log₃27 = 3.", hints: ["3^? = 27.", "3³.", "3."] },
      // @q05
