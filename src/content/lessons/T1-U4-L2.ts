    ...
    pool: [
      ...
      },
      {
        ...
        diagnoses: {
          ...
          c: "$\\frac{3}{8}$ is between a quarter and a half — too much. Multiply 1 and 4 by 2: you need 2 out of 8.",
      ...
      },
      {
        ...
        diagnoses: {
          ...
          d: "Check division: 8 ÷ 4 = 2 and 12 ÷ 4 = 3 — both divide by the same number, so they ARE equivalent.",
        },
      ...
      },
      {
        ...
        options: [
          ...
          { id: "b", text: "Ben" },
          { id: "c", text: "Cal" },
          { id: "d", text: "All get the same amount." },
        ],
        correctOptionId: "d",
        diagnoses: {
          a: "All three pizzas are the same size, and each person's share is $\\frac{1}{3}$. $\\frac{2}{6}$ and $\\frac{3}{9}$ are just different names for the same third.",
      ...
      },
      {
        ...
        correctOptionId: "a",
        diagnoses: {
          b: "$\\frac{4}{3}$ is more than 1, while $\\frac{3}{4}$ is less than 1.",
