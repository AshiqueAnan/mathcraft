...
export const T5U30L1: Lesson = {
  ...
  quiz: {
    pool: [
      // @q01
      { id: "U30L1-mcq-1", type: "mcq", category: "procedural", prompt: "f(x) = 2x + 1. f(3) = …", options: [ { id: "a", text: "7" }, { id: "b", text: "6" }, { id: "c", text: "9" }, { id: "d", text: "5" } ], correctOptionId: "a", diagnoses: { b: "6 is 2×3 without the +1.", c: "9 is 3² — wrong rule.", d: "5 is 3 + 2 — wrong order." }, explanation: "2(3) + 1 = 7.", hints: ["2 × 3.", "+ 1.", "2(3) + 1 = 7."] },
      // @q02
      { id: "U30L1-mcq-2", type: "mcq", category: "conceptual", prompt: "Which rule is NOT a function?", options: [ { id: "a", text: "double the number" }, { id: "b", text: "the number's square root (both signs)" }, { id: "c", text: "add 3" }, { id: "d", text: "square the number" } ], correctOptionId: "b", diagnoses: { a: "Doubling gives one output.", c: "Adding gives one output.", d: "Squaring gives one output." }, explanation: "Square root of 4 is both 2 and -2 — one input, two outputs.", hints: ["One input, two outputs?", "√4 = ±2.", "Not a function."] },
      // @q03
      { id: "U30L1-mcq-3", type: "mcq", category: "word", prompt: "A taxi charges $3 plus $2 per km. Distance d km → cost f(d). f(5) = …", options: [ { id: "a", text: "15" }, { id: "b", text: "10" }, { id: "c", text: "13" }, { id: "d", text: "8" } ], correctOptionId: "c", diagnoses: { b: "10 is 2×5 without the $3 base.", a: "15 is 3×5 — wrong rule.", d: "8 is 3 + 5 — forgot to double." }, explanation: "f(d) = 2d + 3, so f(5) = 10 + 3 = 13.", hints: ["2 × 5.", "+ 3.", "f(d) = 2d + 3, so f(5) = 10 + 3 = 13."] },
      // @q04
      { id: "U30L1-mcq-4", type: "mcq", category: "procedural", prompt: "g(x) = x². g(-4) = …", options: [ { id: "a", text: "-8" }, { id: "b", text: "-16" }, { id: "c", text: "8" }, { id: "d", text: "16" } ], correctOptionId: "d", diagnoses: { b: "-16 keeps the negative — squaring makes it positive.", c: "8 is 2×4 — wrong rule.", a: "-8 is -2×4 — wrong rule." }, explanation: "(-4)² = 16 — squaring always gives a non-negative result.", hints: ["(-4) × (-4).", "Positive.", "(-4)² = 16 — squaring always gives a non-negative result."] },
      // @q05
      { id: "U30L1-mcq-5", type: "mcq", category: "conceptual", prompt: "The domain of f(x) = 1/x is…", options: [ { id: "a", text: "all numbers except 0" }, { id: "b", text: "all numbers" }, { id: "c", text: "only positive numbers" }, { id: "d", text: "only 0" } ], correctOptionId: "a", diagnoses: { b: "1/0 is undefined — 0 can't be an input.", c: "Negative inputs work fine: 1/(-2) = -0.5.", d: "0 is the ONE input that fails." }, explanation: "Division by zero is undefined, so 0 is excluded from the domain.", hints: ["1/0 = ?", "Undefined.", "Division by zero is undefined, so 0 is excluded from the domain."] },
      // @q06
      { id: "U30L1-mcq-6", type: "mcq", category: "word", prompt: "A plant grows 2 cm per day from a 5 cm start. Height h(t) after t days. h(7) = …", options: [ { id: "a", text: "14" }, { id: "b", text: "19" }, { id: "c", text: "12" }, { id: "d", text: "35" } ], correctOptionId: "b", diagnoses: { a: "14 is 2×7 without the 5 cm start.", c: "12 is 5 + 7 — forgot to double.", d: "35 is 5×7 — wrong rule." }, explanation: "h(t) = 2t + 5, so h(7) = 14 + 5 = 19.", hints: ["2 × 7.", "+ 5.", "h(t) = 2t + 5, so h(7) = 14 + 5 = 19."] },
      // @q07
      { id: "U30L1-num-1", type: "numeric-input", category: "procedural", prompt: "f(x) = 3x - 2. f(4) = …", answer: 10, tolerance: 0, explanation: "3(4) - 2 = 12 - 2 = 10.", hints: ["3 × 4.", "12 - 2.", "3(4) - 2 = 12 - 2 = 10."] },
      // @q08
      { id: "U30L1-num-2", type: "numeric-input", category: "procedural", prompt: "g(x) = x² + 1. g(5) = …", answer: 26, tolerance: 0, explanation: "25 + 1 = 26.", hints: ["5².", "25 + 1.", "25 + 1 = 26."] },
      // @q09
      { id: "U30L1-num-3", type: "numeric-input", category: "conceptual", prompt: "f(x) = 2x. What input gives output 14?", answer: 7, tolerance: 0, explanation: "2x = 14 → x = 7.", hints: ["2x = 14.", "Divide by 2.", "2x = 14 → x = 7."] },
      // @q10
      { id: "U30L1-frac-1", type: "fraction-input", category: "conceptual", prompt: "f(x) = 1/x. f(2) as a fraction.", numerator: 1, denominator: 2, acceptEquivalent: true, explanation: "1/2 — the reciprocal of 2.", hints: ["1 ÷ 2.", "1/2.", "1/2 — the reciprocal of 2."] },
      // @q11
      { id: "U30L1-tf-1", type: "true-false-justify", category: "conceptual", prompt: "f(x) = x² is a function even though f(3) = f(-3) = 9.", isTrue: true, explanation: "Different inputs sharing an output is fine — the rule still gives each input exactly one output.", hints: ["One input, one output.", "Sharing is OK.", "Different inputs sharing an output is fine — the rule still gives each input exactly one output."] },
      // @q12
      { id: "U30L1-tf-2", type: "true-false-justify", category: "conceptual", prompt: "The rule 'the number's square root' is a function.", isTrue: false, explanation: "4 would give both 2 and -2 — one input, two outputs, so it's not a function.", hints: ["√4 = ?", "±2.", "4 would give both 2 and -2 — one input, two outputs, so it's not a function."] },
      // @q13
      { id: "U30L1-order-1", type: "order-steps", category: "word", prompt: "Order the steps to evaluate f(3) for f(x) = 2x + 1.", sequence: ["Substitute x = 3", "Multiply 2 × 3", "Add 1"], diagnoses: { "Substitute x = 3@1": "Start by substituting.", "Multiply 2 × 3@0": "Then multiply.", "Add 1@0": "Add last." }, explanation: "Substitute, multiply, then add — order matters.", hints: ["Plug in 3.", "2 × 3.", "Substitute, multiply, then add — order matters."] },
      // @q14
      { id: "U30L1-drag-1", type: "drag-match", category: "conceptual", prompt: "Match each term to its meaning.", pairs: [ { source: "Domain", target: "allowed inputs" }, { source: "Range", target: "outputs that appear" }, { source: "f(x)", target: "output for input x" } ], diagnoses: { "Domain->outputs that appear": "Domain is the inputs.", "Range->allowed inputs": "Range is the outputs.", "f(x)->allowed inputs": "f(x) is the output." }, explanation: "Domain = inputs, range = outputs, f(x) = the output value.", hints: ["Inputs.", "Outputs.", "Domain = inputs, range = outputs, f(x) = the output value."] },
      // @q15
      { id: "U30L1-graph-1", type: "graph-interact", category: "word", prompt: "f(x) = 2x + 1. Set the slider to f(4) (key: value).", challenge: "f(x) = 2x + 1. — adjust the values below to match the condition.", validate: { value: 9 }, tolerance: 0.01, explanation: "2(4) + 1 = 9.", hints: ["2 × 4.", "+ 1.", "2(4) + 1 = 9."] }
    ],
