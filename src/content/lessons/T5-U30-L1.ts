...
export const T5U30L1: Lesson = {
  ...
  quiz: {
    pool: [
      ...
      // @q06
      { id: "U30L1-mcq-6", type: "mcq", category: "word", prompt: "A plant grows 2 cm per day from a 5 cm start. Height h(t) after t days. h(7) = …", options: [ { id: "a", text: "14" }, { id: "b", text: "19" }, { id: "c", text: "12" }, { id: "d", text: "35" } ], correctOptionId: "b", diagnoses: { a: "14 is 2×7 without the 5 cm start.", c: "12 is 5 + 7 — forgot to double.", d: "35 is 5×7 — wrong rule." }, explanation: "h(t) = 2t + 5, so h(7) = 14 + 5 = 19.", hints: ["2 × 7.", "+ 5.", "19."] },
      // @q07
