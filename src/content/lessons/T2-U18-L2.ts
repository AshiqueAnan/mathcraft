...
export const T2U18L2: Lesson = {
  ...
  quiz: {
    pool: [
      // @q01
      { id: "U18L2-mcq-1", type: "mcq", category: "procedural", prompt: "Line through (1, 2) and (3, 8). Gradient?", options: [ { id: "a", text: "3" }, { id: "b", text: "6" }, { id: "c", text: "2" }, { id: "d", text: "1/3" } ], correctOptionId: "a", diagnoses: { b: "6 is the RISE alone — divide by run 2.", c: "2 is the run, not the gradient.", d: "That's run ÷ rise, upside down." }, explanation: "rise = 6, run = 2 → 6/2 = 3.", hints: ["y₂ − y₁ = 6.", "x₂ − x₁ = 2.", "3."] },
      // @q02
      { id: "U18L2-mcq-2", type: "mcq", category: "conceptual", prompt: "Why is the gradient the same at ANY two points on a straight line?", options: [ { id: "a", text: "The line rises proportionally — rise/run never changes" }, { id: "b", text: "Every line has exactly two points" }, { id: "c", text: "The gradient is random" }, { id: "d", text: "It's constant only at the origin" } ], correctOptionId: "a", diagnoses: { b: "Lines have infinitely many points.", c: "The gradient is fixed by the line's steepness.", d: "Constancy holds along the whole line." }, explanation: "Constant steepness = constant rise per run.", hints: ["Straight meaning.", "Same tilt.", "Fixed ratio."] },
      // @q03
      { id: "U18L2-mcq-3", type: "mcq", category: "word", prompt: "A ramp rises 3 m over 12 m of run. Gradient?", options: [ { id: "a", text: "1/4" }, { id: "b", text: "4" }, { id: "c", text: "3" }, { id: "d", text: "12" } ], correctOptionId: "a", diagnoses: { b: "4 is run ÷ rise — upside down.", c: "3 is just the rise.", d: "12 is just the run." }, explanation: "3 ÷ 12 = 1/4 — gentle slope.", hints: ["rise ÷ run.", "3 ÷ 12.", "1/4."] },
      // @q04
      { id: "U18L2-mcq-4", type: "mcq", category: "procedural", prompt: "Line through (0, 5) and (4, 1). Gradient?", options: [ { id: "a", text: "−1" }, { id: "b", text: "1" }, { id: "c", text: "−4" }, { id: "d", text: "4" } ], correctOptionId: "a", diagnoses: { b: "y falls — gradient is negative.", c: "−4 is the rise; ÷ run 4 → −1.", d: "x subtracted the wrong way — sign flipped." }, explanation: "rise = 1 − 5 = −4, run = 4 → −1.", hints: ["y falls.", "−4 ÷ 4.", "−1."] },
      // @q05
      { id: "U18L2-mcq-5", type: "mcq", category: "conceptual", prompt: "What does a NEGATIVE gradient mean?", options: [ { id: "a", text: "The line slopes downhill (falls as x grows)" }, { id: "b", text: "The line is vertical" }, { id: "c", text: "The line is horizontal" }, { id: "d", text: "The line doesn't exist" } ], correctOptionId: "a", diagnoses: { b: "Vertical lines have undefined gradient.", c: "Horizontal lines have gradient 0.", d: "Negative slope lines exist all the time." }, explanation: "As x increases, y decreases — downhill.", hints: ["Downhill tilt.", "y decreases.", "Negative."] },
      // @q06
      { id: "U18L2-mcq-6", type: "mcq", category: "word", prompt: "A ski run drops 200 m over 800 m horizontally. Gradient?", options: [ { id: "a", text: "−1/4" }, { id: "b", text: "1/4" }, { id: "c", text: "−4" }, { id: "d", text: "200" } ], correctOptionId: "a", diagnoses: { b: "It DESCENDS — the sign is negative.", c: "That's the reciprocal.", d: "200 is the rise alone." }, explanation: "drop = −200, run = 800 → −200/800 = −1/4.", hints: ["Descent = negative.", "−200 ÷ 800.", "−1/4."] },
      // @q07
      { id: "U18L2-num-1", type: "numeric-input", category: "procedural", prompt: "Line through (0, 0) and (4, 6). Type the gradient.", answer: 1.5, tolerance: 0, explanation: "6/4 = 3/2 = 1.5.", hints: ["rise 6, run 4.", "6 ÷ 4.", "1.5."] },
      // @q08
      { id: "U18L2-num-2", type: "numeric-input", category: "procedural", prompt: "Line through (1, 2) and (3, 8). Type the rise.", answer: 6, tolerance: 0, explanation: "8 − 2 = 6.", hints: ["y₂ − y₁.", "8 − 2.", "6."] },
      // @q09
      { id: "U18L2-num-3", type: "numeric-input", category: "conceptual", prompt: "Line through (2, 1) and (5, 4). Type the gradient.", answer: 1, tolerance: 0, explanation: "rise = 3, run = 3 → 1.", hints: ["3 and 3.", "3 ÷ 3.", "1."] },
      // @q10
      { id: "U18L2-frac-1", type: "fraction-input", category: "conceptual", prompt: "Line through (1, 1) and (3, 2). Write the gradient as a fraction.", numerator: 1, denominator: 2, acceptEquivalent: true, explanation: "rise = 1, run = 2 → 1/2.", hints: ["y: 2 − 1 = 1.", "x: 3 − 1 = 2.", "1/2."] },
      // @q11
      { id: "U18L2-tf-1", type: "true-false-justify", category: "conceptual", prompt: "A horizontal line has gradient 0.", isTrue: true, explanation: "Rise is 0 for any run: 0 ÷ run = 0.", hints: ["No rise.", "0 ÷ anything.", "True."] },
      // @q12
      { id: "U18L2-tf-2", type: "true-false-justify", category: "conceptual", prompt: "A line through (1, 1) and (3, 3) has gradient 3.", isTrue: false, explanation: "rise = 2, run = 2 → gradient 1, not 3.", hints: ["rise 2.", "run 2.", "1."] },
      // @q13
      ...
      // @q15
      { id: "U18L2-graph-1", type: "graph-interact", category: "word", prompt: "A line goes through the origin and the point (2, 6). Set the slider to the gradient (key: value).", challenge: "Set the slider to 3.", validate: { value: 3 }, tolerance: 0.01, explanation: "rise 6, run 2 → gradient 3.", hints: ["6 ÷ 2.", "3.", "3."] }
    ],
