...
export const T2U18L1: Lesson = {
  ...
  quiz: {
    pool: [
      // @q01
      { id: "U18L1-mcq-1", type: "mcq", category: "procedural", prompt: "How do you reach (3, 4) from the origin?", options: [ { id: "a", text: "3 right, 4 up" }, { id: "b", text: "4 right, 3 up" }, { id: "c", text: "3 left, 4 down" }, { id: "d", text: "3 up, 4 right" } ], correctOptionId: "a", diagnoses: { b: "x first, then y: (3, 4) is 3 right then 4 up.", c: "Positives go right and up.", d: "x is horizontal, y vertical — not swapped." }, explanation: "(x, y): x horizontal first, then y vertical.", hints: ["x first.", "Right and up.", "(x, y): x horizontal first, then y vertical."] },
      // @q02
      { id: "U18L1-mcq-2", type: "mcq", category: "conceptual", prompt: "Why would (3, 4) and (4, 3) be different points?", options: [ { id: "a", text: "They're actually the same point" }, { id: "b", text: "The order of x and y matters — they're different addresses" }, { id: "c", text: "Only negative coordinates differ" }, { id: "d", text: "The grid moves" } ], correctOptionId: "b", diagnoses: { a: "3 right / 4 up ≠ 4 right / 3 up.", c: "Order matters regardless of sign.", d: "Coordinates are fixed addresses on the grid." }, explanation: "(3, 4) and (4, 3) land in different spots.", hints: ["Swap the numbers.", "Different spot.", "(3, 4) and (4, 3) land in different spots."] },
      // @q03
      { id: "U18L1-mcq-3", type: "mcq", category: "word", prompt: "A map says the treasure is at (−2, 3). Go…", options: [ { id: "a", text: "3 left, 2 up" }, { id: "b", text: "2 right, 3 up" }, { id: "c", text: "2 left, 3 up" }, { id: "d", text: "2 left, 3 down" } ], correctOptionId: "c", diagnoses: { b: "Negative x means LEFT.", a: "First coordinate is x: −2 → 2 left.", d: "Positive y means UP, not down." }, explanation: "x = −2 → left; y = 3 → up.", hints: ["x negative.", "Left.", "x = −2 → left; y = 3 → up."] },
      // @q04
      { id: "U18L1-mcq-4", type: "mcq", category: "procedural", prompt: "What is the origin's coordinate?", options: [ { id: "a", text: "(1, 0)" }, { id: "b", text: "(1, 1)" }, { id: "c", text: "(0, 1)" }, { id: "d", text: "(0, 0)" } ], correctOptionId: "d", diagnoses: { b: "Origin is zero on both axes.", c: "That's one step up.", a: "That's one step right." }, explanation: "The axes cross at (0, 0) — neither left/right nor up/down.", hints: ["Both zero.", "Crossing point.", "The axes cross at (0, 0) — neither left/right nor up/down."] },
      // @q05
      { id: "U18L1-mcq-5", type: "mcq", category: "conceptual", prompt: "What does the x-coordinate control?", options: [ { id: "a", text: "How far left or right from the y-axis" }, { id: "b", text: "How far up or down" }, { id: "c", text: "The size of the point" }, { id: "d", text: "The color of the point" } ], correctOptionId: "a", diagnoses: { b: "Up/down is y.", c: "Points are zero-size locations.", d: "Color is styling, not math." }, explanation: "x is horizontal position; y is vertical.", hints: ["Horizontal.", "Left/right.", "x is horizontal position; y is vertical."] },
      // @q06
      { id: "U18L1-mcq-6", type: "mcq", category: "word", prompt: "Chess: king at (5, 1) moves one right. New coordinate?", options: [ { id: "a", text: "(5, 2)" }, { id: "b", text: "(6, 1)" }, { id: "c", text: "(4, 1)" }, { id: "d", text: "(6, 2)" } ], correctOptionId: "b", diagnoses: { a: "One right changes x, not y.", c: "Right increases x: 5 → 6.", d: "Only one step — can't change both." }, explanation: "Right adds 1 to x: (5 + 1, 1) = (6, 1).", hints: ["Right = x change.", "5 + 1.", "Right adds 1 to x: (5 + 1, 1) = (6, 1)."] },
      // @q07
      { id: "U18L1-num-1", type: "numeric-input", category: "procedural", prompt: "Type the x-coordinate of (−2, 5).", answer: -2, tolerance: 0, explanation: "First number in the pair is x: −2.", hints: ["First is x.", "−2.", "First number in the pair is x: −2."] },
      // @q08
      { id: "U18L1-num-2", type: "numeric-input", category: "procedural", prompt: "Type the y-coordinate of (3, −4).", answer: -4, tolerance: 0, explanation: "Second number is y: −4.", hints: ["Second is y.", "−4.", "Second number is y: −4."] },
      // @q09
      { id: "U18L1-num-3", type: "numeric-input", category: "conceptual", prompt: "A point sits 5 left and 2 down from the origin. Type its x-coordinate.", answer: -5, tolerance: 0, explanation: "Left = negative x: x = −5.", hints: ["Left is negative.", "−5.", "Left = negative x: x = −5."] },
      // @q10
      { id: "U18L1-frac-1", type: "fraction-input", category: "conceptual", prompt: "A point sits half a unit right and 1 up. Write its x-coordinate as a fraction.", numerator: 1, denominator: 2, acceptEquivalent: true, explanation: "Half right: x = 1/2.", hints: ["Half right.", "x = 1/2.", "Half right: x = 1/2."] },
      // @q11
      { id: "U18L1-tf-1", type: "true-false-justify", category: "conceptual", prompt: "(4, 2) is reached by moving 4 right and 2 up from the origin.", isTrue: true, explanation: "x = 4 → 4 right; y = 2 → 2 up.", hints: ["x first.", "4 right, 2 up.", "x = 4 → 4 right; y = 2 → 2 up."] },
      // @q12
      { id: "U18L1-tf-2", type: "true-false-justify", category: "conceptual", prompt: "(3, 7) and (7, 3) label the same point.", isTrue: false, explanation: "Order swaps the location — different addresses.", hints: ["x vs y.", "Different spot.", "Order swaps the location — different addresses."] },
      // @q13
      ...
      // @q14
      { id: "U18L1-drag-1", type: "drag-match", category: "conceptual", prompt: "Match each point to its direction from the origin.", pairs: [ { source: "(3, −2)", target: "Right 3, down 2" }, { source: "(−4, 1)", target: "Left 4, up 1" }, { source: "(0, 5)", target: "Straight up 5" } ], diagnoses: { "(3, −2)->Left 4, up 1": "x = 3 → right, not left.", "(−4, 1)->Right 3, down 2": "x = −4 → left.", "(0, 5)->Right 3, down 2": "x = 0 → no sideways step." }, explanation: "Read x (horizontal, negative left) then y (vertical, negative down).", hints: ["x first.", "Negative left/down.", "Read x (horizontal, negative left) then y (vertical, negative down)."] },
      // @q15
      { id: "U18L1-graph-1", type: "graph-interact", category: "word", prompt: "Plot the point (3, 2) on the grid. Set the slider to its x-coordinate first (key: value).", challenge: "Adjust the values below so they match the condition described in the prompt.", validate: { value: 3 }, tolerance: 0.01, explanation: "The x-coordinate of (3, 2) is 3.", hints: ["x first.", "3.", "The x-coordinate of (3, 2) is 3."] }
    ],
