...
export const T1U10L2: Lesson = {
  ...
  quiz: {
    pool: [
      ...
      // @q02
      { id: "U10L2-mcq-2", type: "mcq", category: "conceptual", prompt: "A = {1, 2, 3} and B = {3, 4, 5}. What is A ∩ B?", options: [ { id: "a", text: "{3}" }, { id: "b", text: "{1, 2, 3, 4, 5}" }, { id: "c", text: "{}" }, { id: "d", text: "{1, 2}" } ], correctOptionId: "a", diagnoses: { b: "That's the union, not the intersection.", c: "3 is shared, so the intersection is not empty.", d: "1 and 2 are only in A." }, explanation: "The only member in BOTH sets is 3, so A ∩ B = {3}.", hints: ["Intersection = members in both.", "Which number appears in A and B?", "{3}."] },
      // @q03
      { id: "U10L2-mcq-3", type: "mcq", category: "word", prompt: "12 students play football, 9 play basketball, and 4 play both. How many play football OR basketball?", options: [ { id: "a", text: "17" }, { id: "b", text: "21" }, { id: "c", text: "13" }, { id: "d", text: "6" } ], correctOptionId: "a", diagnoses: { b: "12 + 9 = 21 double-counts the 4 both.", c: "13 is 17 − 4 — you subtracted twice.", d: "6 is just 12 − 4 − 2, wrong arithmetic." }, explanation: "12 + 9 − 4 = 17, subtracting the doubly-counted overlap once.", hints: ["Add the two groups.", "Subtract the 'both' once.", "17."] },
      // @q04
      { id: "U10L2-mcq-4", type: "mcq", category: "procedural", prompt: "If |A| = 7, |B| = 6, and |A ∩ B| = 2, what is |A ∪ B|?", options: [ { id: "a", text: "11" }, { id: "b", text: "13" }, { id: "c", text: "9" }, { id: "d", text: "15" } ], correctOptionId: "a", diagnoses: { b: "7 + 6 = 13 — you forgot to subtract the overlap.", c: "7 + 6 − 2 − 2 = 9 subtracts twice.", d: "Too large — 15 adds extra." }, explanation: "|A ∪ B| = 7 + 6 − 2 = 11.", hints: ["Add the sizes.", "Subtract the overlap once.", "11."] },
      // @q05
      ...
      // @q06
      { id: "U10L2-mcq-6", type: "mcq", category: "word", prompt: "A lunch counter: 14 orders include rice, 11 include chicken, 5 include BOTH. How many orders include rice OR chicken?", options: [ { id: "a", text: "20" }, { id: "b", text: "25" }, { id: "c", text: "19" }, { id: "d", text: "9" } ], correctOptionId: "a", diagnoses: { b: "14 + 11 = 25 double-counts the 5 both.", c: "14 + 11 − 5 − 1 = 19 — extra subtraction mistake.", d: "Too small — that's subtracting both groups wrong." }, explanation: "14 + 11 − 5 = 20, removing the double-counted overlap once.", hints: ["Add the two totals.", "Subtract the 'both' once.", "20."] },
      // @q07
      { id: "U10L2-num-1", type: "numeric-input", category: "procedural", prompt: "A = {0, 1, 2, 3}, B = {2, 3, 4, 5}. Type the number of members in A ∩ B.", answer: 2, tolerance: 0, explanation: "The shared members are 2 and 3 — two of them.", hints: ["Which numbers are in both sets?", "2 and 3.", "2."] },
      // @q08
      { id: "U10L2-num-2", type: "numeric-input", category: "procedural", prompt: "A = {0, 1, 2, 3}, B = {2, 3, 4, 5}. Type the number of members in A ∪ B.", answer: 6, tolerance: 0, explanation: "The union is {0, 1, 2, 3, 4, 5} — six members.", hints: ["List everything in either set.", "0, 1, 2, 3, 4, 5.", "6."] },
      // @q09
      { id: "U10L2-num-3", type: "numeric-input", category: "conceptual", prompt: "If |A| = 7, |B| = 5, and |A ∪ B| = 9, what is |A ∩ B|? Type the size of the overlap.", answer: 3, tolerance: 0, explanation: "|A ∩ B| = |A| + |B| − |A ∪ B| = 7 + 5 − 9 = 3.", hints: ["Rearrange the union rule.", "Overlap = |A| + |B| − |A ∪ B|.", "3."] },
      // @q10
      { id: "U10L2-frac-1", type: "fraction-input", category: "conceptual", prompt: "Universe U = {1, 2, 3, 4, 5, 6}, A = {1, 2, 3}. What fraction of U is in A's complement A′? (Write it.)", numerator: 1, denominator: 2, acceptEquivalent: true, explanation: "A′ = {4, 5, 6} — 3 of 6 members, fraction 3/6 = 1/2.", hints: ["What is NOT in A?", "{4, 5, 6}.", "3/6 = 1/2."] },
      // @q11
      { id: "U10L2-tf-1", type: "true-false-justify", category: "conceptual", prompt: "If |A| = 5, |B| = 3, and |A ∩ B| = 2, then |A ∪ B| = 6.", isTrue: true, explanation: "5 + 3 − 2 = 6, subtracting the doubly-counted overlap once.", hints: ["Add the sizes, subtract overlap once.", "5 + 3 − 2.", "True — 6."] },
      // @q12
      { id: "U10L2-tf-2", type: "true-false-justify", category: "conceptual", prompt: "A ∪ B has fewer members than A ∩ B.", isTrue: false, explanation: "The union is always at least as big as the intersection — it contains the intersection and more.", hints: ["Which is bigger: 'or' or 'and'?", "∪ holds everything in either set.", "False."] },
      // @q13
      { id: "U10L2-order-1", type: "order-steps", category: "word", prompt: "Order the steps to count: 12 football, 9 basketball, 4 both → how many play football OR basketball?", sequence: ["Write |F| = 12, |B| = 9", "Write |F ∩ B| = 4", "Add: 12 + 9 = 21", "Subtract the overlap: 21 − 4 = 17"], diagnoses: { "Write |F ∩ B| = 4@0": "List the sizes first.", "Subtract the overlap: 21 − 4 = 17@0": "Add before subtracting.", "Add: 12 + 9 = 21@2": "Add after listing sizes." }, explanation: "Add the totals, then subtract the overlap once to avoid double-counting.", hints: ["Write the given sizes.", "Then the overlap.", "Finally 17."] },
      // @q14
      ...
      // @q15
      { id: "U10L2-graph-1", type: "graph-interact", category: "word", prompt: "A = {1, 2, 3, 4, 5}, B = {4, 5, 6, 7}. Set the slider to the number of members in A ∩ B (key: value).", challenge: "Set the slider to 2.", validate: { value: 2 }, tolerance: 0, explanation: "The shared members are 4 and 5 — two of them.", hints: ["What is in both sets?", "4 and 5.", "2."] }
    ],
