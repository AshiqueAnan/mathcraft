...
export const T2U12L4: Lesson = {
  ...
  quiz: {
    pool: [
      ...
      // @q08
      { id: "U12L4-num-2", type: "numeric-input", category: "procedural", prompt: "Factorize x² − 7x + 10. Type the LESS NEGATIVE constant (e.g. type −2 if the pair is −2, −5).", answer: -2, tolerance: 0, explanation: "Pairs of 10: −2 and −5 multiply to 10 and add to −7.", hints: ["Product +10, sum −7.", "Both negative.", "Pairs of 10: −2 and −5 multiply to 10 and add to −7."] },
      // @q09
      { id: "U12L4-num-3", type: "numeric-input", category: "conceptual", prompt: "Factorize x² + 4x + 4. Type the repeated bracket number.", answer: 2, tolerance: 0, explanation: "Pairs of 4: 2 and 2 add to 4 → (x + 2)(x + 2) = (x + 2)².", hints: ["Pairs of 4.", "Both add to 4.", "Pairs of 4: 2 and 2 add to 4 → (x + 2)(x + 2) = (x + 2)²."] },
      // @q10
      { id: "U12L4-frac-1", type: "fraction-input", category: "conceptual", prompt: "Factorize x² + x + 1/4. Write the fraction inside the bracket (repeated).", numerator: 1, denominator: 2, acceptEquivalent: true, explanation: "Pairs of 1/4: 1/2 and 1/2 add to 1 → (x + 1/2)².", hints: ["Square root of 1/4.", "1/2.", "Pairs of 1/4: 1/2 and 1/2 add to 1 → (x + 1/2)²."] },
      // @q11
      ...
      // @q14
      { id: "U12L4-drag-1", type: "drag-match", category: "conceptual", prompt: "Match each quadratic to its factorization.", pairs: [ { source: "x² + 5x + 6", target: "(x + 2)(x + 3)" }, { source: "x² + 7x + 12", target: "(x + 3)(x + 4)" }, { source: "x² − 5x + 6", target: "(x − 2)(x − 3)" } ], diagnoses: { "x² + 5x + 6->(x + 3)(x + 4)": "Middle 5 → 2 + 3.", "x² − 5x + 6->(x + 2)(x + 3)": "Negative middle, positive 6 → both negative.", "x² + 7x + 12->(x + 2)(x + 3)": "Middle 7 → 3 + 4." }, explanation: "Pairs: 2+3=5, 3+4=7, −2−3=−5.", hints: ["Match middle sum.", "Match constants.", "Pairs: 2+3=5, 3+4=7, −2−3=−5."] },
      // @q15
      { id: "U12L4-graph-1", type: "graph-interact", category: "word", prompt: "For x² + 8x + 12, set the slider to the SMALLER of the two bracket numbers (key: value).", challenge: "For x² + 8x + 12, — adjust the values below to match the condition.", validate: { value: 2 }, tolerance: 0, explanation: "Pairs of 12: 2 and 6 add to 8 → (x + 2)(x + 6).", hints: ["Pairs of 12.", "2 + 6 = 8.", "Pairs of 12: 2 and 6 add to 8 → (x + 2)(x + 6)."] }
    ],
