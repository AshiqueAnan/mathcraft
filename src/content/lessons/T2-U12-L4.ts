...
export const T2U12L4: Lesson = {
  ...
  quiz: {
    pool: [
      ...
      // @q06
      { id: "U12L4-mcq-6", type: "mcq", category: "word", prompt: "A photo's area is x² + 8x + 15 cm². Find its factored sides.", options: [ { id: "a", text: "(x + 1)(x + 15)" }, { id: "b", text: "(x + 3)(x + 5)" }, { id: "c", text: "(x + 2)(x + 7)" }, { id: "d", text: "(x + 4)(x + 11)" } ], correctOptionId: "b", diagnoses: { a: "1 + 15 = 16, not 8.", c: "2 + 7 = 9, not 8.", d: "4 + 11 = 15, not 8." }, explanation: "Pair of 15 adding to 8: 3 and 5 → (x + 3)(x + 5).", hints: ["Pairs of 15.", "Sum to 8.", "3 and 5."] },
      // @q07
