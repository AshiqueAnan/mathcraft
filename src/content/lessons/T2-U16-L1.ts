...
export const T2U16L1: Lesson = {
  ...
  quiz: {
    pool: [
      ...
      // @q03
      { id: "U16L1-mcq-3", type: "mcq", category: "word", prompt: "Ride requires height ≥ 120 cm. Who CAN ride?", options: [ { id: "a", text: "Cal, 115 cm" }, { id: "b", text: "Ben, 119.5 cm" }, { id: "c", text: "Aisha, 131 cm" }, { id: "d", text: "Dana, 99 cm" } ], correctOptionId: "c", diagnoses: { b: "119.5 < 120 — below the boundary.", a: "115 < 120.", d: "99 < 120." }, explanation: "131 ≥ 120 qualifies; the rest are below.", hints: ["Compare to 120.", "131 passes.", "Aisha."] },
      // @q04
