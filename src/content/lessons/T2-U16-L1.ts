...
export const T2U16L1: Lesson = {
  ...
  quiz: {
    pool: [
      // @q01
      { id: "U16L1-mcq-1", type: "mcq", category: "procedural", prompt: "x ≥ 3 on a number line uses…", options: [ { id: "a", text: "a closed dot at 3 and a ray to the right" }, { id: "b", text: "an open dot at 3 and a ray to the right" }, { id: "c", text: "a closed dot at 3 and a ray to the left" }, { id: "d", text: "two rays from 3" } ], correctOptionId: "a", diagnoses: { b: "Open dot means >, not ≥.", c: "Ray direction: ≥ goes right (bigger).", d: "One ray only — a single boundary." }, explanation: "≥ includes 3 (closed dot) and everything greater (ray right).", hints: ["≥ means 'or equal'.", "Closed dot.", "Ray right."] },
      // @q02
      { id: "U16L1-mcq-2", type: "mcq", category: "conceptual", prompt: "What's the difference between an open and a closed dot?", options: [ { id: "a", text: "Closed includes the boundary value; open excludes it" }, { id: "b", text: "Open includes it; closed doesn't" }, { id: "c", text: "They mean the same thing" }, { id: "d", text: "Closed means 'end of the line'" } ], correctOptionId: "a", diagnoses: { b: "Reversed — closed includes.", c: "They encode ≤ vs <, a real difference.", d: "Dots are about inclusion, not endings." }, explanation: "Closed = the boundary is in the range; open = it's just outside.", hints: ["Thinks of ≥ vs >.", "Closed = included.", "Open = excluded."] },
      // @q03
      { id: "U16L1-mcq-3", type: "mcq", category: "word", prompt: "Ride requires height ≥ 120 cm. Who CAN ride?", options: [ { id: "a", text: "Aisha, 131 cm" }, { id: "b", text: "Ben, 119.5 cm" }, { id: "c", text: "Cal, 115 cm" }, { id: "d", text: "Dana, 99 cm" } ], correctOptionId: "a", diagnoses: { b: "119.5 < 120 — below the boundary.", c: "115 < 120.", d: "99 < 120." }, explanation: "131 ≥ 120 qualifies; the rest are below.", hints: ["Compare to 120.", "131 passes.", "Aisha."] },
      // @q04
      { id: "U16L1-mcq-4", type: "mcq", category: "procedural", prompt: "x < 2 is drawn as…", options: [ { id: "a", text: "an open dot at 2, ray to the left" }, { id: "b", text: "a closed dot at 2, ray to the left" }, { id: "c", text: "an open dot at 2, ray to the right" }, { id: "d", text: "a closed dot at 2, ray to the right" } ], correctOptionId: "a", diagnoses: { b: "Closed dot would include 2 — but x < 2 doesn't.", c: "Ray left for smaller values.", d: "Both dot and direction are wrong." }, explanation: "< excludes 2 (open dot) and shades everything smaller (left).", hints: ["< means 'less than'.", "2 NOT included → open.", "Ray left."] },
      // @q05
      { id: "U16L1-mcq-5", type: "mcq", category: "conceptual", prompt: "Why is an inequality a RANGE, not a single answer?", options: [ { id: "a", text: "The boundary splits the line into a whole half-line of valid values" }, { id: "b", text: "Every inequality has exactly one solution" }, { id: "c", text: "Ranges are only for temperatures" }, { id: "d", text: "It has two answers, one left and one right" } ], correctOptionId: "a", diagnoses: { b: "x > 5 has infinitely many solutions, not one.", c: "Ranges apply everywhere, not just temperature.", d: "One ray, not one answer on each side." }, explanation: "One boundary → one ray: infinitely many values all valid.", hints: ["Slide along the line.", "Many values work.", "A whole ray."] },
      // @q06
      { id: "U16L1-mcq-6", type: "mcq", category: "word", prompt: "Oven must stay under 220°C: t < 220. Which is safe?", options: [ { id: "a", text: "219.8°C" }, { id: "b", text: "220°C" }, { id: "c", text: "220.5°C" }, { id: "d", text: "221°C" } ], correctOptionId: "a", diagnoses: { b: "220 is NOT less than 220 — excluded by the open boundary.", c: "220.5 > 220.", d: "221 > 220." }, explanation: "t < 220 keeps 219.8 safe and excludes exactly 220.", hints: ["Barely under 220.", "219.8 passes.", "219.8°C."] },
      // @q07
      { id: "U16L1-num-1", type: "numeric-input", category: "procedural", prompt: "x > 5. Type the SMALLEST whole number that satisfies it.", answer: 6, tolerance: 0, explanation: "5 itself is excluded, so 6 is the first whole number.", hints: ["More than 5.", "Not 5.", "6."] },
      // @q08
      { id: "U16L1-num-2", type: "numeric-input", category: "procedural", prompt: "x ≤ 4. Type the LARGEST whole number that satisfies it.", answer: 4, tolerance: 0, explanation: "≤ includes 4, so 4 itself is the largest.", hints: ["≤ means 'or equal'.", "4 included.", "4."] },
      // @q09
      { id: "U16L1-num-3", type: "numeric-input", category: "conceptual", prompt: "Ride limit: h ≥ 120. Type the smallest height (cm) allowed.", answer: 120, tolerance: 0, explanation: "≥ includes exactly 120.", hints: ["Boundary value.", "120 included.", "120."] },
      // @q10
      { id: "U16L1-frac-1", type: "fraction-input", category: "conceptual", prompt: "x > 1/2. Write a fraction just above the boundary that satisfies it.", numerator: 3, denominator: 4, acceptEquivalent: true, explanation: "3/4 > 1/2 — any value in the open range works.", hints: ["Bigger than 1/2.", "3/4 works.", "3/4."] },
      // @q11
      { id: "U16L1-tf-1", type: "true-false-justify", category: "conceptual", prompt: "x > 4 includes 4.", isTrue: false, explanation: "Strict 'greater than' excludes exactly 4 — that's what the open dot shows.", hints: ["> is strict.", "4 not included.", "False."] },
      // @q12
      ...
      // @q15
      { id: "U16L1-graph-1", type: "graph-interact", category: "word", prompt: "The ride boundary is at 120 cm. Set the slider to the smallest height that satisfies h ≥ 120 (key: value).", challenge: "Set the slider to 120.", validate: { value: 120 }, tolerance: 0.01, explanation: "≥ includes 120 — the closed boundary.", hints: ["Boundary value.", "120 included.", "120."] }
    ],
