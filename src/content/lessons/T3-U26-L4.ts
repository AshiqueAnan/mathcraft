...
export const T3U26L4: Lesson = {
  ...
  intuitionBlocks: [{ widget: "geometry-playground", props: { mode: "trig" }, narrative: "Inspect the half-equilateral: sides 2, 1, √3 give sin 30° = ½, cos 30° = √3/2, tan 30° = 1/√3. The half-square 1-1-√2 gives the 45° values. Drag the special triangles and the exact ratios stay locked — only the scale changes." }],
