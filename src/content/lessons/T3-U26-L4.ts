...
export const T3U26L4: Lesson = {
  ...
  quiz: {
    pool: [
      // @q01
      { id: "U26L4-mcq-1", type: "mcq", category: "procedural", prompt: "sin 30° = …", options: [ { id: "a", text: "1/2" }, { id: "b", text: "√3/2" }, { id: "c", text: "√2/2" }, { id: "d", text: "1/√3" } ], correctOptionId: "a", diagnoses: { b: "√3/2 is cos 30° (or sin 60°).", c: "√2/2 is for 45°.", d: "1/√3 is tan 30°." }, explanation: "Half-equilateral: opposite 1 over hypotenuse 2.", hints: ["1 over 2.", "1/2.", "1/2."] },
      // @q02
      { id: "U26L4-mcq-2", type: "mcq", category: "conceptual", prompt: "Where does tan 45° = 1 come from?", options: [ { id: "a", text: "The 45-45-90 triangle has equal legs" }, { id: "b", text: "The hypotenuse is 1" }, { id: "c", text: "sin 45° is larger than cos 45°" }, { id: "d", text: "45° is half of 90°" } ], correctOptionId: "a", diagnoses: { b: "Legs being equal is the reason, not the hypotenuse's length.", c: "sin 45° = cos 45°, so their quotient is 1.", d: "Halving an angle isn't the ratio's source." }, explanation: "Half a square: both legs are the same length → opposite/adjacent = 1.", hints: ["Equal legs.", "Ratio 1.", "Equal legs."] },
      // @q03
      { id: "U26L4-mcq-3", type: "mcq", category: "word", prompt: "A 30° ramp has a 2 m hypotenuse. Its height (sin 30° = ½) is…", options: [ { id: "a", text: "1 m" }, { id: "b", text: "2 m" }, { id: "c", text: "√3 m ≈ 1.73 m" }, { id: "d", text: "0.5 m" } ], correctOptionId: "a", diagnoses: { b: "2 m is the hypotenuse.", c: "√3 is the adjacent for a side-2 hypotenuse.", d: "0.5 is the ratio, not the height." }, explanation: "height = sin 30° × 2 = ½ × 2 = 1 m.", hints: ["½ × 2.", "1 m.", "1 m."] },
      // @q04
      { id: "U26L4-mcq-4", type: "mcq", category: "procedural", prompt: "cos 60° = …", options: [ { id: "a", text: "1/2" }, { id: "b", text: "√3/2" }, { id: "c", text: "√3" }, { id: "d", text: "1/√3" } ], correctOptionId: "a", diagnoses: { b: "√3/2 is sin 60° (or cos 30°).", c: "√3 is tan 60°.", d: "1/√3 is tan 30°." }, explanation: "In a 30-60-90, the side adjacent to 60° (the short leg) is 1 over hypotenuse 2.", hints: ["Short leg over 2.", "1/2.", "1/2."] },
      // @q05
      ...
      // @q06
      { id: "U26L4-mcq-6", type: "mcq", category: "word", prompt: "A 60° ramp, hypotenuse 4 m. It rises (sin 60° = √3/2) by…", options: [ { id: "a", text: "2√3 m ≈ 3.46 m" }, { id: "b", text: "2 m" }, { id: "c", text: "4√3 m" }, { id: "d", text: "√3 m ≈ 1.73 m" } ], correctOptionId: "a", diagnoses: { b: "2 m is for sin 30° with this hypotenuse.", c: "4√3 uses the hypotenuse as the ratio — inverted.", d: "√3 is for hypotenuse 2, not 4." }, explanation: "height = sin 60° × 4 = (√3/2) × 4 = 2√3 ≈ 3.46 m.", hints: ["√3/2 × 4.", "2√3.", "≈ 3.46 m."] },
      // @q07
      { id: "U26L4-num-1", type: "numeric-input", category: "procedural", prompt: "cos 30° = √3/2 ≈ 0.866. With hypotenuse 10, the adjacent side is about…", answer: 8.66, tolerance: 0.1, explanation: "adjacent = cos 30° × 10 ≈ 8.66.", hints: ["0.866 × 10.", "≈ 8.66.", "8.66."] },
      // @q08
      { id: "U26L4-num-2", type: "numeric-input", category: "procedural", prompt: "tan 60° = √3 ≈ 1.732. Opposite = √3 × adjacent; if adjacent = 5, opposite ≈ …", answer: 8.66, tolerance: 0.1, explanation: "opposite = √3 × 5 ≈ 8.66.", hints: ["1.732 × 5.", "≈ 8.66.", "8.66."] },
      // @q09
      { id: "U26L4-num-3", type: "numeric-input", category: "conceptual", prompt: "A 45-45-90 triangle has hypotenuse 4. Each leg = 4/√2 ≈ …", answer: 2.83, tolerance: 0.1, explanation: "leg = hyp/√2 = 4/1.414 ≈ 2.83.", hints: ["4 ÷ √2.", "≈ 2.83.", "2.83."] },
      // @q10
      { id: "U26L4-frac-1", type: "fraction-input", category: "conceptual", prompt: "In a 30-60-90 triangle (sides 2, 1, √3), what fraction of the hypotenuse is the short leg?", numerator: 1, denominator: 2, acceptEquivalent: true, explanation: "Short leg 1 over hypotenuse 2 → 1/2 (that's sin 30°).", hints: ["1 ÷ 2.", "1/2.", "1/2."] },
      // @q11
      { id: "U26L4-tf-1", type: "true-false-justify", category: "conceptual", prompt: "sin 30° = cos 60° = 1/2.", isTrue: true, explanation: "The short leg is opposite 30° AND adjacent to 60° — both ratios give 1/2.", hints: ["Same leg, two labels.", "Both = 1/2.", "True."] },
      // @q12
      { id: "U26L4-tf-2", type: "true-false-justify", category: "conceptual", prompt: "tan 45° = 0.707.", isTrue: false, explanation: "tan 45° = 1; 0.707 is sin/cos 45°.", hints: ["Equal legs.", "tan 45° = 1.", "False."] },
      // @q13
      { id: "U26L4-order-1", type: "order-steps", category: "word", prompt: "Order the steps to derive sin 30° from an equilateral triangle of side 2.", sequence: ["Halve it: sides 2, 1, √3", "Label the 30° angle", "sin 30° = opposite/hypotenuse = 1/2"], diagnoses: { "Halve it: sides 2, 1, √3@1": "Halve the triangle first.", "Label the 30° angle@0": "Then find the 30° corner.", "sin 30° = opposite/hypotenuse = 1/2@0": "Read the ratio last." }, explanation: "Halve the equilateral, label, read the ratio.", hints: ["2, 1, √3.", "30° at one end.", "1/2."] },
      // @q14
      { id: "U26L4-drag-1", type: "drag-match", category: "conceptual", prompt: "Match each angle to its exact sine.", pairs: [ { source: "30°", target: "1/2" }, { source: "45°", target: "√2/2" }, { source: "60°", target: "√3/2" } ], diagnoses: { "30°->√2/2": "30° sine is 1/2.", "45°->√3/2": "45° sine is √2/2.", "60°->1/2": "60° sine is √3/2." }, explanation: "Each special angle owns its exact fraction.", hints: ["30 → 1/2.", "45 → √2/2.", "60 → √3/2."] },
      // @q15
      { id: "U26L4-graph-1", type: "graph-interact", category: "word", prompt: "sin 30° = 1/2 with hypotenuse 6. Set the slider to the OPPOSITE side (key: value).", challenge: "Set the slider to 3.", validate: { value: 3 }, tolerance: 0.01, explanation: "opposite = ½ × 6 = 3.", hints: ["½ × 6.", "3.", "3."] }
    ],
