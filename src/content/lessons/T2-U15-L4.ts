...
export const T2U15L4: Lesson = {
  ...
  quiz: {
    pool: [
      ...
      // @q03
      { id: "U15L4-mcq-3", type: "mcq", category: "word", prompt: "A rocket: 5t² − 20t + 15 = 0 (height 0 when it lands). Using the formula, when does it land?", options: [ { id: "a", text: "t = 5 and t = 15" }, { id: "b", text: "t = 2 only" }, { id: "c", text: "t = 1 and t = 3" }, { id: "d", text: "t = −1 and t = −3" } ], correctOptionId: "c", diagnoses: { b: "t = 2 is the vertex time, not a root.", a: "5 and 15 are a and c, not roots.", d: "Times can't be negative here." }, explanation: "x = (20 ± √(400 − 300))/10 = (20 ± 10)/10 → t = 3 or 1.", hints: ["a=5, b=−20, c=15.", "Discriminant = 100.", "t = 1 or 3."] },
      // @q04
      { id: "U15L4-mcq-4", type: "mcq", category: "procedural", prompt: "x² + 2x + 2 = 0. What is b² − 4ac?", options: [ { id: "a", text: "−8" }, { id: "b", text: "4" }, { id: "c", text: "0" }, { id: "d", text: "−4" } ], correctOptionId: "d", diagnoses: { b: "4 is just b² — you forgot −4ac.", c: "0 would mean one root; this has none.", a: "−8 is 2² − 4·1·2? 4 − 8 = −4." }, explanation: "4 − 4(1)(2) = 4 − 8 = −4.", hints: ["b² − 4ac.", "4 − 8.", "−4."] },
      // @q05
