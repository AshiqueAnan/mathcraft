...
export const T2U15L4: Lesson = {
  ...
  quiz: {
    pool: [
      ...
      // @q02
      { id: "U15L4-mcq-2", type: "mcq", category: "conceptual", prompt: "What does the discriminant tell you?", options: [ { id: "a", text: "How many real solutions exist" }, { id: "b", text: "The size of c" }, { id: "c", text: "Where the vertex is" }, { id: "d", text: "The slope at the vertex" } ], correctOptionId: "a", diagnoses: { b: "c is already visible in the equation.", c: "The vertex uses −b/2a, not the discriminant.", d: "Slopes aren't the discriminant's job." }, explanation: "b² − 4ac > 0 → two real; = 0 → one; < 0 → none (real).", hints: ["Look at b² − 4ac.", "Positive, zero, negative.", "Counts real roots."] },
      // @q03
      { id: "U15L4-mcq-3", type: "mcq", category: "word", prompt: "A rocket: 5t² − 20t + 15 = 0 (height 0 when it lands). Using the formula, when does it land?", options: [ { id: "a", text: "t = 1 and t = 3" }, { id: "b", text: "t = 2 only" }, { id: "c", text: "t = 5 and t = 15" }, { id: "d", text: "t = −1 and t = −3" } ], correctOptionId: "a", diagnoses: { b: "t = 2 is the vertex time, not a root.", c: "5 and 15 are a and c, not roots.", d: "Times can't be negative here." }, explanation: "x = (20 ± √(400 − 300))/10 = (20 ± 10)/10 → t = 3 or 1.", hints: ["a=5, b=−20, c=15.", "Discriminant = 100.", "t = 1 or 3."] },
      // @q04
      { id: "U15L4-mcq-4", type: "mcq", category: "procedural", prompt: "x² + 2x + 2 = 0. What is b² − 4ac?", options: [ { id: "a", text: "−4" }, { id: "b", text: "4" }, { id: "c", text: "0" }, { id: "d", text: "−8" } ], correctOptionId: "a", diagnoses: { b: "4 is just b² — you forgot −4ac.", c: "0 would mean one root; this has none.", d: "−8 is 2² − 4·1·2? 4 − 8 = −4." }, explanation: "4 − 4(1)(2) = 4 − 8 = −4.", hints: ["b² − 4ac.", "4 − 8.", "−4."] },
      // @q05
      { id: "U15L4-mcq-5", type: "mcq", category: "conceptual", prompt: "When the discriminant is negative, the parabola…", options: [ { id: "a", text: "never crosses the x-axis" }, { id: "b", text: "crosses twice" }, { id: "c", text: "touches once" }, { id: "d", text: "is a straight line" } ], correctOptionId: "a", diagnoses: { b: "Two crossings need a positive discriminant.", c: "One touch means discriminant = 0.", d: "It's still a parabola — just above/below the axis." }, explanation: "No real roots → no x-axis meeting.", hints: ["Negative discriminant.", "No real roots.", "No crossing."] },
      // @q06
      { id: "U15L4-mcq-6", type: "mcq", category: "word", prompt: "A ball's path: −2t² + 4t + 6 = 0. What does the formula's larger root mean?", options: [ { id: "a", text: "When it lands — the time it returns to height 0" }, { id: "b", text: "When it's highest" }, { id: "c", text: "When it was thrown" }, { id: "d", text: "How far it travels sideways" } ], correctOptionId: "a", diagnoses: { b: "The peak is the vertex, not a root.", c: "The throw is the smaller root (t = −1, behind you).", d: "Roots are times, not distances." }, explanation: "t = (−4 ± √(16 + 48))/(−4) = (−4 ± 8)/(−4) → t = 3 landing, t = −1 throw time.", hints: ["Roots are where height = 0.", "Larger root = later time.", "t = 3."] },
      // @q07
      { id: "U15L4-num-1", type: "numeric-input", category: "procedural", prompt: "x² − 5x + 6 = 0. Using the formula, type the SMALLER solution.", answer: 2, tolerance: 0, explanation: "x = (5 ± 1)/2 → 3 or 2.", hints: ["a=1, b=−5, c=6.", "Discriminant = 1.", "x = 2 or 3."] },
      // @q08
      { id: "U15L4-num-2", type: "numeric-input", category: "procedural", prompt: "x² − 5x + 6 = 0. Using the formula, type the LARGER solution.", answer: 3, tolerance: 0, explanation: "(5 + 1)/2 = 3.", hints: ["Use the + sign.", "(5 + 1)/2.", "3."] },
      // @q09
      { id: "U15L4-num-3", type: "numeric-input", category: "conceptual", prompt: "x² + 4x + 4 = 0. The discriminant is 0 — type the single solution.", answer: -2, tolerance: 0, explanation: "x = (−4 ± 0)/2 = −2.", hints: ["b = 4, a = 1.", "x = −4/2.", "−2."] },
      // @q10
      { id: "U15L4-frac-1", type: "fraction-input", category: "conceptual", prompt: "2x² + 3x + 1 = 0. Write one root as a fraction.", numerator: -1, denominator: 2, acceptEquivalent: true, explanation: "x = (−3 ± 1)/4 → −1/2 or −1.", hints: ["a=2, b=3, c=1.", "Discriminant = 1.", "x = −1/2."] },
      // @q11
      { id: "U15L4-tf-1", type: "true-false-justify", category: "conceptual", prompt: "The quadratic formula solves ANY quadratic equation, even ones that don't factor.", isTrue: true, explanation: "It's derived from completing the square — universal for ax² + bx + c = 0.", hints: ["Works for all a, b, c.", "Derived generally.", "True."] },
      // @q12
      { id: "U15L4-tf-2", type: "true-false-justify", category: "conceptual", prompt: "If the discriminant is negative, the equation has no solutions at all.", isTrue: false, explanation: "It has no REAL solutions — two complex ones exist (using √ of a negative).", hints: ["No real roots.", "Complex roots exist.", "False."] },
      // @q13
      { id: "U15L4-order-1", type: "order-steps", category: "word", prompt: "Order the steps to solve x² − 5x + 6 = 0 with the formula.", sequence: ["Identify a=1, b=−5, c=6", "Compute b² − 4ac = 1", "Apply x = (−b ± √(b²−4ac))/2a", "Simplify: x = 3 or x = 2"], diagnoses: { "Identify a=1, b=−5, c=6@1": "Identify coefficients first.", "Apply x = (−b ± √(b²−4ac))/2a@0": "Compute the discriminant before applying.", "Simplify: x = 3 or x = 2@0": "Simplify at the end." }, explanation: "Identify, discriminate, substitute, simplify.", hints: ["Read off a, b, c.", "Discriminant next.", "Then simplify."] },
      // @q14
      ...
      // @q15
      { id: "U15L4-graph-1", type: "graph-interact", category: "word", prompt: "y = x² − 5x + 6 crosses the x-axis at 2 and 3. Set the slider to the LARGER crossing (key: value).", challenge: "Set the slider to 3.", validate: { value: 3 }, tolerance: 0.01, explanation: "(5 + 1)/2 = 3.", hints: ["Formula gives 2 or 3.", "Larger is 3.", "3."] }
    ],
