...
export const T2U16L3: Lesson = {
  ...
  quiz: {
    pool: [
      // @q01
      { id: "U16L3-mcq-1", type: "mcq", category: "procedural", prompt: "2 ≤ x < 6. Which whole numbers satisfy it?", options: [ { id: "a", text: "2, 3, 4, 5" }, { id: "b", text: "3, 4, 5" }, { id: "c", text: "2, 3, 4, 5, 6" }, { id: "d", text: "1, 2, 3, 4, 5" } ], correctOptionId: "a", diagnoses: { b: "2 is included (≤).", c: "6 is EXCLUDED (< 6).", d: "1 is below the closed boundary." }, explanation: "≤ includes 2, < excludes 6 → 2, 3, 4, 5.", hints: ["Left: ≤ includes 2.", "Right: < excludes 6.", "2, 3, 4, 5."] },
      // @q02
      { id: "U16L3-mcq-2", type: "mcq", category: "conceptual", prompt: "What makes an integer-solutions problem different from a plain inequality?", options: [ { id: "a", text: "You list discrete whole numbers instead of shading a whole ray" }, { id: "b", text: "You ignore the inequality symbol" }, { id: "c", text: "Only negative numbers count" }, { id: "d", text: "You always round up" } ], correctOptionId: "a", diagnoses: { b: "The symbol still chooses which integers count.", c: "Positive and negative integers both count.", d: "Rounding isn't the rule — boundaries decide." }, explanation: "The ray stays, but you collect only the integer tick marks on it.", hints: ["Tick marks only.", "Whole numbers.", "Discrete list."] },
      // @q03
      { id: "U16L3-mcq-3", type: "mcq", category: "word", prompt: "A lift takes at least 8 people and at most 12: 8 ≤ x ≤ 12. How many people can ride?", options: [ { id: "a", text: "8, 9, 10, 11, or 12" }, { id: "b", text: "9, 10, 11" }, { id: "c", text: "8 only" }, { id: "d", text: "9 to 13" } ], correctOptionId: "a", diagnoses: { b: "Both 8 and 12 are included (≤ on both sides).", c: "Only one person count? The range is wider.", d: "13 exceeds 12." }, explanation: "Both bounds closed → integers 8 through 12.", hints: ["≤ includes 8.", "≤ includes 12.", "8–12."] },
      // @q04
      { id: "U16L3-mcq-4", type: "mcq", category: "procedural", prompt: "x > 3.5. What is the SMALLEST integer satisfying it?", options: [ { id: "a", text: "4" }, { id: "b", text: "3" }, { id: "c", text: "3.5" }, { id: "d", text: "5" } ], correctOptionId: "a", diagnoses: { b: "3 is less than 3.5.", c: "3.5 isn't an integer.", d: "4 is the first integer above 3.5 — 5 skips it." }, explanation: "The first whole number strictly above 3.5 is 4.", hints: ["Above 3.5.", "First whole number.", "4."] },
      // @q05
      { id: "U16L3-mcq-5", type: "mcq", category: "conceptual", prompt: "Which of these includes 5 as an integer solution?", options: [ { id: "a", text: "x ≤ 5" }, { id: "b", text: "x < 5" }, { id: "c", text: "5 < x" }, { id: "d", text: "x > 5" } ], correctOptionId: "a", diagnoses: { b: "< 5 excludes exactly 5.", c: "'5 less than x' means x > 5, excluding 5.", d: "x > 5 excludes 5." }, explanation: "Only ≤ (or ≥) includes its boundary value.", hints: ["Boundary included?", "'or equal'.", "x ≤ 5."] },
      // @q06
      { id: "U16L3-mcq-6", type: "mcq", category: "word", prompt: "Pencils: fewer than 20, at least 15: 15 ≤ p < 20. How many pencils can you buy?", options: [ { id: "a", text: "15, 16, 17, 18, or 19" }, { id: "b", text: "15 to 20" }, { id: "c", text: "16 to 19" }, { id: "d", text: "14 to 19" } ], correctOptionId: "a", diagnoses: { b: "20 is excluded by '< 20'.", c: "15 is included by '≥ 15'.", d: "14 is below the closed boundary." }, explanation: "15 ≤ p < 20 → 15 through 19 inclusive.", hints: ["≥ 15 includes 15.", "< 20 excludes 20.", "15–19."] },
      // @q07
      { id: "U16L3-num-1", type: "numeric-input", category: "procedural", prompt: "x > 4.5. Type the SMALLEST integer that satisfies it.", answer: 5, tolerance: 0, explanation: "First whole number strictly above 4.5 is 5.", hints: ["Above 4.5.", "Next whole number.", "5."] },
      // @q08
      { id: "U16L3-num-2", type: "numeric-input", category: "procedural", prompt: "x < 8. Type the LARGEST integer that satisfies it.", answer: 7, tolerance: 0, explanation: "8 excluded, so 7 is the largest.", hints: ["< 8 excludes 8.", "7.", "7."] },
      // @q09
      { id: "U16L3-num-3", type: "numeric-input", category: "conceptual", prompt: "5 ≤ x < 9. Type the number of integers in the solution set.", answer: 4, tolerance: 0, explanation: "5, 6, 7, 8 → four integers.", hints: ["List 5–8.", "Count them.", "4."] },
      // @q10
      { id: "U16L3-frac-1", type: "fraction-input", category: "conceptual", prompt: "x ≥ 1/2. Write the SMALLEST integer that satisfies it as a fraction.", numerator: 1, denominator: 1, acceptEquivalent: true, explanation: "1 is the smallest integer ≥ 1/2.", hints: ["≥ 1/2 means 1, 2, 3…", "The boundary itself isn't an integer.", "1."] },
      // @q11
      { id: "U16L3-tf-1", type: "true-false-justify", category: "conceptual", prompt: "x ≤ 4 has integer solutions 4, 3, 2, 1, 0, −1, …", isTrue: true, explanation: "≤ includes 4 and everything below, including all integers.", hints: ["Closed boundary.", "All integers below.", "True."] },
      // @q12
      { id: "U16L3-tf-2", type: "true-false-justify", category: "conceptual", prompt: "x < 4 and x ≤ 4 have the same integer solutions.", isTrue: false, explanation: "x < 4 excludes 4; x ≤ 4 includes it — different sets.", hints: ["4 included?", "< no, ≤ yes.", "False."] },
      // @q13
      ...
      // @q15
      { id: "U16L3-graph-1", type: "graph-interact", category: "word", prompt: "The lift allows 8 ≤ x ≤ 12. Set the slider to the LARGEST allowed integer (key: value).", challenge: "Set the slider to 12.", validate: { value: 12 }, tolerance: 0.01, explanation: "12 is included by ≤ — the largest allowed.", hints: ["≤ includes 12.", "Largest is 12.", "12."] }
    ],
