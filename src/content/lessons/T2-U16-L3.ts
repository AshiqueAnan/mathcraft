...
export const T2U16L3: Lesson = {
  ...
  quiz: {
    pool: [
      ...
      // @q04
      { id: "U16L3-mcq-4", type: "mcq", category: "procedural", prompt: "x > 3.5. What is the SMALLEST integer satisfying it?", options: [ { id: "a", text: "5" }, { id: "b", text: "3" }, { id: "c", text: "3.5" }, { id: "d", text: "4" } ], correctOptionId: "d", diagnoses: { b: "3 is less than 3.5.", c: "3.5 isn't an integer.", a: "4 is the first integer above 3.5 — 5 skips it." }, explanation: "The first whole number strictly above 3.5 is 4.", hints: ["Above 3.5.", "First whole number.", "4."] },
      // @q05
