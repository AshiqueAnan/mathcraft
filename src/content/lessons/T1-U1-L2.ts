    ...
    pool: [
      {
        ...
        hints: ["Smallest = furthest left on the number line.", "Which is further left: −4 or −1?", "Lowest means furthest LEFT: −4 is left of −1, 0, and 3."],
      },
      {
        id: "U1L2-mcq-2", type: "mcq", category: "conceptual",
        prompt: "At midnight it was −6°C. By noon it was 4°C. How many degrees did it rise?",
        options: [{ id: "a", text: "2" }, { id: "b", text: "10" }, { id: "c", text: "6" }, { id: "d", text: "−10" }],
        correctOptionId: "b",
        diagnoses: { a: "2 is 4 − 6, but you can't just subtract — you cross zero.", c: "6 only counts the below-zero part.", d: "It rose, so the change is positive." },
        explanation: "From −6 to 0 is 6 degrees, then 0 to 4 is 4 more: 10 degrees total.",
        hints: ["Count from −6 up to 0.", "Then from 0 up to 4.", "From −6 to 0 is 6 degrees, then 0 to 4 is 4 more: 10 degrees total."],
      },
      {
        ...
        options: [{ id: "a", text: "80 m" }, { id: "b", text: "−80 m" }, { id: "c", text: "−160 m" }, { id: "d", text: "160 m" }],
        correctOptionId: "c",
        diagnoses: { b: "You subtracted; diving deeper ADDS distance below.", a: "Sign error — below sea level is negative.", d: "Right size, wrong sign — below is negative." },
      ...
      },
      {
        ...
        options: [{ id: "a", text: "False — they are equal" }, { id: "b", text: "True — 7 is bigger than 2" }, { id: "c", text: "True — minus makes everything equal" }, { id: "d", text: "False — −7 is further left, so smaller" }],
        correctOptionId: "d",
        diagnoses: { b: "For positives 7 > 2 works, but the minus flips it.", c: "The minus doesn't make them equal.", a: "Different sizes entirely." },
      ...
      },
      {
        ...
        hints: ["Start at −3.", "Move 4 more left.", "Both moves go left: 3 below zero, then 4 more below = 7 below zero."],
      },
      {
        id: "U1L2-mcq-6", type: "mcq", category: "word",
        prompt: "A bank balance is −$50. You deposit $80. What is the new balance?",
        options: [{ id: "a", text: "$130" }, { id: "b", text: "$30" }, { id: "c", text: "−$30" }, { id: "d", text: "−$130" }],
        correctOptionId: "b",
        diagnoses: { a: "Deposits fill the hole first; you double counted.", c: "The deposit was bigger than the debt, so you're out of the hole.", d: "Sign wrong — depositing moves you UP." },
        explanation: "−50 + 80 = 30: the $80 fills the $50 hole and leaves $30.",
        hints: ["From −50, count up 80.", "−50 + 50 = 0, then 30 more.", "−50 + 80 = 30: the $80 fills the $50 hole and leaves $30."],
      },
      {
        ...
        hints: ["5 minus 5 is 0.", "Four more to remove.", "From 5, move 9 left: 0 after 5 steps, then 4 more below = −4."],
      },
      {
        ...
        hints: ["What adds to −6 to reach −1?", "−6 + 5 = −1.", "From −6, moving right 5 lands on −1."],
      },
      {
        ...
        hints: ["Crossing zero adds the parts.", "5 + 12.", "From −5 to 0 is 5, then 0 to 12 is 12: 17 degrees."],
      },
      {
        ...
        hints: ["8 down to 0 is 8 floors.", "4 more floors below.", "8 − 12 = −4: four floors below ground level."],
      },
      {
        ...
        hints: ["Halfway between 0 and 1 is 1/2.", "Below zero it's the same size, negative.", "Halfway below zero between −1 and 0 is −1/2; the fraction's size is 1/2."],
      },
      {
        ...
        hints: ["Left means smaller.", "−10 is left of −2.", "−10 is further left on the number line, so it is smaller."],
      },
      {
      ...
      },
      {
        ...
        challenge: "Move the point to minus three . — adjust the values below to match the condition.",
        validate: { value: -3 }, tolerance: 0,
        explanation: "−3 is three steps left of zero.",
        hints: ["Left of zero.", "Three steps left.", "−3 is three steps left of zero."],
      },
    ],
