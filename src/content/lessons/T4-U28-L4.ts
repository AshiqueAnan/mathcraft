...
export const T4U28L4: Lesson = {
  ...
  quiz: {
    pool: [
      ...
      // @q02
      { id: "U28L4-mcq-2", type: "mcq", category: "conceptual", prompt: "Ice cream sales and drownings both spike in summer. The link is explained by the CONFOUNDER…", options: [ { id: "a", text: "summer weather drives both" }, { id: "b", text: "ice cream makes people drown" }, { id: "c", text: "drowning raises sales" }, { id: "d", text: "no link exists at all" } ], correctOptionId: "a", diagnoses: { b: "There's no causal mechanism.", c: "Drownings don't sell ice cream.", d: "They DO co-vary — but not causally." }, explanation: "Both rise with temperature — summer is the third variable.", hints: ["Third variable.", "Summer.", "Confounder."] },
      // @q03
      { id: "U28L4-mcq-3", type: "mcq", category: "word", prompt: "Studying more correlates with higher scores. A safe statement is…", options: [ { id: "a", text: "they're positively correlated" }, { id: "b", text: "studying always causes success" }, { id: "c", text: "no relationship exists" }, { id: "d", text: "scores cause studying" } ], correctOptionId: "a", diagnoses: { b: "Causation needs more than a correlation.", c: "There IS a visible trend.", d: "Direction isn't proven by correlation." }, explanation: "Correlation reports the co-movement — not the cause.", hints: ["Co-move only.", "Not causation.", "Correlation."] },
      // @q04
      { id: "U28L4-mcq-4", type: "mcq", category: "procedural", prompt: "Dots trend DOWN-RIGHT: temperature (x) vs hot-drink sales (y). This is…", options: [ { id: "a", text: "negative correlation" }, { id: "b", text: "positive correlation" }, { id: "c", text: "no correlation" }, { id: "d", text: "a perfect line" } ], correctOptionId: "a", diagnoses: { b: "Down-right is negative.", c: "There's a clear downward trend.", d: "Trend direction, not perfection." }, explanation: "Hotter outside → fewer hot drinks: inverse relationship.", hints: ["Down-right.", "Negative.", "Negative correlation."] },
      // @q05
      ...
      // @q06
      { id: "U28L4-mcq-6", type: "mcq", category: "word", prompt: "Shoe size and reading skill rise together in kids. The confounder is…", options: [ { id: "a", text: "age — both grow with time" }, { id: "b", text: "bigger feet improve reading" }, { id: "c", text: "reading grows feet" }, { id: "d", text: "random chance forever" } ], correctOptionId: "a", diagnoses: { b: "No such mechanism.", c: "Reading doesn't grow feet.", d: "The joint rise has a clear cause." }, explanation: "Age drives both — the correlation is real but not causal.", hints: ["Third variable.", "Age.", "Confounder."] },
      // @q07
      { id: "U28L4-num-1", type: "numeric-input", category: "procedural", prompt: "Points: (1,2), (2,4), (3,6). Trend up-right. Slope of the trend line = …", answer: 2, tolerance: 0, explanation: "rise/run = 2/1 = 2 — a steep positive slope.", hints: ["Rise over run.", "2.", "2."] },
      // @q08
      { id: "U28L4-num-2", type: "numeric-input", category: "procedural", prompt: "Points: (1,10), (2,8), (3,6). Trend down-right. Slope = …", answer: -2, tolerance: 0, explanation: "rise/run = −2/1 = −2 — negative correlation.", hints: ["−2 over 1.", "−2.", "−2."] },
      // @q09
      { id: "U28L4-num-3", type: "numeric-input", category: "conceptual", prompt: "Scatter mix: hours studied (x) results (y). If every 2 extra hours adds 3 points, the slope is…", answer: 1.5, tolerance: 0.1, acceptFractions: true, explanation: "slope = 3/2 = 1.5 points per hour.", hints: ["3 points per 2 hours.", "1.5.", "1.5."] },
      // @q10
      { id: "U28L4-frac-1", type: "fraction-input", category: "conceptual", prompt: "In a scatter of height vs weight with a tight upward cloud, the number of cases on/near a clean straight line is most of them. If 8 of 12 are close to the line, what fraction is that?", numerator: 2, denominator: 3, acceptEquivalent: true, explanation: "8/12 = 2/3 — a fairly tight positive correlation.", hints: ["8 of 12.", "2/3.", "2/3."] },
      // @q11
      { id: "U28L4-tf-1", type: "true-false-justify", category: "conceptual", prompt: "A tight upward cloud proves one variable causes the other.", isTrue: false, explanation: "Tight correlation shows co-movement — causation needs an experiment or strong reasoning.", hints: ["Co-move ≠ cause.", "Confounder check.", "False."] },
      // @q12
      { id: "U28L4-tf-2", type: "true-false-justify", category: "conceptual", prompt: "A down-right scatter means negative correlation.", isTrue: true, explanation: "As x rises, y falls — the inverse relationship.", hints: ["Down-right.", "Negative.", "True."] },
      // @q13
      { id: "U28L4-order-1", type: "order-steps", category: "word", prompt: "Order the steps to read a scatter plot.", sequence: ["Plot x on one axis, y on the other", "Look at the trend direction", "Check for possible confounders"], diagnoses: { "Plot x on one axis, y on the other@1": "Plot first.", "Look at the trend direction@0": "Then read the trend.", "Check for possible confounders@0": "Hunt confounders last." }, explanation: "Plot, read, question cause.", hints: ["Axes.", "Trend.", "Confounder."] },
      // @q14
      ...
      // @q15
      { id: "U28L4-graph-1", type: "graph-interact", category: "word", prompt: "Points trend: (1,4), (2,5), (3,6). Set the slider to the slope of the trend (key: value).", challenge: "Set the slider to 1.", validate: { value: 1 }, tolerance: 0.01, explanation: "rise = 1 for run = 1 → slope 1.", hints: ["Rise over run.", "1.", "1."] }
    ],
