...
export const T4U28L4: Lesson = {
  ...
  quiz: {
    pool: [
      ...
      // @q06
      { id: "U28L4-mcq-6", type: "mcq", category: "word", prompt: "Shoe size and reading skill rise together in kids. The confounder is…", options: [ { id: "a", text: "bigger feet improve reading" }, { id: "b", text: "age — both grow with time" }, { id: "c", text: "reading grows feet" }, { id: "d", text: "random chance forever" } ], correctOptionId: "b", diagnoses: { a: "No such mechanism.", c: "Reading doesn't grow feet.", d: "The joint rise has a clear cause." }, explanation: "Age drives both — the correlation is real but not causal.", hints: ["Third variable.", "Age.", "Confounder."] },
      // @q07
