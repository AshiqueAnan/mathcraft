...
export const T3U27L2: Lesson = {
  ...
  quiz: {
    pool: [
      ...
      // @q02
      { id: "U27L2-mcq-2", type: "mcq", category: "conceptual", prompt: "k = 0.5 from the origin sends a side of length 8 to…", options: [ { id: "a", text: "4" }, { id: "b", text: "16" }, { id: "c", text: "8" }, { id: "d", text: "0.5" } ], correctOptionId: "a", diagnoses: { b: "16 multiplies by 2, not 0.5.", c: "8 is unchanged — k = 1.", d: "0.5 is the factor, not the side." }, explanation: "8 × 0.5 = 4.", hints: ["× 0.5.", "4.", "4."] },
      // @q03
      { id: "U27L2-mcq-3", type: "mcq", category: "word", prompt: "A photo enlarged by k = 2. Its area becomes…", options: [ { id: "a", text: "4× the original" }, { id: "b", text: "2× the original" }, { id: "c", text: "8× the original" }, { id: "d", text: "the same" } ], correctOptionId: "a", diagnoses: { b: "2× is the LINEAR scale, area squares it.", c: "8× would need 3-D scaling.", d: "Scaling changes area unless k = 1." }, explanation: "Area scales by k² = 2² = 4.", hints: ["k² = 4.", "Area × 4.", "4×."] },
      // @q04
      { id: "U27L2-mcq-4", type: "mcq", category: "procedural", prompt: "Enlarge (3, −2) by k = −1 about the origin. New point = …", options: [ { id: "a", text: "(−3, 2)" }, { id: "b", text: "(3, 2)" }, { id: "c", text: "(−3, −2)" }, { id: "d", text: "(0, 0)" } ], correctOptionId: "a", diagnoses: { b: "(3, 2) reflects across the x-axis only.", c: "(−3, −2) is the k = 1 point unchanged.", d: "(0, 0) would be the centre itself." }, explanation: "k = −1 sends each point to the origin-side opposite: (−3, 2).", hints: ["Negate both.", "(−3, 2).", "(−3, 2)."] },
      // @q05
      ...
      // @q06
      { id: "U27L2-mcq-6", type: "mcq", category: "word", prompt: "A poster printed at 150% (k = 1.5). Its area is about…", options: [ { id: "a", text: "2.25× the original" }, { id: "b", text: "1.5× the original" }, { id: "c", text: "3× the original" }, { id: "d", text: "the same" } ], correctOptionId: "a", diagnoses: { b: "1.5× is the linear scale; area squares it.", c: "3× doubles 1.5 — not the area rule.", d: "Any k ≠ 1 changes area." }, explanation: "Area scales by k² = 1.5² = 2.25.", hints: ["1.5².", "2.25×.", "2.25×."] },
      // @q07
