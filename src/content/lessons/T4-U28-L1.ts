...
export const T4U28L1: Lesson = {
  ...
  intuitionBlocks: [{ widget: "number-line", props: { mode: "dots", dots: [162, 165, 168, 168, 171, 174] }, narrative: "Plot heights as dots on a number line. Move one dot an inch left: the MEAN chases it, the MEDIAN barely shrugs, the MODE only cares if a value repeats most often. Drag a cluster and watch which average moves — that's the fingerprint of each measure." }],
  ...
  quiz: {
    pool: [
      // @q01
      { id: "U28L1-mcq-1", type: "mcq", category: "procedural", prompt: "Data: 2, 3, 3, 4, 8. The MEAN is…", options: [ { id: "a", text: "4" }, { id: "b", text: "3" }, { id: "c", text: "20" }, { id: "d", text: "5" } ], correctOptionId: "a", diagnoses: { b: "3 is the median, not the mean.", c: "20 is the SUM, not the mean.", d: "5 is the count." }, explanation: "Mean = 20 ÷ 5 = 4.", hints: ["Sum ÷ count.", "20 ÷ 5.", "Mean = 20 ÷ 5 = 4."] },
      // @q02
      { id: "U28L1-mcq-2", type: "mcq", category: "conceptual", prompt: "The median requires you to…", options: [ { id: "a", text: "add then divide" }, { id: "b", text: "sort the data first" }, { id: "c", text: "find the most frequent value" }, { id: "d", text: "double the biggest value" } ], correctOptionId: "b", diagnoses: { a: "Adding then dividing is the mean.", c: "The most frequent value is the mode.", d: "Doubling is meaningless here." }, explanation: "Median = middle of the SORTED list.", hints: ["Order it.", "Middle value.", "Median = middle of the SORTED list."] },
      // @q03
      { id: "U28L1-mcq-3", type: "mcq", category: "word", prompt: "Heights (cm): 150, 152, 152, 155, 160, 195. Best 'typical' height?", options: [ { id: "a", text: "Mode 150" }, { id: "b", text: "Mean ≈ 160.7" }, { id: "c", text: "Median 153.5" }, { id: "d", text: "Max 195" } ], correctOptionId: "c", diagnoses: { b: "The 195 outlier inflates the mean beyond most values.", a: "150 appears only once — mode is 152.", d: "The max is an outlier, not typical." }, explanation: "The outlier drags the mean up; the sorted middle (152+155)/2 = 153.5 is more typical.", hints: ["Outlier = bias.", "Use the middle.", "The outlier drags the mean up; the sorted middle (152+155)/2 = 153."] },
      // @q04
      { id: "U28L1-mcq-4", type: "mcq", category: "procedural", prompt: "Data: 1, 2, 2, 9. The MEDIAN is…", options: [ { id: "a", text: "9" }, { id: "b", text: "3.5" }, { id: "c", text: "14" }, { id: "d", text: "2" } ], correctOptionId: "d", diagnoses: { b: "3.5 is the MEAN (14÷4).", c: "14 is the sum.", a: "9 is the outlier." }, explanation: "Sorted: 1, 2, 2, 9 → middle two are 2 and 2 → median = (2+2)/2 = 2.", hints: ["Two middles.", "2 and 2.", "Sorted: 1, 2, 2, 9 → middle two are 2 and 2 → median = (2+2)/2 = 2."] },
      // @q05
      { id: "U28L1-mcq-5", type: "mcq", category: "conceptual", prompt: "Add an extreme 100 to a dataset. The average MOST affected is the…", options: [ { id: "a", text: "mean" }, { id: "b", text: "median" }, { id: "c", text: "mode" }, { id: "d", text: "none" } ], correctOptionId: "a", diagnoses: { b: "The median only shifts by position, not magnitude.", c: "The mode only cares about frequency, not size.", d: "The mean definitely moves." }, explanation: "The mean sums ALL values, so one extreme drags it.", hints: ["Sums everything.", "Mean.", "The mean sums ALL values, so one extreme drags it."] },
      // @q06
      { id: "U28L1-mcq-6", type: "mcq", category: "word", prompt: "Shoe sizes: 5, 6, 6, 7, 8, 8, 8. The MODE is…", options: [ { id: "a", text: "6" }, { id: "b", text: "8" }, { id: "c", text: "6.857" }, { id: "d", text: "7" } ], correctOptionId: "b", diagnoses: { a: "6 appears twice; 8 appears three times.", c: "6.857 is the MEAN.", d: "7 is the middle, not the most frequent." }, explanation: "8 appears 3 times — the most frequent value.", hints: ["Count repeats.", "8 three times.", "8 appears 3 times — the most frequent value."] },
      // @q07
      { id: "U28L1-num-1", type: "numeric-input", category: "procedural", prompt: "Scores: 3, 4, 5, 5, 8. Mean = …", answer: 5, tolerance: 0, explanation: "Sum 25 ÷ 5 = 5.", hints: ["Sum then divide.", "25 ÷ 5.", "Sum 25 ÷ 5 = 5."] },
      // @q08
      { id: "U28L1-num-2", type: "numeric-input", category: "procedural", prompt: "Scores: 3, 4, 5, 5, 8. Median = …", answer: 5, tolerance: 0, explanation: "Sorted middle is 5.", hints: ["Middle of sorted list.", "5.", "Sorted middle is 5."] },
      // @q09
      { id: "U28L1-num-3", type: "numeric-input", category: "conceptual", prompt: "Data: 10, 20, 30. Add one number x so the mean becomes 25. x = …", answer: 40, tolerance: 0, explanation: "(60 + x) ÷ 4 = 25 → 60 + x = 100 → x = 40.", hints: ["4 × 25 = 100.", "100 − 60.", "(60 + x) ÷ 4 = 25 → 60 + x = 100 → x = 40."] },
      // @q10
      { id: "U28L1-frac-1", type: "fraction-input", category: "conceptual", prompt: "The median of an even count (e.g. 2 and 2) averages them. For 1, 2, 2, 9 the median (2) is what fraction of the pair (2+2=4)?", numerator: 1, denominator: 2, acceptEquivalent: true, explanation: "Median 2 = half of the middle pair's sum 4.", hints: ["2 of 4.", "1/2.", "Median 2 = half of the middle pair's sum 4."] },
      // @q11
      { id: "U28L1-tf-1", type: "true-false-justify", category: "conceptual", prompt: "The median resists extreme outliers better than the mean.", isTrue: true, explanation: "Only the middle value matters — magnitude of extremes doesn't touch it.", hints: ["Middle only.", "Outlier-proof.", "Only the middle value matters — magnitude of extremes doesn't touch it."] },
      // @q12
      { id: "U28L1-tf-2", type: "true-false-justify", category: "conceptual", prompt: "The mode requires sorting the data.", isTrue: false, explanation: "The mode counts frequencies — sorting isn't needed (though it helps).", hints: ["Count repeats.", "No sorting needed.", "The mode counts frequencies — sorting isn't needed (though it helps)."] },
      // @q13
      { id: "U28L1-order-1", type: "order-steps", category: "word", prompt: "Order the steps to find the median of 7, 3, 5, 9, 5.", sequence: ["Sort: 3, 5, 5, 7, 9", "Find the middle position (3rd)", "Median = 5"], diagnoses: { "Sort: 3, 5, 5, 7, 9@1": "Sort first.", "Find the middle position (3rd)@0": "Then the middle.", "Median = 5@0": "State it last." }, explanation: "Sort, locate the middle, read the value.", hints: ["3, 5, 5, 7, 9.", "3rd value.", "Sort, locate the middle, read the value."] },
      // @q14
      ...
      // @q15
      { id: "U28L1-graph-1", type: "graph-interact", category: "word", prompt: "Pet counts: 1, 1, 1, 2, 5. Set the slider to the MODE (key: value).", challenge: "Adjust the values below so they match the condition described in the prompt.", validate: { value: 1 }, tolerance: 0.01, explanation: "1 appears three times — the mode.", hints: ["Most frequent.", "1.", "1 appears three times — the mode."] }
    ],
