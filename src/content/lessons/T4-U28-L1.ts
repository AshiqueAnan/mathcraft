...
export const T4U28L1: Lesson = {
  ...
  quiz: {
    pool: [
      ...
      // @q04
      { id: "U28L1-mcq-4", type: "mcq", category: "procedural", prompt: "Data: 1, 2, 2, 9. The MEDIAN is…", options: [ { id: "a", text: "9" }, { id: "b", text: "3.5" }, { id: "c", text: "14" }, { id: "d", text: "2" } ], correctOptionId: "d", diagnoses: { b: "3.5 is the MEAN (14÷4).", c: "14 is the sum.", a: "9 is the outlier." }, explanation: "Sorted: 1, 2, 2, 9 → middle two are 2 and 2 → median = (2+2)/2 = 2.", hints: ["Two middles.", "2 and 2.", "2."] },
      // @q05
