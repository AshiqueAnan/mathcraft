...
export const T3U24L2: Lesson = {
  ...
  quiz: {
    pool: [
      ...
      // @q02
      { id: "U24L2-mcq-2", type: "mcq", category: "conceptual", prompt: "A sector's arc length is…", options: [ { id: "a", text: "the fraction θ/360 of the circumference" }, { id: "b", text: "the fraction θ/360 of the area" }, { id: "c", text: "the whole circumference" }, { id: "d", text: "half the diameter" } ], correctOptionId: "a", diagnoses: { b: "Area share is the sector area, not the arc.", c: "Only a 360° sector has the whole rim.", d: "Half the diameter is a radius, not an arc." }, explanation: "The rim share scales with θ/360: arc = θ/360 × 2πr.", hints: ["Rim share.", "θ/360 × circumference.", "That."] },
      // @q03
      { id: "U24L2-mcq-3", type: "mcq", category: "word", prompt: "A 60° pizza slice from a 12-inch pizza (r = 6 in). Arc length ≈ …", options: [ { id: "a", text: "6.28 in" }, { id: "b", text: "12.56 in" }, { id: "c", text: "37.7 in" }, { id: "d", text: "3.14 in" } ], correctOptionId: "a", diagnoses: { b: "12.56 is a semicircle's arc (180°).", c: "37.7 is the FULL circumference.", d: "3.14 is the full circle's diameter-worth, not a 60° arc." }, explanation: "60/360 = 1/6; arc = 1/6 × 2π(6) = 2π ≈ 6.28 in.", hints: ["Fraction = 1/6.", "1/6 × 2π × 6.", "≈ 6.28."] },
      // @q04
      { id: "U24L2-mcq-4", type: "mcq", category: "procedural", prompt: "Quarter circle (90°), r = 8 m. Its sector area is…", options: [ { id: "a", text: "16π m²" }, { id: "b", text: "64π m²" }, { id: "c", text: "4π m²" }, { id: "d", text: "32π m²" } ], correctOptionId: "a", diagnoses: { b: "64π is the FULL circle's area.", c: "4π divides by r instead of using r².", d: "32π is the full area with a wrong share." }, explanation: "¼ × π(64) = 16π m².", hints: ["Quarter = 1/4.", "¼ × π × 64.", "16π."] },
      // @q05
      ...
      // @q06
      { id: "U24L2-mcq-6", type: "mcq", category: "word", prompt: "A 120° sector from a wheel of radius 9 cm. Sector area ≈ …", options: [ { id: "a", text: "84.8 cm²" }, { id: "b", text: "254.5 cm²" }, { id: "c", text: "42.4 cm²" }, { id: "d", text: "28.3 cm²" } ], correctOptionId: "a", diagnoses: { b: "254.5 is the FULL circle's area.", c: "42.4 halves the correct answer.", d: "28.3 is the 120° arc, not the area." }, explanation: "120/360 = 1/3; ⅓ × π × 81 ≈ 84.8 cm².", hints: ["Fraction = 1/3.", "⅓ × π × 81.", "≈ 84.8."] },
      // @q07
