...
export const T2U13L3: Lesson = {
  ...
  quiz: {
    pool: [
      ...
      // @q02
      { id: "U13L3-mcq-2", type: "mcq", category: "conceptual", prompt: "When x appears on BOTH sides, what should you do first?", options: [ { id: "a", text: "Collect the x-terms onto one side" }, { id: "b", text: "Divide by x immediately" }, { id: "c", text: "Square both sides" }, { id: "d", text: "Move the constants first" } ], correctOptionId: "a", diagnoses: { b: "Only if x is a factor of everything — rare.", c: "Squaring can create fake answers.", d: "Constants move after the x's are gathered." }, explanation: "Strike the x on one side first: gather all x-terms together so one 'x' remains.", hints: ["Both sides have x.", "Get them on one side.", "Collect first."] },
      // @q03
      { id: "U13L3-mcq-3", type: "mcq", category: "word", prompt: "Making x the subject of y = 3/x gives?", options: [ { id: "a", text: "x = 3/y" }, { id: "b", text: "x = y/3" }, { id: "c", text: "x = y − 3" }, { id: "d", text: "x = 3y" } ], correctOptionId: "a", diagnoses: { b: "y/3 would be x = y ÷ 3, wrong operation.", c: "No subtraction involved.", d: "Multiply by x: yx = 3, then divide by y." }, explanation: "Multiply both sides by x (yx = 3), then divide by y: x = 3/y.", hints: ["x is in the denominator.", "Multiply by x first.", "x = 3/y."] },
      // @q04
      { id: "U13L3-mcq-4", type: "mcq", category: "procedural", prompt: "Make x the subject of y = (x + 2)/3.", options: [ { id: "a", text: "x = 3y − 2" }, { id: "b", text: "x = y/3 − 2" }, { id: "c", text: "x = 3y + 2" }, { id: "d", text: "x = y − 6" } ], correctOptionId: "a", diagnoses: { b: "The ÷3 hits the whole (x + 2), so undo it by ×3 first.", c: "Undo the +2 by subtracting, not adding.", d: "y − 6 = (y − 2×3)? No — (x+2)/3 = y means 3y = x+2." }, explanation: "Multiply by 3: 3y = x + 2, then subtract 2: x = 3y − 2.", hints: ["x is inside a fraction.", "Multiply by 3 first.", "x = 3y − 2."] },
      // @q05
      { id: "U13L3-mcq-5", type: "mcq", category: "conceptual", prompt: "Why can't you just 'move' the 3 in y = (x + 2)/3?", options: [ { id: "a", text: "The 3 divides the WHOLE bracket, so you must multiply the whole side by 3" }, { id: "b", text: "3 isn't a number" }, { id: "c", text: "Moving always works" }, { id: "d", text: "Because x is squared" } ], correctOptionId: "a", diagnoses: { b: "3 is a perfectly normal number.", c: "Moving only works when it keeps the equation true — here multiply first.", d: "No square here." }, explanation: "To undo /3, multiply BOTH sides by 3: 3y = x + 2 — the whole bracket, not just x.", hints: ["The /3 belongs to the bracket.", "Multiply both sides.", "Whole side."] },
      // @q06
      { id: "U13L3-mcq-6", type: "mcq", category: "word", prompt: "A scale's equilibrium is F = kx. Make x the subject.", options: [ { id: "a", text: "x = F/k" }, { id: "b", text: "x = kF" }, { id: "c", text: "x = F + k" }, { id: "d", text: "x = k/F" } ], correctOptionId: "a", diagnoses: { b: "Undo ×k by dividing.", c: "No addition here.", d: "Divide by k, not k/F." }, explanation: "x is multiplied by k: divide both sides by k → x = F/k.", hints: ["Undo ×k.", "Divide by k.", "x = F/k."] },
      // @q07
      { id: "U13L3-num-1", type: "numeric-input", category: "procedural", prompt: "Solve 4x + 3 = 11. Type x.", answer: 2, tolerance: 0, explanation: "4x = 8, x = 2.", hints: ["Subtract 3: 4x = 8.", "Divide by 4.", "x = 2."] },
      // @q08
      { id: "U13L3-num-2", type: "numeric-input", category: "procedural", prompt: "Solve 2x + 5 = 11 − x. Type x.", answer: 2, tolerance: 0, explanation: "Add x: 3x + 5 = 11; subtract 5: 3x = 6; x = 2.", hints: ["Collect x's.", "3x = 6.", "x = 2."] },
      // @q09
      { id: "U13L3-num-3", type: "numeric-input", category: "conceptual", prompt: "Solve 6/x = 3. Type x.", answer: 2, tolerance: 0, explanation: "Multiply by x: 6 = 3x → x = 2.", hints: ["x in denominator.", "Multiply both sides by x.", "x = 2."] },
      // @q10
      { id: "U13L3-frac-1", type: "fraction-input", category: "conceptual", prompt: "Solve 4/x = 2. Write x as a fraction.", numerator: 2, denominator: 1, acceptEquivalent: true, explanation: "4 = 2x → x = 2.", hints: ["Multiply by x.", "4 = 2x.", "x = 2 = 2/1."] },
      // @q11
      { id: "U13L3-tf-1", type: "true-false-justify", category: "conceptual", prompt: "3x + 2 = 5x − 4 has solution x = 3.", isTrue: true, explanation: "3(3)+2 = 11 and 5(3)−4 = 11 — checks.", hints: ["Collect x's.", "6 = 2x.", "x = 3."] },
      // @q12
      ...
      // @q14
      { id: "U13L3-drag-1", type: "drag-match", category: "conceptual", prompt: "Match each equation to its solution.", pairs: [ { source: "5/x = 5", target: "x = 1" }, { source: "2x + 1 = 7", target: "x = 3" }, { source: "3x = 9", target: "x = 3" } ], diagnoses: { "5/x = 5->x = 3": "5/x = 5 → 5 = 5x → x = 1.", "3x = 9->x = 1": "x = 9/3 = 3.", "2x + 1 = 7->x = 1": "2x = 6 → x = 3." }, explanation: "Solve each: x = 1, 3, 3.", hints: ["Undo operations.", "Solve each.", "Match."] },
      // @q15
      { id: "U13L3-graph-1", type: "graph-interact", category: "word", prompt: "Set the slider to x in 2x + 3 = 9 (key: value).", challenge: "Set the slider to 3.", validate: { value: 3 }, tolerance: 0, explanation: "2x = 6 → x = 3.", hints: ["2x = 6.", "x = 3.", "Set to 3."] }
    ],
