...
export const T2U11L3: Lesson = {
  ...
  quiz: {
    pool: [
      ...
      // @q03
      { id: "U11L3-mcq-3", type: "mcq", category: "word", prompt: "3 pens cost $6 each and 2 pencils cost $c each. Total cost?", options: [ { id: "a", text: "5c" }, { id: "b", text: "3 × 6 + 2 + c" }, { id: "c", text: "18 + 2c" }, { id: "d", text: "18c" } ], correctOptionId: "c", diagnoses: { b: "2 pencils cost 2 × c, not 2 + c.", a: "5c mixes dollars and pen-counts.", d: "18c multiplies the things together wrongly." }, explanation: "Pens: 3 × $6 = 18; pencils: 2 × c = 2c; total = 18 + 2c.", hints: ["Pens: 3 × 6.", "Pencils: 2 × c.", "18 + 2c."] },
      // @q04
