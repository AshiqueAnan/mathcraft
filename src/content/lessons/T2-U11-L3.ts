...
export const T2U11L3: Lesson = {
  ...
  quiz: {
    pool: [
      // @q01
      { id: "U11L3-mcq-1", type: "mcq", category: "procedural", prompt: "Simplify 3x + 2x.", options: [ { id: "a", text: "5x" }, { id: "b", text: "5x²" }, { id: "c", text: "6x" }, { id: "d", text: "5" } ], correctOptionId: "a", diagnoses: { b: "5x² would come from 3x·2x, not addition.", c: "6x is 3 × 2, not 3 + 2.", d: "You dropped the x." }, explanation: "Both are x-terms: 3 + 2 = 5, keep x → 5x.", hints: ["Add the coefficients.", "Keep the x.", "5x."] },
      // @q02
      { id: "U11L3-mcq-2", type: "mcq", category: "conceptual", prompt: "Which two terms are LIKE terms?", options: [ { id: "a", text: "4x and 7x" }, { id: "b", text: "4x and 4y" }, { id: "c", text: "4x and 4x²" }, { id: "d", text: "4x and 4" } ], correctOptionId: "a", diagnoses: { b: "Different letters — unlike.", c: "Different powers — unlike.", d: "One has no variable — unlike." }, explanation: "Like terms share the letter AND power: 4x and 7x are both x-terms.", hints: ["Compare letters and powers.", "4x and 7x match both.", "4x and 7x."] },
      // @q03
      { id: "U11L3-mcq-3", type: "mcq", category: "word", prompt: "3 pens cost $6 each and 2 pencils cost $c each. Total cost?", options: [ { id: "a", text: "18 + 2c" }, { id: "b", text: "3 × 6 + 2 + c" }, { id: "c", text: "5c" }, { id: "d", text: "18c" } ], correctOptionId: "a", diagnoses: { b: "2 pencils cost 2 × c, not 2 + c.", c: "5c mixes dollars and pen-counts.", d: "18c multiplies the things together wrongly." }, explanation: "Pens: 3 × $6 = 18; pencils: 2 × c = 2c; total = 18 + 2c.", hints: ["Pens: 3 × 6.", "Pencils: 2 × c.", "18 + 2c."] },
      // @q04
      { id: "U11L3-mcq-4", type: "mcq", category: "procedural", prompt: "Simplify 5x² + 3x².", options: [ { id: "a", text: "8x²" }, { id: "b", text: "8x" }, { id: "c", text: "15x²" }, { id: "d", text: "8x⁴" } ], correctOptionId: "a", diagnoses: { b: "The power is preserved — it stays x².", c: "15 is 5 × 3, you should add.", d: "Powers don't combine on addition." }, explanation: "Same kind (x²): 5 + 3 = 8, keep x² → 8x².", hints: ["Add coefficients.", "Keep x².", "8x²."] },
      // @q05
      ...
      // @q06
      { id: "U11L3-mcq-6", type: "mcq", category: "word", prompt: "A rectangle is w cm wide and 3d cm long. Which shows its area?", options: [ { id: "a", text: "3wd" }, { id: "b", text: "3w + d" }, { id: "c", text: "3 + wd" }, { id: "d", text: "3w²d" } ], correctOptionId: "a", diagnoses: { b: "3w + d is a sum — area is a product.", c: "The 3 multiplies the whole.", d: "Only w is squared, not the product." }, explanation: "Area = w × 3d = 3 × w × d = 3wd.", hints: ["Area = length × width.", "w × 3d.", "3wd."] },
      // @q07
      { id: "U11L3-num-1", type: "numeric-input", category: "procedural", prompt: "Simplify 7x + 3x. Type the coefficient.", answer: 10, tolerance: 0, explanation: "7 + 3 = 10, keep x → 10x.", hints: ["Add the coefficients.", "7 + 3.", "10."] },
      // @q08
      { id: "U11L3-num-2", type: "numeric-input", category: "procedural", prompt: "Simplify 5y − 2y. Type the coefficient.", answer: 3, tolerance: 0, explanation: "5 − 2 = 3, keep y → 3y.", hints: ["Subtract coefficients.", "5 − 2.", "3."] },
      // @q09
      { id: "U11L3-num-3", type: "numeric-input", category: "conceptual", prompt: "Simplify 4x + 3x + 2y. Type the coefficient of x.", answer: 7, tolerance: 0, explanation: "4x + 3x = 7x; the 2y stays separate.", hints: ["Combine only x-terms.", "4 + 3.", "7."] },
      // @q10
      { id: "U11L3-frac-1", type: "fraction-input", category: "conceptual", prompt: "If x = 4, what is x/2? Write it as a fraction.", numerator: 2, denominator: 1, acceptEquivalent: true, explanation: "x/2 = 4/2 = 2 = 2/1.", hints: ["x/2 means half of x.", "Half of 4.", "2."] },
      // @q11
      { id: "U11L3-tf-1", type: "true-false-justify", category: "conceptual", prompt: "3x + 2x simplifies to 5x.", isTrue: true, explanation: "Both are x-terms: 3 + 2 = 5, keep x.", hints: ["Like terms combine.", "3 + 2.", "True — 5x."] },
      // @q12
