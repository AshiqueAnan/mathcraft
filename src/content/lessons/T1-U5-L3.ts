    ...
    pool: [
      {
        ...
        hints: ["100% + 15%.", "115% as a decimal.", "100% + 15% = 115% = 1."],
      },
      {
        id: "U5L3-mcq-2", type: "mcq", category: "conceptual",
        prompt: "A price rises 20% then falls 20%. Final price vs original?",
        options: [{ id: "a", text: "Same" }, { id: "b", text: "Lower" }, { id: "c", text: "Higher" }, { id: "d", text: "Cannot tell" }],
        correctOptionId: "b",
        diagnoses: { a: "The 20% off applies to the BIGGER amount, so it removes more than it added.", c: "Rise then same-rate fall can't end higher — try $100→$120→$96.", d: "We can tell: $100 × 1.2 × 0.8 = $96." },
        explanation: "$100 × 1.2 = 120$; $120 × 0.8 = 96$. Lower than 100.",
        hints: ["Compute on $100.", "1.2 then 0.8.", "$100 × 1.2 = 120$; $120 × 0.8 = 96$. Lower than 100."],
      },
      {
        id: "U5L3-mcq-3", type: "mcq", category: "word",
        prompt: "A $50 jacket is on 30% off. What's the sale price?",
        options: [{ id: "a", text: "$30" }, { id: "b", text: "$15" }, { id: "c", text: "$35" }, { id: "d", text: "$65" }],
        correctOptionId: "c",
        diagnoses: { b: "$15 is the discount, not the price.", a: "$30 would be 40% off.", d: "$65 is a 30% increase." },
        explanation: "Pay 70%: 0.7 × 50 = $35.",
        hints: ["30% off means you pay 70%.", "0.7 × 50.", "Pay 70%: 0.7 × 50 = $35."],
      },
      {
        id: "U5L3-mcq-4", type: "mcq", category: "conceptual",
        prompt: "Which multiplier is a 25% discount?",
        options: [{ id: "a", text: "0.025" }, { id: "b", text: "0.25" }, { id: "c", text: "1.25" }, { id: "d", text: "0.75" }],
        correctOptionId: "d",
        diagnoses: { b: "0.25 is the amount OFF, not what you pay.", c: "1.25 is a 25% increase.", a: "0.025 is 2.5%." },
        explanation: "100% − 25% = 75% = 0.75.",
        hints: ["100% − 25%.", "Pay 75%.", "100% − 25% = 75% = 0."],
      },
      {
        ...
        hints: ["10% of 800 = 80.", "800 + 80.", "800 × 1.1 = 880."],
      },
      {
        id: "U5L3-mcq-6", type: "mcq", category: "word",
        prompt: "A phone drops from $300 to $270. What percent decrease?",
        options: [{ id: "a", text: "9%" }, { id: "b", text: "10%" }, { id: "c", text: "11%" }, { id: "d", text: "30%" }],
        correctOptionId: "b",
        diagnoses: { a: "30/300 = 0.1 = 10%, not 9%.", c: "30/270 would misapply the base.", d: "30% of 300 = 90, way too much." },
        explanation: "Drop = 30. 30 ÷ 300 = 0.1 = 10%.",
        hints: ["Amount of change.", "30 ÷ 300.", "Drop = 30. 30 ÷ 300 = 0.1 = 10%."],
      },
      {
      ...
      },
      {
        ...
        hints: ["100% − 40% = 60%.", "Pay 60% of the original.", "100% − 40% = 60% = 0."],
      },
      {
        ...
        hints: ["25% of 60 = 15.", "60 + 15.", "60 × 1.25 = 75."],
      },
      {
      ...
      },
      {
        ...
        hints: ["5% = 5/100.", "Simplify.", "5% = 5/100 = 1/20."],
      },
      {
        ...
        hints: ["40 × 1.25.", "50 × 0.75.", "40 × 1.25 = 50; 50 × 0.75 = 37.5 — not 40."],
      },
      {
      ...
      },
      {
        ...
        hints: ["×1.2.", "×0.8.", "Increase then decrease with changing base lands below the start."],
      },
      {
        ...
        hints: ["+20% = 1.2.", "−20% = 0.8.", "Increase p% → 1 + p/100; decrease p% → 1 − p/100."],
      },
      {
        ...
        hints: ["20% increase means ×1.2.", "Multiply by 1.2.", "100 × 1.2 = 120."],
      },
    ],
