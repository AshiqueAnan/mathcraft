...
export const T3U25L3: Lesson = {
  ...
  quiz: {
    pool: [
      ...
      // @q04
      { id: "U25L3-mcq-4", type: "mcq", category: "procedural", prompt: "Hypotenuse 17, leg 8. Other leg = …", options: [ { id: "a", text: "√353" }, { id: "b", text: "9" }, { id: "c", text: "25" }, { id: "d", text: "15" } ], correctOptionId: "d", diagnoses: { b: "9 is 17 − 8 without squaring.", c: "25 is 17 + 8, adding instead.", a: "√353 adds the squares — wrong direction." }, explanation: "b² = 289 − 64 = 225 → b = 15.", hints: ["289 − 64.", "√225.", "15."] },
      // @q05
