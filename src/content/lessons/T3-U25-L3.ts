...
export const T3U25L3: Lesson = {
  ...
  quiz: {
    pool: [
      // @q01
      { id: "U25L3-mcq-1", type: "mcq", category: "procedural", prompt: "Legs 5 and 12. Hypotenuse = …", options: [ { id: "a", text: "13" }, { id: "b", text: "17" }, { id: "c", text: "119" }, { id: "d", text: "169" } ], correctOptionId: "a", diagnoses: { b: "17 adds the legs without squaring.", c: "119 is c² − 1 — not from Pythagoras.", d: "169 is c², not c." }, explanation: "c = √(25 + 144) = √169 = 13.", hints: ["Add the squares.", "√169.", "13."] },
      // @q02
      { id: "U25L3-mcq-2", type: "mcq", category: "conceptual", prompt: "Finding a LEG needs…", options: [ { id: "a", text: "subtract the known leg's square from c², then root" }, { id: "b", text: "add both squares, then root" }, { id: "c", text: "halve the hypotenuse" }, { id: "d", text: "divide by the leg" } ], correctOptionId: "a", diagnoses: { b: "Adding finds the hypotenuse, not a leg.", c: "Halving isn't Pythagorean.", d: "Division isn't in the theorem." }, explanation: "a² = c² − b², so a = √(c² − b²).", hints: ["c² − b².", "Then root.", "Subtract then root."] },
      // @q03
      { id: "U25L3-mcq-3", type: "mcq", category: "word", prompt: "A ladder 10 m long reaches 8 m up a wall. Foot distance from wall = …", options: [ { id: "a", text: "6 m" }, { id: "b", text: "2 m" }, { id: "c", text: "18 m" }, { id: "d", text: "√164 m" } ], correctOptionId: "a", diagnoses: { b: "2 subtracts the lengths before squaring.", c: "18 adds them.", d: "√164 adds the squares — that's the wrong leg move (adds)." }, explanation: "b² = 100 − 64 = 36 → b = 6 m.", hints: ["100 − 64.", "√36.", "6."] },
      // @q04
      { id: "U25L3-mcq-4", type: "mcq", category: "procedural", prompt: "Hypotenuse 17, leg 8. Other leg = …", options: [ { id: "a", text: "15" }, { id: "b", text: "9" }, { id: "c", text: "25" }, { id: "d", text: "√353" } ], correctOptionId: "a", diagnoses: { b: "9 is 17 − 8 without squaring.", c: "25 is 17 + 8, adding instead.", d: "√353 adds the squares — wrong direction." }, explanation: "b² = 289 − 64 = 225 → b = 15.", hints: ["289 − 64.", "√225.", "15."] },
      // @q05
      { id: "U25L3-mcq-5", type: "mcq", category: "conceptual", prompt: "Why can't a leg come from adding the squares?", options: [ { id: "a", text: "c² − a² would be negative — the sum exceeds c²" }, { id: "b", text: "Adding is always for the hypotenuse" }, { id: "c", text: "Legs are always shorter than 1" }, { id: "d", text: "It can — both directions add" } ], correctOptionId: "a", diagnoses: { b: "That's the memory rule, but the real reason is the inequality.", c: "Legs can be any positive length.", d: "Adding gives c², which is bigger than any leg² — a leg can't match it." }, explanation: "a² = c² − b²; if you instead did c² + b² the result exceeds c², contradicting the hypotenuse being longest.", hints: ["a² + b² = c².", "Leg = c² − b².", "Add is for c."] },
      // @q06
      { id: "U25L3-mcq-6", type: "mcq", category: "word", prompt: "A box diagonal question: room 6 m long, 8 m wide — the floor diagonal is…", options: [ { id: "a", text: "10 m" }, { id: "b", text: "14 m" }, { id: "c", text: "2 m" }, { id: "d", text: "√100 m = 100 m" } ], correctOptionId: "a", diagnoses: { b: "14 adds the sides.", c: "2 subtracts them without squaring.", d: "√100 = 10, not 100." }, explanation: "d = √(36 + 64) = √100 = 10 m.", hints: ["36 + 64.", "√100.", "10."] },
      // @q07
      { id: "U25L3-num-1", type: "numeric-input", category: "procedural", prompt: "Legs 8 and 15. Hypotenuse = …", answer: 17, tolerance: 0, explanation: "√(64 + 225) = √289 = 17.", hints: ["64 + 225.", "√289.", "17."] },
      // @q08
      { id: "U25L3-num-2", type: "numeric-input", category: "procedural", prompt: "Hypotenuse 25, leg 7. Other leg = …", answer: 24, tolerance: 0, explanation: "√(625 − 49) = √576 = 24.", hints: ["625 − 49.", "√576.", "24."] },
      // @q09
      { id: "U25L3-num-3", type: "numeric-input", category: "conceptual", prompt: "A right triangle has legs a and b. If a = 5 and c = 13, find b.", answer: 12, tolerance: 0, explanation: "b = √(169 − 25) = √144 = 12.", hints: ["169 − 25.", "√144.", "12."] },
      // @q10
      { id: "U25L3-frac-1", type: "fraction-input", category: "conceptual", prompt: "The hypotenuse c = √13 for legs 2 and 3. What fraction of c² is the square on the 2-side?", numerator: 4, denominator: 13, acceptEquivalent: true, explanation: "The 2-side's square is 4; c² is 13 → 4/13.", hints: ["2² = 4.", "c² = 13.", "4/13."] },
      // @q11
      { id: "U25L3-tf-1", type: "true-false-justify", category: "conceptual", prompt: "Finding a leg always involves subtracting the known leg's square from c².", isTrue: true, explanation: "a² = c² − b² — isolation gives subtraction before the root.", hints: ["c² − b².", "Subtract, then root.", "True."] },
      // @q12
      { id: "U25L3-tf-2", type: "true-false-justify", category: "conceptual", prompt: "To find the hypotenuse you subtract the smaller square from the larger.", isTrue: false, explanation: "The hypotenuse ADDS both leg squares — subtraction is only for finding a leg.", hints: ["Add for the hypotenuse.", "Subtract for a leg.", "False."] },
      // @q13
      { id: "U25L3-order-1", type: "order-steps", category: "word", prompt: "Order the steps to find a leg (c = 13, b = 5).", sequence: ["c² − b²: 169 − 25 = 144", "Take the root: √144", "Result: 12"], diagnoses: { "c² − b²: 169 − 25 = 144@1": "Subtract squares first.", "Take the root: √144@0": "Root after subtracting.", "Result: 12@0": "State the value last." }, explanation: "Subtract squares, root, report.", hints: ["169 − 25.", "√144.", "12."] },
      // @q14
      { id: "U25L3-drag-1", type: "drag-match", category: "conceptual", prompt: "Match each situation to its operation.", pairs: [ { source: "Find hypotenuse", target: "add squares, root" }, { source: "Find a leg", target: "subtract squares, root" }, { source: "Known leg", target: "c² − its square" } ], diagnoses: { "Find hypotenuse->subtract squares, root": "Hypotenuse adds.", "Find a leg->add squares, root": "Legs subtract from c².", "Known leg->add squares, root": "A known leg is removed from c²." }, explanation: "The missing side's position decides add vs subtract.", hints: ["Longest adds.", "Leg subtracts.", "c² − leg²."] },
      // @q15
      { id: "U25L3-graph-1", type: "graph-interact", category: "word", prompt: "A right triangle has legs 12 and 16. Set the slider to the HYPOTENUSE (key: value).", challenge: "Set the slider to 20.", validate: { value: 20 }, tolerance: 0.01, explanation: "√(144 + 256) = √400 = 20.", hints: ["144 + 256.", "√400.", "20."] }
    ],
