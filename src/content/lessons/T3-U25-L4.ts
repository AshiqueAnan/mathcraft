...
export const T3U25L4: Lesson = {
  ...
  quiz: {
    pool: [
      ...
      // @q06
      { id: "U25L4-mcq-6", type: "mcq", category: "word", prompt: "A garden bed has sides 7, 24, 25. Is a corner square?", options: [ { id: "a", text: "No — 7 + 24 = 31" }, { id: "b", text: "Yes — 49 + 576 = 625 = 25²" }, { id: "c", text: "Only if it's a triangle" }, { id: "d", text: "7-24-25 is acute" } ], correctOptionId: "b", diagnoses: { a: "Compare squares, not raw lengths.", c: "Any triangle can be tested.", d: "Equality means right, not acute." }, explanation: "7² + 24² = 49 + 576 = 625 = 25² → right-angled.", hints: ["49 + 576.", "= 625.", "Yes."] },
      // @q07
