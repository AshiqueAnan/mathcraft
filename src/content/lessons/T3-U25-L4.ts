...
export const T3U25L4: Lesson = {
  ...
  quiz: {
    pool: [
      // @q01
      { id: "U25L4-mcq-1", type: "mcq", category: "procedural", prompt: "Sides 8, 15, 17. Is it right-angled?", options: [ { id: "a", text: "Yes — 64 + 225 = 289 = 17²" }, { id: "b", text: "No — 8 + 15 ≠ 17" }, { id: "c", text: "Only if the 17 is a leg" }, { id: "d", text: "Cannot tell" } ], correctOptionId: "a", diagnoses: { b: "You compare squares, not raw lengths.", c: "17 is the LONGEST side, so it plays c.", d: "The squares decide it exactly." }, explanation: "8² + 15² = 64 + 225 = 289 = 17² → right-angled.", hints: ["Compare squares.", "289 = 17².", "Yes."] },
      // @q02
      { id: "U25L4-mcq-2", type: "mcq", category: "conceptual", prompt: "The converse test compares…", options: [ { id: "a", text: "a² + b² with c², c = longest side" }, { id: "b", text: "a + b with c" }, { id: "c", text: "all three angles by eye" }, { id: "d", text: "the perimeter with the area" } ], correctOptionId: "a", diagnoses: { b: "Sides aren't compared directly.", c: "The test is numeric, not visual.", d: "Perimeter/area are unrelated." }, explanation: "Square the two shorter sides, add, compare with the longest squared.", hints: ["Longest = c.", "Compare squares.", "a² + b² vs c²."] },
      // @q03
      { id: "U25L4-mcq-3", type: "mcq", category: "word", prompt: "A 6 m × 8 m corner with diagonal 10 m — is it square?", options: [ { id: "a", text: "Yes — 36 + 64 = 100" }, { id: "b", text: "No — 6 + 8 = 14" }, { id: "c", text: "Only if the diagonal is 11 m" }, { id: "d", text: "Depends on the material" } ], correctOptionId: "a", diagnoses: { b: "Compare squares, not lengths.", c: "The 10 m diagonal already matches.", d: "Geometry doesn't depend on material." }, explanation: "6² + 8² = 100 = 10² → right angle confirmed.", hints: ["36 + 64.", "= 100 = 10².", "Yes."] },
      // @q04
      { id: "U25L4-mcq-4", type: "mcq", category: "procedural", prompt: "Sides 5, 6, 7. The triangle is…", options: [ { id: "a", text: "acute — 25 + 36 = 61 > 49" }, { id: "b", text: "right-angled" }, { id: "c", text: "obtuse — 25 + 36 < 49" }, { id: "d", text: "impossible" } ], correctOptionId: "a", diagnoses: { b: "61 ≠ 49, so not right.", c: "61 > 49 means ACUTE, not obtuse.", d: "The triangle inequality holds." }, explanation: "a² + b² > c² → all angles acute.", hints: ["Longest = 7.", "61 vs 49.", "Acute."] },
      // @q05
      { id: "U25L4-mcq-5", type: "mcq", category: "conceptual", prompt: "When a² + b² < c², the triangle is…", options: [ { id: "a", text: "obtuse — one angle exceeds 90°" }, { id: "b", text: "acute — all angles under 90°" }, { id: "c", text: "right-angled" }, { id: "d", text: "degenerate" } ], correctOptionId: "a", diagnoses: { b: "Acute is > , this is < .", c: "Equality gives right, less gives obtuse.", d: "It's still a proper triangle." }, explanation: "Less-than means the longest side is too long for a right angle → obtuse.", hints: ["< c².", "Obtuse.", "Obtuse."] },
      // @q06
      { id: "U25L4-mcq-6", type: "mcq", category: "word", prompt: "A garden bed has sides 7, 24, 25. Is a corner square?", options: [ { id: "a", text: "Yes — 49 + 576 = 625 = 25²" }, { id: "b", text: "No — 7 + 24 = 31" }, { id: "c", text: "Only if it's a triangle" }, { id: "d", text: "7-24-25 is acute" } ], correctOptionId: "a", diagnoses: { b: "Compare squares, not raw lengths.", c: "Any triangle can be tested.", d: "Equality means right, not acute." }, explanation: "7² + 24² = 49 + 576 = 625 = 25² → right-angled.", hints: ["49 + 576.", "= 625.", "Yes."] },
      // @q07
      { id: "U25L4-num-1", type: "numeric-input", category: "procedural", prompt: "Sides 9, 12, 15 — test a² + b². What value do you compare with 15²?", answer: 225, tolerance: 0, explanation: "81 + 144 = 225 equals 15² → right-angled.", hints: ["81 + 144.", "225.", "225."] },
      // @q08
      { id: "U25L4-num-2", type: "numeric-input", category: "procedural", prompt: "Sides 20, 21, 29: find a² + b² (the sum to compare with 29²).", answer: 841, tolerance: 0, explanation: "400 + 441 = 841 = 29² → right-angled.", hints: ["400 + 441.", "841.", "841."] },
      // @q09
      { id: "U25L4-num-3", type: "numeric-input", category: "conceptual", prompt: "Sides 4, 5, 6: c² is 36. What is the sum a² + b² you compare it with?", answer: 41, tolerance: 0, explanation: "16 + 25 = 41 > 36 → acute.", hints: ["16 + 25.", "41.", "41."] },
      // @q10
      { id: "U25L4-frac-1", type: "fraction-input", category: "conceptual", prompt: "In a 5-12-13 right triangle, the square on side 12 is what fraction of the square on 13?", numerator: 144, denominator: 169, acceptEquivalent: true, explanation: "12² = 144 and 13² = 169 → 144/169.", hints: ["12² = 144.", "13² = 169.", "144/169."] },
      // @q11
      { id: "U25L4-tf-1", type: "true-false-justify", category: "conceptual", prompt: "If a² + b² = c² then the triangle MUST be right-angled.", isTrue: true, explanation: "That's the converse — the equality forces the 90° angle opposite c.", hints: ["Converse holds.", "Right angle forced.", "True."] },
      // @q12
      { id: "U25L4-tf-2", type: "true-false-justify", category: "conceptual", prompt: "The converse is only useful when you already know the triangle is right-angled.", isTrue: false, explanation: "The converse DECIDES whether it's right-angled — that's its whole purpose.", hints: ["It tests.", "Decides right or not.", "False."] },
      // @q13
      { id: "U25L4-order-1", type: "order-steps", category: "word", prompt: "Order the steps to test sides 5, 12, 13.", sequence: ["Identify c = 13 (longest)", "Compute a² + b²: 25 + 144 = 169", "Compare with c²: 169 = 169 ✓ right"], diagnoses: { "Identify c = 13 (longest)@1": "Identify c first.", "Compute a² + b²: 25 + 144 = 169@0": "Then compute the sum.", "Compare with c²: 169 = 169 ✓ right@0": "Compare last." }, explanation: "Find c, add leg squares, compare with c².", hints: ["c = 13.", "25 + 144.", "169 = 169."] },
      // @q14
      { id: "U25L4-drag-1", type: "drag-match", category: "conceptual", prompt: "Match the comparison to the triangle type.", pairs: [ { source: "a² + b² = c²", target: "right-angled" }, { source: "a² + b² > c²", target: "acute" }, { source: "a² + b² < c²", target: "obtuse" } ], diagnoses: { "a² + b² = c²->acute": "Equality means right, not acute.", "a² + b² > c²->obtuse": "Greater means acute.", "a² + b² < c²->right-angled": "Less means obtuse." }, explanation: "The sign of the comparison classifies the biggest angle.", hints: ["= right.", "> acute.", "< obtuse."] },
      // @q15
      { id: "U25L4-graph-1", type: "graph-interact", category: "word", prompt: "Sides 3, 4, 5: set the slider to a² + b² (the sum to compare with c²).", challenge: "Set the slider to 25.", validate: { value: 25 }, tolerance: 0.01, explanation: "9 + 16 = 25 = 5² → right-angled confirmed.", hints: ["9 + 16.", "25.", "25."] }
    ],
