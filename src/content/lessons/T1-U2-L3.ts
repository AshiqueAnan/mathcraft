    ...
    pool: [
      {
        ...
        hints: ["Undo +7.", "15 − 7.", "Subtract 7 from both sides: x = 8."],
      },
      {
        ...
        correctOptionId: "b",
        diagnoses: { a: "+ is the inverse of −, not ×.", c: "− is the inverse of +.", d: "×3 then ×3 makes it 9 times." },
        explanation: "× and ÷ are inverse pairs.",
        hints: ["What cancels a triple?", "Split into 3 equal parts.", "× and ÷ are inverse pairs."],
      },
      {
        id: "U2L3-mcq-3", type: "mcq", category: "word",
        prompt: "A number is multiplied by 6 and the result is 54. What was the number?",
        options: [{ id: "a", text: "60" }, { id: "b", text: "48" }, { id: "c", text: "9" }, { id: "d", text: "324" }],
        correctOptionId: "c",
        diagnoses: { b: "48 = 54 − 6, but × needs ÷ to undo.", a: "60 = 54 + 6.", d: "324 = 54 × 6." },
        explanation: "Undo ×6 with ÷6: 54 ÷ 6 = 9.",
        hints: ["Undo multiply with divide.", "54 ÷ 6.", "Undo ×6 with ÷6: 54 ÷ 6 = 9."],
      },
      {
        id: "U2L3-mcq-4", type: "mcq", category: "procedural",
        prompt: "y − 4 = 9. What is y?",
        options: [{ id: "a", text: "36" }, { id: "b", text: "5" }, { id: "c", text: "9" }, { id: "d", text: "13" }],
        correctOptionId: "d",
        diagnoses: { b: "5 = 9 − 4, but you need to UNDO the −4 by adding.", c: "That's the result.", a: "36 = 9 × 4." },
        explanation: "Undo −4 by adding 4: y = 9 + 4 = 13.",
        hints: ["Undo minus with plus.", "9 + 4.", "Undo −4 by adding 4: y = 9 + 4 = 13."],
      },
      {
      ...
      },
      {
        ...
        hints: ["Halving is ÷2.", "Undo with ×2.", "×2 both sides: 13 × 2 = 26."],
      },
      {
        ...
        explanation: "÷4 ≡ ×(1/4).",
        hints: ["Division is multiplication by the reciprocal.", "Reciprocal of 4 is 1/4.", "÷4 ≡ ×(1/4)."],
      },
      {
        ...
        hints: ["What do +6 and −6 do together?", "They cancel.", "+ and − are inverse pairs; they cancel."],
      },
      {
        ...
        hints: ["Do ×5 twice to 2.", "2 → 10 → 50, not back to 2.", "×5 twice makes ×25."],
      },
      {
        ...
        hints: ["First, write the equation.", "Undo the +3.", "Undo +3 to isolate x, then verify."],
      },
      {
      ...
      },
      {
        ...
        hints: ["Undo +3.", "10 − 3.", "x = 7 is the solution."],
      },
    ],
