...
export const T5U32L3: Lesson = {
  ...
  quiz: {
    pool: [
      ...
      // @q06
      { id: "U32L3-mcq-6", type: "mcq", category: "word", prompt: "A population triples yearly. Years until 27× the start = …", options: [ { id: "a", text: "3" }, { id: "b", text: "9" }, { id: "c", text: "27" }, { id: "d", text: "6" } ], correctOptionId: "a", diagnoses: { b: "9 is 3² — that's 9×.", c: "27 is the multiplier.", d: "6 is 2 doublings of tripling — no." }, explanation: "3ᵗ = 27 → t = log₃27 = 3.", hints: ["3^t = 27.", "log₃27.", "3."] },
      // @q07
