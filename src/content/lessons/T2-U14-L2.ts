...
export const T2U14L2: Lesson = {
  ...
  quiz: {
    pool: [
      ...
      // @q02
      { id: "U14L2-mcq-2", type: "mcq", category: "conceptual", prompt: "What's the FIRST move for 5x + 4 = 2x + 13?", options: [ { id: "a", text: "Subtract 2x from both sides" }, { id: "b", text: "Subtract 4 only" }, { id: "c", text: "Divide by 5" }, { id: "d", text: "Add 2x" } ], correctOptionId: "a", diagnoses: { b: "Subtracting 4 from one side breaks balance.", c: "Can't divide while x is on both sides.", d: "Adding 2x increases x-count." }, explanation: "Subtract 2x → 3x + 4 = 13, then 3x = 9, x = 3.", hints: ["Collect x-terms.", "Subtract 2x.", "3x = 9."] },
      // @q03
      { id: "U14L2-mcq-3", type: "mcq", category: "word", prompt: "A fruit stall: 3 kg apples cost $2 more than 1 kg apples cost $10. The equation 3x + 2 = x + 10 models it. What is x (price per kg)?", options: [ { id: "a", text: "$4" }, { id: "b", text: "$8" }, { id: "c", text: "$3" }, { id: "d", text: "$12" } ], correctOptionId: "a", diagnoses: { b: "That's 10−2, wrong.", c: "That solves a different equation.", d: "That's 10+2." }, explanation: "3x + 2 = x + 10 → 2x + 2 = 10 → x = 4.", hints: ["Solve the equation.", "2x = 8.", "$4."] },
      // @q04
      { id: "U14L2-mcq-4", type: "mcq", category: "procedural", prompt: "Solve 4x − 2 = 2x + 6.", options: [ { id: "a", text: "x = 4" }, { id: "b", text: "x = 2" }, { id: "c", text: "x = 8" }, { id: "d", text: "x = 1" } ], correctOptionId: "a", diagnoses: { b: "2 gives 6 vs 10 — no.", c: "8 gives 30 vs 22 — no.", d: "1 gives 2 vs 8 — no." }, explanation: "Subtract 2x: 2x − 2 = 6; add 2: 2x = 8; x = 4. Check 14 = 14 ✓.", hints: ["Collect x's.", "2x − 2 = 6.", "x = 4."] },
      // @q05
      ...
      // @q06
      { id: "U14L2-mcq-6", type: "mcq", category: "word", prompt: "Two plans: Plan A charges 5x + 4, Plan B charges 2x + 13 and they cost the same. What is x?", options: [ { id: "a", text: "3" }, { id: "b", text: "9" }, { id: "c", text: "6" }, { id: "d", text: "17" } ], correctOptionId: "a", diagnoses: { b: "9 = 13 − 4, not the full solve.", c: "6 = 9 − 3, wrong.", d: "17 = 9 + 8, wrong." }, explanation: "5x + 4 = 2x + 13 → 3x + 4 = 13 → 3x = 9 → x = 3.", hints: ["Subtract 2x.", "3x = 9.", "x = 3."] },
      // @q07
