...
export const T3U24L1: Lesson = {
  ...
  quiz: {
    pool: [
      // @q01
      { id: "U24L1-mcq-1", type: "mcq", category: "procedural", prompt: "An L-shape splits into 3×4 and 5×2 rectangles. Total area = …", options: [ { id: "a", text: "22 units²" }, { id: "b", text: "14 units²" }, { id: "c", text: "24 units²" }, { id: "d", text: "20 units²" } ], correctOptionId: "a", diagnoses: { b: "14 is 3+4+5+2 — should multiply each rectangle.", c: "24 is 3×4 + 8+? — the two rectangles add to 22.", d: "20 is one rectangle only." }, explanation: "12 + 10 = 22 units².", hints: ["Area of each rectangle.", "12 + 10.", "22."] },
      // @q02
      { id: "U24L1-mcq-2", type: "mcq", category: "conceptual", prompt: "Why do split and subtract strategies give the same area?", options: [ { id: "a", text: "Both count the same squares inside the shape" }, { id: "b", text: "Subtract is more accurate" }, { id: "c", text: "Split only works for rectangles" }, { id: "d", text: "They're different answers" } ], correctOptionId: "a", diagnoses: { b: "Both are exact for straight-edged shapes.", c: "Split works for any compound of simple shapes.", d: "They must agree — great self-check." }, explanation: "Partitioning changes the counting, not the shape's area.", hints: ["Same shape inside.", "Same squares.", "Same area."] },
      // @q03
      { id: "U24L1-mcq-3", type: "mcq", category: "word", prompt: "A 6×6 patio has a 2×3 planter in one corner. Patio area (subtract) = …", options: [ { id: "a", text: "30 units²" }, { id: "b", text: "36 units²" }, { id: "c", text: "24 units²" }, { id: "d", text: "12 units²" } ], correctOptionId: "a", diagnoses: { b: "36 is the full square without removing the planter.", c: "24 is 6×4, not a proper subtract.", d: "12 is just the planter's area." }, explanation: "36 − 6 = 30 units².", hints: ["Big square minus cut-out.", "36 − 6.", "30."] },
      // @q04
      { id: "U24L1-mcq-4", type: "mcq", category: "procedural", prompt: "Notched rectangle 8×5 with 3×2 removed. Area = …", options: [ { id: "a", text: "34 units²" }, { id: "b", text: "40 units²" }, { id: "c", text: "28 units²" }, { id: "d", text: "16 units²" } ], correctOptionId: "a", diagnoses: { b: "40 is the full rectangle before removing.", c: "28 is 8×5 − 12 — wrong removal size.", d: "16 halves something groundlessly." }, explanation: "40 − 6 = 34 units².", hints: ["8 × 5 = 40.", "Remove 3 × 2 = 6.", "34."] },
      // @q05
      { id: "U24L1-mcq-5", type: "mcq", category: "conceptual", prompt: "Splitting a compound shape requires…", options: [ { id: "a", text: "pieces with known dimensions" }, { id: "b", text: "all pieces the same size" }, { id: "c", text: "at least three pieces" }, { id: "d", text: "only squares" } ], correctOptionId: "a", diagnoses: { b: "Pieces can differ.", c: "Two pieces often suffice.", d: "Rectangles and triangles work too." }, explanation: "You can add areas only when you know each piece's dimensions.", hints: ["What does area need?", "Known dimensions.", "Known pieces."] },
      // @q06
      { id: "U24L1-mcq-6", type: "mcq", category: "word", prompt: "A room is 7 m × 5 m with a 2 m × 2 m wardrobe. Carpet area (subtract) = …", options: [ { id: "a", text: "31 m²" }, { id: "b", text: "35 m²" }, { id: "c", text: "33 m²" }, { id: "d", text: "14 m²" } ], correctOptionId: "a", diagnoses: { b: "35 m² is the full floor — the wardrobe isn't carpeted.", c: "33 removes only 2 m² — the wardrobe is 4 m².", d: "14 is half the floor." }, explanation: "35 − 4 = 31 m².", hints: ["7 × 5 = 35.", "Remove 2 × 2 = 4.", "31."] },
      // @q07
      { id: "U24L1-num-1", type: "numeric-input", category: "procedural", prompt: "L-shape: rectangles 4×3 and 6×2. Area in units².", answer: 24, tolerance: 0, unit: "units²", explanation: "12 + 12 = 24 units².", hints: ["Each rectangle's area.", "12 + 12.", "24."] },
      // @q08
      { id: "U24L1-num-2", type: "numeric-input", category: "procedural", prompt: "10 × 8 rectangle with a 4 × 3 corner cut out. Area in units².", answer: 68, tolerance: 0, unit: "units²", explanation: "80 − 12 = 68 units².", hints: ["Full rectangle first.", "80 − 12.", "68."] },
      // @q09
      { id: "U24L1-num-3", type: "numeric-input", category: "conceptual", prompt: "9 × 9 square with a 3 × 3 square removed from a corner. Remaining area.", answer: 72, tolerance: 0, explanation: "81 − 9 = 72 units².", hints: ["Big square minus small.", "81 − 9.", "72."] },
      // @q10
      { id: "U24L1-frac-1", type: "fraction-input", category: "conceptual", prompt: "A 2×2 planter sits inside a 6×6 garden. What fraction of the garden is the planter?", numerator: 1, denominator: 9, acceptEquivalent: true, explanation: "Planter 4, garden 36: 4/36 = 1/9.", hints: ["4 out of 36.", "1/9.", "1/9."] },
      // @q11
      { id: "U24L1-tf-1", type: "true-false-justify", category: "conceptual", prompt: "Split and subtract strategies must agree on the same area.", isTrue: true, explanation: "Both partition the same shape — different counting, same total.", hints: ["Same shape.", "Same squares.", "True."] },
      // @q12
      { id: "U24L1-tf-2", type: "true-false-justify", category: "conceptual", prompt: "A compound shape always has a single formula for its area.", isTrue: false, explanation: "No single formula — decompose into known shapes and add/subtract.", hints: ["Break it apart.", "Add the pieces.", "False."] },
      // @q13
      { id: "U24L1-order-1", type: "order-steps", category: "word", prompt: "Order the steps to subtract a cut-out's area.", sequence: ["Find the big rectangle's area", "Find the cut-out's area", "Subtract: big − cut-out"], diagnoses: { "Find the big rectangle's area@1": "Start with the big shape.", "Find the cut-out's area@0": "Then the cut-out.", "Subtract: big − cut-out@0": "Subtract last." }, explanation: "Big area, small area, subtract.", hints: ["Big shape first.", "Then the hole.", "Subtract."] },
      // @q14
      ...
      // @q15
      { id: "U24L1-graph-1", type: "graph-interact", category: "word", prompt: "A 10×6 rectangle has a 4×3 piece removed. Set the slider to the remaining area (key: value).", challenge: "Set the slider to 48.", validate: { value: 48 }, tolerance: 0.01, explanation: "60 − 12 = 48.", hints: ["10 × 6 = 60.", "60 − 12.", "48."] }
    ],
