...
export const T3U24L1: Lesson = {
  ...
  quiz: {
    pool: [
      ...
      // @q04
      { id: "U24L1-mcq-4", type: "mcq", category: "procedural", prompt: "Notched rectangle 8×5 with 3×2 removed. Area = …", options: [ { id: "a", text: "16 units²" }, { id: "b", text: "40 units²" }, { id: "c", text: "28 units²" }, { id: "d", text: "34 units²" } ], correctOptionId: "d", diagnoses: { b: "40 is the full rectangle before removing.", c: "28 is 8×5 − 12 — wrong removal size.", a: "16 halves something groundlessly." }, explanation: "40 − 6 = 34 units².", hints: ["8 × 5 = 40.", "Remove 3 × 2 = 6.", "34."] },
      // @q05
