    ...
    pool: [
      {
        ...
        hints: ["Compare tenths first.", "0.7 = 7 tenths.", "0.7 has 7 tenths; 0.65 has 6 tenths (65 hundredths = 6.5 tenths). So 0.7 is bigger."],
      },
      {
      ...
      },
      {
        ...
        hints: ["Faster = smaller time.", "Compare 9.80 vs 9.75.", "9.8 s = 9.80 s > 9.75 s, so the 9.75 s runner is faster."],
      },
      {
      ...
      },
      {
        ...
        hints: ["Subtract 1.05 from 1.25.", "125 − 105 hundredths.", "1.25 − 1.05 = 0.20 kg."],
      },
      {
        ...
        hints: ["0.30 = 30 hundredths.", "Simplify.", "0.30 = 30/100 = 3/10. (Type 3/10 as a fraction.)"],
      },
      {
        ...
        hints: ["×10 shifts left.", "4 tenths × 10 = 4 ones.", "0.4 × 10 = 4 — each digit moves one place left."],
      },
      {
        ...
        hints: ["Write 0.7 as 0.70.", "Subtract hundredths.", "0.70 − 0.35 = 0.35."],
      },
      {
        ...
        hints: ["Write 0.6 as 0.60.", "Add.", "0.60 + 0.35 = 0.95 km."],
      },
      {
        ...
        hints: ["25 hundredths.", "Divide by 25.", "0.25 = 25/100 = 1/4."],
      },
      {
        ...
        hints: ["0.3 = 0.30.", "Compare hundredths.", "0.3 = 0.30 > 0.29 (30 hundredths vs 29)."],
      },
      {
        ...
        hints: ["0.750 = 750 thousandths.", "0.75 = 750 thousandths.", "Trailing zeros don't change the value: 0."],
      },
      {
      ...
      },
      {
        ...
        hints: ["1/2 is half.", "1/4 is a quarter.", "1/2 = 0.5, 1/4 = 0.25, 3/4 = 0.75."],
      },
      {
        ...
        hints: ["Between 0 and 1.", "Seven tenths.", "0.7 is seven tenths on the number line."],
      },
    ],
