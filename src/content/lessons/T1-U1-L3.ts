  ...
  quiz: {
    pool: [
      ...
      },
      {
        ...
        options: [{ id: "a", text: "9.75 s — smaller time" }, { id: "b", text: "9.8 s — bigger number" }, { id: "c", text: "Same time" }, { id: "d", text: "Cannot tell" }],
        correctOptionId: "a",
        diagnoses: { b: "Smaller time = faster in a race.", c: "9.8 = 9.80 > 9.75.", d: "Compare from the left." },
      ...
      },
      {
        ...
        options: [{ id: "a", text: "0.50" }, { id: "b", text: "0.500" }, { id: "c", text: "0.05" }, { id: "d", text: "1/2" }],
        correctOptionId: "c",
        diagnoses: { a: "0.50 = 50 hundredths = 0.5.", b: "0.500 = 500 thousandths = 0.5.", d: "1/2 = 0.5 exactly." },
      ...
      },
      {
        ...
        options: [{ id: "a", text: "0.20 kg" }, { id: "b", text: "0.30 kg" }, { id: "c", text: "1.20 kg" }, { id: "d", text: "0.25 kg" }],
        correctOptionId: "a",
        diagnoses: { b: "0.30 would mean you had 0.95 kg.", c: "Subtract, don't add.", d: "0.25 is 1.25 − 1.00." },
