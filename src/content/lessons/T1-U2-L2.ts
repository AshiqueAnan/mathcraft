  ...
  quiz: {
    pool: [
      ...
      },
      {
        ...
        correctOptionId: "a",
        diagnoses: { b: "14 — lower than 20.", c: "14 — the bracket holds 3+4=7, times 2.", d: "10 — smallest of the group." },
      ...
      },
      {
        ...
        options: [{ id: "a", text: "16" }, { id: "b", text: "12" }, { id: "c", text: "18" }, { id: "d", text: "22" }],
        correctOptionId: "a",
        diagnoses: { b: "You forgot to subtract the 2 cracked.", c: "That's counting cracked eggs too.", d: "You added instead of subtracting." },
      ...
      },
      {
        ...
        prompt: "6 × (4 + 1) = ?",
        options: [{ id: "a", text: "30" }, { id: "b", text: "25" }, { id: "c", text: "28" }, { id: "d", text: "24" }],
        correctOptionId: "a",
        diagnoses: { b: "25 = (6×4)+1, ignoring the bracket's ×5.", c: "28 = 6×4 + 4.", d: "24 = 6×4, missing +1 inside." },
      ...
      },
      {
        ...
        options: [{ id: "a", text: "$16" }, { id: "b", text: "$20" }, { id: "c", text: "$14" }, { id: "d", text: "$18" }],
        correctOptionId: "a",
        diagnoses: { b: "That's $4 × 5, ignoring the $2 rate for km 4-5.", c: "$14 = $4×3 + $2, missing one km.", d: "$18 = $4×3 + $2×3." },
