    ...
    pool: [
      {
        ...
        hints: ["Do the bracket first.", "3 + 2 = 5.", "Bracket first: 3+2=5, then 10−5=5."],
      },
      {
      ...
      },
      {
        ...
        hints: ["Good = total − 2.", "18 − 2.", "3 × 6 − 2 = 18 − 2 = 16."],
      },
      {
        ...
        hints: ["Inside first.", "4 + 1 = 5.", "Bracket: 4+1=5, then 6×5=30."],
      },
      {
        ...
        hints: ["Inside first: 5 − 2 = 3.", "12 − 3.", "5 − 2 = 3, so 12 − 3 = 9."],
      },
      {
        ...
        hints: ["First 3 km at $4.", "Next 2 km at $2.", "(3×$4) + (2×$2) = $12 + $4 = $16."],
      },
      {
        ...
        hints: ["Bracket first.", "8 + 6.", "3×2 = 6, then 8+6 = 14."],
      },
      {
        ...
        hints: ["Inside first.", "11 × 2.", "8+3 = 11, then 11×2 = 22."],
      },
      {
        ...
        hints: ["Bracket first.", "20 − 10.", "4+6 = 10, then 20−10 = 10."],
      },
      {
        ...
        hints: ["Group the 2+3.", "5 × 5.", "(2+3)×5 = 5×5 = 25."],
      },
      {
        ...
        hints: ["Left = 8 − 3.", "5 slices of 8.", "8 − 3 = 5, so 5/8 remains."],
      },
      {
        ...
        hints: ["Inside first.", "15 − 2.", "5 − 3 = 2, so 15 − 2 = 13."],
      },
      {
        ...
        hints: ["Left: 6×3 = 18.", "Right: 4 + 6 = 10.", "18 ≠ 10 — brackets change the grouping."],
      },
      {
        ...
        hints: ["Inside first.", "5.", "Bracket: 3+2=5, then 12−5=7."],
      },
      {
        ...
        hints: ["2 + 12.", "5 × 4.", "Brackets decide: 14, 20, 14."],
      },
      {
        ...
        hints: ["What is inside the bracket?", "5 × 4.", "(2+3)×4 = 20."],
      },
    ],
