    ...
    pool: [
      {
        ...
        hints: ["Try dividing by small primes.", "13 has no divisors but 1 and 13.", "13 only divides by 1 and 13."],
      },
      {
        id: "U3L1-mcq-2", type: "mcq", category: "conceptual",
        prompt: "Which is the only even prime?",
        options: [{ id: "a", text: "4" }, { id: "b", text: "2" }, { id: "c", text: "6" }, { id: "d", text: "8" }],
        correctOptionId: "b",
        diagnoses: { a: "4 = 2×2.", c: "6 = 2×3.", d: "8 = 2×4." },
        explanation: "Every other even number divides by 2, so 2 alone is the even prime.",
        hints: ["Even numbers divide by 2.", "Only one has no other divisor.", "Every other even number divides by 2, so 2 alone is the even prime."],
      },
      {
        id: "U3L1-mcq-3", type: "mcq", category: "procedural",
        prompt: "Is 1 a prime number?",
        options: [{ id: "a", text: "Sometimes" }, { id: "b", text: "Yes" }, { id: "c", text: "No" }, { id: "d", text: "Only when odd" }],
        correctOptionId: "c",
        diagnoses: { b: "1 has only one divisor, not two distinct ones.", a: "Definition is fixed.", d: "No special odd rule." },
        explanation: "Primes need exactly two divisors. 1 has only one divisor (itself).",
        hints: ["Count 1's divisors.", "Primes need exactly two.", "Primes need exactly two divisors."],
      },
      {
        id: "U3L1-mcq-4", type: "mcq", category: "conceptual",
        prompt: "A number that has more than two divisors is called...",
        options: [{ id: "a", text: "Atom" }, { id: "b", text: "Prime" }, { id: "c", text: "Odd" }, { id: "d", text: "Composite" }],
        correctOptionId: "d",
        diagnoses: { b: "Prime means exactly two divisors.", c: "Odd says nothing about divisors.", a: "Atoms are the primes." },
        explanation: "Composite numbers have more than two divisors.",
        hints: ["Prime = exactly 2 divisors.", "The opposite is composite.", "Composite numbers have more than two divisors."],
      },
      {
        ...
        hints: ["List ways to split each.", "11 only 1×11.", "Prime 11 resists splitting; composite 9 = 3 × 3."],
      },
      {
        id: "U3L1-mcq-6", type: "mcq", category: "procedural",
        prompt: "Which of these is composite?",
        options: [{ id: "a", text: "17" }, { id: "b", text: "49" }, { id: "c", text: "19" }, { id: "d", text: "23" }],
        correctOptionId: "b",
        diagnoses: { a: "17 is prime.", c: "19 is prime.", d: "23 is prime." },
        explanation: "49 = 7 × 7; the rest are prime.",
        hints: ["Check 7 × 7.", "49 = 49?", "49 = 7 × 7; the rest are prime."],
      },
      {
        ...
        hints: ["List 10–20.", "11, 13, 17, 19.", "11, 13, 17, 19 → 4 primes."],
      },
      {
        ...
        hints: ["Start at 2.", "2 only divides by 1 and 2.", "2 is the smallest prime (and only even prime)."],
      },
      {
        ...
        hints: ["1 and itself.", "Just two.", "Prime has exactly 2 divisors."],
      },
      {
        ...
        hints: ["List primes below 12.", "2, 3, 5, 7, 11.", "Primes below 12: 2, 3, 5, 7, 11 → 5."],
      },
      {
        ...
        hints: ["List 2 to 10.", "Primes: 2, 3, 5, 7.", "2–10 = 9 numbers; primes 2, 3, 5, 7 = 4; so 4/9."],
      },
      {
        ...
        hints: ["Check the smallest prime.", "2 is even.", "2 is prime and even."],
      },
      {
        ...
        hints: ["9 = 3 × 3.", "More than two divisors.", "9 has divisors beyond 1 and 9, so composite."],
      },
      {
      ...
      },
      {
        ...
        hints: ["11: only 1×11.", "12: many factors.", "11 and 23 are prime; 12 is composite."],
      },
      {
        ...
        hints: ["Smallest prime.", "Only even prime.", "2 is the smallest prime."],
      },
    ],
