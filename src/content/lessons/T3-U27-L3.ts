...
export const T3U27L3: Lesson = {
  ...
  quiz: {
    pool: [
      // @q01
      { id: "U27L3-mcq-1", type: "mcq", category: "procedural", prompt: "Distance between (3, 1) and (6, 5) = …", options: [ { id: "a", text: "5" }, { id: "b", text: "√22" }, { id: "c", text: "7" }, { id: "d", text: "13" } ], correctOptionId: "a", diagnoses: { b: "√22 comes from adding squares of wrong gaps.", c: "7 adds 3 + 4 directly.", d: "13 is 9 + 4 added unrooted." }, explanation: "Δx = 3, Δy = 4 → d = √(9 + 16) = 5.", hints: ["Gaps 3 and 4.", "√25.", "Δx = 3, Δy = 4 → d = √(9 + 16) = 5."] },
      // @q02
      { id: "U27L3-mcq-2", type: "mcq", category: "conceptual", prompt: "The distance formula is really…", options: [ { id: "a", text: "the average of the points" }, { id: "b", text: "Pythagoras on the gap triangle" }, { id: "c", text: "the slope of the line" }, { id: "d", text: "adding coordinates" } ], correctOptionId: "b", diagnoses: { a: "Averaging gives the MIDPOINT.", c: "Slope is rise/run, not length.", d: "Adding loses the geometry." }, explanation: "Δx and Δy are the legs; the segment is the hypotenuse.", hints: ["Right triangle.", "Pythagoras.", "Δx and Δy are the legs; the segment is the hypotenuse."] },
      // @q03
      { id: "U27L3-mcq-3", type: "mcq", category: "word", prompt: "Two towns at (2, 3) and (7, 15) on a grid. Straight-line distance = …", options: [ { id: "a", text: "17" }, { id: "b", text: "√89" }, { id: "c", text: "13" }, { id: "d", text: "10" } ], correctOptionId: "c", diagnoses: { b: "√89 uses gaps 5 and 8 — that's 25 + 64 = 89, so the root is √89 which isn't 13.", a: "17 adds 5 + 12 without rooting.", d: "10 is just Δy." }, explanation: "Δx = 5, Δy = 12 → d = √(25 + 144) = √169 = 13.", hints: ["Gaps 5 and 12.", "√169.", "Δx = 5, Δy = 12 → d = √(25 + 144) = √169 = 13."] },
      // @q04
      { id: "U27L3-mcq-4", type: "mcq", category: "procedural", prompt: "Midpoint of (1, 2) and (5, 8) = …", options: [ { id: "a", text: "(6, 10)" }, { id: "b", text: "(4, 6)" }, { id: "c", text: "(2, 3)" }, { id: "d", text: "(3, 5)" } ], correctOptionId: "d", diagnoses: { b: "(4, 6) adds and divides by 1 — midpoint averages.", c: "(2, 3) subtracts the points.", a: "(6, 10) adds without dividing." }, explanation: "M = ((1+5)/2, (2+8)/2) = (3, 5).", hints: ["Average x's.", "Average y's.", "M = ((1+5)/2, (2+8)/2) = (3, 5)."] },
      // @q05
      { id: "U27L3-mcq-5", type: "mcq", category: "conceptual", prompt: "Why can you subtract points in either order for distance?", options: [ { id: "a", text: "The gaps get squared, killing the sign" }, { id: "b", text: "Midpoints swap order" }, { id: "c", text: "Slopes ignore order" }, { id: "d", text: "You can't actually" } ], correctOptionId: "a", diagnoses: { b: "Midpoint order doesn't change either, but that's a separate idea.", c: "Slope DOES care about order — rise/run flips sign.", d: "You can; squaring removes the sign." }, explanation: "(−Δx)² = (Δx)², so distance is order-independent.", hints: ["Squared.", "Sign vanishes.", "(−Δx)² = (Δx)², so distance is order-independent."] },
      // @q06
      { id: "U27L3-mcq-6", type: "mcq", category: "word", prompt: "A phone mast at (0, 0) has a 10 km radius. Which point is JUST OUT of range?", options: [ { id: "a", text: "(6, 8)" }, { id: "b", text: "(9, 5)" }, { id: "c", text: "(8, 6)" }, { id: "d", text: "(0, 10)" } ], correctOptionId: "b", diagnoses: { a: "√(36+64) = 10 — exactly in range.", c: "√(64+36) = 10 — exactly in range.", d: "√(0+100) = 10 — exactly on the radius." }, explanation: "√(81 + 25) = √106 ≈ 10.3 km — over the 10 km radius.", hints: ["d = √(81+25).", "√106 ≈ 10.3.", "√(81 + 25) = √106 ≈ 10."] },
      // @q07
      { id: "U27L3-num-1", type: "numeric-input", category: "procedural", prompt: "Distance from (1, 1) to (4, 5).", answer: 5, tolerance: 0, explanation: "Δx = 3, Δy = 4 → d = √25 = 5.", hints: ["Gaps 3 and 4.", "√25.", "Δx = 3, Δy = 4 → d = √25 = 5."] },
      // @q08
      { id: "U27L3-num-2", type: "numeric-input", category: "procedural", prompt: "Midpoint of (−2, 4) and (6, 8). x-coordinate = …", answer: 2, tolerance: 0, explanation: "x = (−2 + 6)/2 = 2.", hints: ["Average x's.", "4/2.", "x = (−2 + 6)/2 = 2."] },
      // @q09
      { id: "U27L3-num-3", type: "numeric-input", category: "conceptual", prompt: "Distance from (0, 0) to (0, 6): the vertical gap is 6, so d = …", answer: 6, tolerance: 0, explanation: "Vertical-only: d = |Δy| = 6.", hints: ["Straight up.", "6.", "Vertical-only: d = |Δy| = 6."] },
      // @q10
      { id: "U27L3-frac-1", type: "fraction-input", category: "conceptual", prompt: "The midpoint of (0, 0) and (3, 1) has coordinates (3/2, 1/2). What fraction of the way from (0,0) is the midpoint?", numerator: 1, denominator: 2, acceptEquivalent: true, explanation: "The midpoint sits exactly halfway — 1/2 the distance.", hints: ["Halfway.", "1/2.", "The midpoint sits exactly halfway — 1/2 the distance."] },
      // @q11
      { id: "U27L3-tf-1", type: "true-false-justify", category: "conceptual", prompt: "The midpoint's coordinates are the averages of the endpoints' coordinates.", isTrue: true, explanation: "M = ((x₁+x₂)/2, (y₁+y₂)/2) — each coordinate splits its gap in half.", hints: ["Average each pair.", "M = averages.", "M = ((x₁+x₂)/2, (y₁+y₂)/2) — each coordinate splits its gap in half."] },
      // @q12
      { id: "U27L3-tf-2", type: "true-false-justify", category: "conceptual", prompt: "x₂² − x₁² = (x₂ − x₁)².", isTrue: false, explanation: "Squaring a difference needs the whole gap squared: (x₂ − x₁)² ≠ x₂² − x₁².", hints: ["Subtract FIRST.", "Then square.", "Squaring a difference needs the whole gap squared: (x₂ − x₁)² ≠ x₂² − x₁²."] },
      // @q13
      { id: "U27L3-order-1", type: "order-steps", category: "word", prompt: "Order the steps to find the distance from (1, 2) to (4, 6).", sequence: ["Find gaps: Δx = 3, Δy = 4", "Square and add: 9 + 16 = 25", "Root: d = 5"], diagnoses: { "Find gaps: Δx = 3, Δy = 4@1": "Find the gaps first.", "Square and add: 9 + 16 = 25@0": "Then square and add.", "Root: d = 5@0": "Root last." }, explanation: "Gaps, square-sum, root.", hints: ["3 and 4.", "25.", "Gaps, square-sum, root."] },
      // @q14
      { id: "U27L3-drag-1", type: "drag-match", category: "conceptual", prompt: "Match each formula to its use.", pairs: [ { source: "Distance", target: "√((Δx)² + (Δy)²)" }, { source: "Midpoint", target: "average coordinates" }, { source: "Both", target: "need two points" } ], diagnoses: { "Distance->average coordinates": "Distance roots the squared gaps.", "Midpoint->√((Δx)² + (Δy)²)": "Midpoint averages, it doesn't root.", "Both->only one point": "Both formulas use two endpoints." }, explanation: "Distance measures the segment; midpoint halves it.", hints: ["Distance = root-sum.", "Midpoint = average.", "Distance measures the segment; midpoint halves it."] },
      // @q15
      { id: "U27L3-graph-1", type: "graph-interact", category: "word", prompt: "Distance from (0, 0) to (3, 4). Set the slider to d (key: value).", challenge: "Distance from (0, 0) to (3, 4). — adjust the values below to match the condition.", validate: { value: 5 }, tolerance: 0.01, explanation: "√(9 + 16) = 5.", hints: ["√25.", "5.", "√(9 + 16) = 5."] }
    ],
