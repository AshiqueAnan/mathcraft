...
export const T3U22L1: Lesson = {
  ...
  quiz: {
    pool: [
      ...
      // @q03
      { id: "U22L1-mcq-3", type: "mcq", category: "word", prompt: "A builder bisects a 10 m rafter from a blueprint: the perpendicular bisector cuts it into…", options: [ { id: "a", text: "6 m and 4 m" }, { id: "b", text: "10 m and 0 m" }, { id: "c", text: "5 m and 5 m" }, { id: "d", text: "Any two pieces" } ], correctOptionId: "c", diagnoses: { b: "That wouldn't bisect at all.", a: "The bisector splits it exactly in half.", d: "Bisect means precisely two equal halves." }, explanation: "Bisect = divide into two equal parts: 10/2 = 5 m each.", hints: ["Bisect = half.", "10 ÷ 2.", "Bisect = divide into two equal parts: 10/2 = 5 m each."] },
      // @q04
      { id: "U22L1-mcq-4", type: "mcq", category: "procedural", prompt: "An angle bisector of 74° creates two angles of…", options: [ { id: "a", text: "180°" }, { id: "b", text: "74°" }, { id: "c", text: "148°" }, { id: "d", text: "37°" } ], correctOptionId: "d", diagnoses: { b: "That's the original angle, not each half.", c: "148° is the double, not the halves.", a: "180° is a straight line." }, explanation: "74 ÷ 2 = 37° per half.", hints: ["Bisect = halve.", "74 ÷ 2.", "74 ÷ 2 = 37° per half."] },
      // @q05
      { id: "U22L1-mcq-5", type: "mcq", category: "conceptual", prompt: "What does the perpendicular bisector do to AB?", options: [ { id: "a", text: "Cuts it in half at a right angle" }, { id: "b", text: "Extends it twice as long" }, { id: "c", text: "Turns it into an angle" }, { id: "d", text: "Finds its centre circle" } ], correctOptionId: "a", diagnoses: { b: "It cuts, never extends.", c: "It stays a segment, just bisected.", d: "The 'centre' idea applies to the arcs, not the segment." }, explanation: "Perpendicular (90°) + bisector (halves) = midpoint at a right angle.", hints: ["Perpendicular = 90°.", "Bisector = halves.", "Perpendicular (90°) + bisector (halves) = midpoint at a right angle."] },
      // @q06
      { id: "U22L1-mcq-6", type: "mcq", category: "word", prompt: "Fence posts at A and B; you need the point exactly midway but can't measure. The compass method gives…", options: [ { id: "a", text: "A completely random point" }, { id: "b", text: "The perpendicular bisector crossing AB at the midpoint" }, { id: "c", text: "The longer half only" }, { id: "d", text: "The centre of the earth" } ], correctOptionId: "b", diagnoses: { a: "The construction is exact, not random.", c: "Both halves are equal by construction.", d: "Nothing about the earth is needed." }, explanation: "The constructed crossing line meets AB at its exact midpoint.", hints: ["Equal radii.", "Midpoint.", "The constructed crossing line meets AB at its exact midpoint."] },
      // @q07
      { id: "U22L1-num-1", type: "numeric-input", category: "procedural", prompt: "Bisect a 10 cm segment. Type each half's length.", answer: 5, tolerance: 0, explanation: "10 ÷ 2 = 5 cm each.", hints: ["Bisect = half.", "10 ÷ 2.", "10 ÷ 2 = 5 cm each."] },
      // @q08
      { id: "U22L1-num-2", type: "numeric-input", category: "procedural", prompt: "Bisect a 96° angle. Type each angle.", answer: 48, tolerance: 0, explanation: "96 ÷ 2 = 48° each.", hints: ["Halve the angle.", "96 ÷ 2.", "96 ÷ 2 = 48° each."] },
      // @q09
      { id: "U22L1-num-3", type: "numeric-input", category: "conceptual", prompt: "Perpendicular bisector of AB makes a 90° angle. Type it.", answer: 90, tolerance: 0, explanation: "Perpendicular = 90°.", hints: ["Perpendicular.", "90.", "Perpendicular = 90°."] },
      // @q10
      { id: "U22L1-frac-1", type: "fraction-input", category: "conceptual", prompt: "The angle bisector divides an angle into how many equal parts? Write as a fraction.", numerator: 1, denominator: 2, acceptEquivalent: true, explanation: "Bisector = two equal halves.", hints: ["Bisect = two.", "1/2 each part.", "Bisector = two equal halves."] },
      // @q11
      { id: "U22L1-tf-1", type: "true-false-justify", category: "conceptual", prompt: "The perpendicular bisector crosses the segment at right angles at its midpoint.", isTrue: true, explanation: "Perpendicular = 90°, bisector = midpoint — both features at once.", hints: ["Perpendicular.", "Bisector.", "Perpendicular = 90°, bisector = midpoint — both features at once."] },
      // @q12
      { id: "U22L1-tf-2", type: "true-false-justify", category: "conceptual", prompt: "The angle bisector splits the angle into three equal parts.", isTrue: false, explanation: "Bisect means TWO equal parts.", hints: ["Bisect = two.", "Not three.", "Bisect means TWO equal parts."] },
      // @q13
