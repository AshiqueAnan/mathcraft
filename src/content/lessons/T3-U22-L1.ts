...
export const T3U22L1: Lesson = {
  ...
  quiz: {
    pool: [
      ...
      // @q02
      { id: "U22L1-mcq-2", type: "mcq", category: "conceptual", prompt: "Why does a compass arc work for construction?", options: [ { id: "a", text: "Every point on it is the same distance from the centre" }, { id: "b", text: "It draws straight lines perfectly" }, { id: "c", text: "It measures angles automatically" }, { id: "d", text: "It shrinks the drawing" } ], correctOptionId: "a", diagnoses: { b: "Straight lines come from rulers; the compass makes circles.", c: "Angles are constructed, not measured, by compass logic.", d: "Size isn't the point of the arcs." }, explanation: "A fixed radius guarantees equal distances — the core of every construction.", hints: ["Fixed distance.", "Equidistant points.", "Why the arcs work."] },
      // @q03
      { id: "U22L1-mcq-3", type: "mcq", category: "word", prompt: "A builder bisects a 10 m rafter from a blueprint: the perpendicular bisector cuts it into…", options: [ { id: "a", text: "5 m and 5 m" }, { id: "b", text: "10 m and 0 m" }, { id: "c", text: "6 m and 4 m" }, { id: "d", text: "Any two pieces" } ], correctOptionId: "a", diagnoses: { b: "That wouldn't bisect at all.", c: "The bisector splits it exactly in half.", d: "Bisect means precisely two equal halves." }, explanation: "Bisect = divide into two equal parts: 10/2 = 5 m each.", hints: ["Bisect = half.", "10 ÷ 2.", "5 m and 5 m."] },
      // @q04
      { id: "U22L1-mcq-4", type: "mcq", category: "procedural", prompt: "An angle bisector of 74° creates two angles of…", options: [ { id: "a", text: "37°" }, { id: "b", text: "74°" }, { id: "c", text: "148°" }, { id: "d", text: "180°" } ], correctOptionId: "a", diagnoses: { b: "That's the original angle, not each half.", c: "148° is the double, not the halves.", d: "180° is a straight line." }, explanation: "74 ÷ 2 = 37° per half.", hints: ["Bisect = halve.", "74 ÷ 2.", "37°."] },
      // @q05
