  ...
  quiz: {
    pool: [
      ...
      },
      {
        ...
        options: [
          { id: "a", text: "Your slice of A is bigger than your slice of B." },
          { id: "b", text: "Your slice of B is bigger than your slice of A." },
          { id: "c", text: "Both slices are the same size." },
          { id: "d", text: "We can't tell without seeing the pizzas." },
        ],
        correctOptionId: "a",
        diagnoses: {
          b: "More slices means smaller slices, not bigger! Cutting A into 4 gives fewer, bigger pieces. Cutting B into 8 gives more, smaller pieces.",
      ...
      },
      {
        ...
        diagnoses: {
          ...
          c: "7 is how many squares are left — but the fraction is about what Aya ATE, compared to the whole bar (12), not compared to what's left.",
      ...
      },
      {
        ...
        diagnoses: {
          ...
          d: "You reported the leftover (3 out of 5). The question asks for what you USED — 2 out of 5.",
        },
      ...
      },
      {
        ...
        correctOptionId: "a",
        diagnoses: {
          b: "$\\frac{4}{6}$ is how much was EATEN — the question asks what is LEFT.",
