...
export const T2U12L3: Lesson = {
  ...
  quiz: {
    pool: [
      ...
      // @q06
      { id: "U12L3-mcq-6", type: "mcq", category: "word", prompt: "A garden's area is 10x + 15. Which shows it factored as length × width?", options: [ { id: "a", text: "2(5x + 15)" }, { id: "b", text: "5(2x + 3)" }, { id: "c", text: "5(x + 15)" }, { id: "d", text: "10(x + 5)" } ], correctOptionId: "b", diagnoses: { a: "2 isn't the HCF — 5 is.", c: "15÷5 = 3, not 15.", d: "10 doesn't divide 15." }, explanation: "HCF 5: 10x + 15 = 5(2x + 3).", hints: ["HCF of 10 and 15?", "5.", "5(2x + 3)."] },
      // @q07
