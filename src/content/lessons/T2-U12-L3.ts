...
export const T2U12L3: Lesson = {
  ...
  quiz: {
    pool: [
      // @q01
      { id: "U12L3-mcq-1", type: "mcq", category: "procedural", prompt: "Factorize 3x + 12.", options: [ { id: "a", text: "3(x + 4)" }, { id: "b", text: "3(x + 12)" }, { id: "c", text: "x(3 + 12)" }, { id: "d", text: "3x + 4" } ], correctOptionId: "a", diagnoses: { b: "12÷3 = 4, not 12.", c: "x doesn't divide 12.", d: "That's not factored." }, explanation: "HCF of 3x and 12 is 3 → 3(x + 4).", hints: ["What divides 3x and 12?", "3.", "3(x + 4)."] },
      // @q02
      { id: "U12L3-mcq-2", type: "mcq", category: "conceptual", prompt: "Why is 2(3x + 6) NOT the fully factored form of 6x + 12?", options: [ { id: "a", text: "2 isn't the highest common factor" }, { id: "b", text: "It changes the value" }, { id: "c", text: "It's not a product" }, { id: "d", text: "Brackets are wrong" } ], correctOptionId: "a", diagnoses: { b: "2(3x+6) = 6x+12 — same value.", c: "It IS a product (2 × bracket).", d: "Brackets are fine." }, explanation: "The HCF is 6, so the tidy form is 6(x + 2).", hints: ["Biggest factor of both?", "6.", "6(x + 2)."] },
      // @q03
      { id: "U12L3-mcq-3", type: "mcq", category: "word", prompt: "A farm has 8x sheep and 12x goats. Factorize the total.", options: [ { id: "a", text: "4x(2 + 3)" }, { id: "b", text: "4(2x + 3x)" }, { id: "c", text: "x(8 + 12)" }, { id: "d", text: "20x²" } ], correctOptionId: "a", diagnoses: { b: "4 is a factor but x is too — HCF is 4x.", c: "x(8+12) = 20x, valid but 4x is higher.", d: "20x² wrong — add, don't multiply." }, explanation: "8x + 12x = 4x(2 + 3) — both 4 and x divide both terms.", hints: ["HCF of 8x and 12x?", "4x.", "4x(2 + 3)."] },
      // @q04
      { id: "U12L3-mcq-4", type: "mcq", category: "procedural", prompt: "Factorize 4x² + 8x.", options: [ { id: "a", text: "4x(x + 2)" }, { id: "b", text: "4(x² + 8x)" }, { id: "c", text: "2x(2x + 4)" }, { id: "d", text: "x(4x + 8)" } ], correctOptionId: "a", diagnoses: { b: "4 doesn't divide 8x fully? It does — but x is also common; HCF is 4x.", c: "2x is a factor but not the highest — HCF is 4x.", d: "x is a factor but 4 is too — HCF is 4x." }, explanation: "HCF is 4x: 4x·x = 4x² and 4x·2 = 8x → 4x(x + 2).", hints: ["HCF of 4x² and 8x?", "4x.", "4x(x + 2)."] },
      // @q05
      ...
      // @q06
      { id: "U12L3-mcq-6", type: "mcq", category: "word", prompt: "A garden's area is 10x + 15. Which shows it factored as length × width?", options: [ { id: "a", text: "5(2x + 3)" }, { id: "b", text: "2(5x + 15)" }, { id: "c", text: "5(x + 15)" }, { id: "d", text: "10(x + 5)" } ], correctOptionId: "a", diagnoses: { b: "2 isn't the HCF — 5 is.", c: "15÷5 = 3, not 15.", d: "10 doesn't divide 15." }, explanation: "HCF 5: 10x + 15 = 5(2x + 3).", hints: ["HCF of 10 and 15?", "5.", "5(2x + 3)."] },
      // @q07
      { id: "U12L3-num-1", type: "numeric-input", category: "procedural", prompt: "Factorize 6x + 9. Type the number outside the bracket.", answer: 3, tolerance: 0, explanation: "HCF of 6 and 9 is 3 → 3(2x + 3).", hints: ["HCF of 6 and 9.", "3.", "3."] },
      // @q08
      { id: "U12L3-num-2", type: "numeric-input", category: "procedural", prompt: "Factorize 8x + 12x. Type the number outside the bracket.", answer: 4, tolerance: 0, explanation: "8x + 12x = 4x(2 + 3) — number part is 4.", hints: ["HCF of 8 and 12.", "4.", "4."] },
      // @q09
      { id: "U12L3-num-3", type: "numeric-input", category: "conceptual", prompt: "Factorize 4x² + 6x. Type the number outside the bracket.", answer: 2, tolerance: 0, explanation: "HCF is 2x: the number part is 2 → 2x(2x + 3).", hints: ["HCF of 4 and 6.", "2.", "2."] },
      // @q10
      { id: "U12L3-frac-1", type: "fraction-input", category: "conceptual", prompt: "Factorize x + 1/2. Write the constant inside the bracket as a fraction.", numerator: 1, denominator: 2, acceptEquivalent: true, explanation: "HCF is 1: x + 1/2 = 1(x + 1/2) → already in factored form with 1 outside.", hints: ["Every term is a multiple of 1.", "It's already factored.", "1/2."] },
      // @q11
      ...
      // @q15
      { id: "U12L3-graph-1", type: "graph-interact", category: "word", prompt: "Set the slider to the number outside the bracket when you factorize 9x + 12 (key: value).", challenge: "Set the slider to 3.", validate: { value: 3 }, tolerance: 0, explanation: "HCF of 9 and 12 is 3 → 3(3x + 4).", hints: ["HCF of 9 and 12.", "3.", "Set slider to 3."] }
    ],
