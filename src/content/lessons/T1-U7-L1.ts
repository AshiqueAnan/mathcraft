    ...
    pool: [
      {
        ...
        explanation: "3² = 3 × 3 = 9.",
        hints: ["The 2 counts how many 3s.", "3 × 3.", "3² = 3 × 3 = 9."],
      },
      {
        id: "U7L1-mcq-2", type: "mcq", category: "conceptual",
        prompt: "What does the small 3 in 2³ mean?",
        options: [
          { id: "a", text: "Multiply 2 by 3" },
          { id: "b", text: "Multiply 2 by itself 3 times" },
          { id: "c", text: "Add 3 twos" },
          { id: "d", text: "Divide 2 by 3" },
        ],
        correctOptionId: "b",
        diagnoses: { a: "2×3 = 6, but 2³ = 8 — powers repeat multiplication.", c: "2+2+2 is 6, not 8.", d: "Division is not powers." },
        explanation: "2³ = 2 × 2 × 2 = 8 — the index counts repeated multiplication.",
        hints: ["Write 2 three times with ×.", "2 × 2 × 2.", "2³ = 2 × 2 × 2 = 8 — the index counts repeated multiplication."],
      },
      {
        id: "U7L1-mcq-3", type: "mcq", category: "word",
        prompt: "A bacteria count doubles every hour. Start 1. After 4 hours?",
        options: [{ id: "a", text: "4" }, { id: "b", text: "8" }, { id: "c", text: "16" }, { id: "d", text: "32" }],
        correctOptionId: "c",
        diagnoses: { b: "8 is after 3 hours (2³).", a: "4 is just ×2 each hour twice.", d: "32 = 2⁵ — one extra doubling." },
        explanation: "1 × 2 × 2 × 2 × 2 = 2⁴ = 16.",
        hints: ["Doubling ×4.", "2⁴.", "1 × 2 × 2 × 2 × 2 = 2⁴ = 16."],
      },
      {
        id: "U7L1-mcq-4", type: "mcq", category: "procedural",
        prompt: "5² = ?",
        options: [{ id: "a", text: "125" }, { id: "b", text: "10" }, { id: "c", text: "5" }, { id: "d", text: "25" }],
        correctOptionId: "d",
        diagnoses: { b: "10 = 5 × 2 — wrong operation.", c: "That's 5¹.", a: "125 = 5³." },
        explanation: "5² = 5 × 5 = 25.",
        hints: ["The 2 counts how many 5s.", "5 × 5.", "5² = 5 × 5 = 25."],
      },
      {
        ...
        hints: ["Write out both.", "2⁵ = 32.", "2×2×2×2×2 = 32 beats 5×5 = 25."],
      },
      {
        ...
        options: [{ id: "a", text: "6" }, { id: "b", text: "8" }, { id: "c", text: "3" }, { id: "d", text: "9" }],
        correctOptionId: "b",
        diagnoses: { a: "6 = 2×3.", c: "3 is the fold count, not the multiplier.", d: "9 = 3²." },
        explanation: "2³ = 2 × 2 × 2 = 8.",
        hints: ["Three folds, three 2s.", "2 × 2 × 2.", "2³ = 2 × 2 × 2 = 8."],
      },
      {
        id: "U7L1-num-1", type: "numeric-input", category: "procedural",
        prompt: "Type the value of 2⁵.", answer: 32, tolerance: 0,
        explanation: "2⁵ = 32.",
        hints: ["2⁴ = 16.", "2⁵ doubles it.", "2⁵ = 32."],
      },
      {
        id: "U7L1-num-2", type: "numeric-input", category: "procedural",
        prompt: "Type the value of 10².", answer: 100, tolerance: 0,
        explanation: "10 × 10 = 100.",
        hints: ["The 2 means two 10s.", "10 × 10.", "10 × 10 = 100."],
      },
      {
      ...
      },
      {
        ...
        explanation: "2⁶ = 64.",
        hints: ["Count powers: 2,4,8,16,32,64.", "That's 6 doublings.", "2⁶ = 64."],
      },
      {
      ...
      },
      {
        ...
        isTrue: true,
        explanation: "3² = 9 = 3 × 3.",
        hints: ["Index 2 → two 3s.", "3 × 3.", "3² = 9 = 3 × 3."],
      },
      {
        ...
        hints: ["Four twos multiplied.", "16.", "2⁴ = 2 × 2 × 2 × 2 = 16, not 8."],
      },
      {
      ...
      },
      {
        ...
        hints: ["2×2×2.", "3×3.", "Expand each power."],
      },
      {
        ...
        tolerance: 0.01,
        explanation: "2⁴ = 16.",
        hints: ["Write four 2s with ×.", "2×2×2×2.", "2⁴ = 16."],
      },
    ],
