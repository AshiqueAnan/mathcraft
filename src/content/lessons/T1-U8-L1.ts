...
export const T1U8L1: Lesson = {
  ...
  quiz: { pool: [
    { id: "U8L1-mcq-1", type: "mcq", category: "procedural", prompt: "√49 = ?", options: [{ id: "a", text: "7" }, { id: "b", text: "49" }, { id: "c", text: "24.5" }, { id: "d", text: "√24.5" }], correctOptionId: "a", diagnoses: { b: "49 is the base.", c: "24.5 = 49/2.", d: "Not the root." }, explanation: "√49 = 7.", hints: ["7×7=49.", "Positive root.", "√49 = 7."] },
    ...
    { id: "U8L1-mcq-3", type: "mcq", category: "word", prompt: "Square area 10 m². Side (exact)?", options: [{ id: "a", text: "100 m" }, { id: "b", text: "5 m" }, { id: "c", text: "√10 m" }, { id: "d", text: "10 m" }], correctOptionId: "c", diagnoses: { b: "5 = 10÷2.", a: "100 = 10².", d: "10 is the area." }, explanation: "side = √10 m.", hints: ["side² = area.", "√10.", "side = √10 m."] },
    { id: "U8L1-mcq-4", type: "mcq", category: "procedural", prompt: "(√5)² = ?", options: [{ id: "a", text: "√25" }, { id: "b", text: "√5" }, { id: "c", text: "25" }, { id: "d", text: "5" }], correctOptionId: "d", diagnoses: { b: "That's √5 once.", c: "25 = (√5)⁴.", a: "√25 = 5, same value but 5 is simpler." }, explanation: "(√a)² = a — squaring undoes the root.", hints: ["Root then square.", "Net effect: 5.", "(√a)² = a — squaring undoes the root."] },
    { id: "U8L1-mcq-5", type: "mcq", category: "conceptual", prompt: "Which is a surd?", options: [{ id: "a", text: "√8" }, { id: "b", text: "√9" }, { id: "c", text: "√16" }, { id: "d", text: "√25" }], correctOptionId: "a", diagnoses: { b: "√9 = 3 exact.", c: "√16 = 4 exact.", d: "√25 = 5 exact." }, explanation: "A surd stays a root — √8 isn't a perfect square.", hints: ["Which isn't a perfect square?", "√8 stays a root.", "A surd stays a root — √8 isn't a perfect square."] },
    ...
    { id: "U8L1-tf-2", type: "true-false-justify", category: "conceptual", prompt: "√2 = 1.41 exactly.", isTrue: false, explanation: "1.41² = 1.9881 ≠ 2.", hints: ["Square 1.41.", "Not 2.", "1.41² = 1.9881 ≠ 2."] },
    ...
    { id: "U8L1-graph-1", type: "graph-interact", category: "word", prompt: "Set value to √4.", challenge: "Adjust the values below so they match the condition described in the prompt.", validate: { value: 2 }, tolerance: 0.01, explanation: "√4=2.", hints: ["2×2=4.", "2.", "The slider should land on 2, since √4 = 2."] },
