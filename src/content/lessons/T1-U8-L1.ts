...
export const T1U8L1: Lesson = {
  ...
  quiz: { pool: [
    ...
    { id: "U8L1-mcq-2", type: "mcq", category: "conceptual", prompt: "Why is √2 NOT rational?", options: [{ id: "a", text: "Its decimal never terminates or repeats" }, { id: "b", text: "It's negative" }, { id: "c", text: "It's too big" }, { id: "d", text: "It is rational" }], correctOptionId: "a", diagnoses: { b: "√2 ≈ 1.4 > 0.", c: "Size is irrelevant.", d: "No fraction equals √2." }, explanation: "√2 can't be a fraction; its decimal goes on forever without repeating.", hints: ["Try a fraction a/b.", "1.4142135…", "Never repeats — irrational."] },
    { id: "U8L1-mcq-3", type: "mcq", category: "word", prompt: "Square area 10 m². Side (exact)?", options: [{ id: "a", text: "√10 m" }, { id: "b", text: "5 m" }, { id: "c", text: "100 m" }, { id: "d", text: "10 m" }], correctOptionId: "a", diagnoses: { b: "5 = 10÷2.", c: "100 = 10².", d: "10 is the area." }, explanation: "side = √10 m.", hints: ["side² = area.", "√10.", "√10 m."] },
    { id: "U8L1-mcq-4", type: "mcq", category: "procedural", prompt: "(√5)² = ?", options: [{ id: "a", text: "5" }, { id: "b", text: "√5" }, { id: "c", text: "25" }, { id: "d", text: "√25" }], correctOptionId: "a", diagnoses: { b: "That's √5 once.", c: "25 = (√5)⁴.", d: "√25 = 5, same value but 5 is simpler." }, explanation: "(√a)² = a — squaring undoes the root.", hints: ["Root then square.", "Net effect: 5.", "5."] },
    ...
    { id: "U8L1-mcq-6", type: "mcq", category: "word", prompt: "Unit square diagonal = √2 ≈ ? (1 dp)", options: [{ id: "a", text: "1.4" }, { id: "b", text: "1.3" }, { id: "c", text: "1.5" }, { id: "d", text: "2.0" }], correctOptionId: "a", diagnoses: { b: "1.3² = 1.69.", c: "1.5² = 2.25.", d: "2.0 too big." }, explanation: "√2 ≈ 1.414 ≈ 1.4.", hints: ["√2 ≈ 1.414.", "1 dp: 1.4.", "The second decimal is 1, so it rounds to 1.4, not 1.5."] },
