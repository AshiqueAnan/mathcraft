...
export const T1U9L3: Lesson = {
  ...
  quiz: {
    pool: [
      // @q01
      { id: "U9L3-mcq-1", type: "mcq", category: "procedural", prompt: "Estimate 4.8 × 7.3 by rounding each to one significant figure.", options: [ { id: "a", text: "5 × 7 = 35" }, { id: "b", text: "4 × 7 = 28" }, { id: "c", text: "5 × 7 = 35, then ×4" }, { id: "d", text: "4 × 8 = 32" } ], correctOptionId: "a", diagnoses: { b: "4.8 rounds to 5, not 4.", c: "Don't keep the decimals after rounding.", d: "7.3 rounds to 7, not 8." }, explanation: "4.8 ≈ 5 and 7.3 ≈ 7, so the estimate is 5 × 7 = 35.", hints: ["Round each factor to one sig fig.", "4.8 is closer to 5; 7.3 to 7.", "4.8 ≈ 5 and 7.3 ≈ 7, so the estimate is 5 × 7 = 35."] },
      // @q02
      { id: "U9L3-mcq-2", type: "mcq", category: "conceptual", prompt: "Why estimate BEFORE reaching for the calculator?", options: [ { id: "a", text: "To avoid ever multiplying" }, { id: "b", text: "To know what answer makes sense" }, { id: "c", text: "The estimate is the final answer" }, { id: "d", text: "To make the numbers exact" } ], correctOptionId: "b", diagnoses: { a: "You still calculate — the estimate checks the result.", c: "Estimates are sanity checks, not finals.", d: "Rounding makes things less exact, intentionally." }, explanation: "A rounded estimate anchors your expectation, so a typo like pressing 4.8 × 7.3 wrong becomes obvious.", hints: ["What is the estimate FOR?", "A sanity check.", "To know what makes sense."] },
      // @q03
      { id: "U9L3-mcq-3", type: "mcq", category: "word", prompt: "A field is 12.6 m × 8.3 m. Which is the best quick estimate of its area?", options: [ { id: "a", text: "96 m²" }, { id: "b", text: "100 m²" }, { id: "c", text: "104 m²" }, { id: "d", text: "120 m²" } ], correctOptionId: "c", diagnoses: { b: "100 is too rough — round 12.6→13 and 8.3→8 gives 104.", a: "10 × 9.6 isn't from rounding to whole 12.6→13, 8.3→8.", d: "Only one factor rounded up — loses accuracy." }, explanation: "13 × 8 = 104 m² is the rounded estimate.", hints: ["Round to whole numbers: 12.6→13, 8.3→8.", "13 × 8.", "13 × 8 = 104 m² is the rounded estimate."] },
      // @q04
      { id: "U9L3-mcq-4", type: "mcq", category: "procedural", prompt: "A calculator gives 8.21 × 4.97 = 40.8037. Estimate to check this.", options: [ { id: "a", text: "8.2 × 5.0 = 41 — correct" }, { id: "b", text: "8 × 4 = 32 — close but off" }, { id: "c", text: "9 × 5 = 45 — correct" }, { id: "d", text: "8 × 5 = 40 — correct" } ], correctOptionId: "d", diagnoses: { b: "4.97 rounds to 5, not 4.", c: "8.21 rounds to 8, not 9.", a: "That's a fine check too, but the one-sig-fig rule says round 8.21→8." }, explanation: "8.21 ≈ 8 and 4.97 ≈ 5 → 40, matching the calculator.", hints: ["Round 8.21 to 8, 4.97 to 5.", "8 × 5.", "8.21 ≈ 8 and 4.97 ≈ 5 → 40, matching the calculator."] },
      // @q05
      { id: "U9L3-mcq-5", type: "mcq", category: "conceptual", prompt: "A width measured '6.4 m to 1 dp' could really be which values?", options: [ { id: "a", text: "6.35–6.44 m" }, { id: "b", text: "6.0–6.4 m" }, { id: "c", text: "Exactly 6.4 m" }, { id: "d", text: "6.39–6.41 m" } ], correctOptionId: "a", diagnoses: { b: "6.0 and 6.4 aren't the rounding band — 6.44 rounds to 6.4 too.", c: "Measured values are never exact.", d: "Too narrow — 6.40 to 6.44 m also rounds to 6.4." }, explanation: "Anything from 6.35 up to just under 6.45 rounds to 6.4 at 1 dp.", hints: ["Half the step below: 6.35.", "Half the step above: under 6.45.", "Anything from 6."] },
      // @q06
      { id: "U9L3-mcq-6", type: "mcq", category: "word", prompt: "A recipe's flour bag says 1.2 kg (± 0.05). Why is the exact 1.2000 kg misleading?", options: [ { id: "a", text: "The bag is always exactly 1.2" }, { id: "b", text: "The true mass hides in a range" }, { id: "c", text: "1.2000 shows too few zeros" }, { id: "d", text: "Kitchen scales round up only" } ], correctOptionId: "b", diagnoses: { a: "±0.05 means 1.15–1.25 kg.", c: "It shows TOO many digits — overclaiming precision.", d: "Rounding is symmetric, not one-way." }, explanation: "±0.05 kg means the true mass is anywhere from 1.15 to 1.25 kg — quote honestly.", hints: ["What does ±0.05 mean?", "A range around 1.2.", "±0.05 kg means the true mass is anywhere from 1.15 to 1.25 kg — quote honestly."] },
      // @q07
      { id: "U9L3-num-1", type: "numeric-input", category: "procedural", prompt: "Estimate 9.6 × 3.1. Type the estimate (rounded whole number).", answer: 30, tolerance: 0, explanation: "10 × 3 = 30 — rounding 9.6→10 and 3.1→3.", hints: ["9.6 rounds to 10.", "3.1 rounds to 3.", "10 × 3 = 30 — rounding 9."] },
      // @q08
      { id: "U9L3-num-2", type: "numeric-input", category: "procedural", prompt: "Estimate 0.052 × 6.4. Type the estimate.", answer: 0.3, tolerance: 0, explanation: "0.05 × 6 = 0.3 — rounding to one sig fig each.", hints: ["0.052 ≈ 0.05.", "6.4 ≈ 6.", "0.05 × 6 = 0.3 — rounding to one sig fig each."] },
      // @q09
      { id: "U9L3-num-3", type: "numeric-input", category: "conceptual", prompt: "A plank '2.8 m to 1 dp' — what is the smallest possible true length? (Type it.)", answer: 2.75, tolerance: 0.01, unit: "m", explanation: "2.75 is the smallest value that still rounds to 2.8 at one decimal place.", hints: ["Half the step below 2.8.", "2.8 − 0.05.", "2.75 is the smallest value that still rounds to 2.8 at one decimal place."] },
      // @q10
      { id: "U9L3-frac-1", type: "fraction-input", category: "conceptual", prompt: "Estimate 0.49 × 2.05 and write the result as a fraction (simplified).", numerator: 1, denominator: 1, acceptEquivalent: true, explanation: "0.5 × 2 = 1 — the estimate is a whole 1.", hints: ["0.49 ≈ 0.5.", "2.05 ≈ 2.", "0.5 × 2 = 1 — the estimate is a whole 1."] },
      // @q11
      { id: "U9L3-tf-1", type: "true-false-justify", category: "conceptual", prompt: "Estimating 3.9 × 5.1 as 20 is a useful sanity check.", isTrue: true, explanation: "4 × 5 = 20 matches the true 19.89 — confirming the calculation.", hints: ["Round 3.9→4 and 5.1→5.", "4 × 5 = 20.", "4 × 5 = 20 matches the true 19."] },
      // @q12
      ...
      // @q15
      { id: "U9L3-graph-1", type: "graph-interact", category: "word", prompt: "This slider measures a plank. Set it to the LARGEST value that still rounds to 2.8 m at 1 dp (key: value).", challenge: "This slider measures a plank. Set it to the LARGEST value that still rounds to 2.8 m at 1 dp . — adjust the values below to match the condition.", validate: { value: 2.85 }, tolerance: 0.01, explanation: "Just under 2.85 rounds to 2.8 — the top of the band.", hints: ["Half the step above 2.8.", "2.8 + 0.05.", "Just under 2.85 rounds to 2.8 — the top of the band."] }
    ],
