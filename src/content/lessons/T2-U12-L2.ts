...
export const T2U12L2: Lesson = {
  ...
  quiz: {
    pool: [
      ...
      // @q03
      { id: "U12L2-mcq-3", type: "mcq", category: "word", prompt: "A rectangle is (x + 5) by (x + 2). Its area expands to?", options: [ { id: "a", text: "x² + 7x" }, { id: "b", text: "x² + 10" }, { id: "c", text: "x² + 7x + 10" }, { id: "d", text: "10x + 7" } ], correctOptionId: "c", diagnoses: { b: "Missing the middle terms.", a: "Missing the constant 10.", d: "Wrong shape entirely." }, explanation: "x² + 2x + 5x + 10 = x² + 7x + 10.", hints: ["Four products.", "2x + 5x = 7x.", "x² + 7x + 10."] },
      // @q04
      { id: "U12L2-mcq-4", type: "mcq", category: "procedural", prompt: "Expand (x − 2)(x + 3).", options: [ { id: "a", text: "x² + 5x − 6" }, { id: "b", text: "x² − 6" }, { id: "c", text: "x² − x + 6" }, { id: "d", text: "x² + x − 6" } ], correctOptionId: "d", diagnoses: { b: "Missing the middle terms.", c: "Signs wrong: +3x − 2x = x, and (−2)(3) = −6.", a: "5x is wrong; the terms are 3x and −2x." }, explanation: "x² + 3x − 2x − 6 = x² + x − 6.", hints: ["(−2)(x) = −2x.", "3x − 2x = x.", "x² + x − 6."] },
      // @q05
