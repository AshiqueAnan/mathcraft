...
export const T2U12L2: Lesson = {
  ...
  quiz: {
    pool: [
      // @q01
      { id: "U12L2-mcq-1", type: "mcq", category: "procedural", prompt: "Expand (x + 2)(x + 3).", options: [ { id: "a", text: "x² + 5x + 6" }, { id: "b", text: "x² + 6" }, { id: "c", text: "x² + 5x + 5" }, { id: "d", text: "2x² + 6" } ], correctOptionId: "a", diagnoses: { b: "Missing the middle terms 3x + 2x.", c: "Last: 2 × 3 = 6, not 5.", d: "x·x = x², not 2x²." }, explanation: "x² + 2x + 3x + 6 = x² + 5x + 6.", hints: ["Four products.", "3x + 2x = 5x.", "x² + 5x + 6."] },
      // @q02
      { id: "U12L2-mcq-2", type: "mcq", category: "conceptual", prompt: "How many products come from expanding (x + a)(x + b)?", options: [ { id: "a", text: "Four" }, { id: "b", text: "Two" }, { id: "c", text: "Three" }, { id: "d", text: "Six" } ], correctOptionId: "a", diagnoses: { b: "Each term hits each term — 2 × 2.", c: "There are two middle terms but four total products.", d: "Too many." }, explanation: "2 terms × 2 terms = 4 products (First, Outer, Inner, Last).", hints: ["2 × 2.", "Four products.", "Four."] },
      // @q03
      { id: "U12L2-mcq-3", type: "mcq", category: "word", prompt: "A rectangle is (x + 5) by (x + 2). Its area expands to?", options: [ { id: "a", text: "x² + 7x + 10" }, { id: "b", text: "x² + 10" }, { id: "c", text: "x² + 7x" }, { id: "d", text: "10x + 7" } ], correctOptionId: "a", diagnoses: { b: "Missing the middle terms.", c: "Missing the constant 10.", d: "Wrong shape entirely." }, explanation: "x² + 2x + 5x + 10 = x² + 7x + 10.", hints: ["Four products.", "2x + 5x = 7x.", "x² + 7x + 10."] },
      // @q04
      { id: "U12L2-mcq-4", type: "mcq", category: "procedural", prompt: "Expand (x − 2)(x + 3).", options: [ { id: "a", text: "x² + x − 6" }, { id: "b", text: "x² − 6" }, { id: "c", text: "x² − x + 6" }, { id: "d", text: "x² + 5x − 6" } ], correctOptionId: "a", diagnoses: { b: "Missing the middle terms.", c: "Signs wrong: +3x − 2x = x, and (−2)(3) = −6.", d: "5x is wrong; the terms are 3x and −2x." }, explanation: "x² + 3x − 2x − 6 = x² + x − 6.", hints: ["(−2)(x) = −2x.", "3x − 2x = x.", "x² + x − 6."] },
      // @q05
      { id: "U12L2-mcq-5", type: "mcq", category: "conceptual", prompt: "What does FOIL stand for?", options: [ { id: "a", text: "First, Outer, Inner, Last" }, { id: "b", text: "Four, Outside, Inside, Length" }, { id: "c", text: "First, Only, Inner, Larger" }, { id: "d", text: "Four, Order, Index, Last" } ], correctOptionId: "a", diagnoses: { b: "FOIL orders the four products of expansion.", c: "FOIL orders the four products of expansion.", d: "FOIL orders the four products of expansion." }, explanation: "F × F, O × O, I × I, L × L — the four products of two brackets.", hints: ["F.O.I.L.", "First, Outer, Inner, Last.", "First, Outer, Inner, Last."] },
      // @q06
      { id: "U12L2-mcq-6", type: "mcq", category: "word", prompt: "A photo is (x + 4) cm by (x + 1) cm. Which is its area?", options: [ { id: "a", text: "x² + 5x + 4" }, { id: "b", text: "x² + 4" }, { id: "c", text: "x² + 5x" }, { id: "d", text: "5x + 4" } ], correctOptionId: "a", diagnoses: { b: "Missing middle terms.", c: "Missing the constant 4.", d: "Missing x²." }, explanation: "x² + x + 4x + 4 = x² + 5x + 4.", hints: ["Four products.", "x + 4x = 5x.", "x² + 5x + 4."] },
      // @q07
      { id: "U12L2-num-1", type: "numeric-input", category: "procedural", prompt: "Expand (x + 2)(x + 3). Type the coefficient of x.", answer: 5, tolerance: 0, explanation: "3x + 2x = 5x.", hints: ["Middle terms: 3x and 2x.", "3 + 2.", "5."] },
      // @q08
      { id: "U12L2-num-2", type: "numeric-input", category: "procedural", prompt: "Expand (x + 1)(x + 4). Type the constant term.", answer: 4, tolerance: 0, explanation: "1 × 4 = 4.", hints: ["Last × Last.", "1 × 4.", "4."] },
      // @q09
      { id: "U12L2-num-3", type: "numeric-input", category: "conceptual", prompt: "Expand (x + 5)(x + 2). Type the coefficient of x.", answer: 7, tolerance: 0, explanation: "2x + 5x = 7x.", hints: ["Middle: 2x and 5x.", "2 + 5.", "7."] },
      // @q10
      { id: "U12L2-frac-1", type: "fraction-input", category: "conceptual", prompt: "Expand (x + 1)(x − 1). Write the constant term as a fraction (whole over 1).", numerator: -1, denominator: 1, acceptEquivalent: true, explanation: "x² + x − x − 1 = x² − 1 — middles cancel.", hints: ["Middle terms cancel.", "x − x = 0.", "−1 = −1/1."] },
      // @q11
      { id: "U12L2-tf-1", type: "true-false-justify", category: "conceptual", prompt: "(x + 2)(x + 3) = x² + 5x + 6.", isTrue: true, explanation: "x² + 2x + 3x + 6 = x² + 5x + 6.", hints: ["Four products.", "3x + 2x.", "True."] },
      // @q12
      ...
      // @q14
      { id: "U12L2-drag-1", type: "drag-match", category: "conceptual", prompt: "Match each expansion to its bracket pair.", pairs: [ { source: "x² + 5x + 6", target: "(x + 2)(x + 3)" }, { source: "x² + 3x + 2", target: "(x + 1)(x + 2)" }, { source: "x² − 1", target: "(x − 1)(x + 1)" } ], diagnoses: { "x² + 5x + 6->(x + 1)(x + 2)": "Middle 5 needs 2 + 3.", "x² − 1->(x + 2)(x + 3)": "That's the difference of squares.", "x² + 3x + 2->(x − 1)(x + 1)": "Middle 3 needs 1 + 2." }, explanation: "Match middle and constant: 5&6→2&3, 3&2→1&2, 0&−1→1&−1.", hints: ["Check middle coefficient.", "Check constant.", "Match."] },
      // @q15
      { id: "U12L2-graph-1", type: "graph-interact", category: "word", prompt: "Set the slider to the constant term of (x + 2)(x + 5) (key: value).", challenge: "Set the slider to 10.", validate: { value: 10 }, tolerance: 0, explanation: "2 × 5 = 10.", hints: ["Last × Last.", "2 × 5.", "10."] }
    ],
