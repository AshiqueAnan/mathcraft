...
export const T3U20L2: Lesson = {
  ...
  quiz: {
    pool: [
      ...
      // @q03
      { id: "U20L2-mcq-3", type: "mcq", category: "word", prompt: "Two roads cross, making a 35° corner. The opposite corner is…", options: [ { id: "a", text: "70°" }, { id: "b", text: "145°" }, { id: "c", text: "35°" }, { id: "d", text: "55°" } ], correctOptionId: "c", diagnoses: { b: "145° is the neighbouring corner on the same road.", a: "Opposite angles are equal, not double.", d: "55 is 90 − 35, not the opposite." }, explanation: "Road-crossing corners are vertically opposite: 35°.", hints: ["Opposite corner.", "Equal.", "35°."] },
      // @q04
      { id: "U20L2-mcq-4", type: "mcq", category: "procedural", prompt: "One angle at a crossing is 110°. What are the other three?", options: [ { id: "a", text: "180°, 110°, 70°" }, { id: "b", text: "110°, 110°, 110°" }, { id: "c", text: "70°, 70°, 70°" }, { id: "d", text: "70°, 110°, 70°" } ], correctOptionId: "d", diagnoses: { b: "Only one angle can be 110° (its twin); the neighbours are 70°.", c: "The opposites are 110° and 110° — not all the same.", a: "180° is the line total, not an angle in the X." }, explanation: "Opposite = 110°; neighbours = 180 − 110 = 70° each.", hints: ["Opposite = 110°.", "Neighbours = 70°.", "70, 110, 70."] },
      // @q05
