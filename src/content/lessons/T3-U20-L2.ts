...
export const T3U20L2: Lesson = {
  ...
  quiz: {
    pool: [
      // @q01
      { id: "U20L2-mcq-1", type: "mcq", category: "procedural", prompt: "Two lines cross forming a 40° angle. Its vertically opposite angle is…", options: [ { id: "a", text: "40°" }, { id: "b", text: "140°" }, { id: "c", text: "20°" }, { id: "d", text: "90°" } ], correctOptionId: "a", diagnoses: { b: "140° is the ADJACENT angle on the same line, not the opposite.", c: "No halving rule exists here.", d: "90 is for right angles only." }, explanation: "Vertically opposite angles are equal: 40°.", hints: ["Across the X.", "Equal.", "40°."] },
      // @q02
      { id: "U20L2-mcq-2", type: "mcq", category: "conceptual", prompt: "Why must vertically opposite angles be equal?", options: [ { id: "a", text: "Both are 180° minus the same neighbouring angle" }, { id: "b", text: "Because lines are straight" }, { id: "c", text: "They always look the same size" }, { id: "d", text: "It's just a rule to memorize" } ], correctOptionId: "a", diagnoses: { b: "Straight lines give 180° adds, but the equality needs a reason.", c: "Looking similar isn't a proof.", d: "It's derivable — and that's the power." }, explanation: "Opposite angle = 180° − neighbour = its twin; the shared neighbour forces equality.", hints: ["Same neighbour.", "180 − same.", "Equal."] },
      // @q03
      { id: "U20L2-mcq-3", type: "mcq", category: "word", prompt: "Two roads cross, making a 35° corner. The opposite corner is…", options: [ { id: "a", text: "35°" }, { id: "b", text: "145°" }, { id: "c", text: "70°" }, { id: "d", text: "55°" } ], correctOptionId: "a", diagnoses: { b: "145° is the neighbouring corner on the same road.", c: "Opposite angles are equal, not double.", d: "55 is 90 − 35, not the opposite." }, explanation: "Road-crossing corners are vertically opposite: 35°.", hints: ["Opposite corner.", "Equal.", "35°."] },
      // @q04
      { id: "U20L2-mcq-4", type: "mcq", category: "procedural", prompt: "One angle at a crossing is 110°. What are the other three?", options: [ { id: "a", text: "70°, 110°, 70°" }, { id: "b", text: "110°, 110°, 110°" }, { id: "c", text: "70°, 70°, 70°" }, { id: "d", text: "180°, 110°, 70°" } ], correctOptionId: "a", diagnoses: { b: "Only one angle can be 110° (its twin); the neighbours are 70°.", c: "The opposites are 110° and 110° — not all the same.", d: "180° is the line total, not an angle in the X." }, explanation: "Opposite = 110°; neighbours = 180 − 110 = 70° each.", hints: ["Opposite = 110°.", "Neighbours = 70°.", "70, 110, 70."] },
      // @q05
      ...
      // @q06
      { id: "U20L2-mcq-6", type: "mcq", category: "word", prompt: "Scissors' blades cross: one angle measures 75°. The opposite angle is…", options: [ { id: "a", text: "75°" }, { id: "b", text: "105°" }, { id: "c", text: "15°" }, { id: "d", text: "90°" } ], correctOptionId: "a", diagnoses: { b: "105° is the adjacent angle on the straight edge.", c: "15 is 90 − 75, unrelated here.", d: "Scissors don't guarantee right angles." }, explanation: "The scissors' opposite blades make vertically opposite angles: 75°.", hints: ["Opposite blades.", "Equal.", "75°."] },
      // @q07
      { id: "U20L2-num-1", type: "numeric-input", category: "procedural", prompt: "A crossing has one angle 65°. Type its vertically opposite angle.", answer: 65, tolerance: 0, explanation: "Opposite angles are equal: 65°.", hints: ["Opposite.", "Equal.", "65°."] },
      // @q08
      { id: "U20L2-num-2", type: "numeric-input", category: "procedural", prompt: "A crossing has one angle 125°. Type each adjacent angle.", answer: 55, tolerance: 0, explanation: "Adjacent on a straight line: 180 − 125 = 55°.", hints: ["Straight line = 180°.", "180 − 125.", "55°."] },
      // @q09
      { id: "U20L2-num-3", type: "numeric-input", category: "conceptual", prompt: "One angle is 80°, its neighbour is x. Type x.", answer: 100, tolerance: 0, explanation: "x = 180 − 80 = 100°.", hints: ["Neighbour on a line.", "180 − 80.", "100°."] },
      // @q10
      { id: "U20L2-frac-1", type: "fraction-input", category: "conceptual", prompt: "Crossing angles are 90° and 90°. Write 90 as a fraction of 180.", numerator: 1, denominator: 2, acceptEquivalent: true, explanation: "90/180 = 1/2 — a right angle is half a straight line.", hints: ["90 ÷ 180.", "1/2.", "1/2."] },
      // @q11
      { id: "U20L2-tf-1", type: "true-false-justify", category: "conceptual", prompt: "Vertically opposite angles are always equal.", isTrue: true, explanation: "They share the same neighbour, so both equal 180° minus that neighbour.", hints: ["Shared neighbour.", "Equal.", "True."] },
      // @q12
      { id: "U20L2-tf-2", type: "true-false-justify", category: "conceptual", prompt: "Adjacent angles at a crossing always add to 90°.", isTrue: false, explanation: "Adjacent angles lie on a straight line and add to 180°.", hints: ["Same line.", "180°.", "False."] },
      // @q13
      { id: "U20L2-order-1", type: "order-steps", category: "word", prompt: "Order the steps to find all angles at a crossing with one angle 40°.", sequence: ["Note the opposite: 40°", "Find a neighbour: 180 − 40 = 140°", "The other neighbour is also 140°", "Check: 40 + 140 + 40 + 140 = 360°"], diagnoses: { "Note the opposite: 40°@1": "Opposite first.", "Find a neighbour: 180 − 40 = 140°@0": "Then the neighbour.", "Check: 40 + 140 + 40 + 140 = 360°@0": "Check at the end." }, explanation: "Opposite, neighbours, verify the full turn.", hints: ["Opposite.", "Neighbour.", "Check 360°."] },
      // @q14
      { id: "U20L2-drag-1", type: "drag-match", category: "conceptual", prompt: "Match each angle pair at a crossing with one angle 50°.", pairs: [ { source: "Vertically opposite to 50°", target: "50°" }, { source: "Adjacent to 50°", target: "130°" }, { source: "Both neighbours together", target: "260°" } ], diagnoses: { "Vertically opposite to 50°->130°": "Opposite is EQUAL: 50°.", "Adjacent to 50°->50°": "Adjacent adds to 180: 130°.", "Both neighbours together->50°": "130 + 130 = 260°." }, explanation: "Opposite = 50°, neighbours = 130° each.", hints: ["Opposite equal.", "Neighbour 130°.", "130 + 130."] },
      // @q15
      { id: "U20L2-graph-1", type: "graph-interact", category: "word", prompt: "A crossing has opposite angles 60° and 60°. Set the slider to each adjacent angle (key: value).", challenge: "Set the slider to 120.", validate: { value: 120 }, tolerance: 0.01, explanation: "180 − 60 = 120° for each adjacent angle.", hints: ["180 − 60.", "120.", "120°."] }
    ],
