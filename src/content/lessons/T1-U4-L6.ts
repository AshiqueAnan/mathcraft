    ...
    pool: [
      ...
      },
      {
        ...
        diagnoses: {
          ...
          a: "8 eighths fill a whole litre, but she has only $\\frac{3}{4}$ of a litre — 6 eighths fit.",
      ...
      },
      {
        ...
        diagnoses: {
          ...
          b: "Check: $\\frac{2}{3} \\times \\frac{5}{4} = \\frac{10}{12} = \\frac{5}{6}$, not $\\frac{1}{2}$.",
        },
      ...
      },
      {
        ...
        correctOptionId: "a",
        diagnoses: {
          b: "That's $5 \\times \\frac{1}{2}$ (you flipped 5 instead of the half). Dividing by $\\frac{1}{2}$ is doubling: $5 \\div \\frac{1}{2} = 5 \\times 2 = 10$.",
      ...
      },
      {
        ...
        correctOptionId: "b",
        diagnoses: {
          a: "6 sixths make a whole metre. You have only $\\frac{5}{6}$ m, so you get 5 pieces.",
      ...
      },
      {
        ...
        options: [
          { id: "a", text: "The product of the two fractions" },
          { id: "b", text: "How many quarters fit in eight" },
          { id: "c", text: "How many eighths fit in three quarters" },
        ...
        diagnoses: {
          ...
          a: "That's multiplication, not division.",
