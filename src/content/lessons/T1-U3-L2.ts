    ...
    pool: [
      {
        ...
        hints: ["Split 30 into 3 × 10.", "Then split 10.", "2 × 3 × 5."],
      },
      {
        id: "U3L2-mcq-2", type: "mcq", category: "conceptual",
        prompt: "Which factorization means the SAME number as 2 × 3 × 7?",
        options: [{ id: "a", text: "42" }, { id: "b", text: "27" }, { id: "c", text: "62" }, { id: "d", text: "21" }],
        correctOptionId: "a",
        diagnoses: { b: "27 = 3³.", c: "62 = 2 × 31.", d: "21 = 3 × 7 (missing the 2)." },
        explanation: "2 × 3 × 7 = 42.",
        hints: ["Multiply 2 × 3 first.", "6 × 7.", "42."],
      },
      {
        id: "U3L2-mcq-3", type: "mcq", category: "procedural",
        prompt: "Write 18 as a product of primes.",
        options: [{ id: "a", text: "2 × 3²" }, { id: "b", text: "2 × 9" }, { id: "c", text: "3 × 6" }, { id: "d", text: "9 × 2" }],
        correctOptionId: "a",
        diagnoses: { b: "9 isn't prime.", c: "6 isn't prime.", d: "9 isn't prime." },
        explanation: "18 = 2 × 9 = 2 × 3 × 3 = 2 × 3².",
        hints: ["Split 18 = 2 × 9.", "Split 9.", "2 × 3 × 3."],
      },
      {
        id: "U3L2-mcq-4", type: "mcq", category: "conceptual",
        prompt: "Why is 2 × 2 × 3 the ONLY prime factorization of 12?",
        options: [
          { id: "a", text: "Because the primes are unique for every number" },
          { id: "b", text: "Because 12 is small" },
          { id: "c", text: "There are other factorizations like 2×6" },
          { id: "d", text: "It isn't unique" },
        ],
        correctOptionId: "a",
        diagnoses: { b: "Size doesn't matter — uniqueness holds for all numbers.", c: "2×6 is not prime factorization (6 isn't prime).", d: "Wait until you find a counterexample — you won't." },
        explanation: "The Fundamental Theorem guarantees one prime fingerprint per number.",
        hints: ["Split 12 any way → same primes.", "Prime factorization is a fingerprint.", "Unique."],
      },
      {
        ...
        hints: ["72 = 8 × 9.", "8 = 2³, 9 = 3².", "2³ × 3²."],
      },
      {
        id: "U3L2-mcq-6", type: "mcq", category: "conceptual",
        prompt: "The prime factorization of a number is 2 × 5². The number is...",
        options: [{ id: "a", text: "50" }, { id: "b", text: "25" }, { id: "c", text: "20" }, { id: "d", text: "100" }],
        correctOptionId: "a",
        diagnoses: { b: "25 = 5² alone, missing ×2.", c: "20 = 2² × 5.", d: "100 = 2² × 5²." },
        explanation: "2 × 25 = 50.",
        hints: ["5² = 25.", "2 × 25.", "50."],
      },
      {
      ...
      },
      {
        ...
        explanation: "32 = 2⁵.",
        hints: ["Keep halving 32.", "32 → 16 → 8 → 4 → 2 → 1.", "5 twos."],
      },
      {
      ...
      },
      {
        ...
        hints: ["Prime factorization needs primes.", "6 and 10 aren't prime.", "False."],
      },
      {
