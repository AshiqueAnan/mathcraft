...
export const T3U27L1: Lesson = {
  ...
  quiz: {
    pool: [
      // @q01
      { id: "U27L1-mcq-1", type: "mcq", category: "procedural", prompt: "Translate (2, 5) by vector (3, −1). New point = …", options: [ { id: "a", text: "(5, 4)" }, { id: "b", text: "(5, 6)" }, { id: "c", text: "(−1, 6)" }, { id: "d", text: "(6, 4)" } ], correctOptionId: "a", diagnoses: { b: "(2+3, 5+1) adds wrongly on y — the vector's y is −1.", c: "That subtracts the vector.", d: "(6, 4) scrambles the coordinates." }, explanation: "x: 2+3 = 5, y: 5−1 = 4 → (5, 4).", hints: ["Add x, add y.", "5, 4.", "x: 2+3 = 5, y: 5−1 = 4 → (5, 4)."] },
      // @q02
      { id: "U27L1-mcq-2", type: "mcq", category: "conceptual", prompt: "A reflection across the y-axis sends (2, 3) to…", options: [ { id: "a", text: "(2, −3)" }, { id: "b", text: "(−2, 3)" }, { id: "c", text: "(3, 2)" }, { id: "d", text: "(−2, −3)" } ], correctOptionId: "b", diagnoses: { a: "(2, −3) flips across the x-axis.", c: "(3, 2) swaps coordinates.", d: "(−2, −3) flips across BOTH axes." }, explanation: "The y-axis flips x's sign: (2, 3) → (−2, 3).", hints: ["x changes sign.", "(−2, 3).", "The y-axis flips x's sign: (2, 3) → (−2, 3)."] },
      // @q03
      { id: "U27L1-mcq-3", type: "mcq", category: "word", prompt: "Describing a rotation needs…", options: [ { id: "a", text: "only the centre" }, { id: "b", text: "only the angle" }, { id: "c", text: "centre, angle, and direction" }, { id: "d", text: "the mirror line" } ], correctOptionId: "c", diagnoses: { b: "The angle alone doesn't say where to turn about.", a: "The centre alone doesn't say how far to turn.", d: "A mirror line belongs to reflection." }, explanation: "Rotate 90° clockwise ABOUT P — three details pin the image.", hints: ["Centre point.", "Angle + direction.", "Rotate 90° clockwise ABOUT P — three details pin the image."] },
      // @q04
      { id: "U27L1-mcq-4", type: "mcq", category: "procedural", prompt: "Enlargement with scale factor 2 from the origin sends (3, 4) to…", options: [ { id: "a", text: "(1, 1)" }, { id: "b", text: "(1.5, 2)" }, { id: "c", text: "(5, 6)" }, { id: "d", text: "(6, 8)" } ], correctOptionId: "d", diagnoses: { b: "That's scale factor ½.", c: "(5, 6) adds 2 to each coordinate.", a: "(1, 1) subtracts 2 from each." }, explanation: "Multiply each coordinate by k = 2: (6, 8).", hints: ["× 2 each.", "(6, 8).", "Multiply each coordinate by k = 2: (6, 8)."] },
      // @q05
      { id: "U27L1-mcq-5", type: "mcq", category: "conceptual", prompt: "A translation preserves…", options: [ { id: "a", text: "size, shape, and orientation" }, { id: "b", text: "size but not shape" }, { id: "c", text: "nothing" }, { id: "d", text: "orientation but not size" } ], correctOptionId: "a", diagnoses: { b: "Translation slides — everything stays identical.", c: "It's a rigid move, nothing changes.", d: "Both size and orientation are preserved." }, explanation: "Sliding doesn't stretch, flip, or rotate — a perfect copy just relocated.", hints: ["Just moved.", "Identical copy.", "Sliding doesn't stretch, flip, or rotate — a perfect copy just relocated."] },
      // @q06
      { id: "U27L1-mcq-6", type: "mcq", category: "word", prompt: "A photocopier at 150% is which transformation?", options: [ { id: "a", text: "translation" }, { id: "b", text: "enlargement" }, { id: "c", text: "reflection" }, { id: "d", text: "rotation" } ], correctOptionId: "b", diagnoses: { a: "Translation moves without resizing.", c: "Reflection flips like a mirror.", d: "Rotation turns in place." }, explanation: "Scaling by 1.5 from the copier's centre is an enlargement.", hints: ["150% = ×1.5.", "Enlargement.", "Scaling by 1.5 from the copier's centre is an enlargement."] },
      // @q07
      { id: "U27L1-num-1", type: "numeric-input", category: "procedural", prompt: "Reflect (4, 7) across the y-axis. New x-coordinate = …", answer: -4, tolerance: 0, explanation: "The y-axis flips x's sign: (4, 7) → (−4, 7).", hints: ["Sign flips.", "−4.", "The y-axis flips x's sign: (4, 7) → (−4, 7)."] },
      // @q08
      { id: "U27L1-num-2", type: "numeric-input", category: "procedural", prompt: "Translate (1, 2) by vector (−3, 5). New y-coordinate = …", answer: 7, tolerance: 0, explanation: "y: 2 + 5 = 7.", hints: ["2 + 5.", "7.", "y: 2 + 5 = 7."] },
      // @q09
      { id: "U27L1-num-3", type: "numeric-input", category: "conceptual", prompt: "Rotate (0, 0) by 90° clockwise about the origin. New coordinates? (both are 0)", answer: 0, tolerance: 0, explanation: "The origin is the centre — it stays put under any rotation.", hints: ["Centre point.", "Stays fixed.", "The origin is the centre — it stays put under any rotation."] },
      // @q10
      { id: "U27L1-frac-1", type: "fraction-input", category: "conceptual", prompt: "A point 4 units from the enlargement centre, scale factor ½. How far from the centre is the image?", numerator: 2, denominator: 1, acceptEquivalent: true, explanation: "4 × ½ = 2 units.", hints: ["4 × ½.", "2.", "4 × ½ = 2 units."] },
      // @q11
      { id: "U27L1-tf-1", type: "true-false-justify", category: "conceptual", prompt: "A reflection reverses orientation like a mirror.", isTrue: true, explanation: "The image is a mirror copy — clockwise becomes anticlockwise.", hints: ["Mirror flip.", "Orientation reverses.", "The image is a mirror copy — clockwise becomes anticlockwise."] },
      // @q12
      { id: "U27L1-tf-2", type: "true-false-justify", category: "conceptual", prompt: "An enlargement always makes a shape bigger.", isTrue: false, explanation: "Scale factor less than 1 (like ½) shrinks it — enlargement just means scaling from a centre.", hints: ["k < 1 shrinks.", "Scale ≠ bigger always.", "Scale factor less than 1 (like ½) shrinks it — enlargement just means scaling from a centre."] },
      // @q13
      { id: "U27L1-order-1", type: "order-steps", category: "word", prompt: "Order the steps to fully describe a rotation.", sequence: ["Name the centre point", "Give the angle", "State direction (clockwise/anti)"], diagnoses: { "Name the centre point@1": "Centre first.", "Give the angle@0": "Then the angle.", "State direction (clockwise/anti)@0": "Direction last." }, explanation: "Centre, angle, direction complete the description.", hints: ["Centre.", "Angle.", "Centre, angle, direction complete the description."] },
      // @q14
      ...
      // @q15
      { id: "U27L1-graph-1", type: "graph-interact", category: "word", prompt: "Reflect (3, 4) across the y-axis. Set the slider to the NEW X-coordinate (key: value).", challenge: "Reflect (3, 4) across the y-axis. — adjust the values below to match the condition.", validate: { value: -3 }, tolerance: 0.01, explanation: "y-axis reflection flips x: (3, 4) → (−3, 4).", hints: ["x flips sign.", "−3.", "y-axis reflection flips x: (3, 4) → (−3, 4)."] }
    ],
