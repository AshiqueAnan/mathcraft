...
export const T3U27L1: Lesson = {
  ...
  quiz: {
    pool: [
      ...
      // @q02
      { id: "U27L1-mcq-2", type: "mcq", category: "conceptual", prompt: "A reflection across the y-axis sends (2, 3) to…", options: [ { id: "a", text: "(−2, 3)" }, { id: "b", text: "(2, −3)" }, { id: "c", text: "(3, 2)" }, { id: "d", text: "(−2, −3)" } ], correctOptionId: "a", diagnoses: { b: "(2, −3) flips across the x-axis.", c: "(3, 2) swaps coordinates.", d: "(−2, −3) flips across BOTH axes." }, explanation: "The y-axis flips x's sign: (2, 3) → (−2, 3).", hints: ["x changes sign.", "(−2, 3).", "(−2, 3)."] },
      // @q03
      { id: "U27L1-mcq-3", type: "mcq", category: "word", prompt: "Describing a rotation needs…", options: [ { id: "a", text: "centre, angle, and direction" }, { id: "b", text: "only the angle" }, { id: "c", text: "only the centre" }, { id: "d", text: "the mirror line" } ], correctOptionId: "a", diagnoses: { b: "The angle alone doesn't say where to turn about.", c: "The centre alone doesn't say how far to turn.", d: "A mirror line belongs to reflection." }, explanation: "Rotate 90° clockwise ABOUT P — three details pin the image.", hints: ["Centre point.", "Angle + direction.", "All three."] },
      // @q04
      { id: "U27L1-mcq-4", type: "mcq", category: "procedural", prompt: "Enlargement with scale factor 2 from the origin sends (3, 4) to…", options: [ { id: "a", text: "(6, 8)" }, { id: "b", text: "(1.5, 2)" }, { id: "c", text: "(5, 6)" }, { id: "d", text: "(1, 1)" } ], correctOptionId: "a", diagnoses: { b: "That's scale factor ½.", c: "(5, 6) adds 2 to each coordinate.", d: "(1, 1) subtracts 2 from each." }, explanation: "Multiply each coordinate by k = 2: (6, 8).", hints: ["× 2 each.", "(6, 8).", "(6, 8)."] },
      // @q05
      ...
      // @q06
      { id: "U27L1-mcq-6", type: "mcq", category: "word", prompt: "A photocopier at 150% is which transformation?", options: [ { id: "a", text: "enlargement" }, { id: "b", text: "translation" }, { id: "c", text: "reflection" }, { id: "d", text: "rotation" } ], correctOptionId: "a", diagnoses: { b: "Translation moves without resizing.", c: "Reflection flips like a mirror.", d: "Rotation turns in place." }, explanation: "Scaling by 1.5 from the copier's centre is an enlargement.", hints: ["150% = ×1.5.", "Enlargement.", "Enlargement."] },
      // @q07
