...
export const T5U31L3: Lesson = {
  ...
  intuitionBlocks: [{ widget: "graph-plotter", props: { mode: "quadratic" }, narrative: "Drag sliders to morph the parabola while the discriminant readout updates live. Watch b² - 4ac drive the story: positive → two x-crossings, zero → the vertex sits on the axis, negative → no crossings at all. Predict the count before dragging, then check." }],
  ...
  quiz: {
    pool: [
      ...
      // @q08
      { id: "U31L3-num-2", type: "numeric-input", category: "procedural", prompt: "2x² - 4x + 5. The discriminant Δ = …", answer: -24, tolerance: 0, explanation: "16 - 4(2)(5) = 16 - 40 = -24.", hints: ["b² = 16.", "4ac = 40.", "16 - 4(2)(5) = 16 - 40 = -24."] },
      // @q09
      { id: "U31L3-num-3", type: "numeric-input", category: "conceptual", prompt: "How many real roots does x² - 2x - 3 have? (Δ = 16 > 0)", answer: 2, tolerance: 0, explanation: "Positive discriminant → two distinct real roots.", hints: ["Positive Δ.", "Two crossings.", "Positive discriminant → two distinct real roots."] },
      // @q10
      { id: "U31L3-frac-1", type: "fraction-input", category: "conceptual", prompt: "x² + x + 1. The discriminant is 1 - 4 = -3. Express the magnitude 3 as a fraction over 1.", numerator: 3, denominator: 1, acceptEquivalent: true, explanation: "|Δ| = 3 → the quadratic has no real roots.", hints: ["-3 magnitude.", "3/1.", "|Δ| = 3 → the quadratic has no real roots."] },
      // @q11
      { id: "U31L3-tf-1", type: "true-false-justify", category: "conceptual", prompt: "A quadratic with Δ = 0 has exactly one real root (repeated).", isTrue: true, explanation: "The vertex touches the x-axis — one repeated solution.", hints: ["Touches once.", "Repeated root.", "The vertex touches the x-axis — one repeated solution."] },
      // @q12
      { id: "U31L3-tf-2", type: "true-false-justify", category: "conceptual", prompt: "A negative discriminant means the parabola crosses the x-axis twice.", isTrue: false, explanation: "Negative Δ means NO real crossings at all.", hints: ["Negative.", "No crossings.", "Negative Δ means NO real crossings at all."] },
      // @q13
      { id: "U31L3-order-1", type: "order-steps", category: "word", prompt: "Order the steps to classify x² + 4x + 5.", sequence: ["Identify a=1, b=4, c=5", "Compute b² - 4ac = 16 - 20", "Conclude: -4 < 0, no real roots"], diagnoses: { "Identify a=1, b=4, c=5@1": "Identify coefficients first.", "Compute b² - 4ac = 16 - 20@0": "Then compute.", "Conclude: -4 < 0, no real roots@0": "Conclude last." }, explanation: "Coefficients, compute Δ, read the sign.", hints: ["a, b, c.", "16 - 20.", "Coefficients, compute Δ, read the sign."] },
      // @q14
      { id: "U31L3-drag-1", type: "drag-match", category: "conceptual", prompt: "Match each discriminant to its meaning.", pairs: [ { source: "Δ = 9", target: "two real roots" }, { source: "Δ = 0", target: "one repeated root" }, { source: "Δ = -5", target: "no real roots" } ], diagnoses: { "Δ = 9->one repeated root": "Positive → two roots.", "Δ = 0->no real roots": "Zero → one repeated root.", "Δ = -5->two real roots": "Negative → no roots." }, explanation: "Sign of Δ tells the count.", hints: ["Positive.", "Zero.", "Sign of Δ tells the count."] },
      // @q15
      { id: "U31L3-graph-1", type: "graph-interact", category: "word", prompt: "x² - 6x + 9 has Δ = 0. Set the slider to Δ (key: value).", challenge: "Adjust the values below so they match the condition described in the prompt.", validate: { value: 0 }, tolerance: 0.01, explanation: "36 - 36 = 0 — one repeated root.", hints: ["36 - 36.", "0.", "36 - 36 = 0 — one repeated root."] }
    ],
