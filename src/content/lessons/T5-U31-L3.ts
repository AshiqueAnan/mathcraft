...
export const T5U31L3: Lesson = {
  ...
  quiz: {
    pool: [
      ...
      // @q02
      { id: "U31L3-mcq-2", type: "mcq", category: "conceptual", prompt: "A discriminant of -7 means the quadratic has…", options: [ { id: "a", text: "no real roots" }, { id: "b", text: "two real roots" }, { id: "c", text: "one real root" }, { id: "d", text: "infinitely many roots" } ], correctOptionId: "a", diagnoses: { b: "Two roots need a POSITIVE discriminant.", c: "One root needs zero.", d: "Quadratics never have infinitely many roots." }, explanation: "Negative discriminant → the graph never crosses the x-axis.", hints: ["Negative.", "No crossings.", "No real roots."] },
      // @q03
      { id: "U31L3-mcq-3", type: "mcq", category: "word", prompt: "A ball's height h(t) = -5t² + 20t + 1. To check if it ever reaches 30 m, you set h(t) = 30 and check the discriminant's sign. Setup: 5t² - 20t + 29 = 0. Its discriminant is…", options: [ { id: "a", text: "400 - 580 = -180 (so no)" }, { id: "b", text: "400 + 580 (so yes)" }, { id: "c", text: "20² - 4·5·29 = 0 (touches)" }, { id: "d", text: "can't tell" } ], correctOptionId: "a", diagnoses: { b: "4ac is subtracted, not added.", c: "20² - 4(5)(29) = 400 - 580, not 0.", d: "The discriminant answers it." }, explanation: "Δ = 400 - 580 = -180 < 0 → never reaches 30 m.", hints: ["b² - 4ac.", "400 - 580.", "Neg = no."] },
      // @q04
      { id: "U31L3-mcq-4", type: "mcq", category: "procedural", prompt: "x² + 6x + 9. The discriminant is…", options: [ { id: "a", text: "0" }, { id: "b", text: "36" }, { id: "c", text: "72" }, { id: "d", text: "-72" } ], correctOptionId: "a", diagnoses: { b: "36 is just b² — subtract 4ac.", c: "72 is (b²+4ac) — wrong sign.", d: "Negative is impossible here." }, explanation: "36 - 4(1)(9) = 36 - 36 = 0 → one repeated root (x = -3).", hints: ["6² = 36.", "4ac = 36.", "0."] },
      // @q05
      ...
      // @q06
      { id: "U31L3-mcq-6", type: "mcq", category: "word", prompt: "A company's profit is P(x) = -x² + 100x - 200. To check if profit can hit 3000, you solve -x² + 100x - 3200 = 0. The discriminant is…", options: [ { id: "a", text: "10000 - 12800 = -2800 (impossible)" }, { id: "b", text: "10000 + 12800 (possible)" }, { id: "c", text: "0 (barely possible)" }, { id: "d", text: "12800" } ], correctOptionId: "a", diagnoses: { b: "4ac is subtracted — 4(-1)(-3200) = 12800.", c: "10000 - 12800 is negative, not zero.", d: "12800 is just 4ac." }, explanation: "Δ = 10000 - 4(-1)(-3200) = 10000 - 12800 < 0 → profit can't reach 3000.", hints: ["b² - 4ac.", "10000 - 12800.", "Neg = no."] },
      // @q07
