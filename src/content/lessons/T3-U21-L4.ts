...
export const T3U21L4: Lesson = {
  ...
  quiz: {
    pool: [
      // @q01
      { id: "U21L4-mcq-1", type: "mcq", category: "procedural", prompt: "AB is a diameter. For any point X on the circle, ∠AXB = …", options: [ { id: "a", text: "90°" }, { id: "b", text: "180°" }, { id: "c", text: "45°" }, { id: "d", text: "60°" } ], correctOptionId: "a", diagnoses: { b: "180° would mean X lies on the line AB, not on the circle's arc.", c: "45° only happens for special chords.", d: "60° needs particular positions." }, explanation: "The angle in a semicircle is always 90°.", hints: ["Diameter end-to-end.", "Semicircle law.", "The angle in a semicircle is always 90°."] },
      // @q02
      { id: "U21L4-mcq-2", type: "mcq", category: "conceptual", prompt: "Why do the angles in the same segment stay equal as X slides?", options: [ { id: "a", text: "The centre moves to keep them equal" }, { id: "b", text: "Both subtend the same chord AB — the circle geometry locks them" }, { id: "c", text: "It's an optical illusion" }, { id: "d", text: "Only when the radius is 1" } ], correctOptionId: "b", diagnoses: { a: "The circle is fixed; the invariance comes from the chord.", c: "It persists and is measurable — not illusion.", d: "Radius size is irrelevant." }, explanation: "Every point on the arc sees the same chord AB under the same angle.", hints: ["Same chord.", "Same arc.", "Every point on the arc sees the same chord AB under the same angle."] },
      // @q03
      { id: "U21L4-mcq-3", type: "mcq", category: "word", prompt: "A fan's two blades touch a circular hub at fixed spots A and B. You move the spoke tip X along the rim — the angle ∠AXB …", options: [ { id: "a", text: "always equals the radius" }, { id: "b", text: "changes every time X moves" }, { id: "c", text: "stays the same while X stays on the same arc" }, { id: "d", text: "doubles" } ], correctOptionId: "c", diagnoses: { b: "Sliding on the SAME arc keeps the subtended angle fixed.", a: "Angles aren't lengths.", d: "Nothing doubles in this law." }, explanation: "Angles in the same segment are equal — the spoke angle is locked.", hints: ["Same arc.", "Fixed angle.", "Angles in the same segment are equal — the spoke angle is locked."] },
      // @q04
      { id: "U21L4-mcq-4", type: "mcq", category: "procedural", prompt: "A(3,0), B(−3,0) on a circle centred at origin. X any point on the circle. ∠AXB = …", options: [ { id: "a", text: "Depends on X" }, { id: "b", text: "180°" }, { id: "c", text: "45°" }, { id: "d", text: "90°" } ], correctOptionId: "d", diagnoses: { b: "180 would be a straight line through the centre.", c: "45 appears only for special X.", a: "The semicircle law makes it fixed despite X." }, explanation: "A and B are opposite ends of a diameter → angle in semicircle is 90°.", hints: ["Diameter.", "Semicircle.", "A and B are opposite ends of a diameter → angle in semicircle is 90°."] },
      // @q05
      { id: "U21L4-mcq-5", type: "mcq", category: "conceptual", prompt: "Which statement captures 'same segment'?", options: [ { id: "a", text: "Points on the same side of chord AB give equal angles" }, { id: "b", text: "Points on opposite sides also give equal angles" }, { id: "c", text: "Only the endpoints count" }, { id: "d", text: "The centre must be on the chord" } ], correctOptionId: "a", diagnoses: { b: "Crossing to the other side gives the SUPPLEMENT, not the same angle.", c: "Any point on the arc counts, not just endpoints.", d: "The centre sits on the perpendicular bisector, not the chord." }, explanation: "Same arc side → equal subtended angles; opposite side gives the supplement.", hints: ["Same side of chord.", "Same arc.", "Same arc side → equal subtended angles; opposite side gives the supplement."] },
      // @q06
      { id: "U21L4-mcq-6", type: "mcq", category: "word", prompt: "An archway: two feet A and B on the ground, top point X sliding along the circular arch. The engineer cares that ∠AXB stays 90° — that means AB is…", options: [ { id: "a", text: "the radius" }, { id: "b", text: "a diameter of the arch's circle" }, { id: "c", text: "a tangent" }, { id: "d", text: "half a diameter" } ], correctOptionId: "b", diagnoses: { a: "Radius is from centre to rim, not between feet.", c: "Tangents touch the circle at one point.", d: "Half a diameter is a radius." }, explanation: "Constantly 90° at the moving top implies A and B span a diameter.", hints: ["90° always.", "Diameter.", "AB is a diameter."] },
      // @q07
      { id: "U21L4-num-1", type: "numeric-input", category: "procedural", prompt: "AB a diameter, ∠AXB with X on the circle. Type the angle.", answer: 90, tolerance: 0, explanation: "Angle in a semicircle = 90°.", hints: ["Diameter.", "90.", "Angle in a semicircle = 90°."] },
      // @q08
      { id: "U21L4-num-2", type: "numeric-input", category: "procedural", prompt: "∠AXB is the same as ∠AYB = 55°. Type ∠AXB.", answer: 55, tolerance: 0, explanation: "Same segment → equal angles.", hints: ["Same segment.", "55.", "Same segment → equal angles."] },
      // @q09
      { id: "U21L4-num-3", type: "numeric-input", category: "conceptual", prompt: "X slides from one side of chord AB to the other. If the original angle was 50°, the angle on the other side is 180 − 50. Type it.", answer: 130, tolerance: 0, explanation: "Opposite segments supplement: 180 − 50 = 130°.", hints: ["Opposite side.", "Supplement.", "Opposite segments supplement: 180 − 50 = 130°."] },
      // @q10
      { id: "U21L4-frac-1", type: "fraction-input", category: "conceptual", prompt: "An angle in a semicircle compared to a right angle — write it as a fraction of 90°.", numerator: 1, denominator: 1, acceptEquivalent: true, explanation: "90°/90° = 1 — exactly one right angle.", hints: ["90° total.", "1 whole right angle.", "90°/90° = 1 — exactly one right angle."] },
      // @q11
      { id: "U21L4-tf-1", type: "true-false-justify", category: "conceptual", prompt: "The angle in a semicircle is always 90°, wherever the point sits on the arc.", isTrue: true, explanation: "Any point on the circle sees a diameter under a right angle.", hints: ["Semicircle law.", "Always.", "Any point on the circle sees a diameter under a right angle."] },
      // @q12
      { id: "U21L4-tf-2", type: "true-false-justify", category: "conceptual", prompt: "Angles in opposite segments of a chord are equal.", isTrue: false, explanation: "Opposite-segment angles are supplementary (sum 180°), not equal.", hints: ["Opposite sides.", "Supplement.", "Opposite-segment angles are supplementary (sum 180°), not equal."] },
      // @q13
      { id: "U21L4-order-1", type: "order-steps", category: "word", prompt: "Order the steps to find ∠AXB when you know ∠AYB on the same arc.", sequence: ["Check both X and Y lie on the same arc AB", "Note both subtend chord AB", "Equal: ∠AXB = ∠AYB", "Copy the known angle"], diagnoses: { "Check both X and Y lie on the same arc AB@1": "Check the arc first.", "Note both subtend chord AB@0": "Note the shared chord.", "Copy the known angle@0": "Copy at the end." }, explanation: "Arc check, shared chord, equality, copy.", hints: ["Same arc.", "Same chord.", "Arc check, shared chord, equality, copy."] },
      // @q14
      { id: "U21L4-drag-1", type: "drag-match", category: "conceptual", prompt: "Match each setup to its result.", pairs: [ { source: "AB a diameter", target: "∠AXB = 90°" }, { source: "X, Y on same arc AB", target: "∠AXB = ∠AYB" }, { source: "X, Y on opposite arcs", target: "Angles sum to 180°" } ], diagnoses: { "AB a diameter->∠AXB = ∠AYB": "Diameter gives the 90° semicircle law.", "X, Y on same arc AB->Angles sum to 180°": "Same arc means equal.", "X, Y on opposite arcs->∠AXB = 90°": "Opposite arcs supplement." }, explanation: "Diameter → 90°; same arc → equal; opposite arcs → supplement.", hints: ["Diameter.", "Same arc.", "Diameter → 90°; same arc → equal; opposite arcs → supplement."] },
      // @q15
      { id: "U21L4-graph-1", type: "graph-interact", category: "word", prompt: "∠AXB is 40°. X stays on the same arc. Set the slider to ∠AYB (key: value).", challenge: "Adjust the values below so they match the condition described in the prompt.", validate: { value: 40 }, tolerance: 0.01, explanation: "Same-segment angles are equal: 40°.", hints: ["Same segment.", "Equal.", "Same-segment angles are equal: 40°."] }
    ],
