...
export const T2U16L2: Lesson = {
  ...
  quiz: {
    pool: [
      // @q01
      { id: "U16L2-mcq-1", type: "mcq", category: "procedural", prompt: "3x > 9. Divide by 3. Which is correct?", options: [ { id: "a", text: "x > 3" }, { id: "b", text: "x < 3" }, { id: "c", text: "x ≥ 3" }, { id: "d", text: "x = 3" } ], correctOptionId: "a", diagnoses: { b: "No flip — dividing by a POSITIVE keeps the direction.", c: "> stayed >; no 'or equal' introduced.", d: "It's an inequality, not an equation — a whole range." }, explanation: "Positive divisor → direction unchanged: x > 3.", hints: ["3 is positive.", "No flip.", "Positive divisor → direction unchanged: x > 3."] },
      // @q02
      { id: "U16L2-mcq-2", type: "mcq", category: "conceptual", prompt: "−2 < 3. Multiply both sides by −1. What's true?", options: [ { id: "a", text: "2 < −3" }, { id: "b", text: "2 > −3 (flip!)" }, { id: "c", text: "−2 < 3 stays the same" }, { id: "d", text: "−2 > 3" } ], correctOptionId: "b", diagnoses: { a: "2 > −3 — the order reverses, so the symbol flips.", c: "Multiplying changes the numbers; the direction must flip.", d: "−2 × −1 = 2, not −2." }, explanation: "Multiply by −1 reflects the line: −2 < 3 becomes 2 > −3.", hints: ["Multiply each side.", "Order reverses.", "Multiply by −1 reflects the line: −2 < 3 becomes 2 > −3."] },
      // @q03
      { id: "U16L2-mcq-3", type: "mcq", category: "word", prompt: "Budget: −5x > 20 means you lose 5 each round; how many rounds until debt exceeds 20? Solve −5x > 20.", options: [ { id: "a", text: "x > 4" }, { id: "b", text: "x > −4" }, { id: "c", text: "x < −4" }, { id: "d", text: "x < 4" } ], correctOptionId: "c", diagnoses: { b: "Dividing by −5 flips the > to <.", a: "No flip AND the sign of the RHS is wrong.", d: "The ÷(−5) forces a flip: x < −4." }, explanation: "−5x > 20 ÷(−5): x < −4.", hints: ["Divide by −5.", "NEGATIVE → flip.", "−5x > 20 ÷(−5): x < −4."] },
      // @q04
      { id: "U16L2-mcq-4", type: "mcq", category: "procedural", prompt: "x + 4 < 9. Subtract 4. Which is correct?", options: [ { id: "a", text: "x < −5" }, { id: "b", text: "x > 5" }, { id: "c", text: "x < 13" }, { id: "d", text: "x < 5" } ], correctOptionId: "d", diagnoses: { b: "Subtracting never flips the symbol.", c: "Subtract 4, don't add it.", a: "9 − 4 = 5, not −5." }, explanation: "x + 4 − 4 < 9 − 4 → x < 5. Addition/subtraction: no flip.", hints: ["Do the same to both.", "No flip.", "x + 4 − 4 < 9 − 4 → x < 5."] },
      // @q05
      ...
      // @q06
      { id: "U16L2-mcq-6", type: "mcq", category: "word", prompt: "You need at least 60 marks: 20 + 2x ≥ 60 (x = correct answers). Solve for x.", options: [ { id: "a", text: "x > 20" }, { id: "b", text: "x ≥ 20" }, { id: "c", text: "x ≥ 40" }, { id: "d", text: "x ≤ 20" } ], correctOptionId: "b", diagnoses: { a: "≥ includes 20 — you don't lose it.", c: "Subtract 20 first: 2x ≥ 40, then x ≥ 20.", d: "Positive divisor keeps ≥ going the same way." }, explanation: "2x ≥ 40 → x ≥ 20 (no flip; positive 2).", hints: ["Subtract 20.", "Divide by 2.", "2x ≥ 40 → x ≥ 20 (no flip; positive 2)."] },
      // @q07
      { id: "U16L2-num-1", type: "numeric-input", category: "procedural", prompt: "−3x > 9. Type the boundary of the solution (the number x compares with).", answer: -3, tolerance: 0, explanation: "÷(−3) → x < −3 — the flip is baked into the answer's direction.", hints: ["Divide by −3.", "9 ÷ −3 = −3.", "÷(−3) → x < −3 — the flip is baked into the answer's direction."] },
      // @q08
      { id: "U16L2-num-2", type: "numeric-input", category: "procedural", prompt: "4x < 20. Type the largest whole number solution.", answer: 4, tolerance: 0, explanation: "x < 5, so the largest whole number is 4.", hints: ["x < 5.", "Whole numbers under 5.", "x < 5, so the largest whole number is 4."] },
      // @q09
      { id: "U16L2-num-3", type: "numeric-input", category: "conceptual", prompt: "x + 5 ≥ 8. Type the smallest whole number solution.", answer: 3, tolerance: 0, explanation: "x ≥ 3 → 3 is included.", hints: ["Subtract 5.", "x ≥ 3.", "x ≥ 3 → 3 is included."] },
      // @q10
      { id: "U16L2-frac-1", type: "fraction-input", category: "conceptual", prompt: "2x > 1. Write the boundary value as a fraction.", numerator: 1, denominator: 2, acceptEquivalent: true, explanation: "x > 1/2 — the boundary is 1/2.", hints: ["Divide by 2.", "x > 1/2.", "x > 1/2 — the boundary is 1/2."] },
      // @q11
      { id: "U16L2-tf-1", type: "true-false-justify", category: "conceptual", prompt: "Multiplying an inequality by a negative number flips its direction.", isTrue: true, explanation: "The number line reflects — every order reverses.", hints: ["Reflect the line.", "Order reverses.", "The number line reflects — every order reverses."] },
      // @q12
      { id: "U16L2-tf-2", type: "true-false-justify", category: "conceptual", prompt: "x + 2 < 5 solves to x > 3 (subtracting 2 flips the symbol).", isTrue: false, explanation: "Subtracting never flips: x < 3.", hints: ["Add/subtract: no flip.", "x < 3.", "Subtracting never flips: x < 3."] },
      // @q13
      { id: "U16L2-order-1", type: "order-steps", category: "word", prompt: "Order the steps to solve −2x > 6.", sequence: ["Note the coefficient of x is negative (−2)", "Divide both sides by −2", "FLIP the sign: x < −3", "Check: −2(−4) = 8 > 6 ✓"], diagnoses: { "Note the coefficient of x is negative (−2)@1": "Check the coefficient first.", "Divide both sides by −2@0": "Divide before flipping.", "FLIP the sign: x < −3@1": "Flip AFTER dividing by the negative." }, explanation: "Negative coefficient → divide → flip → verify.", hints: ["Check coefficient.", "Divide.", "Negative coefficient → divide → flip → verify."] },
      // @q14
      { id: "U16L2-drag-1", type: "drag-match", category: "conceptual", prompt: "Match each step to whether it flips the symbol.", pairs: [ { source: "Multiply both sides by −2", target: "Flip" }, { source: "Subtract 7 from both sides", target: "No flip" }, { source: "Divide both sides by positive 5", target: "No flip" } ], diagnoses: { "Multiply both sides by −2->No flip": "Negative multiplier ALWAYS flips.", "Subtract 7 from both sides->Flip": "Adding/subtracting never flips.", "Divide both sides by positive 5->Flip": "Positive divisor keeps direction." }, explanation: "Only × or ÷ by a negative flips.", hints: ["Negative multiplier.", "Flip for negative.", "Only × or ÷ by a negative flips."] },
      // @q15
      { id: "U16L2-graph-1", type: "graph-interact", category: "word", prompt: "−2x > 6 solves to x < −3. Set the slider to −3 (key: value) — the boundary.", challenge: "−2x > 6 solves to x < −3. — adjust the values below to match the condition.", validate: { value: -3 }, tolerance: 0.01, explanation: "Boundary is −3; the flip points the ray left.", hints: ["Divide by −2.", "x < −3.", "Boundary is −3; the flip points the ray left."] }
    ],
