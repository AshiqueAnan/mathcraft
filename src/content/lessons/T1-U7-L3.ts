    ...
    pool: [
      {
        ...
        hints: ["Pattern: divide by base.", "2⁰ = 1.", "Anything non-zero to the 0 power = 1."],
      },
      {
        id: "U7L3-mcq-2", type: "mcq", category: "conceptual",
        prompt: "Why is 2⁰ = 1?",
        options: [
          { id: "a", text: "Because 0 twos multiply to 0" },
          { id: "b", text: "Following the ÷2 pattern: 2²=4 → 2¹=2 → 2⁰=1" },
          { id: "c", text: "Because we round down" },
          { id: "d", text: "It's actually 2" },
        ],
        correctOptionId: "b",
        diagnoses: { a: "Zero twos multiplied is confusing — the PATTERN (divide by 2) is the proof: 4→2→1.", c: "No rounding — exact pattern.", d: "2¹ = 2, not 2⁰." },
      ...
      },
      {
        ...
        options: [{ id: "a", text: "8" }, { id: "b", text: "−16" }, { id: "c", text: "$\\frac{1}{16}$" }, { id: "d", text: "16" }],
        correctOptionId: "c",
        diagnoses: { b: "Negative index ≠ negative number.", a: "8 = 2³, wrong sign.", d: "16 = 2⁴." },
        explanation: "2⁻⁴ = 1/(2⁴) = 1/16.",
        hints: ["Negative index → reciprocal.", "1 ÷ 2⁴.", "2⁻⁴ = 1/(2⁴) = 1/16."],
      },
      {
        id: "U7L3-mcq-4", type: "mcq", category: "procedural",
        prompt: "What is 2⁻²?",
        options: [{ id: "a", text: "$\\frac{1}{2}$" }, { id: "b", text: "−4" }, { id: "c", text: "−2" }, { id: "d", text: "$\\frac{1}{4}$" }],
        correctOptionId: "d",
        diagnoses: { b: "−4 = −(2²), not a reciprocal.", c: "−2 ignores the reciprocal.", a: "1/2 is 2⁻¹." },
        explanation: "2⁻² = 1/(2²) = 1/4.",
        hints: ["Reciprocal of 2².", "1 ÷ 4.", "2⁻² = 1/(2²) = 1/4."],
      },
      {
        ...
        hints: ["Reciprocal of 10.", "1 ÷ 10.", "10⁻¹ = 1/10 = 0."],
      },
      {
        id: "U7L3-mcq-6", type: "mcq", category: "word",
        prompt: "Measurement in metres: 10⁻³ km equals 1 metre. 10⁻³ as a decimal?",
        options: [{ id: "a", text: "0.01" }, { id: "b", text: "0.001" }, { id: "c", text: "−0.001" }, { id: "d", text: "1000" }],
        correctOptionId: "b",
        diagnoses: { a: "0.01 = 10⁻².", c: "Negative index ≠ negative number.", d: "1000 = 10³." },
        explanation: "10⁻³ = 1/1000 = 0.001.",
        hints: ["1 ÷ 10³.", "1 ÷ 1000.", "10⁻³ = 1/1000 = 0."],
      },
      {
        ...
        hints: ["Follow the ÷base pattern.", "Pattern → 1.", "Any non-zero base power 0 = 1."],
      },
      {
        ...
        hints: ["Reciprocal of 3.", "1 ÷ 3.", "3⁻¹ = 1/3 ≈ 0.333."],
      },
      {
        ...
        hints: ["Reciprocal of 2³.", "1 ÷ 8.", "2⁻³ = 1/2³ = 1/8 = 0."],
      },
      {
        ...
        hints: ["Continue the halving.", "2, then half.", "2¹ = 2, then 2⁰ = 1 — halving again lands on 1."],
      },
      {
        ...
        hints: ["5² = 25.", "Reciprocal.", "5⁻² = 1/5² = 1/25."],
      },
      {
        ...
        hints: ["Divide by 2 each step.", "1.", "Pattern: 2²=4, 2¹=2, 2⁰=1."],
      },
      {
        ...
        hints: ["Reciprocal, not negative.", "1/4.", "Negative index means RECIPROCAL: 2⁻² = 1/4, not −4."],
      },
      {
        ...
        hints: ["Reciprocal first.", "3².", "a⁻ⁿ = 1/aⁿ."],
      },
      {
        ...
        hints: ["No twos → 1.", "Half.", "Power 0 → 1; negative → reciprocal."],
      },
      {
        ...
        hints: ["1 ÷ 2².", "Reciprocal of 4.", "2⁻² = 1/4 = 0.25."],
      },
    ],
