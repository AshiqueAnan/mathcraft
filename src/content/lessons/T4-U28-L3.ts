...
export const T4U28L3: Lesson = {
  ...
  quiz: {
    pool: [
      ...
      // @q06
      { id: "U28L3-mcq-6", type: "mcq", category: "word", prompt: "A headline bar chart shows 'debt crisis!' — a 2-unit rise from a 100-unit base with axis starting at 98. The true story is…", options: [ { id: "a", text: "debt doubling" }, { id: "b", text: "a tiny 2% increase over a large baseline" }, { id: "c", text: "debt tripling" }, { id: "d", text: "no change" } ], correctOptionId: "b", diagnoses: { a: "100→102 is a 2% rise, not double.", c: "Tripling would need ≈ 300.", d: "There is a small change." }, explanation: "Read the numbers, not the visual: 102 ÷ 100 = a 2% rise.", hints: ["102 vs 100.", "2% rise.", "Tiny change."] },
      // @q07
