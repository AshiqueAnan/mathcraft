...
export const T4U28L3: Lesson = {
  ...
  quiz: {
    pool: [
      ...
      // @q15
      { id: "U28L3-graph-1", type: "graph-interact", category: "word", prompt: "Scores: 5, 8, 12, 20. Set the slider to the RANGE (key: value).", challenge: "Set the slider to 15.", validate: { value: 15 }, tolerance: 0.01, explanation: "Range = 20 − 5 = 15.", hints: ["20 − 5.", "15.", "15."] }
    ],
