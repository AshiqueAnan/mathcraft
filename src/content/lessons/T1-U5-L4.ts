    ...
    pool: [
      {
        ...
        hints: ["Undo ×1.2.", "120 ÷ 1.2.", "New = original × 1."],
      },
      {
        ...
        hints: ["Paying 40% means ×0.4.", "40 ÷ 0.4.", "You pay 40% of the original: original = 40 ÷ 0."],
      },
      {
        ...
        hints: ["Pay 70% = ×0.7.", "63 ÷ 0.7.", "Pay 70%: original = 63 ÷ 0."],
      },
      {
      ...
      },
      {
        ...
        hints: ["Undo ×1.1.", "550 ÷ 1.1.", "550 ÷ 1.1 = 500."],
      },
      {
        ...
        hints: ["Pay 85% = ×0.85.", "204 ÷ 0.85.", "Pay 85%: original = 204 ÷ 0."],
      },
      {
        ...
        hints: ["×0.5.", "50 ÷ 0.5.", "Pay 50% = ×0.5. Original = 50 ÷ 0.5 = 100."],
      },
      {
      ...
      },
      {
        ...
        hints: ["Pay 70%.", "21 ÷ 0.7.", "Pay 70%: 21 ÷ 0."],
      },
      {
        ...
        hints: ["Undo ×1.2.", "96 ÷ 1.2.", "96 ÷ 1.2 = 80."],
      },
      {
        ...
        hints: ["Original divided by sale price.", "25 ÷ 20.", "25/20 = 5/4 — original is 1."],
      },
      {
        ...
        hints: ["Undo multiplication.", "÷1.1.", "New = original × 1."],
      },
      {
        ...
        hints: ["40 ÷ 0.5.", "80.", "Pay 50%: original = 40 ÷ 0."],
      },
      {
        ...
        hints: ["Pay 80%.", "48 ÷ 0.8.", "Pay 80% → multiplier 0."],
      },
      {
        ...
        hints: ["Pay 80%.", "×1.25 reversed.", "Discount p% → divide by (1 − p/100); increase p% → divide by (1 + p/100)."],
      },
      {
