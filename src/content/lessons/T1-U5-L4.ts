  ...
  quiz: {
    pool: [
      ...
      },
      {
        ...
        options: [{ id: "a", text: "$100" }, { id: "b", text: "$64" }, { id: "c", text: "$24" }, { id: "d", text: "$40" }],
        correctOptionId: "a",
        diagnoses: { b: "64 = 40 × 1.6 — adding 60% of 40, but the 60% was of the ORIGINAL.", c: "24 = 40 × 0.6 — you paid 40%, so divide by 0.4, not 0.6.", d: "40 is what you pay, not the original." },
      ...
      },
      {
        ...
        options: [{ id: "a", text: "$90" }, { id: "b", text: "$81.90" }, { id: "c", text: "$44.10" }, { id: "d", text: "$63" }],
        correctOptionId: "a",
        diagnoses: { b: "81.90 = 63 × 1.3 — adding 30% of sale price, wrong base.", c: "44.10 = 63 × 0.7 — the sale is 70%, so divide by 0.7.", d: "63 is the sale price." },
      ...
      },
      {
        ...
        options: [
          { id: "a", text: "The 30% was taken from the original, not from the sale price" },
          { id: "b", text: "Percentages can't be reversed" },
          { id: "c", text: "30% is too small" },
          { id: "d", text: "You can always just add it back" },
        ],
        correctOptionId: "a",
        diagnoses: { b: "They can be reversed — divide by the MULTIPLIER (0.7), not add the percent.", c: "Size doesn't matter; the base does.", d: "Test it: 100 → 70 → add 21 = 91 ≠ 100." },
      ...
      },
      {
        ...
        options: [{ id: "a", text: "$240" }, { id: "b", text: "$234.60" }, { id: "c", text: "$173.40" }, { id: "d", text: "$204" }],
        correctOptionId: "a",
        diagnoses: { b: "234.60 = 204 × 1.15 — wrong base.", c: "173.40 = 204 × 0.85 — divide by 0.85 instead.", d: "204 is the sale price." },
