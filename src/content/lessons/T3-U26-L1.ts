...
export const T3U26L1: Lesson = {
  ...
  quiz: {
    pool: [
      // @q01
      { id: "U26L1-mcq-1", type: "mcq", category: "procedural", prompt: "In a right triangle, opposite = 3, hypotenuse = 5. sin θ = …", options: [ { id: "a", text: "3/5 = 0.6" }, { id: "b", text: "5/3 ≈ 1.67" }, { id: "c", text: "3 − 5 = −2" }, { id: "d", text: "3 × 5 = 15" } ], correctOptionId: "a", diagnoses: { b: "That's hypotenuse/opposite — inverted.", c: "Sine is a ratio (divide), not a difference.", d: "Sine divides, it doesn't multiply." }, explanation: "sin = opposite/hypotenuse = 3/5 = 0.6.", hints: ["Opposite over hypotenuse.", "3 ÷ 5.", "0.6."] },
      // @q02
      { id: "U26L1-mcq-2", type: "mcq", category: "conceptual", prompt: "Why is sin θ the same in two similar triangles?", options: [ { id: "a", text: "They're scaled copies, so side ratios match" }, { id: "b", text: "They have different angles" }, { id: "c", text: "Bigger triangles have bigger sines" }, { id: "d", text: "sin grows with size" } ], correctOptionId: "a", diagnoses: { b: "Similar triangles SHARE all angles.", c: "Size doesn't affect the ratio.", d: "Enlarging scales all sides equally; the ratio stays." }, explanation: "Scaling multiplies opposite AND hypotenuse by the same factor, cancelling in the ratio.", hints: ["Similar = same angles.", "Sides scale together.", "Ratio unchanged."] },
      // @q03
      { id: "U26L1-mcq-3", type: "mcq", category: "word", prompt: "A 30° ladder makes sin 30° = 0.5. A LARGER 30° ladder gives sin 30° = …", options: [ { id: "a", text: "0.5 — the ratio doesn't change" }, { id: "b", text: "bigger than 0.5" }, { id: "c", text: "smaller than 0.5" }, { id: "d", text: "unknown without numbers" } ], correctOptionId: "a", diagnoses: { b: "Size scales sides equally; ratio fixed.", c: "Same angle → same ratio.", d: "The angle fully determines sin." }, explanation: "sin 30° = 0.5 for EVERY 30° right triangle, any size.", hints: ["Angle decides sine.", "30° always 0.5.", "0.5."] },
      // @q04
      { id: "U26L1-mcq-4", type: "mcq", category: "procedural", prompt: "sin 45° ≈ 0.707. If a hypotenuse is 10, the opposite side is about…", options: [ { id: "a", text: "7.07" }, { id: "b", text: "0.707" }, { id: "c", text: "14.14" }, { id: "d", text: "10" } ], correctOptionId: "a", diagnoses: { b: "0.707 is the RATIO, not the side.", c: "14.14 multiplies by 1/sin — inverted.", d: "10 is the hypotenuse itself." }, explanation: "opposite = sin θ × hypotenuse = 0.707 × 10 ≈ 7.07.", hints: ["Multiply by hypotenuse.", "0.707 × 10.", "≈ 7.07."] },
      // @q05
      ...
      // @q06
      { id: "U26L1-mcq-6", type: "mcq", category: "word", prompt: "A ramp rises 3 m over a 5 m hypotenuse. sin of the ramp's angle = …", options: [ { id: "a", text: "0.6" }, { id: "b", text: "1.67" }, { id: "c", text: "0.4" }, { id: "d", text: "8" } ], correctOptionId: "a", diagnoses: { b: "That's hypotenuse/opposite.", c: "0.4 is 2/5 — the horizontal run over hypotenuse (cosine, next lesson).", d: "8 adds them." }, explanation: "sin = opposite/hypotenuse = 3/5 = 0.6.", hints: ["3 ÷ 5.", "0.6.", "0.6."] },
      // @q07
      { id: "U26L1-num-1", type: "numeric-input", category: "procedural", prompt: "Opposite 4, hypotenuse 10. sin θ (as a decimal).", answer: 0.4, tolerance: 0.01, acceptFractions: true, explanation: "4/10 = 0.4.", hints: ["4 ÷ 10.", "0.4.", "0.4."] },
      // @q08
      { id: "U26L1-num-2", type: "numeric-input", category: "procedural", prompt: "sin θ = 0.5 and hypotenuse = 12. The opposite side is…", answer: 6, tolerance: 0, explanation: "opposite = 0.5 × 12 = 6.", hints: ["Multiply ratio × hypotenuse.", "0.5 × 12.", "6."] },
      // @q09
      { id: "U26L1-num-3", type: "numeric-input", category: "conceptual", prompt: "sin 30° = 0.5 exactly. What is the hypotenuse when the opposite side is 4?", answer: 8, tolerance: 0, explanation: "hypotenuse = opposite ÷ sin = 4 ÷ 0.5 = 8.", hints: ["Divide by the ratio.", "4 ÷ 0.5.", "8."] },
      // @q10
      { id: "U26L1-frac-1", type: "fraction-input", category: "conceptual", prompt: "The ratio scale for sin 30° is 1/2. For an opposite of 1 unit, what's the hypotenuse in the same units?", numerator: 2, denominator: 1, acceptEquivalent: true, explanation: "opposite/hypotenuse = 1/2, so hypotenuse = 2 when opposite = 1.", hints: ["Ratio 1:2.", "Hypotenuse 2.", "2/1."] },
      // @q11
      { id: "U26L1-tf-1", type: "true-false-justify", category: "conceptual", prompt: "sin θ stays the same if you enlarge the triangle.", isTrue: true, explanation: "Similar triangles share angles; scaling cancels in the ratio.", hints: ["Similar shapes.", "Ratios match.", "True."] },
      // @q12
      { id: "U26L1-tf-2", type: "true-false-justify", category: "conceptual", prompt: "sin θ = opposite × hypotenuse.", isTrue: false, explanation: "Sine DIVIDES opposite by hypotenuse — it's a ratio, not a product.", hints: ["Ratio means divide.", "opposite ÷ hypotenuse.", "False."] },
      // @q13
      { id: "U26L1-order-1", type: "order-steps", category: "word", prompt: "Order the steps to find sin θ.", sequence: ["Locate the side opposite θ", "Locate the hypotenuse", "Divide: opposite ÷ hypotenuse"], diagnoses: { "Locate the side opposite θ@1": "Find opposite first.", "Locate the hypotenuse@0": "Then the hypotenuse.", "Divide: opposite ÷ hypotenuse@0": "Divide last." }, explanation: "Opposite, hypotenuse, divide.", hints: ["Opposite side.", "Hypotenuse.", "Divide."] },
      // @q14
      { id: "U26L1-drag-1", type: "drag-match", category: "conceptual", prompt: "Match each angle to its sine.", pairs: [ { source: "30°", target: "0.5" }, { source: "45°", target: "≈ 0.707" }, { source: "60°", target: "≈ 0.866" } ], diagnoses: { "30°->≈ 0.707": "30° has sine 0.5.", "45°->0.5": "45° sine is ≈ 0.707.", "60°->0.5": "60° sine is ≈ 0.866." }, explanation: "Each angle owns a fixed ratio.", hints: ["30° → 0.5.", "45° → ≈ 0.707.", "60° → ≈ 0.866."] },
      // @q15
      { id: "U26L1-graph-1", type: "graph-interact", category: "word", prompt: "sin 30° = 0.5 with hypotenuse 10. Set the slider to the OPPOSITE side (key: value).", challenge: "Set the slider to 5.", validate: { value: 5 }, tolerance: 0.01, explanation: "opposite = 0.5 × 10 = 5.", hints: ["0.5 × 10.", "5.", "5."] }
    ],
