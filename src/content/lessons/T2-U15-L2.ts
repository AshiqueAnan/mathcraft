...
export const T2U15L2: Lesson = {
  ...
  quiz: {
    pool: [
      // @q01
      { id: "U15L2-mcq-1", type: "mcq", category: "procedural", prompt: "y = 3x and x + y = 8. After substituting y, which equation do you solve?", options: [ { id: "a", text: "x + 3x = 8" }, { id: "b", text: "3x + 8 = x" }, { id: "c", text: "x · 3x = 8" }, { id: "d", text: "x + 3 = 8" } ], correctOptionId: "a", diagnoses: { b: "y is replaced, not the other way round.", c: "That's multiplication, but the equations ADD y.", d: "3x replaces y — keep the x." }, explanation: "x + 3x = 8 → 4x = 8 → x = 2.", hints: ["Replace y with 3x.", "x + 3x = 8.", "4x = 8."] },
      // @q02
      { id: "U15L2-mcq-2", type: "mcq", category: "conceptual", prompt: "Why does elimination add x + y = 10 and x − y = 4?", options: [ { id: "a", text: "The y terms cancel (+y − y = 0), leaving one equation in x" }, { id: "b", text: "It makes the numbers smaller" }, { id: "c", text: "You always add two equations" }, { id: "d", text: "It doubles the answers" } ], correctOptionId: "a", diagnoses: { b: "Size isn't the goal — cancellation is.", c: "Sometimes you subtract; you choose the operation that cancels.", d: "Both sides stay equal; the system keeps one solution." }, explanation: "+y − y = 0, so 2x = 14 — one unknown, solvable.", hints: ["Look at the y coefficients.", "+y and −y cancel.", "2x = 14."] },
      // @q03
      { id: "U15L2-mcq-3", type: "mcq", category: "word", prompt: "Two numbers: their sum is 12 and their difference is 4. With x + y = 12 and x − y = 4, what are the numbers?", options: [ { id: "a", text: "8 and 4" }, { id: "b", text: "6 and 6" }, { id: "c", text: "12 and 0" }, { id: "d", text: "10 and 2" } ], correctOptionId: "a", diagnoses: { b: "6 and 6 have difference 0, not 4.", c: "12 and 0 have difference 12.", d: "10 − 2 = 8, not 4." }, explanation: "Add: 2x = 16 → x = 8; then y = 4. 8 + 4 = 12 ✓, 8 − 4 = 4 ✓.", hints: ["Eliminate y by adding.", "2x = 16.", "8 and 4."] },
      // @q04
      { id: "U15L2-mcq-4", type: "mcq", category: "procedural", prompt: "x + y = 10 and x − y = 4. After adding, what is 2x?", options: [ { id: "a", text: "14" }, { id: "b", text: "6" }, { id: "c", text: "10" }, { id: "d", text: "4" } ], correctOptionId: "a", diagnoses: { b: "6 is x − y's side alone — you must add both equations.", c: "That's just the first equation's total.", d: "That's the difference alone." }, explanation: "x + x = 2x and 10 + 4 = 14 → 2x = 14.", hints: ["Add left sides and right sides.", "2x = 14.", "x = 7."] },
      // @q05
      ...
      // @q06
      { id: "U15L2-mcq-6", type: "mcq", category: "word", prompt: "Two tickets: a + b = 35 and a − b = 5 (adult minus child). What are the prices?", options: [ { id: "a", text: "Adult $20, child $15" }, { id: "b", text: "Adult $15, child $20" }, { id: "c", text: "Adult $30, child $5" }, { id: "d", text: "Adult $35, child $5" } ], correctOptionId: "a", diagnoses: { b: "Adult must be MORE: a − b = 5.", c: "30 − 5 = 25, not 5 — and 35 + 5? 30 + 5 = 35 ✓ but difference is 25.", d: "35 + 5 = 40, not 35." }, explanation: "Add: 2a = 40 → a = 20; then b = 15. 20 + 15 = 35 ✓, 20 − 15 = 5 ✓.", hints: ["Eliminate b by adding.", "2a = 40.", "Adult $20, child $15."] },
      // @q07
      { id: "U15L2-num-1", type: "numeric-input", category: "procedural", prompt: "y = 2x and x + y = 9. Type x.", answer: 3, tolerance: 0, explanation: "x + 2x = 9 → 3x = 9 → x = 3.", hints: ["Substitute y = 2x.", "3x = 9.", "x = 3."] },
      // @q08
      { id: "U15L2-num-2", type: "numeric-input", category: "procedural", prompt: "y = 2x and x + y = 9. Type y.", answer: 6, tolerance: 0, explanation: "y = 2x = 2 × 3 = 6.", hints: ["x = 3 from before.", "y = 2x.", "y = 6."] },
      // @q09
      { id: "U15L2-num-3", type: "numeric-input", category: "conceptual", prompt: "x + y = 12 and x − y = 4. Type x.", answer: 8, tolerance: 0, explanation: "Add: 2x = 16 → x = 8.", hints: ["Eliminate y.", "2x = 16.", "x = 8."] },
      // @q10
      { id: "U15L2-frac-1", type: "fraction-input", category: "conceptual", prompt: "x + y = 5 and y = x − 1. Write x as a fraction.", numerator: 3, denominator: 1, acceptEquivalent: true, explanation: "x + (x − 1) = 5 → 2x = 6 → x = 3.", hints: ["Substitute y.", "2x − 1 = 5.", "x = 3."] },
      // @q11
      { id: "U15L2-tf-1", type: "true-false-justify", category: "conceptual", prompt: "Substitution and elimination always give the same solution for the same system.", isTrue: true, explanation: "They are different roads to the same crossing point — both solve the same two equations.", hints: ["Same system, same point.", "Same solution.", "True."] },
      // @q12
      ...
      // @q15
      { id: "U15L2-graph-1", type: "graph-interact", category: "word", prompt: "The system y = 2x and x + y = 9 crosses at x = 3. Set the slider to the crossing's x-value (key: value).", challenge: "Set the slider to 3.", validate: { value: 3 }, tolerance: 0.01, explanation: "Substitution: x + 2x = 9 → x = 3, y = 6.", hints: ["x + 2x = 9.", "3x = 9.", "x = 3."] }
    ],
