...
export const T2U15L2: Lesson = {
  ...
  quiz: {
    pool: [
      ...
      // @q04
      { id: "U15L2-mcq-4", type: "mcq", category: "procedural", prompt: "x + y = 10 and x − y = 4. After adding, what is 2x?", options: [ { id: "a", text: "4" }, { id: "b", text: "6" }, { id: "c", text: "10" }, { id: "d", text: "14" } ], correctOptionId: "d", diagnoses: { b: "6 is x − y's side alone — you must add both equations.", c: "That's just the first equation's total.", a: "That's the difference alone." }, explanation: "x + x = 2x and 10 + 4 = 14 → 2x = 14.", hints: ["Add left sides and right sides.", "2x = 14.", "x = 7."] },
      // @q05
