...
export const T2U18L4: Lesson = {
  ...
  quiz: {
    pool: [
      // @q01
      { id: "U18L4-mcq-1", type: "mcq", category: "procedural", prompt: "Line through (1, 3) and (3, 7). What is m?", options: [ { id: "a", text: "2" }, { id: "b", text: "4" }, { id: "c", text: "1/2" }, { id: "d", text: "3" } ], correctOptionId: "a", diagnoses: { b: "4 is the rise alone — ÷ run 2.", c: "That's run ÷ rise.", d: "3 is a y-coordinate." }, explanation: "m = (7−3)/(3−1) = 4/2 = 2.", hints: ["rise 4.", "run 2.", "m = (7−3)/(3−1) = 4/2 = 2."] },
      // @q02
      { id: "U18L4-mcq-2", type: "mcq", category: "conceptual", prompt: "With m = 2 and point (1, 3), how do you find c?", options: [ { id: "a", text: "Substitute: 1 = 2(3) + c → c = −5" }, { id: "b", text: "Substitute: 3 = 2(1) + c → c = 1" }, { id: "c", text: "c = m × 3" }, { id: "d", text: "c = the y-coordinate always" } ], correctOptionId: "b", diagnoses: { a: "x goes beside m; y stands alone: 3 = 2(1) + c.", c: "c comes from the point, not m times y.", d: "c is y only when x = 0." }, explanation: "y = mx + c → 3 = 2(1) + c → c = 1.", hints: ["y = mx + c.", "Plug (1, 3).", "y = mx + c → 3 = 2(1) + c → c = 1."] },
      // @q03
      { id: "U18L4-mcq-3", type: "mcq", category: "word", prompt: "A plant grows 3 cm/week from 5 cm: the line passes (0, 5) with m = 3. Equation?", options: [ { id: "a", text: "y = 3x" }, { id: "b", text: "y = 5x + 3" }, { id: "c", text: "y = 3x + 5" }, { id: "d", text: "y = 8x" } ], correctOptionId: "c", diagnoses: { b: "m = 3, c = 5 — swapped.", a: "It ignores the starting 5 cm.", d: "8 is the height at week 1, not the gradient." }, explanation: "m = growth rate 3; c = starting height 5 → y = 3x + 5.", hints: ["m = 3/week.", "c = 5 start.", "m = growth rate 3; c = starting height 5 → y = 3x + 5."] },
      // @q04
      { id: "U18L4-mcq-4", type: "mcq", category: "procedural", prompt: "m = −1 through (2, 4). What is c?", options: [ { id: "a", text: "−2" }, { id: "b", text: "2" }, { id: "c", text: "−6" }, { id: "d", text: "6" } ], correctOptionId: "d", diagnoses: { b: "2 is the x; 4 = −2 + c → c = 6.", c: "Sign: 4 + 2 = 6, positive.", a: "Substitute correctly: c = 4 + 2 = 6." }, explanation: "4 = −1(2) + c → c = 6.", hints: ["4 = −2 + c.", "c = 6.", "4 = −1(2) + c → c = 6."] },
      // @q05
      { id: "U18L4-mcq-5", type: "mcq", category: "conceptual", prompt: "Why do TWO points determine a line uniquely?", options: [ { id: "a", text: "They fix both the tilt (m) and the height (c)" }, { id: "b", text: "Lines need at least three points" }, { id: "c", text: "One point is enough" }, { id: "d", text: "Points don't determine lines" } ], correctOptionId: "a", diagnoses: { b: "Two points are sufficient for a straight line.", c: "One point allows many tilts through it.", d: "Two points pin m and c together." }, explanation: "Two points give rise/run (m) and a substitution (c).", hints: ["Rise/run needs two.", "Then solve c.", "Two points give rise/run (m) and a substitution (c)."] },
      // @q06
      { id: "U18L4-mcq-6", type: "mcq", category: "word", prompt: "Cooling: 40° at t = 0, 30° at t = 2 (linear). Equation T = mt + c?", options: [ { id: "a", text: "T = 5t + 40" }, { id: "b", text: "T = −5t + 40" }, { id: "c", text: "T = −10t + 30" }, { id: "d", text: "T = 40t + 30" } ], correctOptionId: "b", diagnoses: { a: "It cools — m is negative.", c: "m = (30−40)/2 = −5, and c = 40.", d: "40 is c, not the rate." }, explanation: "m = (30−40)/2 = −5; c = 40 → T = −5t + 40.", hints: ["m = −10/2.", "c = 40.", "m = (30−40)/2 = −5; c = 40 → T = −5t + 40."] },
      // @q07
      { id: "U18L4-num-1", type: "numeric-input", category: "procedural", prompt: "Through (1, 3) and (3, 7). Type c.", answer: 1, tolerance: 0, explanation: "m = 2; 3 = 2(1) + c → c = 1.", hints: ["m = 2.", "3 = 2 + c.", "m = 2; 3 = 2(1) + c → c = 1."] },
      // @q08
      { id: "U18L4-num-2", type: "numeric-input", category: "procedural", prompt: "Through (0, 2) with gradient 3. Type c.", answer: 2, tolerance: 0, explanation: "x = 0, so y = c = 2.", hints: ["On the y-axis.", "c = 2.", "x = 0, so y = c = 2."] },
      // @q09
      { id: "U18L4-num-3", type: "numeric-input", category: "conceptual", prompt: "m = 2 through (2, 6). Type c.", answer: 2, tolerance: 0, explanation: "6 = 2(2) + c → c = 2.", hints: ["6 = 4 + c.", "c = 2.", "6 = 2(2) + c → c = 2."] },
      // @q10
      { id: "U18L4-frac-1", type: "fraction-input", category: "conceptual", prompt: "Through (1, 2) and (3, 3). Write m as a fraction.", numerator: 1, denominator: 2, acceptEquivalent: true, explanation: "m = (3−2)/(3−1) = 1/2.", hints: ["rise 1.", "run 2.", "m = (3−2)/(3−1) = 1/2."] },
      // @q11
      { id: "U18L4-tf-1", type: "true-false-justify", category: "conceptual", prompt: "Two points always pin down one unique straight line.", isTrue: true, explanation: "They fix m from rise/run and c from substitution.", hints: ["One pair of points.", "One line through both.", "They fix m from rise/run and c from substitution."] },
      // @q12
      { id: "U18L4-tf-2", type: "true-false-justify", category: "conceptual", prompt: "A line through (1, 1) and (2, 2) has equation y = x.", isTrue: true, explanation: "m = 1, and through (0, 0): c = 0 → y = x.", hints: ["m = 1.", "Crosses origin.", "m = 1, and through (0, 0): c = 0 → y = x."] },
      // @q13
      ...
      // @q14
      { id: "U18L4-drag-1", type: "drag-match", category: "conceptual", prompt: "Match each line to its equation.", pairs: [ { source: "Through (0, 1), m = 2", target: "y = 2x + 1" }, { source: "Through (1, 3), m = 1", target: "y = x + 2" }, { source: "Through (0, −2), m = −1", target: "y = −x − 2" } ], diagnoses: { "Through (0, 1), m = 2->y = x + 2": "c = 1 and m = 2 → y = 2x + 1.", "Through (1, 3), m = 1->y = 2x + 1": "3 = 1(1) + c → c = 2 → y = x + 2.", "Through (0, −2), m = −1->y = 2x + 1": "c = −2, m = −1 → y = −x − 2." }, explanation: "Substitute the point into y = mx + c to solve for c.", hints: ["c = y when x = 0.", "Plug the point in.", "Substitute the point into y = mx + c to solve for c."] },
      // @q15
      { id: "U18L4-graph-1", type: "graph-interact", category: "word", prompt: "Make the line pass through (2, 6) with gradient 2. Set the slider to the gradient m first (key: value).", challenge: "Adjust the values below so they match the condition described in the prompt.", validate: { value: 2 }, tolerance: 0.01, explanation: "m = 2; through (2, 6) → c = 2, so y = 2x + 2 is the whole line.", hints: ["Gradient from the clue.", "m = 2.", "m = 2; through (2, 6) → c = 2, so y = 2x + 2 is the whole line."] }
    ],
