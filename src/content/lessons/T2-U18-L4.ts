...
export const T2U18L4: Lesson = {
  ...
  quiz: {
    pool: [
      ...
      // @q04
      { id: "U18L4-mcq-4", type: "mcq", category: "procedural", prompt: "m = −1 through (2, 4). What is c?", options: [ { id: "a", text: "−2" }, { id: "b", text: "2" }, { id: "c", text: "−6" }, { id: "d", text: "6" } ], correctOptionId: "d", diagnoses: { b: "2 is the x; 4 = −2 + c → c = 6.", c: "Sign: 4 + 2 = 6, positive.", a: "Substitute correctly: c = 4 + 2 = 6." }, explanation: "4 = −1(2) + c → c = 6.", hints: ["4 = −2 + c.", "c = 6.", "6."] },
      // @q05
      ...
      // @q06
      { id: "U18L4-mcq-6", type: "mcq", category: "word", prompt: "Cooling: 40° at t = 0, 30° at t = 2 (linear). Equation T = mt + c?", options: [ { id: "a", text: "T = 5t + 40" }, { id: "b", text: "T = −5t + 40" }, { id: "c", text: "T = −10t + 30" }, { id: "d", text: "T = 40t + 30" } ], correctOptionId: "b", diagnoses: { a: "It cools — m is negative.", c: "m = (30−40)/2 = −5, and c = 40.", d: "40 is c, not the rate." }, explanation: "m = (30−40)/2 = −5; c = 40 → T = −5t + 40.", hints: ["m = −10/2.", "c = 40.", "T = −5t + 40."] },
      // @q07
