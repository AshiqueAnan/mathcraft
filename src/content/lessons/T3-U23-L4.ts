...
export const T3U23L4: Lesson = {
  ...
  quiz: {
    pool: [
      // @q01
      { id: "U23L4-mcq-1", type: "mcq", category: "procedural", prompt: "Cuboid 2 × 3 × 4. Its VOLUME is…", options: [ { id: "a", text: "24 units³" }, { id: "b", text: "52 units²" }, { id: "c", text: "26 units³" }, { id: "d", text: "9 units³" } ], correctOptionId: "a", diagnoses: { b: "52 is the surface area, not volume.", c: "26 is half the surface.", d: "9 adds the side lengths." }, explanation: "V = 2 × 3 × 4 = 24 units³.", hints: ["Multiply all three.", "2 × 3 × 4.", "24."] },
      // @q02
      { id: "U23L4-mcq-2", type: "mcq", category: "conceptual", prompt: "Surface area of a cuboid counts…", options: [ { id: "a", text: "the 6 faces' areas added" }, { id: "b", text: "the space inside" }, { id: "c", text: "the edges' lengths" }, { id: "d", text: "the number of corners" } ], correctOptionId: "a", diagnoses: { b: "That's volume.", c: "Edges are 1-D lengths.", d: "Corners aren't a surface measure." }, explanation: "Unfold to a net: 6 rectangles, add their areas.", hints: ["Unfold the box.", "Six faces.", "Sum of face areas."] },
      // @q03
      { id: "U23L4-mcq-3", type: "mcq", category: "word", prompt: "A fish tank is 40 cm × 25 cm × 30 cm. Water it holds (volume) is…", options: [ { id: "a", text: "30,000 cm³" }, { id: "b", text: "15,000 cm³" }, { id: "c", text: "7,400 cm²" }, { id: "d", text: "95 cm³" } ], correctOptionId: "a", diagnoses: { b: "15,000 halves one dimension.", c: "7,400 is the surface area (paper, not water).", d: "95 adds the lengths." }, explanation: "V = 40 × 25 × 30 = 30,000 cm³.", hints: ["Multiply all three.", "40 × 25 × 30.", "30,000."] },
      // @q04
      { id: "U23L4-mcq-4", type: "mcq", category: "procedural", prompt: "A cube has side 5 cm. Its volume is…", options: [ { id: "a", text: "125 cm³" }, { id: "b", text: "25 cm³" }, { id: "c", text: "150 cm²" }, { id: "d", text: "250 cm³" } ], correctOptionId: "a", diagnoses: { b: "25 is 5² — one face's area.", c: "150 is the surface area.", d: "250 is 5³ × 2 — wrong factor." }, explanation: "V = 5 × 5 × 5 = 125 cm³.", hints: ["Cube = side³.", "5³.", "125."] },
      // @q05
      { id: "U23L4-mcq-5", type: "mcq", category: "conceptual", prompt: "Double EVERY side of a cube. Its volume…", options: [ { id: "a", text: "× 8" }, { id: "b", text: "× 2" }, { id: "c", text: "× 4" }, { id: "d", text: "× 6" } ], correctOptionId: "a", diagnoses: { b: "×2 is for a single edge.", c: "×4 is for area scaling.", d: "×6 matches face count, not volume." }, explanation: "(2s)³ = 8s³ — eight times.", hints: ["Three dimensions each ×2.", "2 × 2 × 2.", "× 8."] },
      // @q06
      { id: "U23L4-mcq-6", type: "mcq", category: "word", prompt: "A box is 3 m × 4 m × 2 m. Wrapping paper for ALL faces needs about…", options: [ { id: "a", text: "52 m²" }, { id: "b", text: "24 m³" }, { id: "c", text: "26 m²" }, { id: "d", text: "12 m²" } ], correctOptionId: "a", diagnoses: { b: "24 m³ is the volume (inside), not paper.", c: "26 m² is half the surface — missing faces.", d: "12 m² is one face only." }, explanation: "2(lw + lh + wh) = 2(12 + 6 + 8) = 52 m².", hints: ["Sum all 6 faces.", "2 × 26.", "52 m²."] },
      // @q07
      { id: "U23L4-num-1", type: "numeric-input", category: "procedural", prompt: "Cuboid 4 cm × 3 cm × 2 cm. Surface area in cm².", answer: 52, tolerance: 0, unit: "cm²", explanation: "2(12 + 8 + 6) = 52 cm².", hints: ["Each pair of faces twice.", "2(12+8+6).", "52."] },
      // @q08
      { id: "U23L4-num-2", type: "numeric-input", category: "procedural", prompt: "Prism: base area 15 cm², height 4 cm. Volume in cm³.", answer: 60, tolerance: 0, unit: "cm³", explanation: "V = base area × height = 15 × 4 = 60 cm³.", hints: ["Base area × height.", "15 × 4.", "60."] },
      // @q09
      { id: "U23L4-num-3", type: "numeric-input", category: "conceptual", prompt: "Unit cubes in a 5 × 4 × 3 box.", answer: 60, tolerance: 0, explanation: "5 × 4 × 3 = 60 cubes.", hints: ["Layers times rows.", "5 × 4 × 3.", "60."] },
      // @q10
      { id: "U23L4-frac-1", type: "fraction-input", category: "conceptual", prompt: "A prism's base area is A and height h. Its volume as a fraction of (A × h) is…", numerator: 1, denominator: 1, acceptEquivalent: true, explanation: "Volume equals base area × height exactly — no halving for prisms (unlike triangles in 2-D).", hints: ["Base × height.", "1/1.", "1."] },
      // @q11
      ...
      // @q12
      { id: "U23L4-tf-2", type: "true-false-justify", category: "conceptual", prompt: "A prism's volume is base area × height.", isTrue: true, explanation: "Stack the base layer height times — always base area × height.", hints: ["Stack of base layers.", "Base × height.", "True."] },
      // @q13
