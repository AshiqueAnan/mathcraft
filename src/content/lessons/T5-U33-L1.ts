...
export const T5U33L1: Lesson = {
  ...
  quiz: {
    pool: [
      ...
      // @q02
      { id: "U33L1-mcq-2", type: "mcq", category: "conceptual", prompt: "Dividing by (x + 3) means you plug in…", options: [ { id: "a", text: "-3" }, { id: "b", text: "+3" }, { id: "c", text: "0" }, { id: "d", text: "1" } ], correctOptionId: "a", diagnoses: { b: "+3 is for (x - 3).", c: "0 is for (x - 0).", d: "1 is for (x - 1)." }, explanation: "The divisor (x + 3) = (x - (-3)), so a = -3 and the remainder is f(-3).", hints: ["x + 3 = 0.", "x = -3.", "-3."] },
      // @q03
      { id: "U33L1-mcq-3", type: "mcq", category: "word", prompt: "A machine's cost model is f(x) = 2x³ - x. Checking if (x - 1) is a factor means evaluating f(1). f(1) = …", options: [ { id: "a", text: "1" }, { id: "b", text: "0" }, { id: "c", text: "2" }, { id: "d", text: "-1" } ], correctOptionId: "a", diagnoses: { b: "0 would mean a factor — but f(1) = 2 - 1 = 1.", c: "2 is the leading coefficient.", d: "-1 is -x at x = 1 alone." }, explanation: "f(1) = 2(1) - 1 = 1 — not 0, so (x - 1) is NOT a factor.", hints: ["2(1³) - 1.", "2 - 1.", "1."] },
      // @q04
      { id: "U33L1-mcq-4", type: "mcq", category: "procedural", prompt: "f(x) = x³ - 2x + 4. Remainder when divided by (x - 2) = …", options: [ { id: "a", text: "8" }, { id: "b", text: "4" }, { id: "c", text: "6" }, { id: "d", text: "0" } ], correctOptionId: "a", diagnoses: { b: "4 is the constant term.", c: "6 is 2x at x=3 — no.", d: "0 would mean (x-2) is a factor." }, explanation: "f(2) = 8 - 4 + 4 = 8.", hints: ["2³ - 4 + 4.", "8.", "8."] },
      // @q05
