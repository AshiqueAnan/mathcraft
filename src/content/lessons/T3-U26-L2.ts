...
export const T3U26L2: Lesson = {
  ...
  quiz: {
    pool: [
      ...
      // @q03
      { id: "U26L2-mcq-3", type: "mcq", category: "word", prompt: "tan 45° = 1 because…", options: [ { id: "a", text: "the hypotenuse equals a leg" }, { id: "b", text: "45° is half of 90°" }, { id: "c", text: "a 45° right triangle's legs are equal" }, { id: "d", text: "sine and cosine are 0.707, so they cancel" } ], correctOptionId: "c", diagnoses: { b: "Halving explains angles, not the ratio's value.", a: "The hypotenuse is longer than either leg.", d: "That's why tan = sin/cos = 1, and it works BECAUSE the legs are equal." }, explanation: "Opposite and adjacent are both the same length in a 45-45-90 triangle → ratio 1.", hints: ["Isosceles right triangle.", "Legs equal.", "Ratio 1."] },
      // @q04
