...
export const T3U21L2: Lesson = {
  ...
  quiz: {
    pool: [
      ...
      // @q02
      { id: "U21L2-mcq-2", type: "mcq", category: "conceptual", prompt: "Why do exterior angles always total 360°?", options: [ { id: "a", text: "Because triangles have 3 sides" }, { id: "b", text: "The walking path brings you back to face the same way — one full turn" }, { id: "c", text: "Exteriors are all right angles" }, { id: "d", text: "Only squares do" } ], correctOptionId: "b", diagnoses: { a: "The side count isn't the cause.", c: "Exteriors vary; only the total is fixed.", d: "ALL convex polygons share the rule." }, explanation: "Net rotation around the polygon is exactly one full turn.", hints: ["Full turn.", "360°.", "Always."] },
      // @q03
