...
export const T3U21L2: Lesson = {
  ...
  quiz: {
    pool: [
      // @q01
      { id: "U21L2-mcq-1", type: "mcq", category: "procedural", prompt: "A square's exterior angles sum to…", options: [ { id: "a", text: "360°" }, { id: "b", text: "720°" }, { id: "c", text: "180°" }, { id: "d", text: "540°" } ], correctOptionId: "a", diagnoses: { b: "720° is a hexagon's interior sum.", c: "180° is one straight line of turns.", d: "540° is a pentagon's interior." }, explanation: "Exterior ALWAYS sum to 360°.", hints: ["Exteriors.", "360°.", "360°."] },
      // @q02
      { id: "U21L2-mcq-2", type: "mcq", category: "conceptual", prompt: "Why do exterior angles always total 360°?", options: [ { id: "a", text: "The walking path brings you back to face the same way — one full turn" }, { id: "b", text: "Because triangles have 3 sides" }, { id: "c", text: "Exteriors are all right angles" }, { id: "d", text: "Only squares do" } ], correctOptionId: "a", diagnoses: { b: "The side count isn't the cause.", c: "Exteriors vary; only the total is fixed.", d: "ALL convex polygons share the rule." }, explanation: "Net rotation around the polygon is exactly one full turn.", hints: ["Full turn.", "360°.", "Always."] },
      // @q03
      { id: "U21L2-mcq-3", type: "mcq", category: "word", prompt: "A regular hexagon sign — one exterior angle?", options: [ { id: "a", text: "60°" }, { id: "b", text: "120°" }, { id: "c", text: "90°" }, { id: "d", text: "72°" } ], correctOptionId: "a", diagnoses: { b: "120° is the interior.", c: "90° is a square's corner.", d: "72° belongs to a pentagon." }, explanation: "360 ÷ 6 = 60° per exterior.", hints: ["360 ÷ 6.", "60°.", "60°."] },
      // @q04
      { id: "U21L2-mcq-4", type: "mcq", category: "procedural", prompt: "At one vertex, interior 150° → the exterior is…", options: [ { id: "a", text: "30°" }, { id: "b", text: "150°" }, { id: "c", text: "210°" }, { id: "d", text: "360°" } ], correctOptionId: "a", diagnoses: { b: "Interior and exterior are different — they add to 180°.", c: "210° = 360 − 150, an exterior outside the linear pair.", d: "360 is the whole turn, not one exterior." }, explanation: "Interior + exterior = 180° → exterior = 180 − 150 = 30°.", hints: ["180 − 150.", "30°.", "30°."] },
      // @q05
      { id: "U21L2-mcq-5", type: "mcq", category: "conceptual", prompt: "A regular 12-gon — each exterior angle?", options: [ { id: "a", text: "30°" }, { id: "b", text: "36°" }, { id: "c", text: "45°" }, { id: "d", text: "150°" } ], correctOptionId: "a", diagnoses: { b: "36° would be a 10-gon.", c: "45° would be an 8-gon.", d: "150° is the interior of a 12-gon." }, explanation: "360 ÷ 12 = 30°.", hints: ["360 ÷ 12.", "30°.", "30°."] },
      // @q06
      { id: "U21L2-mcq-6", type: "mcq", category: "word", prompt: "Walking a triangular block: one exterior is 90°, another 120°. The third is…", options: [ { id: "a", text: "150°" }, { id: "b", text: "60°" }, { id: "c", text: "30°" }, { id: "d", text: "90°" } ], correctOptionId: "a", diagnoses: { b: "60° would sum to 270° — not a full turn.", c: "30 is the interior partner of 150, not the exterior.", d: "Two right turns already make 180." }, explanation: "360 − 90 − 120 = 150°.", hints: ["360 − 210.", "150°.", "150°."] },
      // @q07
      { id: "U21L2-num-1", type: "numeric-input", category: "procedural", prompt: "A regular octagon — one exterior angle?", answer: 45, tolerance: 0, explanation: "360 ÷ 8 = 45°.", hints: ["360 ÷ 8.", "45.", "45°."] },
      // @q08
      { id: "U21L2-num-2", type: "numeric-input", category: "procedural", prompt: "A pentagon has exteriors 70°, 80°, 60°, 90°. Type the last.", answer: 60, tolerance: 0, explanation: "360 − 300 = 60°.", hints: ["Sum others.", "360 − 300.", "60°."] },
      // @q09
      { id: "U21L2-num-3", type: "numeric-input", category: "conceptual", prompt: "Interior 110° — type the exterior.", answer: 70, tolerance: 0, explanation: "180 − 110 = 70°.", hints: ["180 − interior.", "70.", "70°."] },
      // @q10
      { id: "U21L2-frac-1", type: "fraction-input", category: "conceptual", prompt: "One exterior of a regular decagon as a fraction of 360°.", numerator: 1, denominator: 10, acceptEquivalent: true, explanation: "Each exterior = 360/10 = 36° = 1/10 of 360.", hints: ["360 ÷ 10.", "1/10.", "1/10."] },
      // @q11
      { id: "U21L2-tf-1", type: "true-false-justify", category: "conceptual", prompt: "Exterior angles always sum to 360° for any convex polygon.", isTrue: true, explanation: "The walking turn around the polygon is always one full rotation.", hints: ["Full turn.", "360°.", "True."] },
      // @q12
      { id: "U21L2-tf-2", type: "true-false-justify", category: "conceptual", prompt: "Interior and exterior at a vertex sum to 90°.", isTrue: false, explanation: "They share a straight line: interior + exterior = 180°.", hints: ["Straight line.", "180°.", "False."] },
      // @q13
      { id: "U21L2-order-1", type: "order-steps", category: "word", prompt: "Order the steps to find a regular pentagon's interior angle.", sequence: ["Exterior = 360 ÷ 5 = 72°", "Interior = 180 − exterior", "Interior = 180 − 72 = 108°", "Check: 108 × 5 = 540° (matches interior sum)"], diagnoses: { "Exterior = 360 ÷ 5 = 72°@1": "Find the exterior first.", "Interior = 180 − exterior@0": "Then subtract from 180.", "Check: 108 × 5 = 540° (matches interior sum)@0": "Check at the end." }, explanation: "Exterior, subtract, state, verify.", hints: ["360 ÷ 5.", "180 − 72.", "108°."] },
      // @q14
      { id: "U21L2-drag-1", type: "drag-match", category: "conceptual", prompt: "Match each regular polygon to its exterior angle.", pairs: [ { source: "Triangle", target: "120°" }, { source: "Square", target: "90°" }, { source: "Hexagon", target: "60°" } ], diagnoses: { "Triangle->90°": "360 ÷ 3 = 120°.", "Square->120°": "Square's exterior = 90°.", "Hexagon->120°": "Hexagon's = 60°." }, explanation: "360 ÷ n gives each exterior.", hints: ["360 ÷ n.", "Match.", "Exteriors."] },
      // @q15
      { id: "U21L2-graph-1", type: "graph-interact", category: "word", prompt: "A regular nonagon (9 sides). Set the slider to one exterior angle (key: value).", challenge: "Set the slider to 40.", validate: { value: 40 }, tolerance: 0.01, explanation: "360 ÷ 9 = 40°.", hints: ["360 ÷ 9.", "40.", "40°."] }
    ],
