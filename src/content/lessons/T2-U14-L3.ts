...
export const T2U14L3: Lesson = {
  ...
  quiz: {
    pool: [
      ...
      // @q03
      { id: "U14L3-mcq-3", type: "mcq", category: "word", prompt: "Half your savings s is $15: s/2 = 15. What are your savings?", options: [ { id: "a", text: "$7.50" }, { id: "b", text: "$15" }, { id: "c", text: "$30" }, { id: "d", text: "$45" } ], correctOptionId: "c", diagnoses: { b: "15 is half, not the whole.", a: "7.50 = 15/2.", d: "45 is triple." }, explanation: "s/2 = 15 → multiply both by 2 → s = 30.", hints: ["×2 both sides.", "s = 30.", "$30."] },
      // @q04
      { id: "U14L3-mcq-4", type: "mcq", category: "procedural", prompt: "Solve 3(x − 2) = 9.", options: [ { id: "a", text: "x = 7" }, { id: "b", text: "x = 1" }, { id: "c", text: "x = 3" }, { id: "d", text: "x = 5" } ], correctOptionId: "d", diagnoses: { b: "1 makes 3(−1) = −3 ≠ 9.", c: "3 makes 3 = 3 ≠ 9.", a: "7 makes 15 = 15? 3(5)=15 ≠ 9." }, explanation: "3x − 6 = 9 → 3x = 15 → x = 5.", hints: ["Expand 3x − 6.", "3x = 15.", "x = 5."] },
      // @q05
      ...
      // @q06
      { id: "U14L3-mcq-6", type: "mcq", category: "word", prompt: "A car's tank holds x litres. Triple it minus 2 is 13: 3x − 2 = 13. What is x?", options: [ { id: "a", text: "11 L" }, { id: "b", text: "5 L" }, { id: "c", text: "3 L" }, { id: "d", text: "15 L" } ], correctOptionId: "b", diagnoses: { a: "11 = 13−2, incomplete.", c: "3 would give 7.", d: "15 would give 43." }, explanation: "3x − 2 = 13 → 3x = 15 → x = 5.", hints: ["Add 2.", "3x = 15.", "5 L."] },
      // @q07
