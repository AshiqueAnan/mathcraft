...
export const T2U14L3: Lesson = {
  ...
  quiz: {
    pool: [
      // @q01
      { id: "U14L3-mcq-1", type: "mcq", category: "procedural", prompt: "Solve 2(x + 1) = 6.", options: [ { id: "a", text: "x = 2" }, { id: "b", text: "x = 3" }, { id: "c", text: "x = 4" }, { id: "d", text: "x = 5" } ], correctOptionId: "a", diagnoses: { b: "3(x+1)=6 → x+1=3 → x=2, not 3.", c: "x=4 would make LHS 10.", d: "x=5 would make LHS 12." }, explanation: "Expand: 2x + 2 = 6 → 2x = 4 → x = 2. Check 2(3) = 6 ✓.", hints: ["Expand bracket.", "2x + 2 = 6.", "x = 2."] },
      // @q02
      { id: "U14L3-mcq-2", type: "mcq", category: "conceptual", prompt: "When clearing x/3 = 4, what must you do to BOTH sides?", options: [ { id: "a", text: "Multiply by 3" }, { id: "b", text: "Subtract 3" }, { id: "c", text: "Divide by 3" }, { id: "d", text: "Add 3" } ], correctOptionId: "a", diagnoses: { b: "Subtracting doesn't clear a denominator.", c: "Dividing keeps the fraction.", d: "Adding doesn't help." }, explanation: "Multiply both sides by 3: x = 12.", hints: ["The ÷3 is undone by ×3.", "×3 both sides.", "Multiply by 3."] },
      // @q03
      { id: "U14L3-mcq-3", type: "mcq", category: "word", prompt: "Half your savings s is $15: s/2 = 15. What are your savings?", options: [ { id: "a", text: "$30" }, { id: "b", text: "$15" }, { id: "c", text: "$7.50" }, { id: "d", text: "$45" } ], correctOptionId: "a", diagnoses: { b: "15 is half, not the whole.", c: "7.50 = 15/2.", d: "45 is triple." }, explanation: "s/2 = 15 → multiply both by 2 → s = 30.", hints: ["×2 both sides.", "s = 30.", "$30."] },
      // @q04
      { id: "U14L3-mcq-4", type: "mcq", category: "procedural", prompt: "Solve 3(x − 2) = 9.", options: [ { id: "a", text: "x = 5" }, { id: "b", text: "x = 1" }, { id: "c", text: "x = 3" }, { id: "d", text: "x = 7" } ], correctOptionId: "a", diagnoses: { b: "1 makes 3(−1) = −3 ≠ 9.", c: "3 makes 3 = 3 ≠ 9.", d: "7 makes 15 = 15? 3(5)=15 ≠ 9." }, explanation: "3x − 6 = 9 → 3x = 15 → x = 5.", hints: ["Expand 3x − 6.", "3x = 15.", "x = 5."] },
      // @q05
      { id: "U14L3-mcq-5", type: "mcq", category: "conceptual", prompt: "For (x + 1)/2 = 4, why is x = 8 WRONG?", options: [ { id: "a", text: "The ×2 must multiply the whole numerator (x + 1)" }, { id: "b", text: "8 is too big" }, { id: "c", text: "4 is the answer already" }, { id: "d", text: "You should divide by 2" } ], correctOptionId: "a", diagnoses: { b: "Size isn't the reason.", c: "4 is the RHS value, not x.", d: "You clear the denominator by ×2." }, explanation: "×2 both sides: x + 1 = 8 → x = 7. The whole numerator gets multiplied.", hints: ["Multiply x AND 1.", "x + 1 = 8.", "x = 7."] },
      // @q06
      { id: "U14L3-mcq-6", type: "mcq", category: "word", prompt: "A car's tank holds x litres. Triple it minus 2 is 13: 3x − 2 = 13. What is x?", options: [ { id: "a", text: "5 L" }, { id: "b", text: "11 L" }, { id: "c", text: "3 L" }, { id: "d", text: "15 L" } ], correctOptionId: "a", diagnoses: { b: "11 = 13−2, incomplete.", c: "3 would give 7.", d: "15 would give 43." }, explanation: "3x − 2 = 13 → 3x = 15 → x = 5.", hints: ["Add 2.", "3x = 15.", "5 L."] },
      // @q07
      { id: "U14L3-num-1", type: "numeric-input", category: "procedural", prompt: "Solve 2(x + 1) = 6. Type x.", answer: 2, tolerance: 0, explanation: "2x + 2 = 6 → 2x = 4 → x = 2.", hints: ["Expand.", "2x = 4.", "2."] },
      // @q08
      { id: "U14L3-num-2", type: "numeric-input", category: "procedural", prompt: "Solve x/3 = 4. Type x.", answer: 12, tolerance: 0, explanation: "Multiply both by 3: x = 12.", hints: ["×3 both.", "x = 12.", "12."] },
      // @q09
      { id: "U14L3-num-3", type: "numeric-input", category: "conceptual", prompt: "Solve 3(x − 2) = 9. Type x.", answer: 5, tolerance: 0, explanation: "3x − 6 = 9 → 3x = 15 → x = 5.", hints: ["Expand.", "3x = 15.", "5."] },
      // @q10
      { id: "U14L3-frac-1", type: "fraction-input", category: "conceptual", prompt: "Solve x/4 = 2. Write x as a fraction.", numerator: 8, denominator: 1, acceptEquivalent: true, explanation: "×4 both: x = 8.", hints: ["×4 both.", "8.", "8/1."] },
      // @q11
      { id: "U14L3-tf-1", type: "true-false-justify", category: "conceptual", prompt: "(x + 1)/2 = 4 has solution x = 7.", isTrue: true, explanation: "×2: x + 1 = 8 → x = 7.", hints: ["×2 both.", "x + 1 = 8.", "7 — True."] },
      // @q12
      { id: "U14L3-tf-2", type: "true-false-justify", category: "conceptual", prompt: "x/2 = 5 → subtract 2 from both sides gives x = 3.", isTrue: false, explanation: "Fractions are cleared by MULTIPLYING, not subtracting: ×2 → x = 10.", hints: ["÷2 undone by ×2.", "x = 10.", "False."] },
      // @q13
      {"explanation":"STUB","hints":["a","b","c"],"id":"U14L3-order-1","type":"order-steps","category":"word","prompt":"STUB","sequence":["a","b","c"],"diagnoses":{"a@0":"STUB","b@0":"STUB"}},
      // @q14
      {"explanation":"STUB","hints":["a","b","c"],"id":"U14L3-drag-1","type":"drag-match","category":"conceptual","prompt":"STUB","pairs":[{"source":"a","target":"b"},{"source":"c","target":"d"}],"diagnoses":{"a->d":"STUB"}},
      // @q15
      {"explanation":"STUB","hints":["a","b","c"],"id":"U14L3-graph-1","type":"graph-interact","category":"word","prompt":"STUB","challenge":"STUB","validate":{"value":0},"tolerance":0.01}
    ],
