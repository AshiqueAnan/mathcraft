...
export const T5U30L3: Lesson = {
  ...
  quiz: {
    pool: [
      ...
      // @q02
      { id: "U30L3-mcq-2", type: "mcq", category: "conceptual", prompt: "y = x² + 3 shifts y = x²…", options: [ { id: "a", text: "up 3" }, { id: "b", text: "right 3" }, { id: "c", text: "down 3" }, { id: "d", text: "left 3" } ], correctOptionId: "a", diagnoses: { b: "Right is a change inside the brackets.", c: "Down would be x² - 3.", d: "Left is inside brackets." }, explanation: "+3 outside = shift up 3.", hints: ["Outside = vertical.", "+ = up.", "Up 3."] },
      // @q03
      { id: "U30L3-mcq-3", type: "mcq", category: "word", prompt: "A ball's height is h(t) = -t² + 4t. Which graph is h(t) + 2?", options: [ { id: "a", text: "same graph shifted up 2 (peak 2 higher)" }, { id: "b", text: "same graph shifted right 2" }, { id: "c", text: "same graph flipped" }, { id: "d", text: "a straight line" } ], correctOptionId: "a", diagnoses: { b: "Right would change the input.", c: "Flip comes from a negative in front.", d: "It stays a parabola." }, explanation: "Adding 2 outside shifts the whole curve up 2.", hints: ["Outside shift.", "Up.", "Peak +2."] },
      // @q04
      { id: "U30L3-mcq-4", type: "mcq", category: "procedural", prompt: "y = (x+2)² shifts y = x²…", options: [ { id: "a", text: "left 2" }, { id: "b", text: "right 2" }, { id: "c", text: "up 2" }, { id: "d", text: "down 2" } ], correctOptionId: "a", diagnoses: { b: "Plus inside shifts LEFT, not right.", c: "Up is an outside change.", d: "Down is an outside minus." }, explanation: "+2 inside = shift left 2 — opposite the sign.", hints: ["Inside = horizontal.", "Plus = left.", "Left 2."] },
      // @q05
