...
export const T5U31L1: Lesson = {
  ...
  quiz: {
    pool: [
      ...
      // @q02
      { id: "U31L1-mcq-2", type: "mcq", category: "conceptual", prompt: "Why must we subtract the corner we add?", options: [ { id: "a", text: "To keep the expression equal to the original" }, { id: "b", text: "To make the square smaller" }, { id: "c", text: "To change the coefficient" }, { id: "d", text: "We don't — adding is enough" } ], correctOptionId: "a", diagnoses: { b: "We reshape, not shrink.", c: "The coefficient x stays 1.", d: "(x+3)² alone is 9 too big." }, explanation: "Adding 9 and subtracting 9 keeps the value identical.", hints: ["Equal value.", "Add AND subtract.", "Keeps it equal."] },
      // @q03
      { id: "U31L1-mcq-3", type: "mcq", category: "word", prompt: "A photo is x cm wide and (x + 6) cm tall. The area is x² + 6x. To frame it as a square of side x + 3, you add a corner of area…", options: [ { id: "a", text: "9" }, { id: "b", text: "6" }, { id: "c", text: "36" }, { id: "d", text: "3" } ], correctOptionId: "a", diagnoses: { b: "6 is the strip width, not the corner area.", c: "36 is 6² — that's the strip squared, not half.", d: "3 is the corner's side, not its area." }, explanation: "The missing corner is 3×3 = 9.", hints: ["Half of 6.", "3 × 3.", "9."] },
      // @q04
      { id: "U31L1-mcq-4", type: "mcq", category: "procedural", prompt: "Complete the square: x² - 10x = (x - _)² - _", options: [ { id: "a", text: "5, 25" }, { id: "b", text: "10, 100" }, { id: "c", text: "5, 10" }, { id: "d", text: "-5, 25" } ], correctOptionId: "a", diagnoses: { b: "10 is the full coefficient — take half.", c: "The corner is 5², not 10.", d: "Inside is (x-5)², the '-5' isn't written separately." }, explanation: "Half of -10 is -5; (-5)² = 25 → (x-5)² - 25.", hints: ["-10 ÷ 2.", "(-5)².", "5, 25."] },
      // @q05
      ...
      // @q06
      { id: "U31L1-mcq-6", type: "mcq", category: "word", prompt: "A plot is x m by (x + 12) m (area x² + 12x). Completing the square gives a square of side (x + 6) — what corner area is added and subtracted?", options: [ { id: "a", text: "36" }, { id: "b", text: "12" }, { id: "c", text: "144" }, { id: "d", text: "6" } ], correctOptionId: "a", diagnoses: { b: "12 is the strip width.", c: "144 is 12² — the strip squared, not half.", d: "6 is the side, not the area." }, explanation: "(12/2)² = 6² = 36.", hints: ["12 ÷ 2.", "6².", "36."] },
      // @q07
