...
export const T5U31L1: Lesson = {
  ...
  quiz: {
    pool: [
      ...
      // @q03
      { id: "U31L1-mcq-3", type: "mcq", category: "word", prompt: "A photo is x cm wide and (x + 6) cm tall. The area is x² + 6x. To frame it as a square of side x + 3, you add a corner of area…", options: [ { id: "a", text: "36" }, { id: "b", text: "6" }, { id: "c", text: "9" }, { id: "d", text: "3" } ], correctOptionId: "c", diagnoses: { b: "6 is the strip width, not the corner area.", a: "36 is 6² — that's the strip squared, not half.", d: "3 is the corner's side, not its area." }, explanation: "The missing corner is 3×3 = 9.", hints: ["Half of 6.", "3 × 3.", "The missing corner is 3×3 = 9."] },
      // @q04
      { id: "U31L1-mcq-4", type: "mcq", category: "procedural", prompt: "Complete the square: x² - 10x = (x - _)² - _", options: [ { id: "a", text: "-5, 25" }, { id: "b", text: "10, 100" }, { id: "c", text: "5, 10" }, { id: "d", text: "5, 25" } ], correctOptionId: "d", diagnoses: { b: "10 is the full coefficient — take half.", c: "The corner is 5², not 10.", a: "Inside is (x-5)², the '-5' isn't written separately." }, explanation: "Half of -10 is -5; (-5)² = 25 → (x-5)² - 25.", hints: ["-10 ÷ 2.", "(-5)².", "Half of -10 is -5; (-5)² = 25 → (x-5)² - 25."] },
      // @q05
      { id: "U31L1-mcq-5", type: "mcq", category: "conceptual", prompt: "x² + bx always completes to (x + b/2)² minus…", options: [ { id: "a", text: "(b/2)²" }, { id: "b", text: "b²" }, { id: "c", text: "b" }, { id: "d", text: "2b" } ], correctOptionId: "a", diagnoses: { b: "b² would be the full square, not the corner.", c: "b is the strip, not the corner area.", d: "2b is the perimeter idea — no." }, explanation: "The missing corner is half the coefficient, squared: (b/2)².", hints: ["Half of b.", "Squared.", "The missing corner is half the coefficient, squared: (b/2)²."] },
      // @q06
      { id: "U31L1-mcq-6", type: "mcq", category: "word", prompt: "A plot is x m by (x + 12) m (area x² + 12x). Completing the square gives a square of side (x + 6) — what corner area is added and subtracted?", options: [ { id: "a", text: "12" }, { id: "b", text: "36" }, { id: "c", text: "144" }, { id: "d", text: "6" } ], correctOptionId: "b", diagnoses: { a: "12 is the strip width.", c: "144 is 12² — the strip squared, not half.", d: "6 is the side, not the area." }, explanation: "(12/2)² = 6² = 36.", hints: ["12 ÷ 2.", "6².", "(12/2)² = 6² = 36."] },
      // @q07
      { id: "U31L1-num-1", type: "numeric-input", category: "procedural", prompt: "Complete the square for x² + 4x: what number do you add and subtract?", answer: 4, tolerance: 0, explanation: "(4/2)² = 2² = 4 → (x+2)² - 4.", hints: ["4 ÷ 2.", "2².", "(4/2)² = 2² = 4 → (x+2)² - 4."] },
      // @q08
      { id: "U31L1-num-2", type: "numeric-input", category: "procedural", prompt: "Complete the square for x² + 2x: inside the bracket is (x + _). What is the blank?", answer: 1, tolerance: 0, explanation: "Half of 2 is 1 → (x+1)² - 1.", hints: ["2 ÷ 2.", "1.", "Half of 2 is 1 → (x+1)² - 1."] },
      // @q09
      { id: "U31L1-num-3", type: "numeric-input", category: "conceptual", prompt: "x² + 6x = (x+3)² - N. What is N?", answer: 9, tolerance: 0, explanation: "3² = 9 — the corner you add and subtract.", hints: ["3².", "9.", "3² = 9 — the corner you add and subtract."] },
      // @q10
      { id: "U31L1-frac-1", type: "fraction-input", category: "conceptual", prompt: "Complete the square for x² + x: the corner added is (1/2)² = …", numerator: 1, denominator: 4, acceptEquivalent: true, explanation: "(1/2)² = 1/4 → (x + 1/2)² - 1/4.", hints: ["1/2 squared.", "1/4.", "(1/2)² = 1/4 → (x + 1/2)² - 1/4."] },
      // @q11
      { id: "U31L1-tf-1", type: "true-false-justify", category: "conceptual", prompt: "x² + 8x = (x+4)² - 16 is correct.", isTrue: true, explanation: "Half of 8 is 4; 4² = 16 → (x+4)² - 16.", hints: ["(8/2)².", "16.", "Half of 8 is 4; 4² = 16 → (x+4)² - 16."] },
      // @q12
      { id: "U31L1-tf-2", type: "true-false-justify", category: "conceptual", prompt: "x² + 6x equals (x+3)² with no adjustment.", isTrue: false, explanation: "(x+3)² = x² + 6x + 9 — it's 9 too big; you must subtract 9.", hints: ["(x+3)² = x²+6x+9.", "Subtract 9.", "(x+3)² = x² + 6x + 9 — it's 9 too big; you must subtract 9."] },
      // @q13
      { id: "U31L1-order-1", type: "order-steps", category: "word", prompt: "Order the steps to complete the square for x² + 6x.", sequence: ["Take half of 6 (that's 3)", "Square it (9)", "Write (x+3)² - 9"], diagnoses: { "Take half of 6 (that's 3)@1": "Halve first.", "Square it (9)@0": "Then square.", "Write (x+3)² - 9@0": "Write last." }, explanation: "Halve, square, write in vertex form.", hints: ["6 ÷ 2.", "3².", "Halve, square, write in vertex form."] },
      // @q14
      { id: "U31L1-drag-1", type: "drag-match", category: "conceptual", prompt: "Match each quadratic to its completed-square form.", pairs: [ { source: "x² + 6x", target: "(x+3)² - 9" }, { source: "x² - 4x", target: "(x-2)² - 4" }, { source: "x² + 10x", target: "(x+5)² - 25" } ], diagnoses: { "x² + 6x->(x-2)² - 4": "Half of 6 is +3, not -2.", "x² - 4x->(x+3)² - 9": "Half of -4 is -2.", "x² + 10x->(x+3)² - 9": "Half of 10 is 5, square 25." }, explanation: "Each is (x + b/2)² - (b/2)².", hints: ["Half of 6.", "Half of -4.", "Each is (x + b/2)² - (b/2)²."] },
      // @q15
      { id: "U31L1-graph-1", type: "graph-interact", category: "word", prompt: "x² + 4x completes to (x+2)² - N. Set the slider to N (key: value).", challenge: "Adjust the values below so they match the condition described in the prompt.", validate: { value: 4 }, tolerance: 0.01, explanation: "(4/2)² = 4.", hints: ["2².", "4.", "(4/2)² = 4."] }
    ],
