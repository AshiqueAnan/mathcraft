...
export const T2U14L4: Lesson = {
  ...
  quiz: {
    pool: [
      ...
      // @q02
      { id: "U14L4-mcq-2", type: "mcq", category: "conceptual", prompt: "What's the FIRST step for any word problem?", options: [ { id: "a", text: "Name the unknown (let x be …)" }, { id: "b", text: "Jump straight to the answer" }, { id: "c", text: "Add all the numbers" }, { id: "d", text: "Draw a graph" } ], correctOptionId: "a", diagnoses: { b: "Guess-and-check isn't the method.", c: "Adding blindly ignores the words.", d: "A graph isn't the first move." }, explanation: "Name the unknown first — everything translates onto x.", hints: ["Let x = …", "Start with the unknown.", "Name it first."] },
      // @q03
      { id: "U14L4-mcq-3", type: "mcq", category: "word", prompt: "'5 less than a number is 9.' What's the equation?", options: [ { id: "a", text: "x − 5 = 9" }, { id: "b", text: "5 − x = 9" }, { id: "c", text: "x + 5 = 9" }, { id: "d", text: "5x = 9" } ], correctOptionId: "a", diagnoses: { b: "5 less than x means x − 5.", c: "'Less than' subtracts, not adds.", d: "That's '5 times a number'." }, explanation: "x − 5 = 9 → x = 14.", hints: ["Less than = subtract.", "From x.", "x − 5 = 9."] },
      // @q04
      { id: "U14L4-mcq-4", type: "mcq", category: "procedural", prompt: "'Half of a number is 6.' Equation?", options: [ { id: "a", text: "x/2 = 6" }, { id: "b", text: "2x = 6" }, { id: "c", text: "x − 2 = 6" }, { id: "d", text: "x + 2 = 6" } ], correctOptionId: "a", diagnoses: { b: "That's 'twice a number'.", c: "That's '2 less'.", d: "That's '2 more'." }, explanation: "x/2 = 6 → x = 12.", hints: ["Half → ÷2.", "x/2 = 6.", "x = 12."] },
      // @q05
      ...
      // @q06
      { id: "U14L4-mcq-6", type: "mcq", category: "word", prompt: "'A number increased by 4 is 11.' What is the number?", options: [ { id: "a", text: "7" }, { id: "b", text: "15" }, { id: "c", text: "4" }, { id: "d", text: "11" } ], correctOptionId: "a", diagnoses: { b: "15 = 11 + 4 — added wrong side.", c: "4 is the increase, not x.", d: "11 is the total." }, explanation: "x + 4 = 11 → x = 7.", hints: ["Increased → +4.", "x + 4 = 11.", "7."] },
      // @q07
