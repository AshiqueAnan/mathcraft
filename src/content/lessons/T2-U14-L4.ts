...
export const T2U14L4: Lesson = {
  ...
  quiz: {
    pool: [
      // @q01
      { id: "U14L4-mcq-1", type: "mcq", category: "procedural", prompt: "'Three more than twice a number is 17.' What's the equation?", options: [ { id: "a", text: "2x + 3 = 17" }, { id: "b", text: "2(x + 3) = 17" }, { id: "c", text: "x + 3 = 17" }, { id: "d", text: "3x + 2 = 17" } ], correctOptionId: "a", diagnoses: { b: "That's 'twice the sum' — but it's 3 more than twice x.", c: "Missing the 'twice'.", d: "Twice is on x, not 3." }, explanation: "2x + 3 = 17 → x = 7.", hints: ["Twice → 2x.", "More than → +3.", "2x + 3 = 17 → x = 7."] },
      // @q02
      { id: "U14L4-mcq-2", type: "mcq", category: "conceptual", prompt: "What's the FIRST step for any word problem?", options: [ { id: "a", text: "Jump straight to the answer" }, { id: "b", text: "Name the unknown (let x be …)" }, { id: "c", text: "Add all the numbers" }, { id: "d", text: "Draw a graph" } ], correctOptionId: "b", diagnoses: { a: "Guess-and-check isn't the method.", c: "Adding blindly ignores the words.", d: "A graph isn't the first move." }, explanation: "Name the unknown first — everything translates onto x.", hints: ["Let x = …", "Start with the unknown.", "Name the unknown first — everything translates onto x."] },
      // @q03
      { id: "U14L4-mcq-3", type: "mcq", category: "word", prompt: "'5 less than a number is 9.' What's the equation?", options: [ { id: "a", text: "x + 5 = 9" }, { id: "b", text: "5 − x = 9" }, { id: "c", text: "x − 5 = 9" }, { id: "d", text: "5x = 9" } ], correctOptionId: "c", diagnoses: { b: "5 less than x means x − 5.", a: "'Less than' subtracts, not adds.", d: "That's '5 times a number'." }, explanation: "x − 5 = 9 → x = 14.", hints: ["Less than = subtract.", "From x.", "x − 5 = 9 → x = 14."] },
      // @q04
      { id: "U14L4-mcq-4", type: "mcq", category: "procedural", prompt: "'Half of a number is 6.' Equation?", options: [ { id: "a", text: "x + 2 = 6" }, { id: "b", text: "2x = 6" }, { id: "c", text: "x − 2 = 6" }, { id: "d", text: "x/2 = 6" } ], correctOptionId: "d", diagnoses: { b: "That's 'twice a number'.", c: "That's '2 less'.", a: "That's '2 more'." }, explanation: "x/2 = 6 → x = 12.", hints: ["Half → ÷2.", "x/2 = 6.", "x/2 = 6 → x = 12."] },
      // @q05
      { id: "U14L4-mcq-5", type: "mcq", category: "conceptual", prompt: "Why must you CHECK your answer in a word problem?", options: [ { id: "a", text: "To make sure it reads back correctly in the sentence" }, { id: "b", text: "To make the equation bigger" }, { id: "c", text: "To change the unknown" }, { id: "d", text: "To add more steps" } ], correctOptionId: "a", diagnoses: { b: "Checking isn't about size.", c: "The unknown stays the same.", d: "Checking is the final step, not extra." }, explanation: "Substitute back into the words: if x = 14, '5 less than 14' is 9 ✓.", hints: ["Read the sentence again.", "Plug the answer in.", "Substitute back into the words: if x = 14, '5 less than 14' is 9 ✓."] },
      // @q06
      { id: "U14L4-mcq-6", type: "mcq", category: "word", prompt: "'A number increased by 4 is 11.' What is the number?", options: [ { id: "a", text: "15" }, { id: "b", text: "7" }, { id: "c", text: "4" }, { id: "d", text: "11" } ], correctOptionId: "b", diagnoses: { a: "15 = 11 + 4 — added wrong side.", c: "4 is the increase, not x.", d: "11 is the total." }, explanation: "x + 4 = 11 → x = 7.", hints: ["Increased → +4.", "x + 4 = 11.", "x + 4 = 11 → x = 7."] },
      // @q07
      { id: "U14L4-num-1", type: "numeric-input", category: "procedural", prompt: "'Three more than twice a number is 17.' Type the number.", answer: 7, tolerance: 0, explanation: "2x + 3 = 17 → x = 7.", hints: ["2x + 3 = 17.", "2x = 14.", "2x + 3 = 17 → x = 7."] },
      // @q08
      { id: "U14L4-num-2", type: "numeric-input", category: "procedural", prompt: "'5 less than a number is 9.' Type the number.", answer: 14, tolerance: 0, explanation: "x − 5 = 9 → x = 14.", hints: ["x − 5 = 9.", "x = 14.", "x − 5 = 9 → x = 14."] },
      // @q09
      { id: "U14L4-num-3", type: "numeric-input", category: "conceptual", prompt: "'Half of a number is 6.' Type the number.", answer: 12, tolerance: 0, explanation: "x/2 = 6 → x = 12.", hints: ["Half → ÷2.", "×2 both.", "x/2 = 6 → x = 12."] },
      // @q10
      { id: "U14L4-frac-1", type: "fraction-input", category: "conceptual", prompt: "'A number divided by 3 is 4.' Write the number as a fraction.", numerator: 12, denominator: 1, acceptEquivalent: true, explanation: "x/3 = 4 → x = 12.", hints: ["×3 both.", "12.", "x/3 = 4 → x = 12."] },
      // @q11
      { id: "U14L4-tf-1", type: "true-false-justify", category: "conceptual", prompt: "'7 more than a number is 12' translates to x + 7 = 12.", isTrue: true, explanation: "The known 7 is added to the unknown x.", hints: ["More than → +7.", "x + 7 = 12.", "The known 7 is added to the unknown x."] },
      // @q12
      { id: "U14L4-tf-2", type: "true-false-justify", category: "conceptual", prompt: "'3 less than a number is 8' translates to 3 − x = 8.", isTrue: false, explanation: "It's x − 3 = 8 — the known 3 is subtracted from the unknown.", hints: ["Less than → from x.", "x − 3 = 8.", "It's x − 3 = 8 — the known 3 is subtracted from the unknown."] },
      // @q13
      { id: "U14L4-order-1", type: "order-steps", category: "word", prompt: "Order the steps to solve 'three more than twice a number is 17'.", sequence: ["Let x = the number", "Translate: 2x + 3 = 17", "Solve: 2x = 14, x = 7", "Check: 14 + 3 = 17"], diagnoses: { "Translate: 2x + 3 = 17@0": "Name the unknown first.", "Check: 14 + 3 = 17@0": "Check at the end.", "Solve: 2x = 14, x = 7@1": "Translate before solving." }, explanation: "Name x, translate the sentence, solve, then check.", hints: ["Name the unknown.", "Translate.", "Name x, translate the sentence, solve, then check."] },
      // @q14
      ...
      // @q15
      { id: "U14L4-graph-1", type: "graph-interact", category: "word", prompt: "'A number less than 10 is 6.' Set the slider to the number (key: value).", challenge: "'A number less than 10 is 6.' — adjust the values below to match the condition.", validate: { value: 4 }, tolerance: 0, explanation: "10 − x = 6 → x = 4.", hints: ["10 − x = 6.", "x = 4.", "10 − x = 6 → x = 4."] }
    ],
