...
export const T5U30L2: Lesson = {
  ...
  quiz: {
    pool: [
      // @q01
      { id: "U30L2-mcq-1", type: "mcq", category: "procedural", prompt: "f(x) = x + 3, g(x) = 2x. g(f(4)) = …", options: [ { id: "a", text: "14" }, { id: "b", text: "11" }, { id: "c", text: "7" }, { id: "d", text: "24" } ], correctOptionId: "a", diagnoses: { b: "11 is f(g(4)) — wrong order.", c: "7 is just f(4).", d: "24 multiplies 4 by 6 — no." }, explanation: "f(4) = 7, then g(7) = 14.", hints: ["f(4) first.", "7 × 2.", "f(4) = 7, then g(7) = 14."] },
      // @q02
      { id: "U30L2-mcq-2", type: "mcq", category: "conceptual", prompt: "Which is true about composites?", options: [ { id: "a", text: "fg(x) always equals fg(2x)" }, { id: "b", text: "fg(x) = g(f(x)) — apply f first" }, { id: "c", text: "fg(x) = f(x) × g(x)" }, { id: "d", text: "order never matters" } ], correctOptionId: "b", diagnoses: { a: "No — the input is replaced by the composite.", c: "Composite chains, it does not multiply.", d: "Order matters critically." }, explanation: "fg(x) means apply f then g to x.", hints: ["Inner first.", "f, then g.", "fg(x) means apply f then g to x."] },
      // @q03
      { id: "U30L2-mcq-3", type: "mcq", category: "word", prompt: "A machine doubles, then a machine adds 5. Feed 3. Output = …", options: [ { id: "a", text: "13" }, { id: "b", text: "16" }, { id: "c", text: "11" }, { id: "d", text: "8" } ], correctOptionId: "c", diagnoses: { b: "16 is (3+5)×2 — wrong order.", a: "13 is 2×3+5 then +2 — no.", d: "8 is 3+5 — forgot the double." }, explanation: "Double 3 = 6, then add 5 = 11.", hints: ["3 × 2.", "+ 5.", "Double 3 = 6, then add 5 = 11."] },
      // @q04
      { id: "U30L2-mcq-4", type: "mcq", category: "procedural", prompt: "f(x) = 2x + 1. f⁻¹(7) = …", options: [ { id: "a", text: "13" }, { id: "b", text: "15" }, { id: "c", text: "4" }, { id: "d", text: "3" } ], correctOptionId: "d", diagnoses: { b: "15 is f(7) — that's forward, not inverse.", c: "4 is (7+1)/2 — wrong order.", a: "13 is 2×7-1 — wrong." }, explanation: "Undo +1 then ×2: (7-1)/2 = 3.", hints: ["7 - 1.", "÷ 2.", "Undo +1 then ×2: (7-1)/2 = 3."] },
      // @q05
      { id: "U30L2-mcq-5", type: "mcq", category: "conceptual", prompt: "To invert f(x) = 3x - 2, you…", options: [ { id: "a", text: "add 2, then divide by 3" }, { id: "b", text: "divide by 3, then add 2" }, { id: "c", text: "subtract 2, then multiply by 3" }, { id: "d", text: "multiply by 3, then add 2" } ], correctOptionId: "a", diagnoses: { b: "Reverse order — undo the -2 first.", c: "Wrong operations entirely.", d: "That's the forward function." }, explanation: "Reverse the steps: undo -2 (add 2), then undo ×3 (divide by 3).", hints: ["Reverse order.", "Undo -2 first.", "Reverse the steps: undo -2 (add 2), then undo ×3 (divide by 3)."] },
      // @q06
      { id: "U30L2-mcq-6", type: "mcq", category: "word", prompt: "A machine adds 4, then doubles. To undo it, you…", options: [ { id: "a", text: "subtract 4, then halve" }, { id: "b", text: "halve, then subtract 4" }, { id: "c", text: "double, then add 4" }, { id: "d", text: "add 4, then double" } ], correctOptionId: "b", diagnoses: { a: "Reverse order — undo the double first.", c: "That's the forward chain.", d: "That's the forward chain." }, explanation: "Reverse: undo double (halve), then undo +4 (subtract 4).", hints: ["Reverse order.", "Halve first.", "Halve, then -4."] },
      // @q07
      { id: "U30L2-num-1", type: "numeric-input", category: "procedural", prompt: "f(x) = 2x, g(x) = x + 5. g(f(3)) = …", answer: 11, tolerance: 0, explanation: "f(3) = 6, then g(6) = 11.", hints: ["f(3) first.", "6 + 5.", "f(3) = 6, then g(6) = 11."] },
      // @q08
      { id: "U30L2-num-2", type: "numeric-input", category: "procedural", prompt: "f(x) = 3x. f⁻¹(12) = …", answer: 4, tolerance: 0, explanation: "Undo ×3: 12 ÷ 3 = 4.", hints: ["Reverse.", "12 ÷ 3.", "Undo ×3: 12 ÷ 3 = 4."] },
      // @q09
      { id: "U30L2-num-3", type: "numeric-input", category: "conceptual", prompt: "f(x) = x + 2, g(x) = 5x. Evaluate f(g(1)).", answer: 7, tolerance: 0, explanation: "g(1) = 5, then f(5) = 7.", hints: ["g(1) = 5.", "f(5).", "g(1) = 5, then f(5) = 7."] },
      // @q10
      { id: "U30L2-frac-1", type: "fraction-input", category: "conceptual", prompt: "f(x) = 1/x. In the chain f(f(x)), the final output of feeding 2 is 2. Express 2 as a fraction.", numerator: 2, denominator: 1, acceptEquivalent: true, explanation: "f(2) = 1/2, then f(1/2) = 2 — applying the reciprocal twice returns you to start.", hints: ["1/2 then 2.", "Reciprocal twice.", "f(2) = 1/2, then f(1/2) = 2 — applying the reciprocal twice returns you to start."] },
      // @q11
      { id: "U30L2-tf-1", type: "true-false-justify", category: "conceptual", prompt: "f(x) = x + 2, g(x) = 3x. Then g(f(x)) and f(g(x)) give the same result for all x.", isTrue: false, explanation: "g(f(x)) = 3(x+2) = 3x+6 but f(g(x)) = 3x+2 — different.", hints: ["3(x+2).", "3x + 2.", "g(f(x)) = 3(x+2) = 3x+6 but f(g(x)) = 3x+2 — different."] },
      // @q12
      { id: "U30L2-tf-2", type: "true-false-justify", category: "conceptual", prompt: "f⁻¹(f(5)) = 5 for any invertible function f.", isTrue: true, explanation: "The inverse undoes f exactly — f(5) goes to some y, and f⁻¹(y) returns 5.", hints: ["Undo.", "Back to start.", "The inverse undoes f exactly — f(5) goes to some y, and f⁻¹(y) returns 5."] },
      // @q13
      { id: "U30L2-order-1", type: "order-steps", category: "word", prompt: "Order the steps to find f⁻¹ for f(x) = 2x + 1.", sequence: ["Write y = 2x + 1", "Subtract 1 from both sides", "Divide by 2"], diagnoses: { "Write y = 2x + 1@1": "Start with the equation.", "Subtract 1 from both sides@0": "Undo the +1.", "Divide by 2@0": "Undo the ×2 last." }, explanation: "Undo in reverse: subtract 1, then divide by 2.", hints: ["y = 2x + 1.", "-1.", "Undo in reverse: subtract 1, then divide by 2."] },
      // @q14
      { id: "U30L2-drag-1", type: "drag-match", category: "conceptual", prompt: "Match each notation to its meaning.", pairs: [ { source: "fg(x)", target: "apply f, then g" }, { source: "f⁻¹(y)", target: "input that produced y" }, { source: "f(x) = y", target: "machine f maps x to y" } ], diagnoses: { "fg(x)->input that produced y": "fg chains forward.", "f⁻¹(y)->apply f, then g": "Inverse undoes f.", "f(x) = y->apply f, then g": "It maps x to y." }, explanation: "fg chains, f⁻¹ undoes, f(x)=y is the mapping.", hints: ["Chain.", "Undo.", "fg chains, f⁻¹ undoes, f(x)=y is the mapping."] },
      // @q15
      { id: "U30L2-graph-1", type: "graph-interact", category: "word", prompt: "f(x) = 2x, g(x) = x + 1. Set the slider to g(f(3)) (key: value).", challenge: "f(x) = 2x, g(x) = x + 1. — adjust the values below to match the condition.", validate: { value: 7 }, tolerance: 0.01, explanation: "f(3) = 6, then g(6) = 7.", hints: ["f(3) = 6.", "6 + 1.", "f(3) = 6, then g(6) = 7."] }
    ],
