...
export const T5U30L2: Lesson = {
  ...
  quiz: {
    pool: [
      ...
      // @q02
      { id: "U30L2-mcq-2", type: "mcq", category: "conceptual", prompt: "Which is true about composites?", options: [ { id: "a", text: "fg(x) always equals fg(2x)" }, { id: "b", text: "fg(x) = g(f(x)) — apply f first" }, { id: "c", text: "fg(x) = f(x) × g(x)" }, { id: "d", text: "order never matters" } ], correctOptionId: "b", diagnoses: { a: "No — the input is replaced by the composite.", c: "Composite chains, it does not multiply.", d: "Order matters critically." }, explanation: "fg(x) means apply f then g to x.", hints: ["Inner first.", "f, then g.", "g(f(x))."] },
      // @q03
      { id: "U30L2-mcq-3", type: "mcq", category: "word", prompt: "A machine doubles, then a machine adds 5. Feed 3. Output = …", options: [ { id: "a", text: "13" }, { id: "b", text: "16" }, { id: "c", text: "11" }, { id: "d", text: "8" } ], correctOptionId: "c", diagnoses: { b: "16 is (3+5)×2 — wrong order.", a: "13 is 2×3+5 then +2 — no.", d: "8 is 3+5 — forgot the double." }, explanation: "Double 3 = 6, then add 5 = 11.", hints: ["3 × 2.", "+ 5.", "11."] },
      // @q04
      { id: "U30L2-mcq-4", type: "mcq", category: "procedural", prompt: "f(x) = 2x + 1. f⁻¹(7) = …", options: [ { id: "a", text: "13" }, { id: "b", text: "15" }, { id: "c", text: "4" }, { id: "d", text: "3" } ], correctOptionId: "d", diagnoses: { b: "15 is f(7) — that's forward, not inverse.", c: "4 is (7+1)/2 — wrong order.", a: "13 is 2×7-1 — wrong." }, explanation: "Undo +1 then ×2: (7-1)/2 = 3.", hints: ["7 - 1.", "÷ 2.", "3."] },
      // @q05
