...
export const T3U24L3: Lesson = {
  ...
  quiz: {
    pool: [
      // @q01
      { id: "U24L3-mcq-1", type: "mcq", category: "procedural", prompt: "A wall is 24 m²; a can covers 10 m². Cans to buy = …", options: [ { id: "a", text: "3" }, { id: "b", text: "2" }, { id: "c", text: "2.4" }, { id: "d", text: "4" } ], correctOptionId: "a", diagnoses: { b: "2 cans cover 20 m² — short by 4 m².", c: "2.4 is the division, but you can't buy partial cans.", d: "4 is over-buying by nearly a can." }, explanation: "24 ÷ 10 = 2.4 → round UP to 3 cans.", hints: ["Divide by coverage.", "Round up.", "3."] },
      // @q02
      { id: "U24L3-mcq-2", type: "mcq", category: "conceptual", prompt: "Fencing a garden needs the…", options: [ { id: "a", text: "perimeter" }, { id: "b", text: "area" }, { id: "c", text: "volume" }, { id: "d", text: "radius" } ], correctOptionId: "a", diagnoses: { b: "Area is for turf or tiling — the fence runs around the edge.", c: "Volume fills 3-D space.", d: "Radius only applies to circles." }, explanation: "Fence length = boundary = perimeter.", hints: ["Around the edge.", "Perimeter.", "Perimeter."] },
      // @q03
      { id: "U24L3-mcq-3", type: "mcq", category: "word", prompt: "A 12 m² floor with 0.25 m² tiles needs how many tiles?", options: [ { id: "a", text: "48" }, { id: "b", text: "24" }, { id: "c", text: "3" }, { id: "d", text: "12.25" } ], correctOptionId: "a", diagnoses: { b: "24 is 12 ÷ 0.5 — think tiles per metre, not halves.", c: "3 is 12 ÷ 4 — inverted the tile size.", d: "12.25 just adds the numbers." }, explanation: "12 ÷ 0.25 = 48 tiles.", hints: ["Divide by tile area.", "12 ÷ 0.25.", "48."] },
      // @q04
      { id: "U24L3-mcq-4", type: "mcq", category: "procedural", prompt: "A 5 m × 4 m wall needs painting, a can covers 10 m². Cans = …", options: [ { id: "a", text: "2" }, { id: "b", text: "20" }, { id: "c", text: "1" }, { id: "d", text: "2.5" } ], correctOptionId: "a", diagnoses: { b: "20 is the area, not the cans.", c: "1 can covers only 10 m² — wall is 20 m².", d: "2.5 rounds up to 3, but 20 ÷ 10 = 2 exactly." }, explanation: "Area 20 m²; 20 ÷ 10 = 2 cans.", hints: ["Area = 5 × 4 = 20.", "20 ÷ 10.", "2."] },
      // @q05
      { id: "U24L3-mcq-5", type: "mcq", category: "conceptual", prompt: "Mixing metres and centimetres, you must first…", options: [ { id: "a", text: "convert to one unit" }, { id: "b", text: "add the numbers" }, { id: "c", text: "ignore the centimetres" }, { id: "d", text: "convert to square metres only" } ], correctOptionId: "a", diagnoses: { b: "Adding mixed units gives nonsense.", c: "Ignoring centimetres drops real information.", d: "Convert everything to ONE consistent unit first." }, explanation: "Consistent units are non-negotiable — 100 cm = 1 m, never mixed in a formula.", hints: ["Same unit everywhere.", "Convert first.", "Convert."] },
      // @q06
      { id: "U24L3-mcq-6", type: "mcq", category: "word", prompt: "A square garden, side 10 m, needs fence. Length of fence = …", options: [ { id: "a", text: "40 m" }, { id: "b", text: "100 m" }, { id: "c", text: "10 m" }, { id: "d", text: "20 m" } ], correctOptionId: "a", diagnoses: { b: "100 is the AREA — the fence runs the boundary.", c: "10 is one side only.", d: "20 is two sides." }, explanation: "Perimeter = 4 × 10 = 40 m.", hints: ["Boundary = perimeter.", "4 sides × 10.", "40."] },
      // @q07
      { id: "U24L3-num-1", type: "numeric-input", category: "procedural", prompt: "Wall 30 m², can covers 10 m². Cans needed.", answer: 3, tolerance: 0, explanation: "30 ÷ 10 = 3 cans exactly.", hints: ["Divide by coverage.", "30 ÷ 10.", "3."] },
      // @q08
      { id: "U24L3-num-2", type: "numeric-input", category: "procedural", prompt: "Floor 15 m², tiles 0.5 m² each. Tiles needed.", answer: 30, tolerance: 0, explanation: "15 ÷ 0.5 = 30 tiles.", hints: ["Divide by tile area.", "15 ÷ 0.5.", "30."] },
      // @q09
      { id: "U24L3-num-3", type: "numeric-input", category: "conceptual", prompt: "Garden 8 m × 6 m, fence 2 m high costs per metre of LENGTH. Fence length in m.", answer: 28, tolerance: 0, unit: "m", explanation: "Perimeter = 2(8 + 6) = 28 m.", hints: ["2 × (8 + 6).", "Perimeter.", "28."] },
      // @q10
      { id: "U24L3-frac-1", type: "fraction-input", category: "conceptual", prompt: "A can covers 10 m² and the wall is 15 m². What fraction of the second can is needed to finish?", numerator: 1, denominator: 2, acceptEquivalent: true, explanation: "First can covers 10 m²; 5 remaining = half a can more.", hints: ["5 of 10.", "1/2.", "1/2."] },
      // @q11
      { id: "U24L3-tf-1", type: "true-false-justify", category: "conceptual", prompt: "Fencing needs the perimeter, not the area.", isTrue: true, explanation: "The fence traces the boundary — perimeter decides the length.", hints: ["Boundary edge.", "Perimeter.", "True."] },
      // @q12
      { id: "U24L3-tf-2", type: "true-false-justify", category: "conceptual", prompt: "1 cm and 1 m can be multiplied directly.", isTrue: false, explanation: "Convert to one unit first — 1 m = 100 cm — or the result is off by 100×.", hints: ["Convert first.", "100 cm = 1 m.", "False."] },
      // @q13
      { id: "U24L3-order-1", type: "order-steps", category: "word", prompt: "Order the steps to buy paint for a 25 m² wall (can covers 10 m²).", sequence: ["Divide: 25 ÷ 10 = 2.5", "Round up: 3 cans", "Check: 3 × 10 = 30 ≥ 25 ✓"], diagnoses: { "Divide: 25 ÷ 10 = 2.5@1": "Divide first.", "Round up: 3 cans@0": "Round after dividing.", "Check: 3 × 10 = 30 ≥ 25 ✓@0": "Check last." }, explanation: "Divide, round up, verify.", hints: ["25 ÷ 10.", "Round up to 3.", "Check 30 ≥ 25."] },
      // @q14
      ...
      // @q15
      { id: "U24L3-graph-1", type: "graph-interact", category: "word", prompt: "A wall is 7 m × 3 m with a can covering 5 m². Set the slider to the cans needed (key: value).", challenge: "Set the slider to 5.", validate: { value: 5 }, tolerance: 0.01, explanation: "21 m² ÷ 5 = 4.2 → round up to 5 cans.", hints: ["21 ÷ 5 = 4.2.", "Round up.", "5."] }
    ],
