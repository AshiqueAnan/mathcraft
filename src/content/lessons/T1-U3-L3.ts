  ...
  quiz: {
    pool: [
      ...
      },
      {
        ...
        hints: ["Fingerprints: 3·5 and 5·5.", "Shared prime: 5.", "15 = 3×5, 25 = 5²."],
      },
      {
        ...
        hints: ["Recall prime definition.", "Two divisors.", "Primes have exactly two divisors: 1 and itself."],
      },
      {
      ...
      },
      {
        ...
        hints: ["Factor 10 and 15.", "10 = 2·5, 15 = 3·5.", "10 = 2×5, 15 = 3×5."],
      },
      {
        ...
        hints: ["Factor both.", "Both have 7.", "14 = 2×7, 21 = 3×7."],
      },
      {
        ...
        hints: ["Fingerprints.", "16 = 2⁴.", "16 = 2⁴, 40 = 2³×5."],
      },
      {
        ...
        hints: ["18 = 2·3², 24 = 2³·3.", "Overlap 2·3.", "HCF(18, 24) = 2×3 = 6."],
      },
      {
        ...
        hints: ["6 out of 18.", "Simplify.", "6/18 = 1/3."],
      },
      {
      ...
      },
      {
        ...
        hints: ["Factor both.", "Overlap.", "Shared primes 2 and 5 give HCF = 10."],
      },
      {
      ...
      },
      {
        ...
        hints: ["Shared primes 2 and 5.", "2 × 5.", "HCF(20, 30) = 10."],
      },
    ],
