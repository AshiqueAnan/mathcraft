  ...
  quiz: {
    pool: [
      ...
      },
      {
        ...
        options: [{ id: "a", text: "Multiplying the shared primes" }, { id: "b", text: "Adding all primes" }, { id: "c", text: "Taking the biggest prime only" }, { id: "d", text: "Multiplying all primes" }],
        correctOptionId: "a",
        diagnoses: { b: "Adding primes isn't a product.", c: "The biggest prime alone misses shared smaller ones.", d: "Multiplying ALL primes gives the LCM or more." },
      ...
      },
      {
        ...
        options: [{ id: "a", text: "12" }, { id: "b", text: "6" }, { id: "c", text: "24" }, { id: "d", text: "72" }],
        correctOptionId: "a",
        diagnoses: { b: "6 packs is a factor option but not the maximum.", c: "24 packs would need 1.5 pencils each — not whole.", d: "72 is the LCM." },
      ...
      },
      {
        ...
        prompt: "HCF(15, 25) = ?",
        options: [{ id: "a", text: "5" }, { id: "b", text: "75" }, { id: "c", text: "3" }, { id: "d", text: "15" }],
        correctOptionId: "a",
        diagnoses: { b: "75 is the LCM.", c: "3 divides 15 but not 25.", d: "15 doesn't divide 25." },
      ...
      },
      {
        ...
        options: [{ id: "a", text: "8 m" }, { id: "b", text: "4 m" }, { id: "c", text: "16 m" }, { id: "d", text: "12 m" }],
        correctOptionId: "a",
        diagnoses: { b: "4 works but isn't the largest.", c: "16 doesn't divide 24.", d: "12 doesn't divide 16." },
