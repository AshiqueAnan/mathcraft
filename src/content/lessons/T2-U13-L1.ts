...
export const T2U13L1: Lesson = {
  ...
  quiz: {
    pool: [
      // @q01
      { id: "U13L1-mcq-1", type: "mcq", category: "procedural", prompt: "Use v = u + at with u = 2, a = 3, t = 4. What is v?", options: [ { id: "a", text: "14" }, { id: "b", text: "20" }, { id: "c", text: "9" }, { id: "d", text: "24" } ], correctOptionId: "a", diagnoses: { b: "20 = 2+3×4 — added before multiplying.", c: "9 = 2+3+4.", d: "24 = 2×3×4." }, explanation: "v = 2 + 3×4 = 2 + 12 = 14.", hints: ["Multiply a×t first.", "3 × 4 = 12.", "v = 2 + 3×4 = 2 + 12 = 14."] },
      // @q02
      { id: "U13L1-mcq-2", type: "mcq", category: "conceptual", prompt: "In A = lw, what operation does the formula use?", options: [ { id: "a", text: "Add length and width" }, { id: "b", text: "Multiply length by width" }, { id: "c", text: "Divide length by width" }, { id: "d", text: "Square the length" } ], correctOptionId: "b", diagnoses: { a: "A = lw is l × w.", c: "No division here.", d: "lw isn't l²." }, explanation: "Adjacent letters mean multiply: lw = l × w.", hints: ["Adjacent letters multiply.", "l × w.", "Adjacent letters mean multiply: lw = l × w."] },
      // @q03
      { id: "U13L1-mcq-3", type: "mcq", category: "word", prompt: "Pizza price P = 2n + 3 for n toppings. Find P when n = 4.", options: [ { id: "a", text: "24" }, { id: "b", text: "9" }, { id: "c", text: "11" }, { id: "d", text: "7" } ], correctOptionId: "c", diagnoses: { b: "9 = 2+4+3 — 2n is 2×n.", a: "24 = 2×4×3.", d: "7 = 4+3, dropped the 2n." }, explanation: "P = 2×4 + 3 = 8 + 3 = 11.", hints: ["2n = 2×4.", "8 + 3.", "P = 2×4 + 3 = 8 + 3 = 11."] },
      // @q04
      { id: "U13L1-mcq-4", type: "mcq", category: "procedural", prompt: "Evaluate E = mc² for m = 2, c = 3.", options: [ { id: "a", text: "6" }, { id: "b", text: "36" }, { id: "c", text: "12" }, { id: "d", text: "18" } ], correctOptionId: "d", diagnoses: { b: "36 = 2×3×6 — mis-squared.", c: "12 = 2×3×2 — mis-squared.", a: "6 = 2×3 — missed the square." }, explanation: "c² = 9, so E = 2 × 9 = 18.", hints: ["c² = 3² = 9.", "2 × 9.", "c² = 9, so E = 2 × 9 = 18."] },
      // @q05
      ...
      // @q06
      { id: "U13L1-mcq-6", type: "mcq", category: "word", prompt: "Taxi fare F = 2d + 5 for d km. Find F for 10 km.", options: [ { id: "a", text: "70" }, { id: "b", text: "25" }, { id: "c", text: "12" }, { id: "d", text: "15" } ], correctOptionId: "b", diagnoses: { a: "70 = 2×10×5 — the +5 adds.", c: "12 = 10+2 — dropped the 5.", d: "15 = 10+5 — dropped the ×2." }, explanation: "F = 2×10 + 5 = 20 + 5 = 25.", hints: ["2×10 = 20.", "Then +5.", "F = 2×10 + 5 = 20 + 5 = 25."] },
      // @q07
      { id: "U13L1-num-1", type: "numeric-input", category: "procedural", prompt: "v = u + at, u = 4, a = 2, t = 5. Type v.", answer: 14, tolerance: 0, explanation: "4 + 2×5 = 4 + 10 = 14.", hints: ["2×5 = 10.", "4 + 10.", "4 + 2×5 = 4 + 10 = 14."] },
      // @q08
      { id: "U13L1-num-2", type: "numeric-input", category: "procedural", prompt: "A = lw with l = 7, w = 3. Type A.", answer: 21, tolerance: 0, explanation: "7 × 3 = 21.", hints: ["l × w.", "7 × 3.", "7 × 3 = 21."] },
      // @q09
      { id: "U13L1-num-3", type: "numeric-input", category: "conceptual", prompt: "P = 2l + 2w with l = 5, w = 3. Type P.", answer: 16, tolerance: 0, explanation: "2×5 + 2×3 = 10 + 6 = 16.", hints: ["2×5 = 10.", "2×3 = 6.", "2×5 + 2×3 = 10 + 6 = 16."] },
      // @q10
      { id: "U13L1-frac-1", type: "fraction-input", category: "conceptual", prompt: "v = u + at with u = 1, a = 1, t = 1/2. Write v as a fraction.", numerator: 3, denominator: 2, acceptEquivalent: true, explanation: "1 + 1×(1/2) = 1 + 1/2 = 3/2.", hints: ["1 × 1/2 = 1/2.", "1 + 1/2.", "1 + 1×(1/2) = 1 + 1/2 = 3/2."] },
      // @q11
      { id: "U13L1-tf-1", type: "true-false-justify", category: "conceptual", prompt: "In A = lw, substituting l = 4, w = 5 gives A = 20.", isTrue: true, explanation: "4 × 5 = 20.", hints: ["l × w.", "4 × 5.", "4 × 5 = 20."] },
      // @q12
      ...
      // @q14
      { id: "U13L1-drag-1", type: "drag-match", category: "conceptual", prompt: "Match each formula to its meaning.", pairs: [ { source: "A = lw", target: "area = length × width" }, { source: "v = u + at", target: "final speed = start + accel × time" }, { source: "P = l + w + l + w", target: "perimeter = sum of sides" } ], diagnoses: { "A = lw->perimeter = sum of sides": "Area multiplies length × width.", "v = u + at->area = length × width": "That's motion, not area.", "P = l + w + l + w->final speed": "Perimeter adds the sides." }, explanation: "Each formula is a sentence about its quantities.", hints: ["Read each as a sentence.", "Match the meaning.", "Each formula is a sentence about its quantities."] },
      // @q15
      { id: "U13L1-graph-1", type: "graph-interact", category: "word", prompt: "Set the slider to v when u = 2, a = 3, t = 4 (key: value).", challenge: "Adjust the values below so they match the condition described in the prompt.", validate: { value: 14 }, tolerance: 0, explanation: "v = 2 + 3×4 = 14.", hints: ["3×4 = 12.", "2 + 12.", "v = 2 + 3×4 = 14."] }
    ],
