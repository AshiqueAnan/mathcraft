...
export const T2U13L1: Lesson = {
  ...
  quiz: {
    pool: [
      ...
      // @q03
      { id: "U13L1-mcq-3", type: "mcq", category: "word", prompt: "Pizza price P = 2n + 3 for n toppings. Find P when n = 4.", options: [ { id: "a", text: "24" }, { id: "b", text: "9" }, { id: "c", text: "11" }, { id: "d", text: "7" } ], correctOptionId: "c", diagnoses: { b: "9 = 2+4+3 — 2n is 2×n.", a: "24 = 2×4×3.", d: "7 = 4+3, dropped the 2n." }, explanation: "P = 2×4 + 3 = 8 + 3 = 11.", hints: ["2n = 2×4.", "8 + 3.", "11."] },
      // @q04
      { id: "U13L1-mcq-4", type: "mcq", category: "procedural", prompt: "Evaluate E = mc² for m = 2, c = 3.", options: [ { id: "a", text: "6" }, { id: "b", text: "36" }, { id: "c", text: "12" }, { id: "d", text: "18" } ], correctOptionId: "d", diagnoses: { b: "36 = 2×3×6 — mis-squared.", c: "12 = 2×3×2 — mis-squared.", a: "6 = 2×3 — missed the square." }, explanation: "c² = 9, so E = 2 × 9 = 18.", hints: ["c² = 3² = 9.", "2 × 9.", "18."] },
      // @q05
      ...
      // @q06
      { id: "U13L1-mcq-6", type: "mcq", category: "word", prompt: "Taxi fare F = 2d + 5 for d km. Find F for 10 km.", options: [ { id: "a", text: "70" }, { id: "b", text: "25" }, { id: "c", text: "12" }, { id: "d", text: "15" } ], correctOptionId: "b", diagnoses: { a: "70 = 2×10×5 — the +5 adds.", c: "12 = 10+2 — dropped the 5.", d: "15 = 10+5 — dropped the ×2." }, explanation: "F = 2×10 + 5 = 20 + 5 = 25.", hints: ["2×10 = 20.", "Then +5.", "25."] },
      // @q07
