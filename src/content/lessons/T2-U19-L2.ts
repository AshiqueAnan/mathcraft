...
export const T2U19L2: Lesson = {
  ...
  quiz: {
    pool: [
      // @q01
      { id: "U19L2-mcq-1", type: "mcq", category: "procedural", prompt: "y = x³ at x = −2 gives…", options: [ { id: "a", text: "−8" }, { id: "b", text: "8" }, { id: "c", text: "−6" }, { id: "d", text: "6" } ], correctOptionId: "a", diagnoses: { b: "(−2)³ = −8 — the cube keeps the sign.", c: "That's x × 3, not x³.", d: "−2 × −2 × −2 = −8." }, explanation: "(−2)³ = −2 × −2 × −2 = −8.", hints: ["Cube = ×3 times.", "Sign stays.", "−8."] },
      // @q02
      { id: "U19L2-mcq-2", type: "mcq", category: "conceptual", prompt: "What is an ASYMPTOTE?", options: [ { id: "a", text: "A line the curve approaches but never touches" }, { id: "b", text: "Another name for the vertex" }, { id: "c", text: "The steepest part of a cubic" }, { id: "d", text: "A type of parabola" } ], correctOptionId: "a", diagnoses: { b: "Vertices are turning points, not asymptotes.", c: "Cubics don't have a fixed steepest part.", d: "Asymptotes are invisible guide lines." }, explanation: "The reciprocal races toward an asymptote forever without landing on it.", hints: ["Never touches.", "Invisible wall.", "Approaches forever."] },
      // @q03
      { id: "U19L2-mcq-3", type: "mcq", category: "word", prompt: "Camera shutter: y = 1/x. At x = 0.01 (very close to 0), y is…", options: [ { id: "a", text: "Huge (100)" }, { id: "b", text: "Tiny (0.01)" }, { id: "c", text: "Zero" }, { id: "d", text: "Negative" } ], correctOptionId: "a", diagnoses: { b: "0.01 is x; 1/0.01 = 100.", c: "y = 0 would need an infinitely large x.", d: "Positive x gives positive y." }, explanation: "1 ÷ 0.01 = 100 — y explodes near zero.", hints: ["1 ÷ 0.01.", "= 100.", "Huge."] },
      // @q04
      { id: "U19L2-mcq-4", type: "mcq", category: "procedural", prompt: "y = 1/x at x = 4 is…", options: [ { id: "a", text: "1/4" }, { id: "b", text: "4" }, { id: "c", text: "1/16" }, { id: "d", text: "−4" } ], correctOptionId: "a", diagnoses: { b: "4 is x itself; y = 1/4.", c: "That's 1/x².", d: "Positive x → positive y." }, explanation: "y = 1/4 at x = 4.", hints: ["Reciprocal of 4.", "1/4.", "1/4."] },
      // @q05
      { id: "U19L2-mcq-5", type: "mcq", category: "conceptual", prompt: "Why does y = 1/x have NO point at x = 0?", options: [ { id: "a", text: "1 ÷ 0 is undefined — division by zero doesn't exist" }, { id: "b", text: "The graph is broken and needs repair" }, { id: "c", text: "Zero is too small to plot" }, { id: "d", text: "It actually does have a point there" } ], correctOptionId: "a", diagnoses: { b: "It's not broken — the asymptote is the mathematical truth.", c: "Smallness isn't the issue; undefinedness is.", d: "1/0 has no value, so no point exists." }, explanation: "Division by zero is undefined — the asymptote marks the boundary.", hints: ["1/0 = ?", "No value.", "Undefined."] },
      // @q06
      { id: "U19L2-mcq-6", type: "mcq", category: "word", prompt: "Speed vs time: t = 60/v (hours). If v doubles from 2 to 4 km/h, the time…", options: [ { id: "a", text: "Halves (30 → 15 h)" }, { id: "b", text: "Stays the same" }, { id: "c", text: "Doubles" }, { id: "d", text: "Quadruples" } ], correctOptionId: "a", diagnoses: { b: "1/x is not constant — it shrinks as x grows.", c: "Doubling v halves t, the reciprocal relationship.", d: "That's inverse-square, not inverse." }, explanation: "t = 60/2 = 30 → 60/4 = 15 — inverse proportion.", hints: ["60 ÷ 2.", "60 ÷ 4.", "30 → 15."] },
      // @q07
      { id: "U19L2-num-1", type: "numeric-input", category: "procedural", prompt: "y = x³. Type the value at x = 2.", answer: 8, tolerance: 0, explanation: "2³ = 8.", hints: ["2 × 2 × 2.", "8.", "8."] },
      // @q08
      { id: "U19L2-num-2", type: "numeric-input", category: "procedural", prompt: "y = 1/x. Type the value at x = 5.", answer: 0.2, tolerance: 0, explanation: "1/5 = 0.2.", hints: ["Reciprocal of 5.", "0.2.", "0.2."] },
      // @q09
      { id: "U19L2-num-3", type: "numeric-input", category: "conceptual", prompt: "y = 1/x. Type the value at x = 0.001.", answer: 1000, tolerance: 0, explanation: "1 ÷ 0.001 = 1000 — huge near zero.", hints: ["1 ÷ 0.001.", "1000.", "1000."] },
      // @q10
      { id: "U19L2-frac-1", type: "fraction-input", category: "conceptual", prompt: "y = 1/x at x = 8. Write y as a fraction.", numerator: 1, denominator: 8, acceptEquivalent: true, explanation: "y = 1/8.", hints: ["Reciprocal of 8.", "1/8.", "1/8."] },
      // @q11
      { id: "U19L2-tf-1", type: "true-false-justify", category: "conceptual", prompt: "y = x³ passes through the origin.", isTrue: true, explanation: "x = 0 → y = 0³ = 0.", hints: ["0³ = 0.", "Passes origin.", "True."] },
      // @q12
      { id: "U19L2-tf-2", type: "true-false-justify", category: "conceptual", prompt: "y = 1/x crosses the y-axis.", isTrue: false, explanation: "x = 0 is undefined — the curve never touches the axis (asymptote).", hints: ["x = 0 undefined.", "No crossing.", "False."] },
      // @q13
      ...
      // @q15
      { id: "U19L2-graph-1", type: "graph-interact", category: "word", prompt: "y = 1/x near x = 0 shoots upward. Set the slider to a small x where y is huge (key: value).", challenge: "Set the slider to 0.1.", validate: { value: 0.1 }, tolerance: 0.01, explanation: "At x = 0.1, y = 10 — steeply climbing.", hints: ["1 ÷ 0.1 = 10.", "x = 0.1.", "0.1."] }
    ],
