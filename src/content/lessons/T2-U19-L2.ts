...
export const T2U19L2: Lesson = {
  ...
  quiz: {
    pool: [
      ...
      // @q04
      { id: "U19L2-mcq-4", type: "mcq", category: "procedural", prompt: "y = 1/x at x = 4 is…", options: [ { id: "a", text: "−4" }, { id: "b", text: "4" }, { id: "c", text: "1/16" }, { id: "d", text: "1/4" } ], correctOptionId: "d", diagnoses: { b: "4 is x itself; y = 1/4.", c: "That's 1/x².", a: "Positive x → positive y." }, explanation: "y = 1/4 at x = 4.", hints: ["Reciprocal of 4.", "1/4.", "1/4."] },
      // @q05
      ...
      // @q06
      { id: "U19L2-mcq-6", type: "mcq", category: "word", prompt: "Speed vs time: t = 60/v (hours). If v doubles from 2 to 4 km/h, the time…", options: [ { id: "a", text: "Stays the same" }, { id: "b", text: "Halves (30 → 15 h)" }, { id: "c", text: "Doubles" }, { id: "d", text: "Quadruples" } ], correctOptionId: "b", diagnoses: { a: "1/x is not constant — it shrinks as x grows.", c: "Doubling v halves t, the reciprocal relationship.", d: "That's inverse-square, not inverse." }, explanation: "t = 60/2 = 30 → 60/4 = 15 — inverse proportion.", hints: ["60 ÷ 2.", "60 ÷ 4.", "30 → 15."] },
      // @q07
