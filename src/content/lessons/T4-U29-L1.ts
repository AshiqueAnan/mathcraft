...
export const T4U29L1: Lesson = {
  ...
  intuitionBlocks: [{ widget: "number-line", narrative: "Slide events onto a 0–1 line: a dice roll, a coin flip, tomorrow's sunrise. Each lands somewhere between impossible (0) and certain (1). Then roll a fair die and count: favourable outcomes divided by the 6 total outcomes gives the probability." }],
  ...
  quiz: {
    pool: [
      // @q01
      { id: "U29L1-mcq-1", type: "mcq", category: "procedural", prompt: "P(getting a 4 on a fair die) = …", options: [ { id: "a", text: "1/6 ≈ 0.167" }, { id: "b", text: "1/4 = 0.25" }, { id: "c", text: "4/6 ≈ 0.667" }, { id: "d", text: "1" } ], correctOptionId: "a", diagnoses: { b: "1/4 confuses faces with total 6.", c: "4/6 is P(4 or more), not P(4).", d: "1 is certainty — impossible for one face." }, explanation: "1 favourable face out of 6 equally likely faces.", hints: ["Favourable ÷ total.", "1 ÷ 6.", "1/6."] },
      // @q02
      { id: "U29L1-mcq-2", type: "mcq", category: "conceptual", prompt: "An impossible event has probability…", options: [ { id: "a", text: "0" }, { id: "b", text: "1" }, { id: "c", text: "0.5" }, { id: "d", text: "negative" } ], correctOptionId: "a", diagnoses: { b: "1 is certainty.", c: "0.5 is a fair coin flip.", d: "Probabilities are never negative." }, explanation: "No favourable outcomes → P = 0.", hints: ["Never happens.", "0.", "0."] },
      // @q03
      { id: "U29L1-mcq-3", type: "mcq", category: "word", prompt: "A fair spinner has 4 equal colours. P(red) = …", options: [ { id: "a", text: "1/4 = 0.25" }, { id: "b", text: "1/3" }, { id: "c", text: "4" }, { id: "d", text: "0.75" } ], correctOptionId: "a", diagnoses: { b: "1/3 would need 3 total outcomes.", c: "4 is the total count.", d: "0.75 is P(not red)." }, explanation: "1 red section out of 4 equal sections.", hints: ["1 of 4.", "1/4.", "0.25."] },
      // @q04
      { id: "U29L1-mcq-4", type: "mcq", category: "procedural", prompt: "P(even) on a fair die is…", options: [ { id: "a", text: "3/6 = 0.5" }, { id: "b", text: "2/6 = 0.33" }, { id: "c", text: "6/6 = 1" }, { id: "d", text: "1/6" } ], correctOptionId: "a", diagnoses: { b: "2/6 is P(one pair of faces).", c: "1 is certainty.", d: "1/6 is P(single face)." }, explanation: "Faces 2, 4, 6 = 3 favourable out of 6.", hints: ["2, 4, 6.", "3 ÷ 6.", "0.5."] },
      // @q05
      ...
      // @q06
      { id: "U29L1-mcq-6", type: "mcq", category: "word", prompt: "A bag has 3 red, 2 blue, 5 green marbles. P(blue) = …", options: [ { id: "a", text: "2/10 = 0.2" }, { id: "b", text: "2/5 = 0.4" }, { id: "c", text: "5/10 = 0.5" }, { id: "d", text: "1/3" } ], correctOptionId: "a", diagnoses: { b: "2/5 ignores green marbles in the total.", c: "5/10 is P(green).", d: "1/3 isn't the split." }, explanation: "2 blue out of 10 total marbles.", hints: ["Total = 10.", "2 ÷ 10.", "0.2."] },
      // @q07
      { id: "U29L1-num-1", type: "numeric-input", category: "procedural", prompt: "P(rolling a 6 on a fair die) as a fraction.", answer: 6, tolerance: 0, explanation: "1 favourable face out of 6 → 1/6, denominator 6.", hints: ["1 of 6.", "1/6.", "denominator 6."] },
      // @q08
      { id: "U29L1-num-2", type: "numeric-input", category: "procedural", prompt: "A fair coin flipped once. P(tails) = … (decimal)", answer: 0.5, tolerance: 0.01, acceptFractions: true, explanation: "1 of 2 equally likely outcomes.", hints: ["1 ÷ 2.", "0.5.", "0.5."] },
      // @q09
      { id: "U29L1-num-3", type: "numeric-input", category: "conceptual", prompt: "P(sun rises tomorrow morning) is closest to…", answer: 1, tolerance: 0.01, acceptFractions: true, explanation: "Effectively certain — probability 1.", hints: ["Certain.", "1.", "1."] },
      // @q10
      { id: "U29L1-frac-1", type: "fraction-input", category: "conceptual", prompt: "A bag: 3 red, 2 blue, 5 green. P(red OR blue) as a fraction of the total.", numerator: 5, denominator: 10, acceptEquivalent: true, explanation: "5 favourable (3 red + 2 blue) out of 10 → 1/2.", hints: ["3 + 2 = 5.", "5/10.", "1/2."] },
      // @q11
      { id: "U29L1-tf-1", type: "true-false-justify", category: "conceptual", prompt: "All probabilities of the possible outcomes sum to 1.", isTrue: true, explanation: "Heads + tails = 1; all six die faces sum to 1; the full set is certainty.", hints: ["Full set = certain.", "Sum = 1.", "True."] },
      // @q12
      { id: "U29L1-tf-2", type: "true-false-justify", category: "conceptual", prompt: "A weighted coin where heads comes up more often still has P(heads) = 0.5.", isTrue: false, explanation: "Unequal outcomes break the equally-likely assumption.", hints: ["Not equally likely.", "No 1/2.", "False."] },
      // @q13
      { id: "U29L1-order-1", type: "order-steps", category: "word", prompt: "Order the steps to find P(even) on a fair die.", sequence: ["Count total outcomes: 6", "Count favourable: 2, 4, 6 → 3", "Divide: 3 ÷ 6 = 0.5"], diagnoses: { "Count total outcomes: 6@1": "Total first.", "Count favourable: 2, 4, 6 → 3@0": "Then favourable.", "Divide: 3 ÷ 6 = 0.5@0": "Divide last." }, explanation: "Total, favourable, divide.", hints: ["6 faces.", "3 evens.", "0.5."] },
      // @q14
      { id: "U29L1-drag-1", type: "drag-match", category: "conceptual", prompt: "Match each event to its probability.", pairs: [ { source: "Heads on fair coin", target: "0.5" }, { source: "Rolling 7 on a standard die", target: "0" }, { source: "Sun rising tomorrow", target: "1" } ], diagnoses: { "Heads on fair coin->0": "A fair coin is 0.5.", "Rolling 7 on a standard die->0.5": "No 7 face → 0.", "Sun rising tomorrow->0": "Certain → 1." }, explanation: "Each event sits at its spot on the 0–1 line.", hints: ["Coin = 0.5.", "7 = 0.", "Sunrise = 1."] },
      // @q15
      { id: "U29L1-graph-1", type: "graph-interact", category: "word", prompt: "A fair die: set the slider to P(rolling a 5) (key: value).", challenge: "Set the slider to 0.17.", validate: { value: 0.17 }, tolerance: 0.02, explanation: "1/6 ≈ 0.167.", hints: ["1 ÷ 6.", "≈ 0.167.", "0.17."] }
    ],
