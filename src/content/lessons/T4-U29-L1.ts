...
export const T4U29L1: Lesson = {
  ...
  quiz: {
    pool: [
      ...
      // @q04
      { id: "U29L1-mcq-4", type: "mcq", category: "procedural", prompt: "P(even) on a fair die is…", options: [ { id: "a", text: "1/6" }, { id: "b", text: "2/6 = 0.33" }, { id: "c", text: "6/6 = 1" }, { id: "d", text: "3/6 = 0.5" } ], correctOptionId: "d", diagnoses: { b: "2/6 is P(one pair of faces).", c: "1 is certainty.", a: "1/6 is P(single face)." }, explanation: "Faces 2, 4, 6 = 3 favourable out of 6.", hints: ["2, 4, 6.", "3 ÷ 6.", "0.5."] },
      // @q05
      ...
      // @q06
      { id: "U29L1-mcq-6", type: "mcq", category: "word", prompt: "A bag has 3 red, 2 blue, 5 green marbles. P(blue) = …", options: [ { id: "a", text: "2/5 = 0.4" }, { id: "b", text: "2/10 = 0.2" }, { id: "c", text: "5/10 = 0.5" }, { id: "d", text: "1/3" } ], correctOptionId: "b", diagnoses: { a: "2/5 ignores green marbles in the total.", c: "5/10 is P(green).", d: "1/3 isn't the split." }, explanation: "2 blue out of 10 total marbles.", hints: ["Total = 10.", "2 ÷ 10.", "0.2."] },
      // @q07
