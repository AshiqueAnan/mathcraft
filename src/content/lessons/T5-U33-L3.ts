...
export const T5U33L3: Lesson = {
  ...
  quiz: {
    pool: [
      ...
      // @q04
      { id: "U33L3-mcq-4", type: "mcq", category: "procedural", prompt: "tan 45° = …", options: [ { id: "a", text: "2" }, { id: "b", text: "√2/2" }, { id: "c", text: "0" }, { id: "d", text: "1" } ], correctOptionId: "d", diagnoses: { b: "√2/2 is sin or cos 45°.", c: "0 is tan 0°.", a: "tan never needs to be 2 here." }, explanation: "tan 45° = sin45°/cos45° = 1.", hints: ["sin45°/cos45°.", "Both √2/2.", "1."] },
      // @q05
      ...
      // @q06
      { id: "U33L3-mcq-6", type: "mcq", category: "word", prompt: "A rope at 60° has sin 60° = √3/2. If cos 60° = 1/2, tan 60° = …", options: [ { id: "a", text: "1/2" }, { id: "b", text: "√3" }, { id: "c", text: "1" }, { id: "d", text: "3" } ], correctOptionId: "b", diagnoses: { a: "1/2 is cos 60°.", c: "1 is tan 45°.", d: "3 is the square of √3." }, explanation: "tan 60° = (√3/2)/(1/2) = √3.", hints: ["Divide the fractions.", "(√3/2) ÷ (1/2).", "√3."] },
      // @q07
