...
export const T5U33L3: Lesson = {
  ...
  quiz: {
    pool: [
      // @q01
      { id: "U33L3-mcq-1", type: "mcq", category: "procedural", prompt: "sin²30° + cos²30° = …", options: [ { id: "a", text: "1" }, { id: "b", text: "1/2" }, { id: "c", text: "3/4" }, { id: "d", text: "2" } ], correctOptionId: "a", diagnoses: { b: "1/2 is sin 30° alone.", c: "3/4 is cos²30° alone.", d: "The identity always sums to 1." }, explanation: "(1/2)² + (√3/2)² = 1/4 + 3/4 = 1.", hints: ["Pythagorean identity.", "Squares sum to 1.", "(1/2)² + (√3/2)² = 1/4 + 3/4 = 1."] },
      // @q02
      { id: "U33L3-mcq-2", type: "mcq", category: "conceptual", prompt: "Where does sin²θ + cos²θ = 1 come from?", options: [ { id: "a", text: "it's a guess" }, { id: "b", text: "Pythagoras on a hypotenuse-1 triangle" }, { id: "c", text: "from the sine rule" }, { id: "d", text: "only for right angles" } ], correctOptionId: "b", diagnoses: { a: "It's proved, not guessed.", c: "The sine rule is unrelated.", d: "It holds for every angle." }, explanation: "Unit circle: x = cos θ, y = sin θ, and x² + y² = 1 is Pythagoras.", hints: ["Hypotenuse 1.", "Legs sin and cos.", "Unit circle: x = cos θ, y = sin θ, and x² + y² = 1 is Pythagoras."] },
      // @q03
      { id: "U33L3-mcq-3", type: "mcq", category: "word", prompt: "A ramp's slope at angle θ: tan θ = sin θ / cos θ. If sin θ = 0.6 and cos θ = 0.8, the slope is…", options: [ { id: "a", text: "1.4" }, { id: "b", text: "0.48" }, { id: "c", text: "0.75" }, { id: "d", text: "1" } ], correctOptionId: "c", diagnoses: { b: "0.48 is sin × cos — the ratio divides.", a: "1.4 adds them.", d: "1 is tan 45°." }, explanation: "tan θ = 0.6 / 0.8 = 0.75.", hints: ["0.6 ÷ 0.8.", "0.75.", "tan θ = 0.6 / 0.8 = 0.75."] },
      // @q04
      { id: "U33L3-mcq-4", type: "mcq", category: "procedural", prompt: "tan 45° = …", options: [ { id: "a", text: "2" }, { id: "b", text: "√2/2" }, { id: "c", text: "0" }, { id: "d", text: "1" } ], correctOptionId: "d", diagnoses: { b: "√2/2 is sin or cos 45°.", c: "0 is tan 0°.", a: "tan never needs to be 2 here." }, explanation: "tan 45° = sin45°/cos45° = 1.", hints: ["sin45°/cos45°.", "Both √2/2.", "tan 45° = sin45°/cos45° = 1."] },
      // @q05
      ...
      // @q06
      { id: "U33L3-mcq-6", type: "mcq", category: "word", prompt: "A rope at 60° has sin 60° = √3/2. If cos 60° = 1/2, tan 60° = …", options: [ { id: "a", text: "1/2" }, { id: "b", text: "√3" }, { id: "c", text: "1" }, { id: "d", text: "3" } ], correctOptionId: "b", diagnoses: { a: "1/2 is cos 60°.", c: "1 is tan 45°.", d: "3 is the square of √3." }, explanation: "tan 60° = (√3/2)/(1/2) = √3.", hints: ["Divide the fractions.", "(√3/2) ÷ (1/2).", "tan 60° = (√3/2)/(1/2) = √3."] },
      // @q07
      { id: "U33L3-num-1", type: "numeric-input", category: "procedural", prompt: "sin²θ + cos²θ = … (any θ)", answer: 1, tolerance: 0, explanation: "The Pythagorean identity always equals 1.", hints: ["Identity.", "1.", "The Pythagorean identity always equals 1."] },
      // @q08
      { id: "U33L3-num-2", type: "numeric-input", category: "procedural", prompt: "If sin θ = 0.6 and θ is acute, cos θ = …", answer: 0.8, tolerance: 0.01, acceptFractions: true, explanation: "cos θ = √(1 - 0.36) = √0.64 = 0.8.", hints: ["1 - 0.36.", "√0.64.", "cos θ = √(1 - 0."] },
      // @q09
      { id: "U33L3-num-3", type: "numeric-input", category: "conceptual", prompt: "sin 45° = √2/2 ≈ 0.7071. And cos 45° = the same value. sin²45° + cos²45° = ?", answer: 1, tolerance: 0, explanation: "2 × (1/2) = 1 — identity holds at 45°.", hints: ["(√2/2)² twice.", "1/2 + 1/2.", "2 × (1/2) = 1 — identity holds at 45°."] },
      // @q10
      { id: "U33L3-frac-1", type: "fraction-input", category: "conceptual", prompt: "tan θ = sin θ / cos θ. If sin θ = 3/5 and cos θ = 4/5, express tan θ as a fraction.", numerator: 3, denominator: 4, acceptEquivalent: true, explanation: "(3/5) ÷ (4/5) = 3/4.", hints: ["(3/5)(5/4).", "3/4.", "(3/5) ÷ (4/5) = 3/4."] },
      // @q11
      { id: "U33L3-tf-1", type: "true-false-justify", category: "conceptual", prompt: "sin²θ + cos²θ = 1 is true for every angle θ.", isTrue: true, explanation: "It's the unit-circle version of Pythagoras — holds for all θ.", hints: ["Unit circle.", "Pythagoras.", "It's the unit-circle version of Pythagoras — holds for all θ."] },
      // @q12
      { id: "U33L3-tf-2", type: "true-false-justify", category: "conceptual", prompt: "sin²θ is the same as sin(θ²).", isTrue: false, explanation: "sin²θ = (sin θ)² — square the value, not the angle.", hints: ["(sin θ)².", "Angle not squared.", "sin²θ = (sin θ)² — square the value, not the angle."] },
      // @q13
      { id: "U33L3-order-1", type: "order-steps", category: "word", prompt: "Order the steps to prove sin²θ + cos²θ = 1 on the unit circle.", sequence: ["Place a point at angle θ on radius 1", "Label x = cos θ, y = sin θ", "Apply Pythagoras: x² + y² = 1"], diagnoses: { "Place a point at angle θ on radius 1@1": "Start with the circle.", "Label x = cos θ, y = sin θ@0": "Then the labels.", "Apply Pythagoras: x² + y² = 1@0": "Pythagoras last." }, explanation: "Circle, labels, Pythagoras.", hints: ["Unit circle.", "cos, sin.", "Circle, labels, Pythagoras."] },
      // @q14
      { id: "U33L3-drag-1", type: "drag-match", category: "conceptual", prompt: "Match each identity to its meaning.", pairs: [ { source: "sin²θ + cos²θ", target: "= 1" }, { source: "tan θ", target: "sin θ / cos θ" }, { source: "point on unit circle", target: "(cos θ, sin θ)" } ], diagnoses: { "sin²θ + cos²θ->sin θ / cos θ": "Squares sum to 1.", "tan θ->= 1": "tan is the ratio.", "point on unit circle->= 1": "Its coordinates are cos and sin." }, explanation: "Identity, ratio, and circle coordinates.", hints: ["Pythagoras.", "Ratio.", "Identity, ratio, and circle coordinates."] },
      // @q15
      { id: "U33L3-graph-1", type: "graph-interact", category: "word", prompt: "sin θ = 0.8. Set the slider to cos θ (key: value).", challenge: "sin θ = 0.8. — adjust the values below to match the condition.", validate: { value: 0.6 }, tolerance: 0.01, explanation: "cos θ = √(1 - 0.64) = √0.36 = 0.6.", hints: ["1 - 0.64.", "√0.36.", "cos θ = √(1 - 0."] }
    ],
