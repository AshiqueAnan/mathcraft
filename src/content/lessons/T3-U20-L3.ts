...
export const T3U20L3: Lesson = {
  ...
  quiz: {
    pool: [
      // @q01
      { id: "U20L3-mcq-1", type: "mcq", category: "procedural", prompt: "With parallel lines, a corresponding angle is 70°. Its twin is…", options: [ { id: "a", text: "70°" }, { id: "b", text: "110°" }, { id: "c", text: "20°" }, { id: "d", text: "90°" } ], correctOptionId: "a", diagnoses: { b: "110° would be the co-interior partner.", c: "No halving here.", d: "90° is for right angles." }, explanation: "Corresponding angles are equal: 70°.", hints: ["Same position.", "Equal.", "70°."] },
      // @q02
      { id: "U20L3-mcq-2", type: "mcq", category: "conceptual", prompt: "Which pair of angles are ALWAYS equal with parallel lines?", options: [ { id: "a", text: "Alternate angles (the zig-zag pair)" }, { id: "b", text: "Co-interior angles" }, { id: "c", text: "Angles on the same line" }, { id: "d", text: "Any two angles below the line" } ], correctOptionId: "a", diagnoses: { b: "Co-interior sum to 180° — they're not equal.", c: "Same-line angles sum to 180°, not equal.", d: "Position matters, not just being below." }, explanation: "Alternate angles (and corresponding) are equal; co-interior sum to 180°.", hints: ["Z-shape.", "Alternate equal.", "Alternate."] },
      // @q03
      { id: "U20L3-mcq-3", type: "mcq", category: "word", prompt: "A staircase rail's parallel bars: an alternate angle is 55°. The other alternate is…", options: [ { id: "a", text: "55°" }, { id: "b", text: "125°" }, { id: "c", text: "35°" }, { id: "d", text: "180°" } ], correctOptionId: "a", diagnoses: { b: "125° is the co-interior neighbour.", c: "35 is 90 − 55, unrelated.", d: "180 is the line total." }, explanation: "Alternate angles are equal: 55°.", hints: ["Alternate equal.", "55°.", "55°."] },
      // @q04
      { id: "U20L3-mcq-4", type: "mcq", category: "procedural", prompt: "A co-interior angle is 65°. What is its partner?", options: [ { id: "a", text: "115°" }, { id: "b", text: "65°" }, { id: "c", text: "25°" }, { id: "d", text: "90°" } ], correctOptionId: "a", diagnoses: { b: "Co-interior are NOT equal — they sum to 180°.", c: "25 is 90 − 65, unrelated.", d: "Right angle isn't guaranteed." }, explanation: "Co-interior sum: 180 − 65 = 115°.", hints: ["Co-interior = 180° total.", "180 − 65.", "115°."] },
      // @q05
      { id: "U20L3-mcq-5", type: "mcq", category: "conceptual", prompt: "What helps you recognize corresponding angles?", options: [ { id: "a", text: "An F-shape — same corner position on each parallel" }, { id: "b", text: "A Z-shape — zig-zag inside the parallels" }, { id: "c", text: "A C-shape — inside on the same side" }, { id: "d", text: "A straight X" } ], correctOptionId: "a", diagnoses: { b: "Z-shape is alternate.", c: "C-shape is co-interior.", d: "An X alone is just crossing lines." }, explanation: "Corresponding angles form the F-shape (or rotated F).", hints: ["F-shape.", "Same corner.", "Corresponding."] },
      // @q06
      { id: "U20L3-mcq-6", type: "mcq", category: "word", prompt: "Two tram rails parallel; a cable crosses making 120°. The co-interior partner inside is…", options: [ { id: "a", text: "60°" }, { id: "b", text: "120°" }, { id: "c", text: "30°" }, { id: "d", text: "180°" } ], correctOptionId: "a", diagnoses: { b: "120 is the given angle; the co-interior partner differs.", c: "30 is 90 − 60, unrelated.", d: "180 is the sum, not one angle." }, explanation: "Co-interior: 180 − 120 = 60°.", hints: ["Co-interior = 180°.", "180 − 120.", "60°."] },
      // @q07
      { id: "U20L3-num-1", type: "numeric-input", category: "procedural", prompt: "A zig-zag alternate angle is 48°. Type its twin.", answer: 48, tolerance: 0, explanation: "Alternate angles are equal: 48°.", hints: ["Alternate equal.", "48°.", "48°."] },
      // @q08
      { id: "U20L3-num-2", type: "numeric-input", category: "procedural", prompt: "A co-interior angle is 110°. Type its partner.", answer: 70, tolerance: 0, explanation: "180 − 110 = 70°.", hints: ["Co-interior = 180°.", "180 − 110.", "70°."] },
      // @q09
      { id: "U20L3-num-3", type: "numeric-input", category: "conceptual", prompt: "A corresponding angle is 33°. Type the other corresponding angle.", answer: 33, tolerance: 0, explanation: "Corresponding angles are equal: 33°.", hints: ["Same position.", "Equal.", "33°."] },
      // @q10
      { id: "U20L3-frac-1", type: "fraction-input", category: "conceptual", prompt: "Two co-interior angles are equal. Write each as a fraction of 180°.", numerator: 1, denominator: 2, acceptEquivalent: true, explanation: "Equal co-interior: 90° each = 1/2 of 180°.", hints: ["180 ÷ 2.", "90°.", "1/2."] },
      // @q11
      { id: "U20L3-tf-1", type: "true-false-justify", category: "conceptual", prompt: "Alternate angles with parallel lines are equal.", isTrue: true, explanation: "The zig-zag pair matches exactly.", hints: ["Z-shape.", "Equal.", "True."] },
      // @q12
      { id: "U20L3-tf-2", type: "true-false-justify", category: "conceptual", prompt: "Co-interior angles with parallel lines are equal.", isTrue: false, explanation: "Co-interior sum to 180° — only equal if both are 90°.", hints: ["C-shape = 180°.", "Not always equal.", "False."] },
      // @q13
      { id: "U20L3-order-1", type: "order-steps", category: "word", prompt: "Order the steps to find a missing alternate angle.", sequence: ["Identify the parallel lines", "Find the zig-zag alternate pair", "Note they are equal", "Copy the given angle value"], diagnoses: { "Identify the parallel lines@1": "Parallels first.", "Find the zig-zag alternate pair@0": "Locate the pair.", "Copy the given angle value@0": "Copy after identifying." }, explanation: "Parallels, pair, equality, value.", hints: ["Parallels.", "Zig-zag pair.", "Equal."] },
      // @q14
      { id: "U20L3-drag-1", type: "drag-match", category: "conceptual", prompt: "Match each angle pair to its rule.", pairs: [ { source: "Corresponding", target: "Equal (F-shape)" }, { source: "Alternate", target: "Equal (Z-shape)" }, { source: "Co-interior", target: "Sum 180° (C-shape)" } ], diagnoses: { "Corresponding->Sum 180° (C-shape)": "Corresponding are equal — F-shape.", "Alternate->Sum 180° (C-shape)": "Alternate are equal — Z-shape.", "Co-interior->Equal (F-shape)": "Co-interior sum to 180°." }, explanation: "F and Z equal; C sums to 180°.", hints: ["F = equal.", "Z = equal.", "C = 180°."] },
      // @q15
      { id: "U20L3-graph-1", type: "graph-interact", category: "word", prompt: "A co-interior angle is 115°. Set the slider to its partner (key: value).", challenge: "Set the slider to 65.", validate: { value: 65 }, tolerance: 0.01, explanation: "180 − 115 = 65°.", hints: ["180 − 115.", "65.", "65°."] }
    ],
