...
export const T3U20L3: Lesson = {
  ...
  quiz: {
    pool: [
      ...
      // @q06
      { id: "U20L3-mcq-6", type: "mcq", category: "word", prompt: "Two tram rails parallel; a cable crosses making 120°. The co-interior partner inside is…", options: [ { id: "a", text: "120°" }, { id: "b", text: "60°" }, { id: "c", text: "30°" }, { id: "d", text: "180°" } ], correctOptionId: "b", diagnoses: { a: "120 is the given angle; the co-interior partner differs.", c: "30 is 90 − 60, unrelated.", d: "180 is the sum, not one angle." }, explanation: "Co-interior: 180 − 120 = 60°.", hints: ["Co-interior = 180°.", "180 − 120.", "60°."] },
      // @q07
